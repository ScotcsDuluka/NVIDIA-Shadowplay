...
function(e, t, n) {
  ! function(e, r) {
    ...
    function h() {
      var e = this;
      return e instanceof SVGElement ? (e = e.ownerSVGElement || e, e.hasAttribute("viewBox") ? (e = e.viewBox
        .baseVal, [
          [e.x, e.y],
    ...
    function g(e, t, n) {
      ...
      return e.translate(i > r ? (r + i) / 2 : Math.min(0, r) || Math.max(0, i), a > o ? (o + a) / 2 : Math.min(0,
        o) || Math.max(0, a))
    }

    function y() {
      function e(e) {
        e.property("__zoom", p).on("wheel.zoom", T).on("mousedown.zoom", C).on("dblclick.zoom", x).filter(P).on(
          "touchstart.zoom", S).on("touchmove.zoom", A).on("touchend.zoom touchcancel.zoom", M).style(
      ...
      function T() {
        ...
        if (I.apply(this, arguments)) {
          var t = $(this, arguments),
            ...
            a = i.mouse(this);
          if (t.wheel) t.mouse[0][0] === a[0] && t.mouse[0][1] === a[1] || (t.mouse[1] = n.invert(t.mouse[0] = a)),
            clearTimeout(t.wheel);
          else {
            if (n.k === r) return;
            t.mouse = [a, n.invert(a)], o.interrupt(this), t.start()
          }
          d(), t.wheel = setTimeout(e, z), t.zoom("mouse", D(y(u(n, r), t.mouse[0], t.mouse[1]), t.extent, U))
        }
      }
      ...
      function C() {
        ...
        if (!N && I.apply(this, arguments)) {
          var r = $(this, arguments, !0),
            ...
            c = i.event.clientX,
            u = i.event.clientY;
          n.dragDisable(i.event.view), l(), r.mouse = [s, this.__zoom.invert(s)], o.interrupt(this), r.start()
        }
      }
      ...
      function x() {
        if (I.apply(this, arguments)) {
          ...
          d(), F > 0 ? i.select(this).transition().duration(F).call(_, a, n) : i.select(this).call(e.transform, a)
        }
      }

      function S() {
        if (I.apply(this, arguments)) {
          var e, t, n, r, a = i.event.touches,
            s = a.length,
            c = $(this, arguments, i.event.changedTouches.length === s);
          for (l(), t = 0; t < s; ++t) n = a[t], r = i.touch(this, a, n.identifier), r = [r, this.__zoom.invert(r), n
            .identifier
          ], c.touch0 ? c.touch1 || c.touch0[2] === r[2] || (c.touch1 = r, c.taps = 0) : (c.touch0 = r, e = !0, c
            .taps = 1 + !!k);
      ...
      function A() {
        if (this.__zooming) {
          var e, t, n, r, o = $(this, arguments),
            a = i.event.changedTouches,
            s = a.length;
          for (d(), k && (k = clearTimeout(k)), o.taps = 0, e = 0; e < s; ++e) t = a[e], n = i.touch(this, a, t
              .identifier), o.touch0 && o.touch0[2] === t.identifier ? o.touch0[0] = n : o.touch1 && o.touch1[2] === t
            .identifier && (o.touch1[0] = n);
          if (t = o.that.__zoom, o.touch1) {
            ...
            t = u(t, Math.sqrt(p / m)), n = [(c[0] + f[0]) / 2, (c[1] + f[1]) / 2], r = [(l[0] + h[0]) / 2, (l[1] + h[
              1]) / 2]
          } else {
            if (!o.touch0) return;
      ...
      function M() {
        if (this.__zooming) {
          var e, t, n = $(this, arguments),
            r = i.event.changedTouches,
            o = r.length;
          for (l(), N && clearTimeout(N), N = setTimeout(function() {
              N = null
            }, B), e = 0; e < o; ++e) t = r[e], n.touch0 && n.touch0[2] === t.identifier ? delete n.touch0 : n
            .touch1 && n.touch1[2] === t.identifier && delete n.touch1;
          if (n.touch1 && !n.touch0 && (n.touch0 = n.touch1, delete n.touch1), n.touch0) n.touch0[1] = this.__zoom
            .invert(n.touch0[0]);
      ...
      return e.transform = function(e, t, n) {
        ...
        r.property("__zoom", p), e !== r ? _(e, t, n) : r.interrupt().each(function() {
          $(this, arguments).start().zoom(null, "function" == typeof t ? t.apply(this, arguments) : t).end()
        })
        ...
        e.transform(t, function() {
          return D(this.__zoom.translate("function" == typeof n ? n.apply(this, arguments) : n, "function" ==
            typeof r ? r.apply(this, arguments) : r), O.apply(this, arguments), U)
        })
        ...
        e.transform(t, function() {
          ...
          return D(b.translate(o[0], o[1]).scale(t.k).translate("function" == typeof n ? -n.apply(this,
            arguments) : -n, "function" == typeof r ? -r.apply(this, arguments) : -r), e, U)
        }, i)
      }, w.prototype = {
        start: function() {
        ...
        zoom: function(e, t) {
          return this.mouse && "mouse" !== e && (this.mouse[1] = t.invert(this.mouse[0])), this.touch0 &&
            "touch" !== e && (this.touch0[1] = t.invert(this.touch0[0])), this.touch1 && "touch" !== e && (this
              .touch1[1] = t.invert(this.touch1[0])), this.that.__zoom = t, this.emit("zoom"), this
        },
        end: function() {
        ...
        return arguments.length ? (U[0][0] = +t[0][0], U[1][0] = +t[1][0], U[0][1] = +t[0][1], U[1][1] = +t[1][1],
          e) : [
          [U[0][0], U[0][1]],
          [U[1][0], U[1][1]]
        ]
