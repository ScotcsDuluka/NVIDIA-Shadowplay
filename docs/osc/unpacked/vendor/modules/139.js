...
// defines    : angular.module("ngResource")
// requires   : (none)
        ...
        function h(e, l, d, b) {
          function E(e, t) {
            ...
            return t = v({}, l, t), m(t, function(t, i) {
              y(t) && (t = t()), n[i] = t && t.charAt && "@" == t.charAt(0) ? r(e, t.substr(1)) : t
            }), n
          }
          ...
          return d = v({}, n.defaults.actions, d), $.prototype.toJSON = function() {
            ...
            d && !t.isNumber(d) && (s.debug(
              ...
              }), !k && f && (A = c.defer(), I.timeout = A.promise, d && (M = u(A.resolve, d))), l && (I
                .data = T), w.setUrlParams(I, v({}, E(T, e.params || {}), S), e.url);
              var R = a(I).then(function(n) {
                ...
                if (a) {
                  if (t.isArray(a) !== !!e.isArray) throw o("badcfg",
                    ...
                    r, e.isArray ? "array" : "object", t.isArray(a) ? "array" : "object", I
                    .method, I.url);
              ...
              return R.finally(function() {
                N.$resolved = !0, !k && f && (N.$cancelRequest = t.noop, u.cancel(M), A = M = I
                  .timeout = null)
              }), R = R.then(function(e) {
                var t = O(e);
                return (C || p)(t, e.headers), t
              }, D), k ? R : (N.$promise = R, N.$resolved = !1, f && (N.$cancelRequest = A.resolve), N)
        ...
        return f.prototype = {
          setUrlParams: function(n, r, i) {
            ...
            m(u.split(/\W/), function(e) {
              ...
              !new RegExp("^\\d+$").test(e) && e && new RegExp("(^|[^\\\\]):" + e + "(\\W|$)").test(
                u) && (h[e] = {
              ...
              a = r.hasOwnProperty(n) ? r[n] : c.defaults[n], t.isDefined(a) && null !== a ? (s = e
                .isQueryParamValue ? d(a, !0) : l(a), u = u.replace(new RegExp(":" + n + "(\\W|$)",
                  "g"), function(e, t) {
                  return s + t
                })) : u = u.replace(new RegExp("(/?):" + n + "(\\W|$)", "g"), function(e, t, n) {
                return "/" == n.charAt(0) ? n : t + n
              })
            }), c.defaults.stripTrailingSlashes && (u = u.replace(/\/+$/, "") || "/"), u = u.replace(
              /\/\.(?=\w+($|\?))/, "."), n.url = f + u.replace(/\/\\\./, "/."), m(r, function(e, t) {
