  ...
  ! function(e, r) {
            ...
            u = m + c;
          {
            ...
            if (o.index > a.index) {
              var l = h - o.x - o.vx,
                f = p - o.y - o.vy,
                g = l * l + f * f;
              g < u * u && (0 === l && (l = s(), g += l * l), 0 === f && (f = s(), g += f * f), g = (u - (g = Math
                  .sqrt(g))) / g * d, a.vx += (l *= g) * (u = (c *= c) / (v + c)), a.vy += (f *= g) * u, o.vx -= l *
                (u = 1 - u), o.vy -= f * u)
            }
          }
        }
        for (var n, i, a, h, p, m, v, g = o.length, y = 0; y < f; ++y)
          for (i = t.quadtree(o, c, u).visitAfter(r), n = 0; n < g; ++n) a = o[n], m = l[a.index], v = m * m, h = a
            .x + a.vx, p = a.y + a.vy, i.visit(e)
      }
    ...
    function h(e) {
      ...
      function r(t) {
        for (var n = 0, r = e.length; n < b; ++n)
          for (var i, o, a, c, d, f, h, p = 0; p < r; ++p) i = e[p], o = i.source, a = i.target, c = a.x + a.vx - o
            .x - o.vx || s(), d = a.y + a.vy - o.y - o.vy || s(), f = Math.sqrt(c * c + d * d), f = (f - l[p]) / f *
            t * u[p], c *= f, d *= f, a.vx -= c * (h = m[p]), a.vy -= d * h, o.vx += c * (h = 1 - h), o.vy += d * h
      }
      ...
      function i() {
        if (h) {
          var t, r, i = h.length,
            a = e.length,
            s = n.map(h, v);
          for (t = 0, p = new Array(i); t < a; ++t) r = e[t], r.index = t, "object" != typeof r.source && (r.source =
            f(s, r.source)), "object" != typeof r.target && (r.target = f(s, r.target)), p[r.source.index] = (p[r
            .source.index] || 0) + 1, p[r.target.index] = (p[r.target.index] || 0) + 1;
          for (t = 0, m = new Array(a); t < a; ++t) r = e[t], m[t] = p[r.source.index] / (p[r.source.index] + p[r
            .target.index]);
    ...
    function v(e) {
      ...
      function o(t) {
        ...
        for (var o = 0; o < t; ++o)
          for (u += (f - u) * d, p.each(function(e) {
              e(u)
            }), n = 0; n < i; ++n) r = e[n], null == r.fx ? r.x += r.vx *= h : (r.x = r.fx, r.vx = 0), null == r.fy ?
            r.y += r.vy *= h : (r.y = r.fy, r.vy = 0);
        return c
      }
      ...
      return null == e && (e = []), a(), c = {
        ...
        find: function(t, n, r) {
          var i, o, a, s, c, u = 0,
            l = e.length;
          for (null == r ? r = 1 / 0 : r *= r, u = 0; u < l; ++u) s = e[u], i = t - s.x, o = n - s.y, a = i * i +
            o * o, a < r && (c = s, r = a);
          return c
        },
        on: function(e, t) {
    ...
    function g() {
      ...
      function r(e) {
        var t, n, r, i, o, a = 0,
          s = 0;
        if (e.length) {
          for (r = i = o = 0; o < 4; ++o)(t = e[o]) && (n = Math.abs(t.value)) && (a += t.value, s += n, r += n * t.x,
            i += n * t.y);
          e.x = r / s, e.y = i / s
        } else {
      ...
      function i(e, t, n, r) {
        ...
        var i = e.x - c.x,
          ...
          a = r - t,
          d = i * i + o * o;
        if (a * a / v < d) return d < h && (0 === i && (i = s(), d += i * i), 0 === o && (o = s(), d += o * o), d <
          f && (d = Math.sqrt(f * d)), c.vx += i * e.value * u / d, c.vy += o * e.value * u / d), !0;
        if (!(e.length || d >= h)) {
          (e.data !== c || e.next) && (0 === i && (i = s(), d += i * i), 0 === o && (o = s(), d += o * o), d < f && (
            d = Math.sqrt(f * d)));
          do e.data !== c && (a = l[e.data.index] * u / d, c.vx += i * a, c.vy += o * a); while (e = e.next)
        }
      }
      var o, c, u, l, d = a(-30),
        f = 1,
    ...
    function y(e, t, n) {
      ...
      function i() {
        if (o) {
          var t, n = o.length;
          for (s = new Array(n), c = new Array(n), t = 0; t < n; ++t) c[t] = +e(o[t], t, o), s[t] = isNaN(c[t]) ? 0 :
            +u(o[t], t, o)
        }
      }
      var o, s, c, u = a(.1);
      return "function" != typeof e && (e = a(+e)), null == t && (t = 0), null == n && (n = 0), r.initialize =
        function(e) {
          o = e, i()
        }, r.strength = function(e) {
    ...
    function b(e) {
      ...
      function n() {
        if (r) {
          var t, n = r.length;
          for (i = new Array(n), o = new Array(n), t = 0; t < n; ++t) i[t] = isNaN(o[t] = +e(r[t], t, r)) ? 0 : +s(r[
            t], t, r)
        }
      }
      var r, i, o, s = a(.1);
