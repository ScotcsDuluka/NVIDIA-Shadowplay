// ─────────────────────────────────────────────────────────────
// VENDOR MODULE 129
// role       : service runTimeConfigService | service hardwareConfigWrapper | service recordingPathConfigWrapper | service twitchIngestServerConfigWrapper | service facebookService | service googleService
// defines    : angular.module("connectSdk")
// requires   : (none)
  ...
  (function(e) {
    ...
    var i = n(161),
      ...
      p = angular.module("ugc-lib", ["underscore", "nvAngularJarvisSdk", "connectSdk", "facebookSdk",
        "googlePhotosSdk", "imgurSdk", "shotWithGeForceSdk", "twitchSdk", "weiboSdk", "youtubeSdk", "gallerySdk"
      ]);
    p.provider("ugcLib", ["connectEndpointsProvider", "facebookEndpointsProvider", "googlePhotosEndpointsProvider",
      "imgurEndpointsProvider", "shotWithGeForceEndpointsProvider", "twitchEndpointsProvider",
      "weiboEndpointsProvider", "youtubeEndpointsProvider", "galleryEndpointsProvider",
      function(e, t, n, r, i, o, a, s, c) {
        return {
          setNodeConfig: function(u) {
            e.setConfig(u), t.setConfig(u), n.setConfig(u), r.setConfig(u), i.setConfig(u), o.setConfig(u), a
              .setConfig(u), s.setConfig(u), c.setNodeConfig(u)
          },
      ...
      var e = this;
      e.hardwareSystemInfoGetter = null, e.hardwareSystemDescriptionGetter = null, e.init = function(t, n) {
    ...
    v.provider("facebookEndpoints", [function() {
      ...
      return {
        ...
        $get: ["$interpolate", "NvEndpointFactory", "$http", "jarvisService", function(t, n, r, i) {
          var o, a, s, c, u, l, f, h, p, m, v, g, y, b, E, $, w, T, C = new n,
            x = "v9.0",
          ...
          return C.setDefaultTimeout(A), C.setUrlGenerator(function(e, t) {
            ...
            return C.createEndpoint({
              ...
              params: {
                fields: _.reduce(t, function(e, t) {
                  return e + "reactions.type(" + t + ").limit(0).summary(total_count).as(" + t +
                    "),"
                }, "").slice(0, -1)
              }
            })
            ...
            c.append("video_file_chunk", u, "blob"), a(n, i), r({
              ...
              n.data.start_offset !== n.data.end_offset ? $(e, t, n.data.start_offset, n.data
                .end_offset, o, a, s) : s(!0)
            }).catch(function(e) {
              s(!1, e)
            })
          ...
          function(t, n, r, i, o, a, s) {
            ...
            function u(e, r, i, o, a, s) {
              ...
              return l.append("qqfile", c, "blob"), n({
                ...
                return a % 10 === 0 && v.info("Successfully uploaded chunk " + a + " of " + s), a < s ? u(
                  e, r, i, o, a + 1, s) : t
              }, function(e) {
            ...
            return m.setDefaultTimeout(g), m.setUrlGenerator(function(e, t) {
              ...
              return m.createEndpoint({
                ...
                return e.data.success ? e.data : (v.error("ShotWithGeForce connection failed with: ",
                  e), t.reject(e))
              })
            }, {
    ...
    $.provider("weiboEndpoints", function() {
      ...
      return {
        ...
        $get: ["$interpolate", "NvEndpointFactory", "$http", "$log", "$q", "jarvisService", function(t, n, r, i,
          o, a) {
          function s(e, t, n) {
            k || (k = new FileReader);
            var r = o.defer();
          ...
          function c(e) {
            function t() {
              return s(e, i, a).then(function(e) {
                if (!e.byteLength) return c.reject("File read error, invalid chunk length"), void(k =
                  null);
          ...
          _.setDefaultTimeout(C), _.setUrlGenerator(function(e, t) {
            ...
            var i = new FormData;
            return i.append("access_token", t), i.append("status", e.name + x), i.append("pic", e.file,
              "blob"), r({
    ...
    w.provider("youtubeEndpoints", [function() {
      ...
      return {
        ...
        $get: ["$interpolate", "$q", "NvEndpointFactory", "jarvisService", function(t, n, r, i) {
          var o, a, s, c, u, l, f, h, p, m, v, g, y, b, E, _, $ = new r,
    ...
    T.provider("galleryEndpoints", [function() {
      var e, t, n, r, i, o, a = "v.1.2";
      return {
        setNodeConfig: function(s) {
          n = s.server, t = n + s.port + "/Gallery/", e && (r = t + e), i = t + a, o = s.commonHeaders
        },
        setLocalConfig: function(n) {
          e = n.version, t && (r = t + e)
        },
        $get: ["NvEndpointFactory", function(s) {
          var c, u, l, d, f, h, p, m, v, g, y, b, E, _, $, w, T, C, x, S, A, M = new s,
            k = new s;
          return M.setUrlGenerator(function(e, t) {
            ...
            o.X_LOCAL_SECURITY_COOKIE = s.secret, t = n + s.port + "/Gallery/", e && (r = t + e), i = t +
              a
          }, {
    ...
    var S = function(e) {
      var t = function() {};
      if (this.file = e.file, this.contentType = e.contentType || this.file.type || "application/octet-stream", this
        .metadata = e.metadata || {
          title: this.file.name,
          mimeType: this.contentType
        }, this.token = e.token, this.onComplete = e.onComplete || t, this.onProgress = e.onProgress || t, this
        .onError = e.onError || t, this.offset = e.offset || 0, this.chunkSize = e.chunkSize || 0, this
        .retryHandler = new x, this.url = e.url, !this.url) {
        var n = e.params || {};
    ...
    S.prototype.upload = function() {
      ...
      e.open(this.httpMethod, this.url, !0), e.setRequestHeader("Authorization", this.token), e.setRequestHeader(
          "Content-Type", "application/json"), e.setRequestHeader("X-Upload-Content-Length", this.file.size), e
        .setRequestHeader("X-Upload-Content-Type", this.contentType), e.onload = function(e) {
      ...
      var e = this.file,
        t = this.file.size;
      (this.offset || this.chunkSize) && (this.chunkSize && (t = Math.min(this.offset + this.chunkSize, this.file
        .size)), e = e.slice(this.offset, t));
      var n = new XMLHttpRequest;
      n.open("PUT", this.url, !0), n.setRequestHeader("Content-Type", this.contentType), n.setRequestHeader(
          "Content-Range", "bytes " + this.offset + "-" + (t - 1) + "/" + this.file.size), n.setRequestHeader(
          "X-Upload-Content-Type", this.file.type), n.upload && n.upload.addEventListener("progress", this
          .onProgress), n.onload = this.onContentUploadSuccess_.bind(this), n.onerror = this.onContentUploadError_
        .bind(this), n.send(e)
      ...
      e.open("PUT", this.url, !0), e.setRequestHeader("Content-Range", "bytes */" + this.file.size), e
        .setRequestHeader("X-Upload-Content-Type", this.file.type), e.upload && e.upload.addEventListener(
          "progress", this.onProgress), e.onload = this.onContentUploadSuccess_.bind(this), e.onerror = this
        .onContentUploadError_.bind(this), e.send()
      ...
      200 === e.target.status || 201 === e.target.status ? this.onComplete(e.target.response) : e.target.status >=
        500 && e.target.status < 600 ? this.onError(e.target.response) : 308 === e.target.status && (this
          .extractRange_(e.target), this.retryHandler.reset(), this.sendFile_())
    }, S.prototype.onContentUploadError_ = function(e) {
      e.target.status && e.target.status < 500 ? this.onError(e.target.response) : this.retryHandler.retry(this
        .resume_.bind(this))
    ...
    p.service("facebookService", ["$q", "$log", "$interval", "facebookEndpoints", "galleryService", "jarvisService",
      "eventAggregator", "runTimeConfigService", "GALLERY_TYPES", "GALLERY_SUBTYPES", "CONNECT_EVENTS",
      ...
      function(e, t, n, r, i, o, a, s, c, u, l, f) {
        ...
        p.name = "facebook", p.serviceNames = {
          ...
          }, p.reactionTypes = ["NONE", "LIKE", "LOVE", "WOW", "HAHA", "SAD", "ANGRY", "THANKFUL"], p.logoutFunc =
          null;
        var S = function(t) {
          return void 0 === y || t ? null !== g && (g.expiresIn <= 0 || g.expiresOn > Date.now()) ? e.when(m + g
            .accessToken) : null !== g ? (g = null, p.logoutFunc && p.logoutFunc(p.serviceNames.FACEBOOK), e
            .reject("Invalid Login! Forced Logout")) : e.reject("Not logged in!") : e.when(m + y)
        };
        p.setAuthToken = function(e) {
          g = e, void 0 !== e.code && void 0 === e.accessToken ? r.getAccessToken(p.providerInfo, e.code).then(
            function(e) {
              p.setAuthTokenCallback(p.serviceNames.FACEBOOK, e.data)
            },
            function(e) {
              x.error("setAuthToken was unable to request an access token: ", e)
            }) : void 0 === e.accessToken && x.error("setAuthToken called without valid accessToken: ", e)
          ...
          var t = {};
          return t.title = angular.isDefined(e.title) ? e.title : C, t.privacy = angular.isDefined(e.privacy) ?
            e.privacy.value : T, t.destination = angular.isDefined(e.destination) && angular.isDefined(e
              .destination.id) ? e.destination.id : "me", y = angular.isDefined(e.destination) ? e.destination
            .access_token : void 0, S().then(function(e) {
              return r.createRtmpUrl(t)({
                authorization: e
              }).then(function(e) {
                v = e.data.id, x.info("Facebook video id: " + v);
                var t = "";
                return e.data.secure_stream_url ? (t = e.data.secure_stream_url, t.replace(":443", "")) :
                  (t = e.data.stream_url, t.replace(":80", ""))
              }, function(e) {
          ...
          return S().then(function(e) {
            return n({
              ...
              return x.info("Get Content Tags success, " + e.data.data.length + " matches found."), e
                .data.data
            }, function(e) {
          ...
          return S(!0).then(function(t) {
            return r.getPages({
              ...
              return x.info("Get Pages success, " + e.data.data.length + " pages returned."), e.data
                .data
            }, function(t) {
          ...
          return S(!0).then(function(t) {
            return r.getGroups({
              ...
              return x.info("Get Groups success, " + e.data.data.length + " groups returned."), e.data
                .data
            }, function(t) {
          ...
          return void 0 !== t.destination ? (y = t.destination.access_token, void 0 === t.destination.id && (t
            .destination.id = "me")) : (t.destination = {
            id: "me"
            ...
            return r.uploadImage(t, a, l).then(function(e) {
              ...
              .toLocaleTimeString(), c.IMAGE, t.subtype, a, t.originalSource).catch(function(e) {
                x.error("Addition to upload history failed, error : ", e)
              })
            }, function(t) {
              return y = void 0, x.error("Failed to upload image to Facebook: ", t.statusText), t &&
                401 == t.status && p.logoutFunc && p.logoutFunc(p.serviceNames.FACEBOOK), e.reject(t)
            })
          }, function(e) {
            y = void 0, x.info("Upload Access token error: ", e.statusText), a.trigger(f.UGC_NOTIFICATION, {
          ...
          return void 0 !== t.destination ? (y = t.destination.access_token, void 0 === t.destination.id && (t
            ...
            return x.info("Facebook video upload initialization: ", t.filepath, ", size: ", t.file.size), r
              .initializeVideoUpload(t.file.size, t.destination.id)({
                authorization: n
              }).then(function(a) {
                var l = e.defer(),
                  d = a.data.upload_session_id,
                  f = a.data.video_id;
                x.info("Facebook video upload transferring chunks. uploadSessionId = ", d, ", videoId = ",
                  f);
                var m = function(e, t) {
                    x.info("Facebook video upload progress. uploadSessionId = ", d, ", offsets = ", e, t)
                  },
                  v = function(e, a) {
                    if (!e) return a = a || "", x.info("Facebook upload failed, error : ", a), l.reject(
                      a), void(a && 401 == a.status && p.logoutFunc && p.logoutFunc(p.serviceNames
                        .FACEBOOK));
                    ...
                    r.finalizeVideoUpload(d, t, m)({
                      ...
                      x.info("Facebook video upload complete: ", e.data.success), y = void 0;
                      var n = new Date,
                      ...
                      t.subtype === u.GIF && (v = t.filepath.replace(/\\\\/g, "\\")), x.info(
                        "File for UploadHistory thumb: ", v), i.addGalleryUploadHistoryItem(t.title,
                        r, a, c.VIDEO, t.subtype, d, v).then(function() {
                        l.resolve()
                      }, function(e) {
                        x.error("Addition to upload history failed, error : ", e), l.resolve()
                      })
                    }, function(e) {
                      x.info("Facebook upload failed, error : ", e), l.reject(e), e && 401 == e
                        .status && p.logoutFunc && p.logoutFunc(p.serviceNames.FACEBOOK)
                    })
                  };
          ...
          return S().then(function(e) {
            return t({
              ...
              return _.each(p.reactionTypes, function(r) {
                null !== e.data[r] && void 0 !== e.data[r] && (t[r] = e.data[r].summary.total_count,
                  n += t[r])
              }), n /= 2, x.info("Get Reactions Summary success " + n), void 0 !== w && w === t || (a
                .trigger(l.FACEBOOK_REACTIONS, t), w = t), t
            }, function(e) {
          ...
          return S().then(function(e) {
            return n({
              ...
              if (t.data = _.filter(t.data, function(e) {
                  ...
                  e.from.avatarUri = "http://graph.facebook.com/" + e.from.id + "/picture?type=square"
                }), x.info("Get Comments success " + t.summary.total_count), void 0 !== t.data &&
                null !== t.data && void 0 !== t.data[0]) {
          ...
          e && e.facebook ? (p.providerInfo.clientId = e.facebook.clientId, p.providerInfo.useOauthProxy = e
            .facebook.useOauthProxy, e.facebook.config && (x.info(
              "Facebook configuration found, merging with Facebook service config blob."), angular.merge(p
              .providerInfo.services[p.serviceNames.FACEBOOK], e.facebook.config))) : x.error(
            "Facebook service initialization failed. No configuration found for Facebook!")
        }
      }
    ]), p.service("googleService", ["$q", "$log", "$interval", "eventAggregator", "youtubeEndpoints",
      "googlePhotosEndpoints", "jarvisService", "galleryService", "runTimeConfigService", "CONNECT_EVENTS",
      ...
      function(e, t, n, r, i, o, a, s, c, l, f, h, p) {
        ...
        var P = function(t) {
          ...
          if (t === y.serviceNames.GOOGLE_PHOTOS && 1 !== M[t].eFuse) return y.logoutFunc && y.logoutFunc(t),
            e.reject("Forced Google Photos logout due to new scopes.");
          var n = new Date,
            o = new Date(M[t].expiresOn);
          return n < o ? e.when(E + M[t].accessToken) : void 0 !== M[t].refreshToken ? (r.trigger(l
            .ACCESS_TOKEN_EXPIRED, y.name), i.refreshAccessToken(y.providerInfo, M[t]).then(function(e) {
        ...
        y.setAuthToken = function(e, t, n, r) {
          M[t] = e, void 0 !== e.code && void 0 === e.accessToken ? i.getAccessToken(y.providerInfo, e.code, r)
            .then(function(e) {
              y.setAuthTokenCallback(t, e.data)
            }, function(e) {
              D.error("setAuthToken was unable to request an access token: ", e)
            }) : void 0 === e.accessToken ? D.error("setAuthToken called without valid accessToken: ", e) :
            t !== y.serviceNames.GOOGLE_PHOTOS || n || (M[t].eFuse = 1)
          ...
          return P(y.serviceNames.YOUTUBE).then(function(n) {
            var o = {},
              a = new Date;
            O = a.toISOString(), angular.isDefined(t.title) ? (N = t.title, N.length > w && (N = N.substr(0,
                w))) : N = $, I = angular.isDefined(t.privacy) ? t.privacy.value : T, o.startTime = O, o
              .title = N, o.privacy = I;
            var s = i.createLiveBroadcast(o);
            return s({
              authorization: n
            }).then(function(a) {
              if (D.info("YTL LiveBroadcast id: " + a.data.id), x = a.data.id, o.resolution = t
                .resolution, o.frameRate = "30fps", 60 === t.framerate) {
                var s;
                s = y.providerInfo.services[y.serviceNames.YOUTUBE].supported_settings[t.framerate];
              ...
              return u({
                ...
                var o = t.data.cdn.ingestionInfo.ingestionAddress + "/" + t.data.cdn.ingestionInfo
                  .streamName;
              ...
              t({
                ...
                if (D.info("listStream success " + o), 0 === o.localeCompare("active")) {
                  ...
                  a({
                    ...
                    if (D.info("listBroadcast success " + o), 0 === o.localeCompare("live") && n
                      .cancel(g), 0 === o.localeCompare("ready")) {
          ...
          return angular.isDefined(g) && n.cancel(g), k = 0, P(y.serviceNames.YOUTUBE).then(function(e) {
          ...
          var r = {};
          return r.title = N, r.privacy = I, r.startTime = O, P(y.serviceNames.YOUTUBE).then(function(e) {
          ...
          return P(y.serviceNames.GOOGLE_PHOTOS).then(function(n) {
            return D.info("Google Photos media upload initialization: ", t.filepath, ", size: ", t.file
              .size), o.initializeMediaUpload(t.file.size, t.name, t.file.type)({
              authorization: n
            }).then(function(r) {
              var i = e.defer(),
              ...
              var d = function(e, t) {
                ...
                f = function(e, r) {
                  return e ? (D.info("Google Photos media upload complete. Adding to album..."), void o
                    .finalizeMediaUpload(r.data, t, n).then(function(e) {
                      if (!e.data.newMediaItemResults || !e.data.newMediaItemResults[0] || !e.data
                        .newMediaItemResults[0].mediaItem) return void i.reject(
                      ...
                      if (D.info("Google Photos media upload complete (" + e.data
                          .newMediaItemResults[0].mediaItem.status + "): ", r), c.getConfig()
                        .jarvisLinkedContent) {
                        var o = {
                          source: m(t.name),
                          title: t.name,
                      ...
                      return t.subtype === p.GIF && (u = t.filepath.replace(/\\\\/g, "\\")), D.info(
                        "File for UploadHistory thumb: ", u), s.addGalleryUploadHistoryItem(t
                        .name, n.toLocaleDateString(), n.toLocaleTimeString(), h.IMAGE, t.subtype,
                        r, u).then(function() {
                        i.resolve()
                      }, function(e) {
                        D.error("Addition to upload history failed: ", e), i.resolve()
                      })
                    }, function(e) {
                      D.info("Google Photos media upload failed: ", e), i.reject(e), e && 401 == e
                        .status && y.logoutFunc && y.logoutFunc(y.serviceNames.GOOGLE_PHOTOS)
                    })) : (D.info("Google Photos media upload failed: ", r), i.reject(r), void(r &&
                    401 == r.status && y.logoutFunc && y.logoutFunc(y.serviceNames.GOOGLE_PHOTOS)))
                };
              return o.uploadFile(t, u, l, n, d, f), i.promise
            })
          }, function(t) {
            return D.info("Upload Access token error: ", t.statusText), r.trigger(f.UGC_NOTIFICATION, {
              eventName: f.BROADCAST_LOGIN,
              data: n.title
            }), e.reject(t)
          })
              ...
              var r = {
                ...
                o = new S({
                  ...
                  onComplete: function(e) {
                    ...
                    return s.addGalleryUploadHistoryItem(t.title, o, u, h.VIDEO, t.subtype,
                      "https://www.youtube.com/watch?v=" + n.id, t.originalSource).then(
                  function() {
                      i.resolve()
                    }, function(e) {
                      D.error("Addition to upload history failed, error : ", e), i.resolve()
                    })
                  }
                });
              return o.upload(), i.promise
            }, function(e) {
              D.info("Upload Access token error: ", e.statusText), r.trigger(f.UGC_NOTIFICATION, {
                eventName: f.BROADCAST_LOGIN,
                data: n.title
              })
            })
          ...
          n && n.google ? (y.providerInfo.clientId = n.google.clientId, y.providerInfo.clientSecret = n.google
            .clientSecret, y.providerInfo.useOauthProxy = n.google.useOauthProxy, y.providerInfo
            .embeddedRestricted = n.google.embeddedRestricted, y.providerInfo.redirectUriOverride = n.google
            .redirectUriOverride, n.google.config && n.google.config.youtube && (D.info(
                "YouTube configuration found, merging with Google service config blob."), angular.merge(y
                .providerInfo.services[y.serviceNames.YOUTUBE], n.google.config.youtube), w = y.providerInfo
              .services[y.serviceNames.YOUTUBE].broadcastTitleMaxLength), n.google.config && n.google.config
            .photos && (D.info("Google Photos configuration found, merging with Google service config blob."),
              angular.merge(y.providerInfo.services[y.serviceNames.GOOGLE_PHOTOS], n.google.config.photos)),
            v(e), r.on(t, v)) : D.error(
            "Google service initialization failed. No configuration found for Google!")
        }
      }
    ]), p.service("jarvisService", ["$q", "$log", "jarvis", "JarvisSessionManager", "$http", "telemetryService",
      "nvAccountService", "runTimeConfigService", "hardwareConfigWrapper",
      function(t, n, r, i, a, c, u, l, d) {
        function f() {
          return d.hardwareSystemInfoGetter().catch(function() {
            return {}
          }).then(function(e) {
            return e.JarvisDeviceId = e.JarvisDeviceId || "deviceId", e.PCName = e.PCName || "Unnamed PC", e
          })
        }
        ...
        function g(e) {
          return void 0 === e || void 0 === e.userInfo || void 0 === e.userInfo.userId || null === e.userInfo
            .userId || "" === e.userInfo.userId
        }

        function y(e) {
          return D.info("Storing user token and information in accounts file and setting user consent."), f()
            .then(function(t) {
              var n = {
        ...
        function b() {
          if (void 0 !== I && null !== I && null !== I.userToken && S) {
            ...
            u.getJarvisUserToken().then(function(e) {
              ...
              D.info("Unable to get info from accounts file, probably because it did not exist."), y(t)
            })
          }
        }
        ...
        N.loginFromDatabase = function() {
          ...
          return A ? h().then(function(e) {
            ...
            return n = i, r.profile.currentUser.get({
              ...
              return 401 === r.status ? T(e) : r.status !== -1 || k && k.online ? t.reject() : h().then(
                function(t) {
                  return w(e, n, t.user)
                })
            })
          ...
          S && (D.info("Clearing local user session info."), S = void 0, E(null, null), I.closeSession(), I =
            null)
          ...
          return i ? (a.sessionToken = i.sessionToken, o = r.userData.shared.update.bind(this, a, s)) : o = C
            .bind(this, r.userData.shared.update, a, s), o().then(function(e) {
              return e.data.data
            })
          ...
          return i ? (a.sessionToken = i.sessionToken, o = r.userData.shared.modify.bind(this, a, s)) : o = C
            .bind(this, r.userData.shared.modify, a, s), o().then(function(e) {
              return e.data.data
            })
          ...
          N.getUserData(t, n).then(function(r) {
            D.info("Jarvis getUserData"), D.info(r), (angular.equals(r, {}) || null === r || void 0 ===
              r) && (D.info("Jarivs empty"), r = {
                uploadedItems: []
              }), r.uploadedItems.push(e), N.setUserData(t, n, r), D.info("Jarvis setUserData"), D.info(r)
          })
      ...
      function(e, t, n, r, i, o, a, s, c) {
        ...
        l.setAuthToken = function(e) {
          ...
          return void 0 !== d && null !== d && void 0 !== d.accountUsername && null !== d.accountUsername ? e
            .when({
          ...
          return p().then(function(a) {
            ...
            return d.readAsDataURL(t.file), d.onloadend = function() {
              ...
              n.uploadImage(t.name, p)({
                ...
                return t.subtype === c.GIF && (d = t.filepath.replace(/\\\\/g, "\\")), h.info(
                  "File for UploadHistory thumb: ", d), r.addGalleryUploadHistoryItem(t.name, n
                  .toLocaleDateString(), n.toLocaleTimeString(), s.IMAGE, t.subtype, e.data.data
                  .link, d).then(function() {
                  f.resolve()
                }, function(e) {
                  h.error("Addition to upload history failed, error : ", e), f.resolve()
                })
              }, function(e) {
          ...
          e && e.imgur ? (l.providerInfo.clientId = e.imgur.clientId, e.imgur.config && (h.info(
            "Imgur configuration found, merging with Imgur service config blob."), angular.merge(l
            .providerInfo.services[l.serviceNames.IMGUR], e.imgur.config))) : h.error(
            "Imgur service initialization failed. No configuration found for Imgur!")
        }
      }
    ]), p.service("shotWithGeForceService", ["$q", "$log", "$window", "shotWithGeForceEndpoints", "galleryService",
      "hardwareService", "jarvisService", "eventAggregator", "nvAccountService", "runTimeConfigService",
      "GALLERY_TYPES", "CONNECT_EVENTS",
      function(e, t, n, r, i, o, a, s, c, u, l, f) {
        function h(e) {
          var t = /^(.*?)\s\|/g,
            n = t.exec(e);
        ...
        m.startJarvisSession = function(t) {
          ...
          return !m.storedToken || !m.storedToken.sessionToken || m.storedToken.expiresOn < Date.now() ? c
            .getJarvisUserToken().then(function(t) {
              return t && void 0 !== t.userInfo && void 0 !== t.userInfo.userToken ? a.loginWithUserToken(t
                .userInfo.userToken).then(function(e) {
                return m.startJarvisSession(e)
              }, function(t) {
                return t && t.data && "REPEAT_REQUEST" === t.data.error && a.cachedSessionObject ? m
                  .startJarvisSession(a.cachedSessionObject) : (v.info(
                      "updateAccessToken was unable to log into Jarvis with stored token: ", t), n
                    .localStorage.getItem(g) && (n.localStorage.removeItem(g), m.storedToken = null, s
                      .trigger(f.USER_LOGGED_OUT, m.serviceNames.SHOT_WITH_GEFORCE)), e.reject(t))
              }) : e.reject("No stored Jarvis user token found! New login required to get access token.")
            }) : e.when(m.storedToken)
        }, m.setAuthToken = function(e) {
          m.storedToken = e, void 0 !== e.code && void 0 === e.loginToken ? a.getUserTokenFromCode(e.code).then(
            function(t) {
              e.expiration = t.data.expiration, a.loginWithRegistrationToken(t.data.loginToken).then(function(
                e) {
                return m.startJarvisSession(e)
              }, function(e) {
                v.error("setAuthToken was unable to exchange the login token for a user token: ", e)
              })
            },
            function(e) {
              v.error("setAuthToken was unable to exchange the access code for a login token: ", e)
            }) : void 0 === e.loginToken && v.error("setAuthToken called without valid accessToken: ", e)
        }, m.getUser = function() {
          ...
          return m.updateAccessToken().then(function() {
            return t.fileName = p(t.filepath), r.uploadImageData(m.storedToken.sessionToken, m.storedToken
              .accountId, t).then(function(e) {
              ...
              .toLocaleTimeString(), l.IMAGE, t.subtype, e.data.result.url, t.originalSource).catch(
                function(e) {
                  v.error("Addition to upload history failed, error : ", e)
                })
            }, function(t) {
              return v.error("Failed to upload to ShotWithGeForce: " + t.status + ") " + t.statusText),
                e.reject(t)
            })
          }, function(e) {
          ...
          s.on(t, m.onLanguageChanged), n && n.jarvis && n.connect && n.connect.swgf ? (m.providerInfo
            .oauthUrl = a.getLoginWithOauthUrl({
              locale: m.convertToJarvisLocale(e)
                ...
                "ShotWithGeForce configuration found, merging with NVIDIA service config blob."), angular
              .merge(m.providerInfo.services[m.serviceNames.SHOT_WITH_GEFORCE], n.connect.swgf.config)), r
            .init(), m.updateAccessToken(), o.getSystemInfo().then(function(e) {
              m.jarvisDeviceId = e.JarvisDeviceId
            })) : v.error("NVIDIA service initialization failed. No configuration found for ShotWithGeForce!")
        }, m.logout = function() {
          a.logout()
        }
      }
    ]), p.service("sinaService", ["$q", "$log", "weiboEndpoints", "galleryService", "shotWithGeForceService",
      "jarvisService", "eventAggregator", "runTimeConfigService", "UGC_NOTIFICATION_EVENTS", "GALLERY_TYPES",
      "GALLERY_SUBTYPES",
      function(e, t, n, r, i, o, a, s, c, u, l) {
        ...
        var y = function() {
          ...
          return n.getTokenTimeLeft(t).then(function(n) {
            return n >= 0 ? e.when(t) : (h.logoutFunc && h.logoutFunc(h.serviceNames.WEIBO), e.reject(
              "Weibo access token expired!"))
          }, function(n) {
            return 400 == n.status || 401 == n.status ? (h.logoutFunc && h.logoutFunc(h.serviceNames.WEIBO),
              e.reject("Webio rejected the stored access token")) : e.when(t)
          })
        };
        h.ensureValidToken = function() {
          return y()
        }, h.setAuthToken = function(e) {
          p = e, void 0 !== e.code && void 0 === e.accessToken ? n.getAccessToken(h.providerInfo, e.code).then(
            function(e) {
              h.setAuthTokenCallback(h.serviceNames.WEIBO, e.data)
            },
            function(e) {
              v.error("setAuthToken was unable to request an access token: ", e)
            }) : void 0 === e.accessToken && v.error("setAuthToken called without valid accessToken: ", e)
        }, h.getUser = function() {
          ...
          return y().then(function(i) {
            return n.uploadImage(t, i).then(function(e) {
              ...
              return t.subtype === l.GIF && (a = t.filepath.replace(/\\\\/g, "\\")), v.info(
                "File for UploadHistory thumb: ", a), r.addGalleryUploadHistoryItem(t.name, n
                .toLocaleDateString(), n.toLocaleTimeString(), u.IMAGE, t.subtype, e.data
            ...
            return v.info("Upload Access token error: ", t.statusText), a.trigger(c.UGC_NOTIFICATION, {
          ...
          return y().then(function(i) {
            return v.info("Weibo video upload initialization: ", t.filepath, ", size: ", t.file.size), n
              .initializeVideoUpload(t, i).then(function(a) {
                var c = e.defer(),
                  f = a.data.fileToken;
                v.info("Weibo video upload transferring chunks. fileToken = ", f);
                var p = function(e, t) {
                    v.info("Weibo video upload progress. fileToken = ", f, ", offsets = ", e, t)
                  },
                  m = function(e, n) {
                    if (!e) return n = n || "", v.error("Upload to Weibo failed, error : ", n), c.reject(
                      n), void(401 == n.status && h.logoutFunc && h.logoutFunc(h.serviceNames.WEIBO));
                    ...
                    h.getUser().then(function(e) {
                      ...
                      v.info("File for UploadHistory thumb: ", f), r.addGalleryUploadHistoryItem(t
                        .title, n.toLocaleDateString(), n.toLocaleTimeString(), u.VIDEO, t.subtype,
                        i, f).finally(function() {
                        c.resolve()
                      })
                    }).catch(function(e) {
                      v.error("Addition to upload history failed, error : ", e), c.resolve()
                    })
                  };
                return n.uploadVideo(t, a.data, i, p, m), c.promise
              }, function(t) {
                return t = t || "", v.error("Upload to Weibo failed, error: ", t), 401 == t.status && h
                  .logoutFunc && h.logoutFunc(h.serviceNames.WEIBO), e.reject(t)
              })
          }, function(t) {
          ...
          n && n.weibo ? (h.providerInfo.clientId = n.weibo.clientId, h.providerInfo.clientSecret = n.weibo
            .clientSecret, h.providerInfo.useOauthProxy = n.weibo.useOauthProxy, n.weibo.config && (v.info(
              "Weibo configuration found, merging with Sina service config blob."), angular.merge(h
              .providerInfo.services[h.serviceNames.WEIBO], n.weibo.config)), f(e), a.on(t, f)) : v.error(
            "Sina service initialization failed. No configuration found for Sina!")
        }
      }
    ]), p.service("twitchService", ["$q", "$log", "twitchEndpoints", "shadowPlayEndpoints", "eventAggregator",
      "runTimeConfigService", "twitchIngestServerConfigWrapper", "CONNECT_EVENTS",
        ...
        l.providerInfo.services[l.serviceNames.TWITCH] = {
          ...
          return e.all({
            ...
            var o = e.selectedIngestServerName,
              ...
              c = a.indexOf(o);
            if (c < 0 && (c = l.getClosestIngestServer(r)), c < 0 && (c = l.getDefaultServer(r)), m.info(
                "selectedServerIndex : ", c), !r[c]) {
            ...
            return angular.isDefined(t.title) && null !== t.title && (m.info("sessionParams.title : ", t
              .title), l.setBroadcastTitle(t.title, null, !0)), d.replace("{stream_key}", n)
          }, function(e) {
            var t = "getRtmpUrl failed : " + (0, d.default)(e);
          ...
          n && n.twitch ? (l.providerInfo.clientId = n.twitch.clientId, n.twitch.config && (m.info(
            "Twitch configuration found, merging with Twitch service config blob."), angular.merge(l
            .providerInfo.services[l.serviceNames.TWITCH], n.twitch.config), h = l.providerInfo.services[l
            .serviceNames.TWITCH].broadcastTitleMaxLength), c(e), i.on(t, c)) : m.error(
      ...
      "googleService", "facebookService", "imgurService", "sinaService", "shotWithGeForceService", "cefService",
      "nvAccountService", "runTimeConfigService", "CONNECT_EVENTS",
      function(e, t, n, r, i, o, a, s, c, u, l, f, h, p) {
        ...
        y.serviceTypes = {
            ...
            SINA: c.name,
            NVIDIA: u.name
          }, y.endpoints = {}, y.endpoints[y.providerNames.NVIDIA] = u, y.endpoints[y.providerNames.FACEBOOK] = a,
          y.endpoints[y.providerNames.GOOGLE] = o, y.endpoints[y.providerNames.IMGUR] = s, y.endpoints[y
            .providerNames.TWITCH] = i, y.endpoints[y.providerNames.SINA] = c, y.providers = {}, y.services = {},
          y.initialize = function(e, n) {
            ...
            g = JSON.parse(a) || y.serviceTypes.VIDEO_UPLOAD, _.each(y.services, function(e) {
              ...
              y.isLoggedIntoService(e.name) && void 0 !== t && t.setAuthToken(y.getAuthToken(e.name), e.name,
                !0), t.setAuthTokenCallback = y.setAuthToken, t.logoutFunc = y.logout
        ...
        var x = function(e) {
          return {
            ...
            expiresOn: void 0 !== e.expires_in ? new Date((new Date).getTime() + 1e3 * e.expires_in) : void 0
          }
        };
        y.isLoggedIntoJarvis = function() {
          ...
          return f.getJarvisUserToken().then(function(e) {
            return void 0 === e || null === e || void 0 === e.userInfo || _.isEmpty(e.userInfo) ? n.reject(
              "Not logged into Jarvis") : n.when(e.userInfo.userId)
          }, function(e) {
          ...
          if (n && void 0 !== n) {
            ...
            c.setAuthToken(a, e, void 0, i), t.localStorage.setItem(b + e, (0, d.default)(a)), void 0 !== a
              .accessToken && r.trigger(p.USER_LOGGED_IN, {
                serviceName: e,
          ...
          var n = y.services[t],
            ...
            o = i[n.providerName];
          r.redirectUri = o && o.redirectUriOverride ? o.redirectUriOverride : i.redirectUri, n = _.omit(n,
            "provider"), r = _.omit(r, "services");
        ...
        var S = function(e) {
          ...
          var t = n.when(null);
          return y.endpoints[y.services[e].providerName].ensureValidToken && (t = y.endpoints[y.services[e]
            .providerName].ensureValidToken(e)), t.then(function() {
        ...
        y.getAvatarUri = function(e) {
          ...
          var t = void 0;
          return _.has(v, e) && (t = v[e], y.isValidService(t) || (e === y.serviceTypes.ANSEL_UPLOAD && (t = v[y
              .serviceTypes.IMAGE_UPLOAD]), y.isValidService(t) || (t = void 0))), void 0 === t || angular
            .isObject(t) ? t : y.services[t]
          ...
          var t = "image" === e ? y.getPreferredService(y.serviceTypes.IMAGE_UPLOAD) : y.getPreferredService(y
            .serviceTypes.VIDEO_UPLOAD);
          return void 0 !== t
        }, y.setServiceParameters = function(e, n) {
          angular.isDefined(e.privacy) && (e.privacy = e.privacy.value), angular.isDefined(e.destinationType) &&
            (e.destinationType = e.destinationType.name), angular.isDefined(e.destination) && (e.destination = e
              .destination.name), t.localStorage.setItem(T + n, (0, d.default)(e))
          ...
          return angular.isUndefined(n) && (n = {}), angular.isDefined(n.privacy) && (n.privacy = _.findWhere(r
            .privacyOptions, {
              value: n.privacy
          ...
          })), angular.isUndefined(n.destinationType) && (n.destinationType = _.find(r.destinationOptions,
            function() {
              return !0
            })), n
        }
      ...
      t.queueUpload = function(e) {
        ...
        e ? (n.info("Processing Upload Promise. Remaining queue size: ", t.uploadQueue.length), t
          .uploadInProgress = !0, e().then(function() {
            n.info("Processing remaining Upload Queue. Remaining queue size: ", t.uploadQueue.length), t
              .processUploadQueue()
          })) : (t.uploadInProgress = !1, n.info("Upload Queue empty. Done processing uploads."))
      }, t.init = function() {
        return n.info("Upload Manager Service initialized!"), !0
      }
    }]), p.service("uploadService", ["$q", "$log", "$document", "cefService", "connectService", "eventAggregator",
      "uploadManagerService", "hardwareConfigWrapper", "recordingPathConfigWrapper", "galleryEndpoints",
      "GALLERY_EVENTS", "GALLERY_TYPES", "GALLERY_SUBTYPES", "DEFAULT_VIDEO_TAGS", "UGC_NOTIFICATION_EVENTS",
      function(e, t, n, r, i, o, a, s, c, u, l, d, f, h, p) {
        function m(e, t) {
          return n.on("dragover", function(e) {
            e.stopPropagation(), e.preventDefault(), e.dataTransfer.dropEffect = "copy"
          }), n.on("drop", function(r) {
            if (r.stopPropagation(), r.preventDefault(), !r.dataTransfer.files || !r.dataTransfer.files[0])
              return void g.info("bad drop, no file list");
            var i = r.dataTransfer.files[0];
            i.name === e ? t(i) : g.info("bad drag file: " + e + " " + i.name), n.off("dragover"), n.off(
              "drop")
        ...
        v.retryAttemptsDefault = 3, v.uploadContent = function(t, n) {
          ...
          return n = n || v.retryAttemptsDefault, t.type === d.IMAGE && t.fileSize > r.maxImageSize && (a = c
            .recordingPathGetter().then(function(n) {
            ...
            return m(a, function(a) {
              var c = e.when(null);
              return t.type === d.VIDEO && (c = s.hardwareSystemDescriptionGetter()), c.then(function(
              s) {
                var c = t.type !== d.IMAGE && (t.subtype !== f.GIF || r.gifOptions && r.gifOptions
                    .shouldUploadGifAsVideo),
                  u = [];
                ...
                var g = c ? i.endpoints[r.providerName].uploadVideo : i.endpoints[r.providerName]
                  .uploadImage,
                  b = {
                    newUpload: !0,
                    retryCount: n,
                ...
                v.tryUpload(m, r, g, b).then(function(e) {
                  ...
                  t.retryCount = n - b.retryCount, o.trigger(l.UPLOAD_COMPLETE, t), y.resolve()
                })
              })
            })
          })
          ...
          var i = function() {
            return n(e, t).then(function() {
              ...
              r.retryCount > 0 ? (g.info("Upload retry: attempts remaining - ", r.retryCount), r
                .retryCount--, v.tryUpload(e, t, n, r)) : (g.info("Upload failed."), r.tryUploadPromise
                .reject("failed"))
            })
          };
    ...
    ]), p.service("galleryService", ["$q", "$log", "$timeout", "$document", "galleryEndpoints", "cacheService",
      "eventAggregator", "GALLERY_STATE", "GALLERY_TYPES", "GALLERY_AUDIOTYPES", "GALLERY_SUBTYPES",
      "GALLERY_EVENTS",
      function(e, t, n, r, i, o, a, s, c, u, l, d) {
        var f = this,
          h = t.getInstance("ugc-lib/galleryService");
        f.populatedDirs = [], f.populatedDirsPost = [], f.populatedRecentFilesFolder = [], f.recentFiles = [], f
          .videoPath = "", f.tempPath = "", f.uploadHistory = [], f.wasCached = !1, f.thumbSizes = {
            width: 90,
            height: 90
          }, f.EXCLUDE_HIDDEN = "hidden", f.EXCLUDE_EMPTY = "empty", f.EXCLUDE_HIDDENOREMPTY = "hiddenOrEmpty", f
          .EXCLUDE_HIDDENANDEMPTY = "hiddenAndEmpty", o.initialize(), f.getPopulateFolderReference = function() {
            ...
            return i.getGalleryThumbnail({}, {
              ...
              var t = null;
              return f.uploadHistory[n].thumbnail = t, h.error("GalleryThumbnailUploadHistory failed: ", e), t
            })
            ...
            if ("" === f.videoPath) f.videoPath = e.videos, f.tempPath = e.tempFiles, o.setRecordingPaths(f
              .videoPath);
            ...
            var f, h = void 0 === a.duration ? "No Data" : a.duration,
            ...
            f = !o.files || void 0 === o.files[r] || s ? {
              ...
              source: a.fileSource
            } : o.files[r], f.type === c.VIDEO && f.subtype === l.NORMAL && v === u.SEPARATE && (f.subtype = l
              .MTA), f.DRSName = a.DRSName, f.DRSProfileName = a.DRSProfileName;
            ...
            var t = f.videoPath;
            return o.useCacheData(t) ? (h.info("GetUsableData - Using cached data"), f.wasCached = !0, 0 !== f
              .populatedDirs.length) : (f.wasCached = !1, e ? (f.populatedDirs.length = 0, f.getData(t).then(
              function() {
            ...
            function r() {
              n ? f.populatedDirs = f.sortData(f.populatedDirs) : (f.populatedDirsPost = f.sortData(f
                ...
                e.videos = f.populatedDirsPost[t] ? f.populatedDirsPost[t].videos : 0, e.screenshots = f
                  .populatedDirsPost[t] ? f.populatedDirsPost[t].screenshots : 0
              }), f.populatedDirsPost.length = 0, o.setCacheNotDirty(t)), i.resolve(0 !== f.populatedDirs
                .length), h.info("GetUsableData - Fetched data")
            }
            var i = e.defer(),
              a = [];
            ...
            return o.useCacheData(r, !0) ? (f.wasCached = !0, h.info("getRawFolderData - Using cached data"), e
              .when(!0)) : (f.wasCached = !1, o.resetCurrentPopFolder(), f.getGalleryFolderListing(r, !1, i)
              .then(function(e) {
            ...
            function a() {
              o.files.length === l.length && (h.info("getFolderData folder loaded!!"), o.setCacheLoaded(c)), d
                .resolve(!0)
            }
            var s = t.folder,
              c = f.videoPath + "\\" + s,
            ...
            return f.getGalleryRecent().then(function(e) {
              if (f.recentFiles = e, h.info("recentFiles: ", f.recentFiles), f.populatedRecentFilesFolder
                .length = 0, 0 !== f.recentFiles.length) return f.getRecentData()
            })
          }, f.extractGameName = function(e) {
            var t = e.split("\\");
            return t.length < 2 ? (h.error("extractGameName: Cannot parse!"), "Unknown Game") : t[t.length - 2]
      ...
      r.videoPath = "", r.files = [], r.directories = [], r.populatedFolder = [
          ...
          [],
          []
        ], r.folderData = [], r.fileData = [], r.mainCache = [], r.folderCache = [], r.cacheEntries = 5, r
        .initialized = !1, r.ageCounter = 0, r.dataIndex = 0, r.freeInterval = 3e5, r.minEntryAge = 12e5, r
        .active = !1;
      var o = {
        EMPTY: 0,
        PARTIAL: 1,
      ...
      r.resetCacheEntry = function(e) {
          ...
          if (!r.active) {
            for (var e = 2147483647, t = -1, n = new Date, i = n.getTime(), a = 0; a < r
              ...
              var s = r.folderCache[a].time,
                c = i - s;
              0 !== r.folderCache[a].age && r.folderCache[a].age < e && c > r.minEntryAge && (t = a, e =
                r.folderCache[a].age)
            }
            0 !== e && t !== -1 && (r.folderData[t].directories.length = 0, r.folderData[t].files
              .length = 0, r.folderCache[t].loaded === o.FULL && (r.fileData[t].popFolder.length = 0),
              r.resetCacheEntry(t))
          }
        }, r.freeInterval))
        ...
        if (e !== r.videoPath) {
          ...
          var c = new Date,
            u = c.getTime();
          return t ? (a && (r.files = r.folderData[i].files, r.directories = r.folderData[i].directories, r
            .folderCache[i].time = u), a) : (s && (r.populatedFolder[i] = r.fileData[i].popFolder, r
            .folderCache[i].time = u), s)
        }
        ...
        if (t = _.findIndex(r.folderCache, {
          ...
          for (var n = 2147483647, a = 0; a < r.cacheEntries; a++) r.folderCache[a].dirty && r.folderCache[a]
            .age < n && (t = a, n = r.folderCache[a].age);
        if (t === -1)
          for (var n = 2147483647, a = 0; a < r.cacheEntries; a++) r.folderCache[a].age < n && (t = a, n = r
            .folderCache[a].age);
        return t >= r.cacheEntries && i.error("folder cache has bad indexing!"), r.getGalleryFolderCRC(e)
          .then(function(n) {
