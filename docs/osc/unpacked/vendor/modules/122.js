// ─────────────────────────────────────────────────────────────
// VENDOR MODULE 122
// role       : factory NvEndpoint | factory NvEndpointFactory | factory nvHttpStatusInterceptor | constant NV_STATUS
// defines    : angular.module("nvAngularHttpEndpoint")
// requires   : (none)
...
function(e, t, n) {
  ...
  var i = n(25),
    ...
    a = n(26),
    s = r(a);
  angular.module("nvAngularHttpEndpoint", []), angular.module("nvAngularHttpEndpoint").factory("NvEndpoint", ["$http",
    "$timeout", "$q", "NV_STATUS",
    function(e, t, n, r) {
      function i(e, t, n) {
        var r, i;
        for (r in t) i = t[r], n && (i = encodeURIComponent(i)), e.indexOf(":" + r) > -1 && (e = e.replace(
          new RegExp(":" + r, "g"), i), delete t[r]);
        return e
      }
      ...
      function u(e, t) {
        var n = e.data;
        return t && "object" !== ("undefined" == typeof t ? "undefined" : (0, s.default)(t)) ? n = t : t && (n =
          angular.merge({}, e.data, t)), n
      }
      ...
      function h(e, t) {
        return null === e.timeBetweenRetries || void 0 === e.timeBetweenRetries ? t : e.timeBetweenRetries
      }
      ...
      function p(r, i) {
        ...
        function s(e, t) {
          ...
          return r.method = b.method, r.data = u(b, t), r.headers = l(b, n, i.headerGenerator), r.url = a(b, n, i
            .urlGenerator), r.params = n, r
        }
        ...
        function v(r) {
          ...
          return a.timeoutDeferred = f, a.catch(function(e) {
            return !s && r.retriesRemaining > 0 && (e.status === -1 || e.status >= 500 && e.status < 600) ? (r
              .retriesRemaining = r.retriesRemaining - 1, t(function() {
                return v(r)
        ...
        var b = r;
        if (b.method = b.method.toUpperCase(), b.params = b.params || {}, ["PUT", "POST", "GET", "DELETE", "HEAD",
            "JSONP", "PATCH"
  ...
  ]), angular.module("nvAngularHttpEndpoint").factory("NvEndpointFactory", ["$http", "NvEndpoint", function(e, t) {
    function n() {
      var n = {};
      n.urlGenerator = function(e, t) {
          ...
          return {}
        }, n.defaultTimeout = null, n.defaultRetries = 0, n.defaultTimeBetweenRetries = 0, this.setUrlGenerator =
        function(e) {
          n.urlGenerator = e
  ...
  }]), angular.module("nvAngularHttpEndpoint").factory("nvHttpStatusInterceptor", ["$q", "NV_STATUS", function(e, t) {
    var n = {
