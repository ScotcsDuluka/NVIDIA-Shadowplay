...
function(e, t, n) {
  ! function(e, r) {
    ...
    function r(e) {
      for (var t = 0, n = e.length, r = e[n - 1][1] * e[0][0] - e[n - 1][0] * e[0][1]; ++t < n;) r += e[t - 1][1] * e[
        t][0] - e[t - 1][0] * e[t][1];
      return r
    }
    ...
    function d() {
      ...
      function s(e, t, n) {
        function r(e) {
          var t, r, a = [e[0][0] + i, e[0][1] + o],
            s = [e[1][0] + i, e[1][1] + o],
            u = c(a),
            l = c(s);
          (t = p[u]) ? (r = h[l]) ? (delete p[t.end], delete h[r.start], t === r ? (t.ring.push(s), n(t.ring)) : h[t
            .start] = p[r.end] = {
            start: t.start,
            end: r.end,
            ring: t.ring.concat(r.ring)
          }) : (delete p[t.end], t.ring.push(s), p[t.end = l] = t) : (t = h[l]) ? (r = p[u]) ? (delete h[t.start],
            delete p[r.end], t === r ? (t.ring.push(s), n(t.ring)) : h[r.start] = p[t.end] = {
              start: r.start,
              end: t.end,
        ...
        var i, o, a, s, u, l, h = new Array,
          p = new Array;
        for (i = o = -1, s = e[0] >= t, E[s << 1].forEach(r); ++i < d - 1;) a = s, s = e[i + 1] >= t, E[a | s << 1]
          .forEach(r);
        for (E[s << 0].forEach(r); ++o < f - 1;) {
          for (i = -1, s = e[o * d + d] >= t, u = e[o * d] >= t, E[s << 1 | u << 2].forEach(r); ++i < d - 1;) a = s,
            s = e[o * d + d + i + 1] >= t, l = u, u = e[o * d + i + 1] >= t, E[a | s << 1 | u << 2 | l << 3].forEach(
              r);
          E[s | u << 3].forEach(r)
        }
        for (i = -1, u = e[o * d] >= t, E[u << 2].forEach(r); ++i < d - 1;) l = u, u = e[o * d + i + 1] >= t, E[u <<
          2 | l << 3].forEach(r);
        E[u << 3].forEach(r)
      }
      ...
      function u(e, t, n) {
        e.forEach(function(e) {
          var r, i = e[0],
            ...
            s = 0 | o,
            c = t[s * d + a];
          i > 0 && i < d && a === i && (r = t[s * d + a - 1], e[0] = i + (n - r) / (c - r) - .5), o > 0 && o <
            f && s === o && (r = t[(s - 1) * d + a], e[1] = o + (n - r) / (c - r) - .5)
        })
      }
      var d = 1,
        f = 1,
      ...
      return e.contour = a, e.size = function(t) {
        ...
        return arguments.length ? (h = "function" == typeof t ? t : i(Array.isArray(t) ? b.call(t) : t), e) : h
      }, e.smooth = function(t) {
    ...
    function f(e, t, n) {
      for (var r = e.width, i = e.height, o = (n << 1) + 1, a = 0; a < i; ++a)
        for (var s = 0, c = 0; s < r + n; ++s) s < r && (c += e.data[s + a * r]), s >= n && (s >= o && (c -= e.data[
          s - o + a * r]), t.data[s - n + a * r] = c / Math.min(s + 1, r - 1 + o - s, o))
    }

    function h(e, t, n) {
      for (var r = e.width, i = e.height, o = (n << 1) + 1, a = 0; a < r; ++a)
        for (var s = 0, c = 0; s < i + n; ++s) s < i && (c += e.data[a + s * r]), s >= n && (s >= o && (c -= e.data[
          a + (s - o) * r]), t.data[a + (s - n) * r] = c / Math.min(s + 1, i - 1 + o - s, o))
    }
    ...
    function g() {
      ...
      return e.x = function(t) {
        ...
        return arguments.length ? (C = "function" == typeof t ? t : i(Array.isArray(t) ? b.call(t) : t), e) : C
