  ...
  ! function(e, r) {
    ...
    function c(e) {
      return function(t, n, r) {
        return 2 === arguments.length && "function" == typeof n && (r = n, n = void 0), s(t, n).then(function(t) {
          return e(t, r)
        })
      }
    }
    ...
    var p = c(t.csvParse),
      ...
      g = h("text/html"),
      y = h("image/svg+xml");
    e.blob = r, e.buffer = o, e.csv = p, e.dsv = u, e.html = g, e.image = l, e.json = f, e.svg = y, e.text = s, e
      .tsv = m, e.xml = v, Object.defineProperty(e, "__esModule", {
        value: !0
      })
  })
}
