// ─────────────────────────────────────────────────────────────
// VENDOR MODULE 123
// role       : factory JarvisSessionManager | provider jarvis | constant JARVIS_CONSTANTS
// defines    : angular.module("nvAngularJarvisSdk")
// requires   : (none)
// source     : Overlay/osc/vendor.js (minified) — beautified, unrecoverable local names remain
// ─────────────────────────────────────────────────────────────
function(e, t) {
  "use strict";
  angular.module("nvAngularJarvisSdk", ["nvAngularHttpEndpoint", "nvAngularAccountSdk", "base64"]), angular.module(
    "nvAngularJarvisSdk").provider("jarvis", [function() {
    var e, t, n, r, i, o, a = 1,
    ...
    return {
      setConfig: function(f) {
        a = f.version, s = f.server, e = f.redirectUrl, t = f.redirectUrlJarvisOauth, i = {
          ...
          }, f.magic && (i.MagicHeader = f.magic), c = f.deviceId, n = f.deviceDescription, u = f.clientId, r =
          f.clientDescription, o = f.defaultTimeout, l = f.defaultRetries || l, d = f
      ...
      $get: ["NvEndpointFactory", "$window", "JARVIS_CONSTANTS", function(f, h, p) {
        ...
        y.setUrlGenerator(function(e, t) {
          return e.url.startsWith("/dev/") || e.url.startsWith("/ping") ? s + e.url : s + "/api/" + a + e
            .url
        }), y.setHeaderGenerator(function(e, t) {
          var n = angular.merge({}, e.headers, i),
            r = "";
          return e.authType && ("userCredentials" === e.authType ? t.accessToken ? (r = m(t.accessToken +
            ":"), delete t.accessToken) : t.username && t.password && (r = m(t.username + ":" + t
            .password), delete t.username, delete t.password) : (r = m(t[e.authType] + ":"), delete t[
            e.authType]), n.Authorization = "Basic " + r), n
  ...
  }), angular.module("nvAngularJarvisSdk").factory("JarvisSessionManager", ["$q", "jarvis", "nvAccountService",
    function(e, t, n) {
      function r(e) {
      ...
      return r.prototype = function() {
        var i = function(e) {
            ...
            return t.session.login(e).then(function(t) {
              n.sessionToken = t.data.sessionToken, n.onNewTokenCallback(n.sessionToken), n.userToken = e
                .userToken, n.sessionParams = e
            })
          },
          o = function(e, t) {
            this.userToken = t.userToken, this.sessionParams = t, this.sessionToken = e, this.onNewTokenCallback(
              e)
          },
          a = function(e) {
            this.userToken = null, this.sessionToken = null, this.sessionParams = null, null !== e && void 0 !==
              e || n.deleteJarvisUserToken(), this.onNewTokenCallback(this.sessionToken)
          },
          s = function(e) {
            var n = this,
              r = angular.extend({}, n.sessionParams);
            return delete r.userToken, delete r.clientDescription, r.sessionToken = e, t.session.chain(r).then(
              function(e) {
          ...
          l = function(t) {
            ...
            if (angular.forEach(n.tokenListeners, function(e) {
                t ? e.deferred.reject("Could not get a valid session token") : e.deferred.resolve(c.call(n, e
                  .api, e.params, e.data))
              }), t) return e.reject()
          },
          d = function() {
          ...
          p = function(t, n, r) {
            ...
            return c.call(i, t, n, r).then(function(e) {
              ...
              return 401 === a.status ? "INVALID" === i.sessionToken ? u.call(i, t, n, r) : i.sessionToken !==
                o ? c.call(i, t, n, r) : (i.sessionToken = "INVALID", h.call(i, a, o, t, n, r)) : e.reject(a)
            })
          };
        return {
          constructor: r,
