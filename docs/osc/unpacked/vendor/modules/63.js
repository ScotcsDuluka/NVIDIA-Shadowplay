...
function(e, t, n) {
  ! function(e, r) {
    ...
    function o(e) {
      ...
      "onselectstart" in t ? r.on("selectstart.drag", i, !0) : (t.__noselect = t.style.MozUserSelect, t.style
        .MozUserSelect = "none")
    }
    ...
    function a(e, t) {
      ...
      }, 0)), "onselectstart" in r ? o.on("selectstart.drag", null) : (r.style.MozUserSelect = r.__noselect,
        delete r.__noselect)
    }
    ...
    function c(e, t, n, r, i, o, a, s, c, u) {
      this.target = e, this.type = t, this.subject = n, this.identifier = r, this.active = i, this.x = o, this.y = a,
        this.dx = s, this.dy = c, this._ = u
    }
    ...
    function h() {
      function e(e) {
        e.on("mousedown.drag", h).filter(S).on("touchstart.drag", v).on("touchmove.drag", g).on(
          "touchend.drag touchcancel.drag", y).style("touch-action", "none").style("-webkit-tap-highlight-color",
          "rgba(0,0,0,0)")
      }
      ...
      function h() {
        if (!w && T.apply(this, arguments)) {
          ...
          e && (n.select(n.event.view).on("mousemove.drag", p, !0).on("mouseup.drag", m, !0), o(n.event.view), r(),
            $ = !1, E = n.event.clientX, _ = n.event.clientY, e("start"))
        }
      }
      ...
      function m() {
        n.select(n.event.view).on("mousemove.drag mouseup.drag", null), a(n.event.view, $), i(), A.mouse("end")
      }
      ...
      function g() {
        var e, t, r = n.event.changedTouches,
          o = r.length;
      ...
      function b(t, r, i, o, a) {
        ...
        if (n.customEvent(new c(e, "beforestart", s, t, k, d[0], d[1], 0, 0, f), function() {
            return null != (n.event.subject = s = x.apply(o, a)) && (u = s.x - d[0] || 0, l = s.y - d[1] || 0, !0)
          })) return function h(p) {
          var m, v = d;
          switch (p) {
            case "start":
          ...
          n.customEvent(new c(e, p, s, t, m, d[0] + u, d[1] + l, d[0] - v[0], d[1] - v[1], f), f.apply, f, [p, o,
            a
          ])
        }
      }
