// ─────────────────────────────────────────────────────────────
// VENDOR MODULE 137
// role       : directive ngMessages | directive ngMessagesInclude | directive ngMessage | directive ngMessageExp
// defines    : angular.module("ngMessages")
// requires   : (none)
        ...
        controller: ["$element", "$scope", "$attrs", function(o, s, c) {
          function u(e, t) {
            for (var n = t, r = []; n && n !== e;) {
              ...
              n.childNodes.length && r.indexOf(n) == -1 ? (r.push(n), n = n.childNodes[n.childNodes.length -
                1]) : n.previousSibling ? n = n.previousSibling : (n = n.parentNode, r.push(n))
            }
          }
          ...
          var m, v, g = this.messages = {};
          this.render = function(u) {
            u = u || {}, m = !1, v = u;
            for (var l = t(s, c.ngMessagesMultiple) || t(s, c.multiple), d = [], h = {}, p = f.head, g = !1,
                y = 0; null != p;) {
              y++;
              var b = p.message,
                E = !1;
