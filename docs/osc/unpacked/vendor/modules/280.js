...
function(e, t, n) {
  ...
  ! function(i) {
      ...
      if ("bug-string-char-index" == e) t = "a" != "a" [0];
        ...
        if ("json-stringify" == e) {
          ...
          if (a) {
            ...
            try {
              a = "0" === i(0) && "0" === i(new Number) && '""' == i(new String) && i(u) === c && i(c) === c && i() ===
                c && "1" === i(n) && "[1]" == i([n]) && "[null]" == i([c]) && "null" == i(null) && "[null,null,null]" ==
                i([c, u, null]) && i({
                  a: [n, !0, !1, null, "\0\b\n\f\r\t"]
                }) == r && "1" === i(null, n) && "[\n 1,\n 2\n]" == i([1, 2], null, 1) &&
                '"-271821-04-20T00:00:00.000Z"' == i(new Date(-864e13)) && '"+275760-09-13T00:00:00.000Z"' == i(
                  new Date(864e13)) && '"-000001-01-01T00:00:00.000Z"' == i(new Date(-621987552e5)) &&
    ...
    try {
      h = h.getUTCFullYear() == -109252 && 0 === h.getUTCMonth() && 1 === h.getUTCDate() && 10 == h.getUTCHours() &&
        37 == h.getUTCMinutes() && 6 == h.getUTCSeconds() && 708 == h.getUTCMilliseconds()
    } catch (e) {}
    if (!o("json")) {
      ...
      if (!h) var _ = Math.floor,
        ...
        w = function(e, t) {
          return $[t] + 365 * (e - 1970) + _((e - 1969 + (t = +(t > 1))) / 4) - _((e - 1901 + t) / 100) + _((e -
            1601 + t) / 400)
        };
      ...
      if (s = function(e, t) {
          ...
          return n = r = null, o ? s = 2 == o ? function(e, t) {
            ...
            var n, i, o = u.call(e) == p,
              s = !o && "function" != typeof e.constructor && C(e, "hasOwnProperty") ? e.hasOwnProperty : a;
        ...
        var x = {
          ...
          N = function(e, t, n, r, i, o, l) {
            ...
            if ("object" == typeof d && d)
              if (f = u.call(d), f != m || a.call(d, "toJSON")) "function" == typeof d.toJSON && (f != v && f != g &&
                f != y || a.call(d, "toJSON")) && (d = d.toJSON(e));
              else if (d > -1 / 0 && d < 1 / 0) {
              if (w) {
                for (E = _(d / 864e5), h = _(E / 365.2425) + 1970 - 1; w(h + 1, 0) <= E; h++);
                for (p = _((E - w(h, 0)) / 30.42); w(h, p + 1) <= E; p++);
                E = 1 + E - w(h, p), $ = (d % 864e5 + 864e5) % 864e5, T = _($ / 36e5) % 24, C = _($ / 6e4) % 60, x = _(
                  $ / 1e3) % 60, S = $ % 1e3
              } else h = d.getUTCFullYear(), p = d.getUTCMonth(), E = d.getUTCDate(), T = d.getUTCHours(), C = d
                .getUTCMinutes(), x = d.getUTCSeconds(), S = d.getUTCMilliseconds();
              d = (h <= 0 || h >= 1e4 ? (h < 0 ? "-" : "+") + A(6, h < 0 ? -h : h) : A(4, h)) + "-" + A(2, p + 1) +
                "-" + A(2, E) + "T" + A(2, T) + ":" + A(2, C) + ":" + A(2, x) + "." + A(3, S) + "Z"
            } else d = null;
            ...
            if ("object" == typeof d) {
              ...
              if (l.push(d), M = [], R = o, o += i, f == y) {
                for (O = 0, D = d.length; O < D; O++) I = N(O, d, n, r, i, o, l), M.push(I === c ? "null" : I);
                P = M.length ? i ? "[\n" + o + M.join(",\n" + o) + "\n" + R + "]" : "[" + M.join(",") + "]" : "[]"
        ...
        f.stringify = function(e, t, n) {
          ...
          if ("function" == typeof t || "object" == typeof t && t)
            ...
            o = {};
            for (var s, c = 0, l = t.length; c < l; s = t[c++], a = u.call(s), (a == g || a == v) && (o[s] = 1));
          }
          if (n)
            if ((a = u.call(n)) == v) {
              if ((n -= n % 1) > 0)
      ...
      if (!o("json-parse")) {
        var I, O, D = String.fromCharCode,
            ...
            for (var e, t, n, r, i, o = O, a = o.length; I < a;) switch (i = o.charCodeAt(I)) {
              ...
              case 34:
                for (e = "@", I++; I < a;)
                  ...
                  case 114:
                    ...
                    break;
                  case 117:
                    for (t = ++I, n = I + 4; I < n; I++) i = o.charCodeAt(I), i >= 48 && i <= 57 || i >= 97 && i <=
                      102 || i >= 65 && i <= 70 || P();
                    e += D("0x" + o.slice(t, I));
                    break;
                  default:
              ...
              default:
                if (t = I, 45 == i && (r = !0, i = o.charCodeAt(++I)), i >= 48 && i <= 57) {
                  for (48 == i && (i = o.charCodeAt(I + 1), i >= 48 && i <= 57) && P(), r = !1; I < a && (i = o
                      .charCodeAt(I), i >= 48 && i <= 57); I++);
                  if (46 == o.charCodeAt(I)) {
                    for (n = ++I; n < a && (i = o.charCodeAt(n), i >= 48 && i <= 57); n++);
                    n == I && P(), I = n
                  }
                  if (i = o.charCodeAt(I), 101 == i || 69 == i) {
                    for (i = o.charCodeAt(++I), 43 != i && 45 != i || I++, n = I; n < a && (i = o.charCodeAt(n), i >=
                        48 && i <= 57); n++);
                    n == I && P(), I = n
                  }
                  return +o.slice(t, I)
          ...
          U = function(e) {
            ...
            if ("$" == e && P(), "string" == typeof e) {
              ...
              if ("[" == e) {
                for (t = []; e = L(), "]" != e; n || (n = !0)) n && ("," == e ? (e = L(), "]" == e && P()) : P()),
                  "," == e && P(), t.push(U(e));
                return t
              }
              if ("{" == e) {
                for (t = {}; e = L(), "}" != e; n || (n = !0)) n && ("," == e ? (e = L(), "}" == e && P()) : P()),
                  "," != e && "string" == typeof e && "@" == (E ? e.charAt(0) : e[0]) && ":" == L() || P(), t[e.slice(
                    1)] = U(L());
                return t
              }
              P()
        ...
        f.parse = function(e, t) {
          var n, r;
          return I = 0, O = "" + e, n = U(L()), "$" != L() && P(), I = O = null, t && u.call(t) == p ? j((r = {}, r[
            ""] = n, r), "", t) : n
        }
      }
    }
