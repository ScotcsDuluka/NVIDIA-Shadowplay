...
function(e, t, n) {
  ! function(e, n) {
    ...
    function $(e, t) {
      var n, r, i, o, a, s = new S(e),
        c = +e.value && (s.value = e.value),
        u = [s];
      for (null == t && (t = T); n = u.pop();)
        if (c && (n.value = +n.data.value), (i = t(n.data)) && (a = i.length))
          for (n.children = new Array(a), o = a - 1; o >= 0; --o) u.push(r = n.children[o] = new S(i[o])), r.parent =
            n, r.depth = n.depth + 1;
    ...
    function M(e) {
      for (var t, n, r = 0, i = (e = A(be.call(e))).length, o = []; r < i;) t = e[r], n && I(n, t) ? ++r : (n = D(o =
        k(o, t)), r = 0);
      return n
    }
    ...
    function k(e, t) {
      ...
      for (n = 0; n < e.length - 1; ++n)
        for (r = n + 1; r < e.length; ++r)
          if (N(P(e[n], e[r]), t) && N(P(e[n], t), e[r]) && N(P(e[r], t), e[n]) && O(L(e[n], e[r], t), e)) return [e[
            n], e[r], t];
      throw new Error
    }
    ...
    function U(e, t, n) {
      var r, i, o, a, s = e.x - t.x,
        c = e.y - t.y,
        u = s * s + c * c;
      u ? (i = t.r + n.r, i *= i, a = e.r + n.r, a *= a, i > a ? (r = (u + a - i) / (2 * u), o = Math.sqrt(Math.max(0,
        a / u - r * r)), n.x = e.x - r * s - o * c, n.y = e.y - r * c + o * s) : (r = (u + i - a) / (2 * u), o =
        Math.sqrt(Math.max(0, i / u - r * r)), n.x = t.x + r * s - o * c, n.y = t.y + r * c + o * s)) : (n.x = t.x +
        n.r, n.y = t.y)
    }
    ...
    function B(e) {
      ...
      U(n, t, r = e[2]), t = new H(t), n = new H(n), r = new H(r), t.next = r.previous = n, n.next = t.previous = r, r
        .next = n.previous = t;
      e: for (s = 3; s < i; ++s) {
    ...
    function K() {
      function e(e) {
        return e.x = n / 2, e.y = r / 2, t ? e.eachBefore(X(t)).eachAfter(Q(i, .5)).eachBefore(J(1)) : e.eachBefore(X(
          Y)).eachAfter(Q(V, 1)).eachAfter(Q(i, e.r / Math.min(n, r))).eachBefore(J(Math.min(n, r) / (2 * e.r))), e
      }
      var t = null,
        n = 1,
        r = 1,
    ...
    function ee(e, t, n, r, i) {
      for (var o, a = e.children, s = -1, c = a.length, u = e.value && (r - t) / e.value; ++s < c;) o = a[s], o.y0 =
        n, o.y1 = i, o.x0 = t, o.x1 = t += o.value * u
    }
      ...
      function t(e, t) {
        return function(n) {
          ...
          var r = n.x0,
            ...
            a = n.x1 - i,
            s = n.y1 - i;
          a < r && (r = a = (r + a) / 2), s < o && (o = s = (o + s) / 2), n.x0 = r, n.y0 = o, n.x1 = a, n.y1 = s
        }
      }
      var n = 1,
        r = 1,
    ...
    function ie() {
      function e(e) {
        var r, i, o, a, s, c, u, l = e.length,
          d = new Array(l),
          f = {};
        for (i = 0; i < l; ++i) r = e[i], s = d[i] = new S(r), null != (c = t(r, i, e)) && (c += "") && (u = Ee + (s
          .id = c), f[u] = u in f ? $e : s);
        for (i = 0; i < l; ++i)
    ...
    function ue(e) {
      for (var t, n = 0, r = 0, i = e.children, o = i.length; --o >= 0;) t = i[o], t.z += n, t.m += n, n += t.s + (
        r += t.c)
    }
    ...
    function fe(e) {
      for (var t, n, r, i, o, a = new de(e, 0), s = [a]; t = s.pop();)
        if (r = t._.children)
          for (t.children = new Array(o = r.length), i = o - 1; i >= 0; --i) s.push(n = t.children[i] = new de(r[i],
            i)), n.parent = t;
    ...
    function he() {
      ...
      function r(e, t, n) {
        if (t) {
          for (var r, i = e, a = e, s = t, c = i.parent.children[0], u = i.m, l = a.m, d = s.m, f = c.m; s = se(s),
            i = ae(i), s && i;) c = ae(c), a = se(a), a.a = e, r = s.z + d - i.z - u + o(s._, i._), r > 0 && (ce(le(s,
            e, n), e, r), u += r, l += r), d += s.m, u += i.m, f += c.m, l += a.m;
    ...
    function pe(e, t, n, r, i) {
      for (var o, a = e.children, s = -1, c = a.length, u = e.value && (i - n) / e.value; ++s < c;) o = a[s], o.x0 =
        t, o.x1 = r, o.y0 = n, o.y1 = n += o.value * u
    }

    function me(e, t, n, r, i, o) {
      for (var a, s, c, u, l, d, f, h, p, m, v, g = [], y = t.children, b = 0, E = 0, _ = y.length, $ = t.value; b <
        _;) {
        c = i - n, u = o - r;
        do l = y[E++].value; while (!l && E < _);
        for (d = f = l, m = Math.max(u / c, c / u) / ($ * e), v = l * l * m, p = Math.max(f / v, v / d); E < _; ++E) {
          if (l += s = y[E].value, s < d && (d = s), s > f && (f = s), v = l * l * m, h = Math.max(f / v, v / d), h >
            p) {
            l -= s;
            break
          }
        ...
        }), a.dice ? ee(a, n, r, i, $ ? r += u * l / $ : o) : pe(a, n, r, $ ? n += c * l / $ : i, o), $ -= l, b = E
      }
      return g
    }
    ...
    function ve() {
      ...
      function t(e) {
        var t = a[e.depth],
          ...
          o = e.x1 - t,
          f = e.y1 - t;
        o < r && (r = o = (r + o) / 2), f < i && (i = f = (i + f) / 2), e.x0 = r, e.y0 = i, e.x1 = o, e.y1 = f, e
          .children && (t = a[e.depth + 1] = s(e) / 2, r += d(e) - t, i += c(e) - t, o -= u(e) - t, f -= l(e) - t, o <
            r && (r = o = (r + o) / 2), f < i && (i = f = (i + f) / 2), n(e, r, i, o, f))
      }
      var n = Te,
        r = !1,
        i = 1,
        ...
        function n(e, n, r, i, o) {
          if ((a = e._squarify) && a.ratio === t)
            for (var a, s, c, u, l, d = -1, f = a.length, h = e.value; ++d < f;) {
              for (s = a[d], c = s.children, u = s.value = 0, l = c.length; u < l; ++u) s.value += c[u].value;
              s.dice ? ee(s, n, r, i, r += (o - r) * s.value / h) : pe(s, n, r, n += (i - n) * s.value / h, o), h -= s
                .value
    ...
    e.cluster = c, e.hierarchy = $, e.pack = K, e.packEnclose = M, e.packSiblings = z, e.partition = te, e.stratify =
      ie, e.tree = he, e.treemap = ve, e.treemapBinary = ge, e.treemapDice = ee, e.treemapResquarify = Ce, e
      .treemapSlice = pe, e.treemapSliceDice = ye, e.treemapSquarify = Te, Object.defineProperty(e, "__esModule", {
        value: !0
      })
  })
}
