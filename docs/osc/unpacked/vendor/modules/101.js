...
function(e, t, n) {
  ! function(e, n) {
    ...
    function i(e, t) {
      return function(n, r) {
        for (var i = n.length, o = [], a = 0, s = e[0], c = 0; i > 0 && s > 0 && (c + s + 1 > r && (s = Math.max(1,
            r - c)), o.push(n.substring(i -= s, i + s)), !((c += s + 1) > r));) s = e[a = (a + 1) % e.length];
    ...
    function u(e, t) {
      ...
      var i = r[0],
        ...
        s = i.length;
      return a === s ? i : a > s ? i + new Array(a - s + 1).join("0") : a > 0 ? i.slice(0, a) + "." + i.slice(a) :
    ...
    function l(e, t) {
      ...
      var i = r[0],
        o = r[1];
      return o < 0 ? "0." + new Array(-o).join("0") + i : i.length > o + 1 ? i.slice(0, o + 1) + "." + i.slice(o +
        1) : i + new Array(o - i.length + 2).join("0")
    }
    ...
    function f(e) {
      function t(e) {
        function t(e) {
          ...
          if ("c" === T) l = S(e) + l, e = "";
            ...
            e = +e;
            var p = e < 0 || 1 / e < 0;
            if (e = isNaN(e) ? v : S(Math.abs(e), _), w && (e = c(e)), p && 0 === +e && "+" !== i && (p = !1), u = (
                p ? "(" === i ? i : m : "-" === i || "(" === i ? "" : i) + u, l = ("s" === T ? $[8 + y / 3] : "") +
              l + (p && "(" === i ? ")" : ""), A)
        ...
        var n = e.fill,
          ...
          w = e.trim,
          T = e.type;
        "n" === T ? (b = !0, T = "g") : E[T] || (void 0 === _ && (_ = 12), w = !0, T = "g"), (d || "0" === n &&
          "=" === r) && (d = !0, n = "0", r = "=");
        var C = "$" === o ? u : "#" === o && /[boxX]/.test(T) ? "0" + T.toLowerCase() : "",
          x = "$" === o ? l : /[%p]/.test(T) ? p : "",
          S = E[T],
          A = /[defgprs%]/.test(T);
        return _ = void 0 === _ ? 6 : /[gprs]/.test(T) ? Math.max(1, Math.min(21, _)) : Math.max(0, Math.min(20, _)),
          t.toString = function() {
            return e + ""
          }, t
      }
      ...
      var s = void 0 === e.grouping || void 0 === e.thousands ? d : i(_.call(e.grouping, Number), e.thousands + ""),
    ...
    h({
      ...
      .precisionFixed = p, e.precisionPrefix = m, e.precisionRound = v, Object.defineProperty(e, "__esModule", {
        value: !0
      })
  })
}
