...
function(e, t, n) {
  ! function(e, n) {
    ...
    function s(e, s) {
      function c(n) {
        var r = null == l ? s.ticks ? s.ticks.apply(s, u) : s.domain() : l,
          ...
          O = k.select("line"),
          D = k.select("text");
        M = M.merge(M.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), k = k
          .merge(I), O = O.merge(I.append("line").attr("stroke", "currentColor").attr($ + "2", _ * y)), D = D.merge(I
            .append("text").attr("fill", "currentColor").attr($, _ * f).attr("dy", e === h ? "0em" : e === m ?
              "0.71em" : "0.32em")), n !== A && (M = M.transition(n), k = k.transition(n), O = O.transition(n), D = D
            .transition(n), N = N.transition(n).attr("opacity", g).attr("transform", function(e) {
            ...
            })), N.remove(), M.attr("d", e === v || e == p ? b ? "M" + _ * b + "," + C + "H0.5V" + x + "H" + _ * b :
            "M0.5," + C + "V" + x : b ? "M" + C + "," + _ * b + "V0.5H" + x + "V" + _ * b : "M" + C + ",0.5H" + x), k
          .attr("opacity", 1).attr("transform", function(e) {
            return w(S(e))
          }), O.attr($ + "2", _ * y), D.attr($, _ * f).text(c), A.filter(a).attr("fill", "none").attr("font-size", 10)
          .attr("font-family", "sans-serif").attr("text-anchor", e === p ? "start" : e === v ? "end" : "middle"), A
          .each(function() {
            this.__axis = S
          })
      }
    ...
    var f = Array.prototype.slice,
      ...
      v = 4,
      g = 1e-6;
    e.axisTop = c, e.axisRight = u, e.axisBottom = l, e.axisLeft = d, Object.defineProperty(e, "__esModule", {
      value: !0
    })
  })
}
