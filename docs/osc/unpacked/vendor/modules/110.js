...
function(e, t, n) {
  ...
  var i = n(69),
    ...
    a = n(23),
    s = n(34),
    c = n(45)("engine.io-client:polling");
  e.exports = r;
  var u = function() {
    var e = n(70),
      t = new e({
  ...
  s(r, i), r.prototype.name = "polling", r.prototype.doOpen = function() {
    ...
    a.decodePayload(e, this.socket.binaryType, n), "closed" != this.readyState && (this.polling = !1, this.emit(
      "pollComplete"), "open" == this.readyState ? this.poll() : c('ignoring poll - transport state "%s"', this
      .readyState))
    ...
    var e = this.query || {},
      ...
      n = "";
    return !1 !== this.timestampRequests && (e[this.timestampParam] = +new Date + "-" + i.timestamps++), this
      .supportsBinary || e.sid || (e.b64 = 1), e = o.encode(e), this.port && ("https" == t && 443 != this.port ||
        "http" == t && 80 != this.port) && (n = ":" + this.port), e.length && (e = "?" + e), t + "://" + this
      .hostname + n + this.path + e
  }
}
