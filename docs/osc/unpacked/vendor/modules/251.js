...
function(e, t, n) {
  ! function(e, r) {
    r(t, n(62), n(30), n(21), n(101), n(65), n(103))
    ...
    function l() {
      function e() {
        var e = o().length,
          ...
          s = c[i - 0],
          u = c[1 - i];
        t = (u - s) / Math.max(1, e - f + 2 * h), d && (t = Math.floor(t)), s += (u - s - t * (e - f)) * p, r = t * (
          1 - f), d && (s = Math.round(s), r = Math.round(r));
        var l = n.range(e).map(function(e) {
          return s + t * e
        });
        return a(i ? l.reverse() : l)
      }
      var t, r, i = u().unknown(void 0),
        o = i.domain,
        a = i.range,
        c = [0, 1],
        d = !1,
    ...
    function b(e, t, r) {
      var i = Math.min(e.length, t.length) - 1,
        ...
        a = new Array(i),
        s = -1;
      for (e[i] < e[0] && (e = e.slice().reverse(), t = t.slice().reverse()); ++s < i;) o[s] = v(e[s], e[s + 1]), a[
        s] = r(t[s], t[s + 1]);
      return function(t) {
    ...
    function w(e, t, r, o) {
      var a, s = n.tickStep(e, t, r);
      switch (o = i.formatSpecifier(null == o ? ",f" : o), o.type) {
        case "s":
          var c = Math.max(Math.abs(e), Math.abs(t));
          return null != o.precision || isNaN(a = i.precisionPrefix(s, c)) || (o.precision = a), i.formatPrefix(o, c);
        case "":
        case "e":
        case "g":
        case "p":
        case "r":
          null != o.precision || isNaN(a = i.precisionRound(s, Math.max(Math.abs(e), Math.abs(t)))) || (o.precision =
            a - ("e" === o.type));
          break;
        case "f":
        case "%":
    ...
    function T(e) {
      ...
      return e.ticks = function(e) {
        ...
        var i, o = t(),
          ...
          c = o[a],
          u = o[s];
        return u < c && (i = c, c = u, u = i, i = a, a = s, s = i), i = n.tickIncrement(c, u, r), i > 0 ? (c = Math
          .floor(c / i) * i, u = Math.ceil(u / i) * i, i = n.tickIncrement(c, u, r)) : i < 0 && (c = Math.ceil(c *
          i) / i, u = Math.floor(u * i) / i, i = n.tickIncrement(c, u, r)), i > 0 ? (o[a] = Math.floor(c / i) * i,
          o[s] = Math.ceil(u / i) * i, t(o)) : i < 0 && (o[a] = Math.ceil(c * i) / i, o[s] = Math.floor(u * i) /
          i, t(o)), e
      }, e
    }
    ...
    function P(e) {
      ...
      return a.base = function(e) {
        ...
        if (null == t && (t = 10 === c ? ".0e" : ","), "function" != typeof t && (t = i.format(t)), e === 1 / 0)
          return t;
        null == e && (e = 10);
    ...
    function Z(e, t, r, i, o, a, s, c, u) {
      function l(n) {
        return (s(n) < n ? v : a(n) < n ? g : o(n) < n ? y : i(n) < n ? b : t(n) < n ? r(n) < n ? _ : w : e(n) < n ?
          T : C)(n)
      }
      ...
      function d(t, r, i, o) {
        if (null == t && (t = 10), "number" == typeof t) {
          ...
          s === x.length ? (o = n.tickStep(r / Se, i / Se, t), t = e) : s ? (s = x[a / x[s - 1][2] < x[s][2] / a ? s -
            1 : s], o = s[1], t = s[0]) : (o = Math.max(n.tickStep(r, i, t), 1), t = c)
        }
      ...
      return f.invert = function(e) {
        ...
        var n, r = p(),
          ...
          o = r[r.length - 1],
          a = o < i;
        return a && (n = i, i = o, o = n), n = d(e, i, o, t), n = n ? n.range(i, o + 1) : [], a ? n.reverse() : n
    ...
    function ee() {
      return s.apply(Z(o.timeYear, o.timeMonth, o.timeWeek, o.timeDay, o.timeHour, o.timeMinute, o.timeSecond, o
    ...
    function ne() {
      function e(e) {
        return isNaN(e = +e) ? o : c(0 === r ? .5 : (e = (i(e) - t) * r, u ? Math.max(0, Math.min(1, e)) : e))
      }
      var t, n, r, i, o, a = 0,
        s = 1,
        c = m,
      ...
      return e.domain = function(o) {
          return arguments.length ? (t = i(a = +o[0]), n = i(s = +o[1]), r = t === n ? 0 : 1 / (n - t), e) : [a, s]
        }, e.clamp = function(t) {
    ...
    function le() {
      function e(e) {
        return isNaN(e = +e) ? s : (e = .5 + ((e = +a(e)) - n) * (e < n ? i : o), d(f ? Math.max(0, Math.min(1, e)) :
          e))
      }
      ...
      return e.domain = function(s) {
          return arguments.length ? (t = a(c = +s[0]), n = a(u = +s[1]), r = a(l = +s[2]), i = t === n ? 0 : .5 / (n -
            t), o = n === r ? 0 : .5 / (r - n), e) : [c, u, l]
        }, e.clamp = function(t) {
        ...
        function(s) {
          return a = s, t = s(c), n = s(u), r = s(l), i = t === n ? 0 : .5 / (n - t), o = n === r ? 0 : .5 / (r - n),
            e
        }
    }
    ...
    var ve = Array.prototype,
      ...
      xe = 30 * Te,
      Se = 365 * Te;
    e.scaleBand = l, e.scalePoint = f, e.scaleIdentity = x, e.scaleLinear = C, e.scaleLog = L, e.scaleSymlog = H, e
      .scaleOrdinal = u, e.scaleImplicit = be, e.scalePow = V, e.scaleSqrt = W, e.scaleQuantile = Y, e.scaleQuantize =
      K, e.scaleThreshold = X, e.scaleTime = ee, e.scaleUtc = te, e.scaleSequential = ie, e.scaleSequentialLog = oe, e
      .scaleSequentialPow = se, e.scaleSequentialSqrt = ce, e.scaleSequentialSymlog = ae, e.scaleSequentialQuantile =
      ue, e.scaleDiverging = de, e.scaleDivergingLog = fe, e.scaleDivergingPow = pe, e.scaleDivergingSqrt = me, e
      .scaleDivergingSymlog = he, e.tickFormat = w, Object.defineProperty(e, "__esModule", {
        value: !0
      })
  })
}
