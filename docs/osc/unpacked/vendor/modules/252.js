...
function(e, t, n) {
  ! function(e, r) {
    ...
    function f() {
      function e() {
        var e, n, o = +f.apply(this, arguments),
        ...
        if (b || (b = e = t.path()), a < o && (n = a, a = o, o = n), a > He)
          if (u > qe - He) b.moveTo(a * Pe(s), a * Fe(s)), b.arc(0, 0, a, s, c, !E), o > He && (b.moveTo(o * Pe(c),
            o * Fe(c)), b.arc(0, 0, o, c, s, E));
          else {
            var _, $, w = s,
              T = c,
              C = s,
            ...
            if (k > He) {
              var D = i(k / o * Fe(M)),
                R = i(k / a * Fe(M));
              (S -= 2 * D) > He ? (D *= E ? 1 : -1, C += D, x -= D) : (S = 0, C = x = (s + c) / 2), (A -= 2 * R) >
                He ? (R *= E ? 1 : -1, w += R, T -= R) : (A = 0, w = T = (s + c) / 2)
            }
            var P = a * Pe(w),
              L = a * Fe(w),
              U = o * Pe(x),
            ...
            A > He ? O > He ? (_ = d(z, q, P, L, a, O, E), $ = d(H, B, U, F, a, O, E), b.moveTo(_.cx + _.x01, _.cy + _
              .y01), O < N ? b.arc(_.cx, _.cy, O, Re(_.y01, _.x01), Re($.y01, $.x01), !E) : (b.arc(_.cx, _.cy, O,
              Re(_.y01, _.x01), Re(_.y11, _.x11), !E), b.arc(0, 0, a, Re(_.cy + _.y11, _.cx + _.x11), Re($.cy +
              $.y11, $.cx + $.x11), !E), b.arc($.cx, $.cy, O, Re($.y11, $.x11), Re($.y01, $.x01), !E))) : (b.moveTo(
              P, L), b.arc(0, 0, a, w, T, !E)) : b.moveTo(P, L), o > He && S > He ? I > He ? (_ = d(U, F, H, B, o, -
              I, E), $ = d(P, L, z, q, o, -I, E), b.lineTo(_.cx + _.x01, _.cy + _.y01), I < N ? b.arc(_.cx, _.cy,
              I, Re(_.y01, _.x01), Re($.y01, $.x01), !E) : (b.arc(_.cx, _.cy, I, Re(_.y01, _.x01), Re(_.y11, _
                .x11), !E), b.arc(0, 0, o, Re(_.cy + _.y11, _.cx + _.x11), Re($.cy + $.y11, $.cx + $.x11), E), b
              .arc($.cx, $.cy, I, Re($.y11, $.x11), Re($.y01, $.x01), !E))) : b.arc(0, 0, o, x, C, E) : b.lineTo(U,
              F)
          }
        else b.moveTo(0, 0);
    ...
    function g() {
      function e(e) {
        var n, u, l, d = e.length,
          f = !1;
        for (null == a && (c = s(l = t.path())), n = 0; n <= d; ++n) !(n < d && o(u = e[n], n, e)) === f && ((f = !
          f) ? c.lineStart() : c.lineEnd()), f && c.point(+r(u, n, e), +i(u, n, e));
        ...
        for (null == u && (d = l(p = t.path())), n = 0; n <= m; ++n) {
          if (!(n < m && c(h = e[n], n, e)) === v)
            if (v = !v) r = n, d.areaStart(), d.lineStart();
              ...
              d.lineEnd(), d.areaEnd()
            } v && (g[n] = +i(h, n, e), y[n] = +a(h, n, e), d.point(o ? +o(h, n, e) : g[n], s ? +s(h, n, e) : y[n]))
        }
    ...
    function _() {
      function e(e) {
        ...
        for (null != r ? p.sort(function(e, t) {
            ...
            return i(e[t], e[n])
          }), n = 0, u = h ? (g - f * b) / h : 0; n < f; ++n, v = l) c = p[n], d = m[c], l = v + (d > 0 ? d * u : 0) +
          b, m[c] = {
            data: e[c],
            index: n,
            value: d,
    ...
    function k(e) {
      function r() {
        var n, r = Ve.call(arguments),
          u = i.apply(this, r),
          l = o.apply(this, r);
        if (c || (c = n = t.path()), e(c, +a.apply(this, (r[0] = u, r)), +s.apply(this, r), +a.apply(this, (r[0] = l,
            r)), +s.apply(this, r)), n) return c = null, n + "" || null
      }
      var i = A,
        o = M,
        a = m,
    ...
    function L() {
      function e() {
        var e;
        if (o || (o = e = t.path()), r.apply(this, arguments).draw(o, +i.apply(this, arguments)), e) return o = null,
          e + "" || null
      }
      var r = n(We),
        i = n(64),
    ...
    function Q(e, t, n) {
      ...
      if (e._l01_a > He) {
        ...
        r = (r * s - e._x0 * e._l12_2a + e._x2 * e._l01_2a) / c, i = (i * s - e._y0 * e._l12_2a + e._y2 * e._l01_2a) /
          c
      }
      if (e._l23_a > He) {
        var u = 2 * e._l23_2a + 3 * e._l23_a * e._l12_a + e._l12_2a,
          l = 3 * e._l23_a * (e._l23_a + e._l12_a);
        o = (o * u + e._x1 * e._l23_2a - t * e._l12_2a) / l, a = (a * u + e._y1 * e._l23_2a - n * e._l12_2a) / l
      }
    ...
    function he(e) {
      var t, n, r = e.length - 1,
        ...
        o = new Array(r),
        a = new Array(r);
      for (i[0] = 0, o[0] = 2, a[0] = e[0] + 2 * e[1], t = 1; t < r - 1; ++t) i[t] = 1, o[t] = 4, a[t] = 4 * e[t] +
        2 * e[t + 1];
      for (i[r - 1] = 2, o[r - 1] = 7, a[r - 1] = 8 * e[r - 1] + e[r], t = 1; t < r; ++t) n = i[t] / o[t - 1], o[t] -=
        n, a[t] -= n * a[t - 1];
    ...
    function $e() {
      function e(e) {
        var n, a, s = t.apply(this, arguments),
          c = e.length,
          u = s.length,
          l = new Array(u);
        for (n = 0; n < u; ++n) {
          for (var d, f = s[n], h = l[n] = new Array(c), p = 0; p < c; ++p) h[p] = d = [0, +o(e[p], f, p, e)], d
            .data = e[p];
          h.key = f
        }
      ...
      return e.keys = function(r) {
        ...
        return arguments.length ? (r = null == t ? Ee : "function" == typeof t ? t : n(Ve.call(t)), e) : r
      }, e.offset = function(t) {
    ...
    function Te(e, t) {
      if ((s = e.length) > 0)
        for (var n, r, i, o, a, s, c = 0, u = e[t[0]].length; c < u; ++c)
          for (o = a = 0, n = 0; n < s; ++n)(i = (r = e[t[n]][c])[1] - r[0]) > 0 ? (r[0] = o, r[1] = o += i) : i < 0 ?
            (r[1] = a, r[0] = a += i) : (r[0] = 0, r[1] = i)
    }
      ...
      if ((i = e.length) > 0 && (r = (n = e[t[0]]).length) > 0) {
        for (var n, r, i, o = 0, a = 1; a < r; ++a) {
          for (var s = 0, c = 0, u = 0; s < i; ++s) {
            for (var l = e[t[s]], d = l[a][1] || 0, f = l[a - 1][1] || 0, h = (d - f) / 2, p = 0; p < s; ++p) {
              var m = e[t[p]],
                v = m[a][1] || 0,
                g = m[a - 1][1] || 0;
              h += v - g
      ...
      lt = {
        draw: function(e, t) {
          var n = Math.sqrt(t / ut),
            ...
            s = -o,
            c = a;
          e.moveTo(r, i), e.lineTo(o, a), e.lineTo(s, c), e.lineTo(at * r - st * i, st * r + at * i), e.lineTo(at *
            o - st * a, st * o + at * a), e.lineTo(at * s - st * c, st * s + at * c), e.lineTo(at * r + st * i,
            at * i - st * r), e.lineTo(at * o + st * a, at * a - st * o), e.lineTo(at * s + st * c, at * c - st *
            s), e.closePath()
        }
      },
    ...
    j.prototype = {
      ...
      lineEnd: function() {
        var e = this._x,
          ...
          n = e.length - 1;
        if (n > 0)
          for (var r, i = e[0], o = t[0], a = e[n] - i, s = t[n] - o, c = -1; ++c <= n;) r = c / n, this._basis
            .point(this._beta * e[c] + (1 - this._beta) * (i + r * a), this._beta * t[c] + (1 - this._beta) * (o +
              r * s));
    ...
    te.prototype = {
        ...
        lineEnd: function() {
          ...
          if (n)
            if (this._line ? this._context.lineTo(e[0], t[0]) : this._context.moveTo(e[0], t[0]), 2 === n) this
              ...
              for (var r = he(e), i = he(t), o = 0, a = 1; a < n; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[
                0][o], r[1][o], i[1][o], e[a], t[a]);
      ...
      }, e.arc = f, e.area = y, e.areaRadial = x, e.curveBasis = H, e.curveBasisClosed = z, e.curveBasisOpen = G, e
      .curveBundle = ft, e.curveCardinal = ht, e.curveCardinalClosed = pt, e.curveCardinalOpen = mt, e
      .curveCatmullRom = vt, e.curveCatmullRomClosed = gt, e.curveCatmullRomOpen = yt, e.curveLinear = p, e
      .curveLinearClosed = ne, e.curveMonotoneX = le, e.curveMonotoneY = de, e.curveNatural = pe, e.curveStep = ve, e
      .curveStepAfter = ye, e.curveStepBefore = ge, e.line = g, e.lineRadial = C, e.linkHorizontal = D, e.linkRadial =
      P, e.linkVertical = R, e.pie = _, e.pointRadial = S, e.radialArea = x, e.radialLine = C, e.stack = $e, e
      .stackOffsetDiverging = Te, e.stackOffsetExpand = we, e.stackOffsetNone = be, e.stackOffsetSilhouette = Ce, e
      .stackOffsetWiggle = xe, e.stackOrderAppearance = Se,
      e.stackOrderAscending = Me, e.stackOrderDescending = Ne, e.stackOrderInsideOut = Ie, e.stackOrderNone = Ee, e
      .stackOrderReverse = Oe, e.symbol = L, e.symbolCircle = We, e.symbolCross = Ye, e.symbolDiamond = Qe, e
      .symbolSquare = rt, e.symbolStar = nt, e.symbolTriangle = ot, e.symbolWye = lt, e.symbols = dt, Object
