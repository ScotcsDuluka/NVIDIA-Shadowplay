  ...
  ! function(e, n) {
    ...
    function a(e) {
      ...
      return isNaN(e) ? "Invalid Date" : o(e.getUTCFullYear()) + "-" + i(e.getUTCMonth() + 1, 2) + "-" + i(e
        .getUTCDate(), 2) + (a ? "T" + i(t, 2) + ":" + i(n, 2) + ":" + i(r, 2) + "." + i(a, 3) + "Z" : r ? "T" + i(
        t, 2) + ":" + i(n, 2) + ":" + i(r, 2) + "Z" : n || t ? "T" + i(t, 2) + ":" + i(n, 2) + "Z" : "")
    }

    function s(e) {
      function i(e, r) {
        var i, a, s = o(e, function(e, o) {
      ...
      function o(e, t) {
        function n() {
          ...
          if (e.charCodeAt(r) === d) {
            ...
            return (t = a) >= o ? c = !0 : (n = e.charCodeAt(a++)) === f ? p = !0 : n === h && (p = !0, e.charCodeAt(
              a) === f && ++a), e.slice(r + 1, t - 1).replace(/""/g, '"')
          }
          for (; a < o;) {
      ...
      function g(e) {
        return null == e ? "" : e instanceof Date ? a(e) : y.test(e += "") ? '"' + e.replace(/"/g, '""') + '"' : e
      }
      var y = new RegExp('["' + e + "\n\r]"),
        b = e.charCodeAt(0);
      return {
    ...
    e.autoType = c, e.csvFormat = g, e.csvFormatBody = y, e.csvFormatRow = E, e.csvFormatRows = b, e.csvFormatValue =
      _, e.csvParse = m, e.csvParseRows = v, e.dsvFormat = s, e.tsvFormat = C, e.tsvFormatBody = x, e.tsvFormatRow =
      A, e.tsvFormatRows = S, e.tsvFormatValue = M, e.tsvParse = w, e.tsvParseRows = T, Object.defineProperty(e,
        "__esModule", {
          value: !0
        })
  })
