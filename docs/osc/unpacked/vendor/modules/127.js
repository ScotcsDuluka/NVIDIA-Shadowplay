// ─────────────────────────────────────────────────────────────
// VENDOR MODULE 127
// role       : service targetService | constant ADOBE_TARGET_MBOXES | constant ADOBE_TARGET_CONFIGURATION | constant CRIMSON_WINDOW_NAMES
// defines    : angular.module("nvExperienceControl")
// requires   : (none)
...
function(e, t, n) {
  ...
  ! function(r, a) {
    ...
    e.module("nvExperienceControl", ["crimson"]), e.module("nvExperienceControl").constant("ADOBE_TARGET_MBOXES", {
      ...
      GFN: "gfnclient",
      OSC: "shareclient"
    }), e.module("nvExperienceControl").service("targetService", ["$window", "$q", "$log", "ADOBE_TARGET_MBOXES",
      "ADOBE_TARGET_CONFIGURATION", "CRIMSON_WINDOW_NAMES",
        ...
        c.initialize = function(e, t, n) {
          ...
          if (e.adobe && e.adobe.target) {
            ...
            if (o.mbox3rdPartyId = a(o), d) e.adobe.target.getOffer({
              ...
              params: o,
              success: function(e) {
                if (u.info("Got adobe target offer, response: ", e), e && e[0] && e[0].content) try {
                  var t = JSON.parse(e[0].content);
                  r.resolve(t)
                } catch (t) {
                  u.error("Warning, failed to parse response offer, relaying response"), r.resolve({
                    variant: {
                      data: e[0].content
                    }
                  })
          ...
          if (h && h[n.activityId]) return u.debug("Tracking fake conversion for", n.activityId), i.resolve({}),
            i.promise;
          if (e.adobe && e.adobe.target) {
