// ─────────────────────────────────────────────────────────────
// VENDOR MODULE 126
// role       : provider dbService | provider dbCacheService | constant DB_SERVICE_EVENTS
// defines    : angular.module("nvDbService")
// requires   : (none)
...
function(e, t) {
  ...
  angular.module("nvDbService", ["crimson", "ngEventAggregator"]), angular.module("nvDbService").constant(
      ...
      $get: ["$window", "$log", "$q", "eventAggregator", "DB_SERVICE_EVENTS", function(e, t, n, r, i) {
        function o(e, t, r, i) {
          return t.getItem(s).then(function(o) {
            var a = o || 0;
            if (a > i) return n.reject(e, "Database downgrade not supported dbVersion=" + a + "target=" +
              i);
            var c = n.resolve();
            return angular.forEach(r, function(r, i) {
              i > a && (c = c.then(function() {
                return v.info(e, "Attempt upgrade from version " + a + " to " + i), r(t).then(
                  function() {
                    return v.info(e, "Successfully upgraded to " + i), a = i, t.setItem(s, a)
                      .catch(function(t) {
                        return n.reject(e, "Failed to persist new db version " + a, t)
                      })
                  }).catch(function(t) {
                  return n.reject(e, "Failed to upgrade to db version from " + a + " to " +
                    i, t)
                })
              }))
            }), c.then(function() {
        ...
        function h(e) {
          ...
          var s, u, l = this;
          t(), angular.forEach(["getItem", "setItem", "removeItem", "clear", "length", "keys", "iterate"],
            function(e) {
              l[e] = a.bind(l, u, e)
            }), e.storeDef && (l.setItem = function(e, t) {
            return _.isObject(t) && (t.ts = Date.now()), a.call(l, u, "setItem", e, t).then(function() {
        ...
        function p(e) {
          return u[e.storeDbName] || (t.info("Create datastore instance", e.storeDbName), u[e.storeDbName] =
            new h(e)), u[e.storeDbName]
        }
        var m = {},
    ...
    return {
      ...
      $get: ["$q", "$log", "dbService", "eventAggregator", "DB_SERVICE_EVENTS", function(e, c, u, l, f) {
        function h(e) {
          a[e] = {}, _.each(s, function(n) {
            a[e][n.storeName] = a[e][n.storeName] || {}, a[e][n.storeName][n.key] = new t(n.storeName, n
              .key, e)
          })
        }
        var p = {},
        ...
        return n = u, r = e, l.on(f.DATABASE_ITEM_CHANGE, function(e) {
          var t;
          e.userId ? a[e.userId] && a[e.userId][e.storeName] && (t = a[e.userId][e.storeName][e.key]) : i[
            e.storeName] && (t = i[e.storeName][e.key]), t && t.sync_()
