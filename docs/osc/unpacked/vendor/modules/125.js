// ─────────────────────────────────────────────────────────────
// VENDOR MODULE 125
// role       : service applicationLifetimeService | service cefService | service eventsDetailService | service loggingSanityService | service telemetryService | factory eventAggregator
// defines    : angular.module("crimson")
// requires   : (none)
// cefQuery   : QUERY_IPC_EXTENSION_MESSAGE, QUERY_READ_SHARED_STORAGE, QUERY_WRITE_SHARED_STORAGE, QUERY_WIN_NODE_INFO, QUERY_WIN_DIR_INFO, QUERY_TIME_INFO, QUERY_WIN_ALLOW_CLOSE, QUERY_WIN_IS_BORDERLESS, QUERY_IS_UI_REFRESHED, QUERY_GET_MAX_WINDOW_SIZE, QUERY_WIN_IS_MAXIMIZED, QUERY_WIN_CLOSE, QUERY_WIN_MINIMIZE, QUERY_HIDE_APPLICATION, QUERY_REQUEST_USER_ATTENTION, QUERY_WIN_RESTORE, QUERY_WIN_MAXIMIZE, QUERY_WIN_FOCUS, QUERY_WIN_MOUSE_START, QUERY_WIN_OPEN_OSC, QUERY_WIN_CLOSE_OSC, QUERY_OSC_DISPLAY_IS_DESKTOP_MODE, QUERY_OSC_SET_PAINTING, QUERY_OSC_DROP_URL, QUERY_WIN_KB_MESSAGE, QUERY_DELETE_COOKIES, QUERY_WIN_COPY_TO_CLIPBOARD, QUERY_LOAD_STRING_TABLE, QUERY_WIN_ALLOW_SET_FOREGROUND, QUERY_WIN_TASKBAR_PROGRESS, QUERY_NODE_RESTART, QUERY_REGISTER_WINDOW_EVENTS_CALLBACK, QUERY_REGISTER_APPLICATION_LIFETIME_EVENTS_CALLBACK, QUERY_LAUNCH_COMPANION_APP, QUERY_NOTIFICATION_DATA, QUERY_WIN_ANIMATE_ACTIONS, QUERY_WIN_LANG_CODE, QUERY_GFN_PREPARE, QUERY_GFN_SET_AUTH_INFO, QUERY_GFN_START, QUERY_GFN_RESUME, QUERY_GFN_STOP, QUERY_GFN_CANCEL, QUERY_GFN_REGISTER_CALLBACK, QUERY_CONTROL_STATS, QUERY_GFN_GET_ACTIVE_SESSIONS, QUERY_GFN_SET_AUTH_TOKEN, QUERY_STREAMER_CLOSE, QUERY_STREAMER_LAUNCH, QUERY_STREAMER_IS_INSTALLED, QUERY_STREAMER_INSTALL, QUERY_READ_UPDATE_TICKET, QUERY_IS_APPLICATION_INSTALLED, QUERY_IS_IN_FULLSCREEN_EXCLUSIVE, QUERY_WIN_RECT, QUERY_OSR_SHOW_SDL_WINDOW, QUERY_OSR_HIDE_SDL_WINDOW, QUERY_WIN_OPEN_OSR, QUERY_WIN_CLOSE_OSR, QUERY_DEVICE_ID, QUERY_BROWSE_DIRECTORY, QUERY_IS_APPLICATION_RUNNING, QUERY_OSR_INPUT_MONITOR, QUERY_OSR_REGISTER_INPUT_MONITOR, QUERY_SYSTEM_INFO, QUERY_DNS, QUERY_OSR_REGISTER_KEYPRESS_CALLBACK, QUERY_OSR_REGISTER_KEYPRESS, QUERY_RESTART_APP, QUERY_GFN_NETWORK_TEST, QUERY_GFN_LATENCY_BASED_ROUTING, QUERY_GFN_UPDATE_APP, QUERY_IPC_PUSH_MESSAGE, QUERY_IPC_POP_MESSAGE, QUERY_IPC_CLEAR_MESSAGES, QUERY_IPC_GET_NUMBER_OF_MESSAGES, QUERY_READ_CONFIG, QUERY_WRITE_CONFIG, QUERY_OPEN_CUSTOM_LAYER, QUERY_CLOSE_CUSTOM_LAYER
  ...
  ! function(r, a) {
    ...
    e.module("crimson", ["nvJsEvents", "nvAngularHttpEndpoint"]).constant("ASSET_TYPES", {
        ...
        function(e, t, n, r, i) {
          ...
          function a() {
            return 0 === p.length ? void u.info("no pre-sleep work") : (u.info("starting pre-sleep functions"),
          ...
          function s(e) {
            ...
            r = n && f.length > 0 ? c(f, e) : t.when(!1), r.then(function(t) {
              return t ? void u.info("shutdown was interrupted during onShutdownRequested") : 0 === h.length ? (
                u.info("no OnShutdown work, closing"), void i.windowClose()) : c(h, e).finally(function() {
                i.windowClose()
              })
            }).finally(function() {
              l = !1
          ...
          this.handleCefClientEvent = function(e) {
            ...
            if (e.type === r.SYSTEM_SUSPEND) a();
              ...
              if ((0, d.default)(n).indexOf(e.reason) === -1) return void u.info("Shutdown reason", e.reason,
                "not found in constants, not handling");
              s(e.reason)
            }
        ...
        WINDOWS: "windows",
        OTHER: "other"
      }), e.module("crimson").service("cefService", ["$q", "$log", "$window", "CEF_WINDOW_STYLES", function(e, t, n,
        r) {
        "use strict";
        ...
        function i(t, r) {
          ...
          return t = (0, u.default)(t), n.cefQuery ? n.cefQuery({
            ...
            onSuccess: function(e) {
              "true" === e ? o.resolve(!0) : "false" === e ? o.resolve(!1) : a ? o.notify(e) : o.resolve(e)
            },
            onFailure: function(e, n) {
              ...
              204 === e && (r.isCancelled = !0), i = "cefQuery returned error: cmd=" + t + "errorMessage=" +
                n, c.error(i), o.reject(r)
            }
        ...
        return {
          ...
          $get: ["NvEndpointFactory", "$log", "$q", "nesEndpoints", "CMS_ERRORS", "CMS_URLS", "ASSET_TYPES",
            function(i, o, a, s, c, u, l) {
              ...
              var m = f.createEndpoint({
                ...
                w = function(t) {
                  return _.isUndefined(t) ? $(c.MISSING_GAME_SCHEMA) : _.isUndefined(t.countryMetaData) ? $(c
                    .MISSING_COUNTRY_METADATA) : _.isUndefined(t.countryMetaData.url) ? $(c
                    .MISSING_COUNTRY_METADATA_URL) : m({
                ...
                T = function(t) {
                  return _.isUndefined(t) ? $(c.MISSING_GAME_SCHEMA) : _.isUndefined(t.languageMetaData) ? $(c
                    .MISSING_LANGUAGE_METADATA) : _.isUndefined(t.languageMetaData.url) ? $(c
                    .MISSING_LANGUAGE_METADATA_URL) : m({
                ...
                C = function(t) {
                  return _.isUndefined(t) ? $(c.MISSING_GAME_SCHEMA) : _.isUndefined(t.appMetaDataUrl) ? $(c
                    .MISSING_APP_METADATA_URL) : m({
                ...
                A = function(e, t, n, i) {
                  var o;
                  return S(t) && (o = u.BASE_IMAGE_URL + "/" + e + "/" + r + "/" + t + ";w=" + n + ";h=" + i), o
                },
                M = function(e, t, n) {
                  var i;
                  return S(t) && (i = u.BASE_IMAGE_URL + "/" + e + "/" + r + "/" + t, _.forEach((0, d.default)(n),
                    function(e) {
                      var t = n[e];
                      i += ";" + e + "=" + t
                    })), i
                ...
                k = function(e, t, n, i) {
                  var o;
                  return S(t) && (o = u.BASE_IMAGE_URL + "/" + e + "/" + r + "/" + t + ";w=" + n, i && (o +=
                    ";h=" + i), o += ";bg=000000;f=jpg"), o
                };
              return {
      ...
      }), e.module("events-detail", ["crimson", "underscore", "ngEventAggregator"]), e.module("events-detail")
      .constant("EVENTS_RETURN_CODE", {
        ...
        function(t, n, r, i, o) {
          ...
          function a(e, t) {
            ...
            return c.length === l.length && n.every(r, function(e, t) {
              return "object" === ("undefined" == typeof e ? "undefined" : (0, h.default)(e)) ? "object" === (0,
                h.default)(o[t]) && a(o[t], e) : n.has(o, t)
            })
          }
          ...
          function l(t, r, i) {
            var o = e.merge({}, i);
            return e.merge(o.parameters, r), o.ts = (new Date).toISOString(), n.has(o.parameters, "id") && (o
              .parameters.id = t.enumId), f.event("eventDetail", o, " set for eventName", t), o
          }
          ...
          function d(e, t, a, s, u) {
            if (a && u) {
              var d = Date.now(),
                h = d - a;
              f.info("started ", e.name, "at ", a, "and ended at ", d, "Time elapsed(ms)", h), t = n.extend({}, t, {
                totalMs: h
              });
              var p = c(e, t, u);
              return p.status === r.UNKNOWN_EVENT_TYPE ? (f.error("Unknown event type", e.type), r
                .UNKNOWN_EVENT_TYPE) : p.status === r.INVALID_INFO_FOR_EVENT_TYPE ? (f.error("invalid input", t,
                "for event", e), r.INVALID_INFO_FOR_EVENT_TYPE) : (s && s.positiveDurationLimit && h > s
                .positiveDurationLimit && (f.info("positive duration", e.name, h), i.trigger(o
                  .SKEWED_POSITIVE_DURATIONS, {
                    eventInfo: e,
                    startTime: a,
                    endTime: d,
                    durationMs: t.totalMs
                  })), s && s.negativeDurationLimit && h < s.negativeDurationLimit && (f.info("negative duration",
                  e.name, h), i.trigger(o.SKEWED_NEGATIVE_DURATIONS, {
                  eventInfo: e,
                  startTime: a,
                  endTime: d,
                  durationMs: t.totalMs
            ...
            if (e && i) {
              if (e.name && e.enumId) {
                ...
                return o.status === r.UNKNOWN_EVENT_TYPE ? (f.event("Unknown event type", e.type), r
                  .UNKNOWN_EVENT_TYPE) : o.status === r.INVALID_INFO_FOR_EVENT_TYPE ? (f.error("invalid input",
                  t, "for event", e), r.INVALID_INFO_FOR_EVENT_TYPE) : l(e, t, o.eventDataFormat)
              }
        ...
        return {
          ...
          setConfig: function(e) {
            t = e.server, n = e.optimizedServer, d = d || e.optimizedServerVersion, r = e.cacheServer, l = e
              .version || l, u = e.defaultRetries || u, f = e.defaultTimeout || f, i = e.deviceId, s = e
              .serviceName, c = e.layoutClientName
          },
          $get: ["$log", "NvEndpointFactory", "eventAggregator", function(h, p, m) {
            ...
            v.setDefaultTimeout(f), v.setDefaultRetries(u), v.setUrlGenerator(function(e, i) {
              ...
              return i && i.useCacheServer ? (o = r + e.url, delete i.useCacheServer) : i && i
                .useOptimizedServer ? (o = n + e.url, delete i.useOptimizedServer) : o = t + e.url, o
              ...
              return function() {
                if ((t || "DEBUG" !== s) && (n || "EVENT" !== s) && (r || "PERF" !== s)) {
                  var u = i("date")(new Date, "yyyy-MM-dd HH:mm:ss.sss"),
                    ...
                    f = "";
                  if (d = u + "  " + s + "  " + c + "-", "PERF" === s)
                    if (l.length < 3 || l.length > 4 || !isNaN(l[0]) || isNaN(l[1]) || isNaN(l[2])) d = u +
                      "  ERROR  " + c + "- Performance log called with incorrect arguments: " + e.toJson(l) +
                      ...
                      var h = l[0],
                        ...
                        v = l[3],
                        g = m - p;
                      h = e.toJson(h, !0), v = e.toJson(v || "", !0), d = d + ' "started " ' + h + ' "at " ' +
                        p + ' "and ended at " ' + m + ' "Time elapsed(ms)" ' + g + " " + v
                    }
                  else
    ...
    e.module("crimson").service("telemetryService", ["$log", "cefService", "jsEventsService", "eventsDetailService",
      "EVENTS_RETURN_CODE",
      function(e, t, n, r, i) {
        "use strict";
        ...
        var s = this;
        s.sessionId = "undefined", s.deviceId = "undefined", s.userId = "undefined", s.isUIRefreshed = !1;
        var c = "",
          u = function() {
            return !0
          };
        s.clientVersion = "undefined", s.launchUiEventSent = !1, s.clientConfig = {}, s.eventsDetailData = {}, s
          .clientType = "UNKNOWN", s.setLaunchUiEventSent = function(e) {
            ...
            var c;
            c = r.getFormattedEvent(e, t, s.eventsDetailData), c && c !== i.UNPROCESSED ? (u(c) && a.info(
              "eventDetail", c), n.sendEventDetail(e, c, o)) : a.info("no event detail formatted")
            ...
            u && u !== i.UNPROCESSED ? (a.info("durationEventDetail", u), n.sendEventDetail(e, u, c)) : a.info(
              "no event detail formatted")
          }, s.setEventsCommonData = function(e, t) {
            var r = !1;
            !s.deviceId && e && e.deviceId && a.info("telemetry deviceId", e.deviceId), (!s.userId || t) && e && e
              .userId && a.info("telemetry userId ", e.userId), s.sessionId = "undefined" !== s.sessionId ? s
              .sessionId : o(), s.deviceId = "undefined" !== s.deviceId ? s.deviceId : e && e.deviceId, s
              .clientVersion = e && e.clientVersion || s.clientVersion, t === !0 ? e && (e.userId && e.userId !==
                s.userId || "" === e.userId) && (s.userId = e.userId, r = !0) : s.userId = "undefined" !== s
              .userId ? s.userId : e && e.userId, (r || _.isUndefined(t)) && (a.info("Set common events data: ", s
                .clientConfig.gxTelemetry.clientId, s.clientVersion, s.sessionId, s.deviceId, s.userId, s
                .clientConfig.jsEvents.schemaVersion), n.setEventsCommonData({
