  ...
  (function() {
    ...
    function a(e, t, n) {
      return function(r, i, o) {
        var a = 0,
          s = M(r);
        if ("number" == typeof o) e > 0 ? a = o >= 0 ? o : Math.max(o + s, a) : s = o >= 0 ? Math.min(o + 1, s) :
          o + s + 1;
    ...
    function s(e, t) {
      var n = R.length,
        ...
        o = "constructor";
      for ($.has(e, o) && !$.contains(t, o) && t.push(o); n--;) o = R[n], o in e && e[o] !== i[o] && !$.contains(t,
        o) && t.push(o)
    }
    var c = this,
      u = c._,
    ...
    "undefined" != typeof e && e.exports && (t = e.exports = $), t._ = $, $.VERSION = "1.8.3";
    ...
    $.each = $.forEach = function(e, t, n) {
      ...
      return o
    }, $.reduce = $.foldl = $.inject = n(1), $.reduceRight = $.foldr = n(-1), $.find = $.detect = function(e, t,
    n) {
      var r;
      ...
      for (var t, n = k(e) ? e : $.values(e), r = n.length, i = Array(r), o = 0; o < r; o++) t = $.random(0, o),
        t !== o && (i[o] = i[t]), i[t] = n[o];
      return i
    }, $.sample = function(e, t, n) {
      return null == t || n ? (k(e) || (e = $.values(e)), e[$.random(e.length - 1)]) : $.shuffle(e).slice(0, Math
        .max(0, t))
    ...
    $.flatten = function(e, t) {
      ...
      for (var i = [], o = [], a = 0, s = M(e); a < s; a++) {
        var c = e[a],
          u = n ? n(c, a, e) : c;
        t ? (a && o === u || i.push(c), o = u) : n ? $.contains(o, u) || (o.push(u), i.push(c)) : $.contains(i,
          c) || i.push(c)
      }
      return i
    }, $.union = function() {
      ...
      return o
    }, $.indexOf = a(1, $.findIndex, $.sortedIndex), $.lastIndexOf = a(-1, $.findLastIndex), $.range = function(e,
      t, n) {
    ...
    $.bind = function(e, t) {
      ...
      var t = p.call(arguments, 1),
        n = function() {
          for (var r = 0, i = t.length, o = Array(i), a = 0; a < i; a++) o[a] = t[a] === $ ? arguments[r++] : t[a];
      ...
      return function() {
        ...
        s || n.leading !== !1 || (s = u);
        var l = t - (u - s);
        return r = this, i = arguments, l <= 0 || l > t ? (a && (clearTimeout(a), a = null), s = u, o = e.apply(r,
          i), a || (r = i = null)) : a || n.trailing === !1 || (a = setTimeout(c, l)), o
      }
    ...
    $.keys = function(e) {
      ...
      var r, i, o = {},
        a = e;
      if (null == a) return o;
      $.isFunction(t) ? (i = $.allKeys(a), r = w(t, n)) : (i = I(arguments, !1, !1, 1), r = function(e, t, n) {
        return t in n
      }, a = Object(a));
    ...
    var P = function(e, t, n, r) {
      ...
      if (!o) {
        ...
        var a = e.constructor,
          s = t.constructor;
        if (a !== s && !($.isFunction(a) && a instanceof a && $.isFunction(s) && s instanceof s) && "constructor" in
          e && "constructor" in t) return !1
      }
      n = n || [], r = r || [];
    ...
    $.isEqual = function(e, t) {
      ...
      return null == e || (k(e) && ($.isArray(e) || $.isString(e) || $.isArguments(e)) ? 0 === e.length : 0 === $
        .keys(e).length)
    ...
    $.mixin = function(e) {
      ...
      $.prototype[e] = function() {
        var n = this._wrapped;
        return t.apply(n, arguments), "shift" !== e && "splice" !== e || 0 !== n.length || delete n[0], G(this,
          n)
      }
