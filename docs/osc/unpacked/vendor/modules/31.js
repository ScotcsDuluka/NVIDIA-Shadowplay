  ...
  ! function(e, n) {
    ...
    function n(e) {
      return function() {
        var t = this.ownerDocument,
          n = this.namespaceURI;
        return n === Ye && t.documentElement.namespaceURI === Ye ? t.createElement(e) : t.createElementNS(n, e)
      }
    }
    ...
    function s(e) {
      ...
      for (var t = this._groups, n = t.length, r = new Array(n), i = 0; i < n; ++i)
        for (var o, s, c = t[i], u = c.length, l = r[i] = new Array(u), d = 0; d < u; ++d)(o = c[d]) && (s = e.call(o,
          o.__data__, d, c)) && ("__data__" in o && (s.__data__ = o.__data__), l[d] = s);
    ...
    function l(e) {
      ...
      for (var t = this._groups, n = t.length, r = [], i = [], o = 0; o < n; ++o)
        for (var a, s = t[o], c = s.length, l = 0; l < c; ++l)(a = s[l]) && (r.push(e.call(a, a.__data__, l, s)), i
          .push(a));
      return new Pe(r, i)
    }
    ...
    function f(e) {
      ...
      for (var t = this._groups, n = t.length, r = new Array(n), i = 0; i < n; ++i)
        for (var o, a = t[i], s = a.length, c = r[i] = [], u = 0; u < s; ++u)(o = a[u]) && e.call(o, o.__data__, u,
          a) && c.push(o);
      return new Pe(r, this._parents)
    }
    ...
    function g(e, t, n, r, i, o) {
      for (var a, s = 0, c = t.length, u = o.length; s < u; ++s)(a = t[s]) ? (a.__data__ = o[s], r[s] = a) : n[s] =
        new m(e, o[s]);
    ...
    function y(e, t, n, r, i, o, a) {
      var s, c, u, l = {},
        ...
        f = o.length,
        h = new Array(d);
      for (s = 0; s < d; ++s)(c = t[s]) && (h[s] = u = Xe + a.call(c, c.__data__, s, t), u in l ? i[s] = c : l[u] =
      c);
      for (s = 0; s < f; ++s) u = Xe + a.call(e, o[s], s, o), (c = l[u]) ? (r[s] = c, c.__data__ = o[s], l[u] =
        null) : n[s] = new m(e, o[s]);
    ...
    function _(e, t, n) {
      var r = this.enter(),
        i = this,
        o = this.exit();
      return r = "function" == typeof e ? e(r) : r.append(e + ""), null != t && (i = t(i)), null == n ? o.remove() :
        n(o), r && i ? r.merge(i).order() : i
    }
    ...
    function w() {
      for (var e = this._groups, t = -1, n = e.length; ++t < n;)
        for (var r, i = e[t], o = i.length - 1, a = i[o]; --o >= 0;)(r = i[o]) && (a && 4 ^ r.compareDocumentPosition(
          a) && a.parentNode.insertBefore(r, a), a = r);
      return this
    }
    ...
    function T(e) {
      ...
      for (var n = this._groups, r = n.length, i = new Array(r), o = 0; o < r; ++o) {
        for (var a, s = n[o], c = s.length, u = i[o] = new Array(c), l = 0; l < c; ++l)(a = s[l]) && (u[l] = a);
        u.sort(t)
      }
    ...
    function U(e, n) {
      ...
      return this.each((null == n ? r.local ? O : I : "function" == typeof n ? r.local ? L : P : r.local ? R : D)(r,
        n))
    }
    ...
    function z(e, t, n) {
      return arguments.length > 1 ? this.each((null == t ? j : "function" == typeof t ? B : H)(e, t, null == n ? "" :
        n)) : q(this.node(), e)
    }
    ...
    function Y(e, t) {
      return arguments.length > 1 ? this.each((null == t ? G : "function" == typeof t ? W : V)(e, t)) : this.node()[e]
    }
    ...
    function se(e) {
      return arguments.length ? this.each(null == e ? ie : ("function" == typeof e ? ae : oe)(e)) : this.node()
        .textContent
    }
    ...
    function de(e) {
      return arguments.length ? this.each(null == e ? ce : ("function" == typeof e ? le : ue)(e)) : this.node()
        .innerHTML
    }
    ...
    function Ae(e) {
      return function() {
        var t = this.__on;
        if (t) {
          for (var n, r = 0, i = -1, o = t.length; r < o; ++r) n = t[r], e.type && n.type !== e.type || n.name !== e
            .name ? t[++i] = n : this.removeEventListener(n.type, n.listener, n.capture);
      ...
      return function(i, o, a) {
        ...
        if (c)
          for (var l = 0, d = c.length; l < d; ++l)
            if ((s = c[l]).type === e.type && s.name === e.name) return this.removeEventListener(s.type, s.listener,
              s.capture), this.addEventListener(s.type, s.listener = u, s.capture = n), void(s.value = t);
    ...
    function Ie(e, t, n) {
      var r = F(e),
        i = r.CustomEvent;
      "function" == typeof i ? i = new i(t, n) : (i = r.document.createEvent("Event"), n ? (i.initEvent(t, n.bubbles,
        n.cancelable), i.detail = n.detail) : i.initEvent(t, !1, !1)), e.dispatchEvent(i)
    }
    ...
    function Ge(e) {
      return "string" == typeof e ? new Pe([document.querySelectorAll(e)], [document.documentElement]) : new Pe([
        null == e ? [] : e
      ], Ze)
    }
    ...
    He.prototype = je.prototype = {
      ...
      }, e.clientPoint = ze, e.create = Fe, e.creator = i, e.customEvent = Ne, e.local = je, e.matcher = d, e.mouse =
      qe, e.namespace = t, e.namespaces = Ke, e.select = Ue, e.selectAll = Ge, e.selection = Le, e.selector = a, e
      .selectorAll = u, e.style = q, e.touch = Ve, e.touches = We, e.window = F, Object.defineProperty(e,
        "__esModule", {
          value: !0
        })
  })
