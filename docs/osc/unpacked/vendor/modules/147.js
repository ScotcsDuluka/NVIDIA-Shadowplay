// ─────────────────────────────────────────────────────────────
// VENDOR MODULE 147
// role       : factory $translateDefaultInterpolation | directive translate | directive translateCloak | provider $translate | constant $STORAGE_KEY | filter translate
// defines    : angular.module("pascalprecht.translate")
// requires   : (none)
...
function(e, t) {
  ...
  angular.module("pascalprecht.translate", ["ng"]).run(["$translate", function(e) {
    ...
    n ? n.get(t) ? e.use(n.get(t)).catch(r) : r() : angular.isString(e.preferredLanguage()) && e.use(e
      .preferredLanguage())
  }]), angular.module("pascalprecht.translate").provider("$translate", ["$STORAGE_KEY", "$windowProvider", function(e,
    t) {
    var n, r, i, o, a, s, c, u, l, d, f, h, p, m, v, g = {},
      y = [],
      b = e,
      E = [],
      _ = !1,
    ...
    var M = function(e, t) {
      ...
      N = function(e) {
        for (var t = [], n = angular.lowercase(e), i = 0, o = y.length; i < o; i++) t.push(angular.lowercase(y[
          i]));
        if (M(t, n) > -1) return e;
        if (r) {
          var a;
          for (var s in r) {
            var c = !1,
              u = Object.prototype.hasOwnProperty.call(r, s) && angular.lowercase(s) === angular.lowercase(e);
            if ("*" === s.slice(-1) && (c = s.slice(0, -1) === e.slice(0, s.length - 1)), (u || c) && (a = r[s],
                M(t, angular.lowercase(a)) > -1)) return a
          }
        }
        var l = e.split("_");
    ...
    var O = function(e, t, n, r) {
      var i, o, a, s;
      t || (t = []), n || (n = {});
      for (i in e) Object.prototype.hasOwnProperty.call(e, i) && (s = e[i], angular.isObject(s) ? O(s, t.concat(
        i), n, i) : (o = t.length ? "" + t.join(T) + T + i : i, t.length && i === r && (a = "" + t.join(T),
        n[a] = "@:" + o), n[o] = s));
      return n
    };
    ...
    var R = function(e) {
      return e ? (angular.isString(e) ? (o = !0, i = [e]) : angular.isArray(e) && (o = !1, i = e), angular
        .isString(n) && M(i, n) < 0 && i.push(n), this) : o ? i[0] : i
    };
    this.use = function(e) {
      if (e) {
        if (!g[e] && !f) throw new Error("$translateProvider couldn't find translationTable for langKey: '" +
          e + "'");
        return a = e, this
      }
      return a
    ...
    this.storageKey = P, this.useUrlLoader = function(e, t) {
      ...
      return e === !1 ? v = void 0 : e === !0 ? v = !0 : "undefined" == typeof e ? v = "$translationCache" :
        e && (v = e), this
    }, this.directivePriority = function(e) {
      return void 0 === e ? C : (C = e, this)
    }, this.$get = ["$log", "$injector", "$rootScope", "$q", function(e, t, r, u) {
      var y, T, S, A = t.get(d || "$translateDefaultInterpolation"),
        L = !1,
        U = {},
        F = {},
        j = function(e, t, r, o) {
      ...
      angular.isFunction(A.useSanitizeValueStrategy) && A.useSanitizeValueStrategy(_), E.length && angular
        .forEach(E, function(e) {
          var r = t.get(e);
          r.setLocale(n || a), angular.isFunction(r.useSanitizeValueStrategy) && r.useSanitizeValueStrategy(
            _), U[r.getInterpolationIdentifier()] = r
        });
      var q = function(e) {
          var t = u.defer();
        ...
        G = function(e, t, n, r) {
          ...
          return q(e).then(function(o) {
            if (Object.prototype.hasOwnProperty.call(o, t)) {
              r.setLocale(e);
              var s = o[t];
              "@:" === s.substr(0, 2) ? G(e, s.substr(2), n, r).then(i.resolve, i.reject) : i.resolve(r
                .interpolate(o[t], n)), r.setLocale(a)
            } else i.reject()
          }, i.reject), i.promise
        },
        V = function(e, t, n, r) {
          ...
          if (o && Object.prototype.hasOwnProperty.call(o, t)) {
            if (r.setLocale(e), i = r.interpolate(o[t], n), "@:" === i.substr(0, 2)) return V(e, i.substr(2),
              n, r);
            r.setLocale(a)
          }
          return i
        ...
        J = function(e, t, n, r) {
          ...
          if (s && Object.prototype.hasOwnProperty.call(s, e)) {
            var d = s[e];
            "@:" === d.substr(0, 2) ? j(d.substr(2), t, n, r).then(o.resolve, o.reject) : o.resolve(c
              .interpolate(d, t))
          } else {
            var f;
            l && !L && (f = W(e)), a && i && i.length ? X(e, t, c, r).then(function(e) {
              ...
              o.reject(H(e))
            }) : l && !L && f ? r ? o.resolve(r) : o.resolve(f) : r ? o.resolve(r) : o.reject(H(e))
          }
          return o.promise
        },
        Z = function(e, t, n) {
          ...
          if (U && Object.prototype.hasOwnProperty.call(U, n) && (s = U[n]), o && Object.prototype
            ...
            var u;
            l && !L && (u = W(e)), a && i && i.length ? (T = 0, r = Q(e, t, s)) : r = l && !L && u ? u : H(e)
          }
          return r
        };
      if (j.preferredLanguage = function(e) {
          ...
          var n = N(e);
          return n && (e = n), g[e] || !f || F[e] ? (t.resolve(e), B(e)) : (s = e, F[e] = z(e).then(function(
            n) {
  ...
  }]), angular.module("pascalprecht.translate").factory("$translateDefaultInterpolation", ["$interpolate", function(
  e) {
    var t, n = {},
      r = "default",
      i = null,
      o = {
        escaped: function(e) {
          var t = {};
          for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (angular.isNumber(e[n]) ? t[n] = e[n] :
            t[n] = angular.element("<div></div>").text(e[n]).html());
          return t
        }
      },
      a = function(e) {
  ...
  }]), angular.module("pascalprecht.translate").constant("$STORAGE_KEY", "NG_TRANSLATE_LANG_KEY"), angular.module(
    "pascalprecht.translate").directive("translate", ["$translate", "$q", "$interpolate", "$compile", "$parse",
    "$rootScope",
      ...
      return {
        ...
        compile: function(t, s) {
          ...
          return function(t, h, p) {
            ...
            var m = {},
              v = function(e) {
                if (angular.isFunction(v._unwatchOld) && (v._unwatchOld(), v._unwatchOld = void 0), angular
                  .equals(e, "") || !angular.isDefined(e)) {
            ...
            if (p.$observe("translateDefault", function(e) {
              ...
              for (var _ in p) Object.prototype.hasOwnProperty.call(p, _) && "translateValue" === _.substr(0,
                14) && "translateValues" !== _ && E(_)
            }
            var $ = function() {
                for (var e in m) m.hasOwnProperty(e) && w(e, m[e], t, t.interpolateParams, t.defaultText)
              },
              ...
              T = function(t, n, i, o) {
                if ("translate" === o) {
                  i || "undefined" == typeof n.defaultText || (t = n.defaultText), h.html(n.preText + t + n
                    .postText);
  ...
  ]), angular.module("pascalprecht.translate").directive("translateCloak", ["$rootScope", "$translate", function(e,
  t) {
    return {
      compile: function(n) {
        var r = function() {
