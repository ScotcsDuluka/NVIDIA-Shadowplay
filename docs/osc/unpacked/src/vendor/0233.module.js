  ...
  ! function(r, i, o) {
    ...
    return function() {
      ...
      var n = e,
        ...
        u = o.Rabbit = i.extend({
          _doReset: function() {
            for (var e = this._key.words, n = this.cfg.iv, r = 0; r < 4; r++) e[r] = 16711935 & (e[
              r] << 8 | e[r] >>> 24) | 4278255360 & (e[r] << 24 | e[r] >>> 8);
            var i = this._X = [e[0], e[3] << 16 | e[2] >>> 16, e[1], e[0] << 16 | e[3] >>> 16, e[2],
                e[1] << 16 | e[0] >>> 16, e[3], e[2] << 16 | e[1] >>> 16
              ],
              o = this._C = [e[2] << 16 | e[2] >>> 16, 4294901760 & e[0] | 65535 & e[1], e[3] << 16 |
            ...
            if (n) {
              var a = n.words,
                ...
                d = u >>> 16 | 4294901760 & l,
                f = l << 16 | 65535 & u;
              o[0] ^= u, o[1] ^= d, o[2] ^= l, o[3] ^= f, o[4] ^= u, o[5] ^= d, o[6] ^= l, o[7] ^= f;
              for (var r = 0; r < 4; r++) t.call(this);
            }
          },
