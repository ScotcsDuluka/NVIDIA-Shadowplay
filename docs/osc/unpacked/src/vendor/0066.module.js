...
function(module, exports, require) {
  ! function(e, n) {
    ...
    function c() {
      for (var e, t, n = f, r = 1 / 0; n;) n._call ? (r > n._time && (r = n._time), e = n, n = n._next) : (
    ...
    function u(e) {
      if (!p) {
        m && (m = clearTimeout(m));
        var t = e - b;
        t > 24 ? (e < 1 / 0 && (m = setTimeout(a, e - _.now() - E)), v && (v = clearInterval(v))) : (v || (
          y = _.now(), v = setInterval(s, g)), p = 1, $(a));
      }
    }
    ...
    function d(e, n, i) {
      var o = new r(),
        a = n;
      return null == n ? (o.restart(e, n, i), o) : (n = +n, i = null == i ? t() : +i, o.restart(function t(
        r) {
    ...
    var f,
      ...
      $ = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(
        window) : function(e) {
        setTimeout(e, 17);
      };
    r.prototype = i.prototype = {
      ...
      restart: function(e, n, r) {
        ...
        r = (null == r ? t() : +r) + (null == n ? 0 : +n), this._next || h === this || (h ? h._next =
          this : f = this, h = this), this._call = e, this._time = r, u();
      },
      stop: function() {
