...
function(module, exports, require) {
  ! function(e, n) {
    ...
    function s(e) {
      var t, n;
      return e = (e + "").trim().toLowerCase(), (t = B.exec(e)) ? (n = t[1].length, t = parseInt(t[1], 16),
          6 === n ? c(t) : 3 === n ? new f(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | 240 & t, (15 & t) <<
            4 | 15 & t, 1) : 8 === n ? u(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (255 & t) / 255) :
          4 === n ? u(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | 240 & t, ((15 &
            t) << 4 | 15 & t) / 255) : null) : (t = z.exec(e)) ? new f(t[1], t[2], t[3], 1) : (t = q.exec(
          e)) ? new f(255 * t[1] / 100, 255 * t[2] / 100, 255 * t[3] / 100, 1) : (t = G.exec(e)) ? u(t[1],
          t[2], t[3], t[4]) : (t = V.exec(e)) ? u(255 * t[1] / 100, 255 * t[2] / 100, 255 * t[3] / 100, t[
          4]) : (t = W.exec(e)) ? v(t[1], t[2] / 100, t[3] / 100, 1) : (t = Y.exec(e)) ? v(t[1], t[2] / 100,
          t[3] / 100, t[4]) : K.hasOwnProperty(e) ? c(K[e]) : "transparent" === e ? new f(NaN, NaN, NaN,
        0) : null;
    }
    ...
    function v(e, t, n, r) {
      return r <= 0 ? e = t = n = NaN : n <= 0 || n >= 1 ? e = t = NaN : t <= 0 && (e = NaN), new b(e, t, n,
        r);
    }
    ...
    function g(e) {
      ...
      var t = e.r / 255,
        ...
        u = a - o,
        l = (a + o) / 2;
      return u ? (c = t === a ? (n - i) / u + 6 * (n < i) : n === a ? (i - t) / u + 2 : (t - n) / u + 4,
        u /= l < .5 ? a + o : 2 - a - o, c *= 60) : u = l > 0 && l < 1 ? 0 : c, new b(c, u, l, e.opacity);
    }
    ...
    function _(e) {
      ...
      return r === i && i === o ? t = n = a : (t = C((.4360747 * r + .3850649 * i + .1430804 * o) / Z), n =
        C((.0139322 * r + .0971045 * i + .7141733 * o) / te)), new T(116 * a - 16, 500 * (t - a), 200 * (
        a - n), e.opacity);
    }
    ...
    function M(e) {
      ...
      if (e instanceof T || (e = _(e)), 0 === e.a && 0 === e.b) return new I(NaN, 0 < e.l && e.l < 100 ? 0 :
        NaN, e.l, e.opacity);
    ...
    t(r, s, {
      ...
      darker: function(e) {
        return e = null == e ? L : Math.pow(L, e), new f(this.r * e, this.g * e, this.b * e, this
          .opacity);
      },
      rgb: function() {
        return this;
      ...
      rgb: function() {
        var e = this.h % 360 + 360 * (this.h < 0),
          ...
          r = n + (n < .5 ? n : 1 - n) * t,
          i = 2 * n - r;
        return new f(E(e >= 240 ? e - 240 : e + 120, i, r), E(e, i, r), E(e < 120 ? e + 240 : e -
          120, i, r), this.opacity);
      },
      displayable: function() {
    ...
    t(T, w, n(r, {
      ...
      rgb: function() {
        ...
        return t = Z * x(t), e = ee * x(e), n = te * x(n), new f(S(3.1338561 * t - 1.6168667 * e -
          .4906146 * n), S(-.9787684 * t + 1.9161415 * e + .033454 * n), S(.0719453 * t -
    ...
    t(P, R, n(r, {
        ...
        rgb: function() {
          var e = isNaN(this.h) ? 0 : (this.h + 120) * X,
            ...
            r = Math.cos(e),
            i = Math.sin(e);
          return new f(255 * (t + n * (ae * r + se * i)), 255 * (t + n * (ce * r + ue * i)), 255 * (
            t + n * (le * r)), this.opacity);
        }
      })), e.color = s, e.cubehelix = R, e.gray = $, e.hcl = N, e.hsl = y, e.lab = w, e.lch = k, e.rgb = d,
