...
// ==================================================================
// VENDOR MODULE 141
// provider $sanitize | filter linky | defines angular.module("ngSanitize")
...
function(module, exports) {
  ...
  ! function(e, t) {
    ...
    function o(t, n) {
      ...
      for (var i = l.firstChild; i;) {
        ...
        if (!(o = i.firstChild) && (1 == i.nodeType && n.end(i.nodeName.toLowerCase()), o = i.nextSibling, !
          o))
          for (; null == o && (i = i.parentNode, i !== l);) o = i.nextSibling, 1 == i.nodeType && n.end(i
    ...
    function c(e, n) {
      ...
      return {
        start: function(e, o) {
          e = t.lowercase(e), !r && _[e] && (r = e), r || $[e] !== !0 || (i("<"), i(e), t.forEach(o,
            function(r, o) {
              var a = t.lowercase(o),
          ...
          e = t.lowercase(e), r || $[e] !== !0 || p[e] === !0 || (i("</"), i(e), i(">")), e == r && (r = !
          1);
        },
        chars: function(e) {
          r || i(s(e));
    ...
    ! function(e) {
      var t;
      if (!e.document || !e.document.implementation) throw d("noinert",
    ...
    }(e), t.module("ngSanitize", []).provider("$sanitize", n), t.module("ngSanitize").filter("linky", [
      "$sanitize",
      function(e) {
        ...
        return function(s, c, u) {
          ...
          function d(e, n) {
            ...
            !t.isDefined(c) || "target" in u || v.push('target="', c, '" '), v.push('href="', e.replace(
              /"/g, "&quot;"), '">'), l(n), v.push("</a>");
          }
          if (null == s || "" === s) return s;
          if (!a(s)) throw o("notstring", "Expected string but received: {0}", s);
          for (var f, h, p, m = s, v = []; f = m.match(n);) h = f[0], f[2] || f[4] || (h = (f[3] ?
              "http://" : "mailto:") + h), p = f.index, l(m.substr(0, p)), d(h, f[0].replace(i, "")),
            m = m.substring(p + f[0].length);
          return l(m), e(v.join(""));
        };
      }
    ]);
