...
function(module, exports, require) {
  ! function(e, r) {
    r(exports, require(31), require(20), require(66), require(21), require(44), require(100));
      ...
      function o(i) {
        ...
        for (l in u)
          if (h = u[l], h.name === n.name) {
            ...
            h.state === Te ? (h.state = xe, h.timer.stop(), h.on.call("interrupt", e, e.__data__, h.index, h
              .group), delete u[l]) : +l < t && (h.state = xe, h.timer.stop(), h.on.call("cancel", e, e
              .__data__, h.index, h.group), delete u[l]);
          }
        if (r.timeout(function() {
          ...
          for (n.state = we, c = new Array(f = n.tween.length), l = 0, d = -1; l < f; ++l)(h = n.tween[l]
            .value.call(e, e.__data__, n.index, n.group)) && (c[++d] = h);
          c.length = d + 1;
        }
      }

      function a(t) {
        for (var r = t < n.duration ? n.ease.call(null, t / n.duration) : (n.timer.restart(s), n.state = Ce,
            1), i = -1, o = c.length; ++i < o;) c[i].call(e, r);
    ...
    function f(e, t) {
      ...
      if (o) {
        t = null == t ? null : t + "";
        for (i in o)(n = o[i]).name === t ? (r = n.state > $e && n.state < Ce, n.state = xe, n.timer.stop(),
          n.on.call(r ? "interrupt" : "cancel", e, e.__data__, n.index, n.group), delete o[i]) : a = !1;
    ...
    function y(e, t) {
      var n;
      return ("number" == typeof t ? i.interpolateNumber : t instanceof o.color ? i.interpolateRgb : (n = o
        .color(t)) ? (t = n, i.interpolateRgb) : i.interpolateString)(e, t);
    }
    ...
    function w(e, t, n) {
      ...
      return function() {
        var a,
          s,
          c = n(this);
        return null == c ? void this.removeAttribute(e) : (a = this.getAttribute(e), s = c + "", a === s ?
          null : a === r && s === i ? o : (i = s, o = t(r = a, c)));
      };
    }
    ...
    function T(e, t, n) {
      ...
      return function() {
        var a,
          s,
          c = n(this);
        return null == c ? void this.removeAttributeNS(e.space, e.local) : (a = this.getAttributeNS(e
          .space, e.local), s = c + "", a === s ? null : a === r && s === i ? o : (i = s, o = t(r = a,
          c)));
      };
    }
    ...
    function C(e, n) {
      ...
      return this.attrTween(e, "function" == typeof n ? (r.local ? T : w)(r, o, g(this, "attr." + e, n)) :
        null == n ? (r.local ? E : b)(r) : (r.local ? $ : _)(r, o, n));
    }
    ...
    function P(e) {
      var t = this._id;
      return arguments.length ? this.each(("function" == typeof e ? D : R)(t, e)) : l(this.node(), t)
        .duration;
    }
    ...
    function F(e) {
      ...
      for (var n = this._groups, r = n.length, i = new Array(r), o = 0; o < r; ++o)
        for (var a, s = n[o], c = s.length, u = i[o] = [], l = 0; l < c; ++l)(a = s[l]) && e.call(a, a
          .__data__, l, s) && u.push(a);
    ...
    function V(e) {
      ...
      for (var i = this._groups, o = i.length, a = new Array(o), c = 0; c < o; ++c)
        for (var u, d, f = i[c], h = f.length, p = a[c] = new Array(h), m = 0; m < h; ++m)(u = f[m]) && (d =
          e.call(u, u.__data__, m, f)) && ("__data__" in u && (d.__data__ = u.__data__), p[m] = d, s(p[m],
          n, r, m, p, l(u, r)));
    ...
    function W(e) {
      ...
      for (var i = this._groups, o = i.length, a = [], c = [], u = 0; u < o; ++u)
        for (var d, f = i[u], h = f.length, p = 0; p < h; ++p)
          if (d = f[p]) {
            for (var m, v = e.call(d, d.__data__, p, f), g = l(d, r), y = 0, b = v.length; y < b; ++y)(m =
              v[y]) && s(m, n, r, y, v, g);
            a.push(v), c.push(d);
          }
    ...
    function J(e, n, r) {
      ...
      return function() {
        var s = t.style(this, e),
          c = r(this),
          u = c + "";
        return null == c && (this.style.removeProperty(e), u = c = t.style(this, e)), s === u ? null :
          s === i && u === o ? a : (o = u, a = n(i = s, c));
      };
    }
    ...
    function ee(e, t, n) {
      ...
      return null == t ? this.styleTween(e, K(e, r)).on("end.style." + e, X(e)) : "function" == typeof t ?
        this.styleTween(e, J(e, r, g(this, "style." + e, t))).each(Z(this._id, e)) : this.styleTween(e, Q(e,
          r, t), n).on("end.style." + e, null);
    }
    ...
    function de() {
      ...
      return new Promise(function(o, a) {
        ...
        n.each(function() {
          var n = u(this, r),
            i = n.on;
          i !== e && (t = (e = i).copy(), t._.cancel.push(s), t._.interrupt.push(s), t._.end.push(
            c)), n.on = t;
        });
      });
    }
    ...
    function ve(e) {
      var t, n;
      e instanceof fe ? (t = e._id, e = e._name) : (t = pe(), (n = ke).time = r.now(), e = null == e ?
        null : e + "");
