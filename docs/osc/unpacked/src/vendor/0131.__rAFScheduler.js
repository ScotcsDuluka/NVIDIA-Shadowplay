...
// ==================================================================
// VENDOR MODULE 131
// factory $$rAFScheduler | directive ngAnimateSwap | directive ngAnimateChildren | provider $$animateQueue | provider $$animation | provider $animateCss | provider $$animateCssDriver | provider $$animateJs | provider $$animateJsDriver | defines angular.module("ngAnimate")
  ...
  ! function(e, t) {
    ...
    function v(e, t, n) {
      ...
      return F(r, i), c && (r.domOperation = c), s.addClass ? r.addClass = s.addClass : r.addClass = null, s
        .removeClass ? r.removeClass = s.removeClass : r.removeClass = null, t.addClass = r.addClass, t
        .removeClass = r.removeClass, r;
    }
    ...
    function g(e, t, n) {
      ...
      return H(a, function(t, n) {
        var r, a;
        t === i ? (r = "addClass", a = !e[n]) : t === o && (r = "removeClass", a = e[n]), a && (s[r]
          .length && (s[r] += " "), s[r] += n);
      }), s;
    }
    ...
    function b(e, t, n) {
      var r = "";
      t && (r = o(t, J, !0)), n.addClass && (r = T(r, o(n.addClass, X))), n.removeClass && (r = T(r, o(n
        .removeClass, Q))), r.length && (n.preparationClasses = r, e.addClass(r));
    }

    function E(e, t) {
      t.preparationClasses && (e.removeClass(t.preparationClasses), t.preparationClasses = null), t
        .activeClasses && (e.removeClass(t.activeClasses), t.activeClasses = null);
    }
    ...
    function A(e) {
      ...
      return H(n, function(e) {
        "s" == e.charAt(e.length - 1) && (e = e.substring(0, e.length - 1)), e = parseFloat(e) || 0, t =
          t ? Math.max(e, t) : e;
      }), t;
    }
    ...
    G(e.ontransitionend) && V(e.onwebkittransitionend) ? (re = "-webkit-", O = "WebkitTransition", D =
        "webkitTransitionEnd transitionend") : (O = "transition", D = "transitionend"), G(e.onanimationend) &&
      V(e.onwebkitanimationend) ? (re = "-webkit-", R = "WebkitAnimation", P =
        "webkitAnimationEnd animationend") : (R = "animation", P = "animationend");
    var ie = "Duration",
      oe = "Property",
      ae = "Delay",
      se = "TimingFunction",
      ...
      ge = ["$interpolate", function(e) {
        return {
          link: function(n, r, i) {
            ...
            t.isString(a) && 0 === a.length ? r.data(ne, !0) : (o(e(a)(n)), i.$observe(
              "ngAnimateChildren", o));
          }
        };
      }],
      ...
      Te = ["$animateProvider", function(e) {
        ...
        this.$get = ["$window", "$$jqLite", "$$AnimateRunner", "$timeout", "$$forceReflow", "$sniffer",
          ...
          function(e, r, s, c, u, l, v, g) {
            ...
            function E(n, r, i, o) {
              var a = t.get(i);
              return a || (a = S(e, n, o), "infinite" === a.animationIterationCount && (a
                .animationIterationCount = 1)), t.put(i, a), a;
            }
            ...
            function T(i, a, s, c) {
              ...
              if (t.count(s) > 0 && (u = n.get(s), !u)) {
                var l = o(a, "-stagger");
                r.addClass(i, l), u = S(e, i, c), u.animationDuration = Math.max(u.animationDuration, 0),
                  u.transitionDuration = Math.max(u.transitionDuration, 0), r.removeClass(i, l), n.put(s,
                    u);
              }
              return u || {};
            }
            ...
            function N(e, t, n) {
              var r = E(e, t, n, $e),
                i = r.animationDelay,
                o = r.transitionDelay;
              return r.maxDelay = i && o ? Math.max(i, o) : i || o, r.maxDuration = Math.max(r
                .animationDuration * r.animationIterationCount, r.transitionDuration), r;
            }
            var F = d(r),
              j = 0,
              z = [];
            return function(e, n) {
              ...
              function v(t) {
                if (!(W || K && Y)) {
                  W = !0, Y = !1, q.$$skipPreparationClasses || r.removeClass(e, $e), r.removeClass(e,
                    Ce), $(V, !1), _(V, !1), H(ue, function(e) {
                    V.style[e[0]] = "";
              ...
              function z() {
                function t() {
                  if (!W) {
                    if (E(!1), H(ue, function(e) {
                      ...
                      if (Te = V.className + " " + $e, Ae = b(V, Te), Le = N(V, Te, Ae), Ue = Le
                        .maxDelay, ne = Math.max(Ue, 0), ie = Le.maxDuration, 0 === ie) return void v();
                      Fe.hasTransitions = Le.transitionDuration > 0, Fe.hasAnimations = Le
                        .animationDuration > 0;
                    }
                    if (Fe.applyAnimationDelay && (Ue = "boolean" != typeof q.delay && M(q.delay) ?
                        parseFloat(q.delay) : Ue, ne = Math.max(Ue, 0), Le.animationDelay = Ue, je = x(
                          Ue, !0), ue.push(je), V.style[je[0]] = je[1]), re = ne * be, ae = ie * be, q
                      .easing) {
                      var t,
                        i = q.easing;
                      Fe.hasTransitions && (t = O + se, ue.push([t, i]), V.style[t] = i), Fe
                        .hasAnimations && (t = R + se, ue.push([t, i]), V.style[t] = i);
                    }
                    Le.transitionDuration && he.push(D), Le.animationDuration && he.push(P), ce = Date
                      .now();
                    var o = re + _e * ae,
                      a = ce + o,
                      s = e.data(ye) || [],
                    ...
                    he.length && e.on(he.join(" "), j), q.to && (q.cleanupStyles && I(G, V, Object.keys(
                      q.to)), m(e, q));
                  }
                }
                ...
                if (!W) {
                  ...
                  var i = function(e) {
                    ...
                    o = Re > 0 && (Le.transitionDuration && 0 === Me.transitionDuration || Le
                      .animationDuration && 0 === Me.animationDuration) && Math.max(Me.animationDelay,
                      Me.transitionDelay);
              ...
              var pe = q.event && B(q.event) ? q.event.join(" ") : q.event,
                ...
                ve = "",
                ge = "";
              me ? ve = o(pe, J, !0) : pe && (ve = pe), q.addClass && (ge += o(q.addClass, X)), q
                .removeClass && (ge.length && (ge += " "), ge += o(q.removeClass, Q)), q
                .applyClassesEarly && ge.length && F(e, q);
              ...
              var Fe = {};
              if (Fe.hasTransitions = Le.transitionDuration > 0, Fe.hasAnimations = Le
                .animationDuration > 0, Fe.hasTransitionAll = Fe.hasTransitions && "all" == Le
                .transitionProperty, Fe.applyTransitionDuration = xe && (Fe.hasTransitions && !Fe
                  .hasTransitionAll || Fe.hasAnimations && !Fe.hasTransitions), Fe
                .applyAnimationDuration = q.duration && Fe.hasAnimations, Fe.applyTransitionDelay = M(q
                  .delay) && (Fe.applyTransitionDuration || Fe.hasTransitions), Fe.applyAnimationDelay =
                M(q.delay) && Fe.hasAnimations, Fe.recalculateTimingStyles = ge.length > 0, (Fe
                  .applyTransitionDuration || Fe.applyAnimationDuration) && (ie = q.duration ?
                  parseFloat(q.duration) : ie, Fe.applyTransitionDuration && (Fe.hasTransitions = !0, Le
                    .transitionDuration = ie, Ne = V.style[O + oe].length > 0, ue.push(k(ie, Ne))), Fe
                  .applyAnimationDuration && (Fe.hasAnimations = !0, Le.animationDuration = ie, ue.push(
                    C(ie)))), 0 === ie && !Fe.recalculateTimingStyles) return S();
              if (null != q.delay) {
                var je;
              ...
              return null == q.duration && Le.transitionDuration > 0 && (Fe.recalculateTimingStyles = Fe
                  ...
                  .blockTransition = Le.transitionDuration > 0, Fe.blockKeyframeAnimation = Le
                  .animationDuration > 0 && Me.animationDelay > 0 && 0 === Me.animationDuration), q
                .from && (q.cleanupStyles && I(G, V, Object.keys(q.from)), p(e, q)), Fe
                .blockTransition || Fe.blockKeyframeAnimation ? E(ie) : q.skipBlocking || _(V, !1), {
                  $$willAnimate: !0,
                  end: u,
                  start: function() {
                    if (!W) return te = {
        ...
        this.$get = ["$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$sniffer", "$$jqLite",
          ...
          function(e, a, s, c, u, l, f) {
            ...
            function g(t) {
              var n = t.element,
                r = t.options || {};
              t.structural && (r.event = t.event, r.structural = !0, r.applyClassesEarly = !0, "leave" ===
                t.event && (r.onDone = r.domOperation)), r.preparationClasses && (r.event = T(r.event, r
                .preparationClasses));
              var i = e(n, r);
      ...
      xe = ["$animateProvider", function(e) {
        this.$get = ["$injector", "$$AnimateRunner", "$$jqLite", function(t, n, r) {
          ...
          return function(e, t, r, a) {
            ...
            function d(e, t, r, i, o) {
              ...
              if (0 === a.length) {
                ...
                "beforeSetClass" === o ? (s = l(e, "removeClass", r, i, "beforeRemoveClass"), c = l(e,
                    "addClass", r, i, "beforeAddClass")) : "setClass" === o && (s = l(e,
                    "removeClass", r, i, "removeClass"), c = l(e, "addClass", r, i, "addClass")), s &&
                  (a = a.concat(s)), c && (a = a.concat(c));
              }
            ...
            var p = !1;
            3 === arguments.length && q(r) && (a = r, r = null), a = f(a), r || (r = e.attr(
              "class") || "", a.addClass && (r += " " + a.addClass), a.removeClass && (r += " " + a
                .removeClass));
            var m,
              v,
              g = a.addClass,
            ...
            if (b.length) {
              var E, _;
              "leave" == t ? (_ = "leave", E = "afterLeave") : (_ = "before" + t.charAt(0)
                .toUpperCase() + t.substr(1), E = t), "enter" !== t && "move" !== t && (m = d(e, t,
                a, b, _)), v = d(e, t, a, b, E);
            }
            if (m || v) {
              var $;
          ...
          function(i, o, m, g, _, $, w, T, C, x) {
            ...
            function M(e, t, n) {
              ...
              return a && H(a, function(e) {
                ie.call(e.node, r) ? o.push(e.callback) : "leave" === n && ie.call(e.node, i) && o
                  .push(e.callback);
              }), o;
            }
            ...
            function I(e, t, n) {
              ...
              if (B(_.addClass) && (_.addClass = _.addClass.join(" ")), _.addClass && !z(_.addClass) && (_
                  .addClass = null), B(_.removeClass) && (_.removeClass = _.removeClass.join(" ")), _
                .removeClass && !z(_.removeClass) && (_.removeClass = null), _.from && !q(_.from) && (_
                  .from = null), _.to && !q(_.to) && (_.to = null), !d) return c(), T;
              ...
              var k = ["enter", "move", "leave"].indexOf(t) >= 0,
                ...
                F = !R && W.get(d) || {},
                j = !!F.state;
              if (R || j && F.state == l || (R = !P(e, m, t)), R) return I && r(T, t, "start"), c(), I &&
                r(T, t, "close"), T;
              k && O(e);
              var G = {
                structural: k,
              ...
              if (j) {
                ...
                if (Y) {
                  ...
                  var K = a("join", e, G, F);
                  if (K) {
                    if (F.state !== p) return b(e, k ? t : null, _), t = G.event = F.event, _ = v(e, F,
                      G), F.runner;
                    A(e, G);
                  }
                }
              ...
              var J = G.structural;
              if (J || (J = "animate" === G.event && Object.keys(G.options.to || {}).length > 0 || u(G)),
                !J) return c(), D(e), T;
              var Z = (F.counter || 0) + 1;
              return G.counter = Z, L(e, l, G), o.$$postDigest(function() {
                ...
                if (i || n.counter !== Z || !a) return i && (re(e, _), h(e, _)), (i || k && n
                  .event !== t) && (_.domOperation(), T.end()), void(a || D(e));
            ...
            var W = new _(),
              ...
              oe = {
                ...
                pin: function(e, t) {
                  n(Y(e), "element", "not an element"), n(Y(t), "parentElement", "not an element"), e
                    .data(Me, t);
                },
        ...
        this.$get = ["$$jqLite", "$rootScope", "$injector", "$$AnimateRunner", "$$HashMap",
          ...
          function(e, s, c, u, l, p) {
            function m(e) {
              ...
              function n(e) {
                ...
                for (t = 0; t < r.length; t++) {
                  var s = r[t];
                  i <= 0 && (i = o, o = 0, n.push(a), a = []), a.push(s.fn), s.children.forEach(function(
                    e) {
                    o++, r.push(e);
                  }), i--;
                }
            ...
            return function(l, d, b) {
              ...
              function S(t) {
                l.off("$destroy", x), n(l), g(l, b), h(l, b), b.domOperation(), N && e.removeClass(l,
                  N), l.removeClass(te), M.complete(!t);
              }
              b = f(b);
        ...
        return {
          ...
          link: function(t, n, r, i, o) {
            ...
            t.$watchCollection(r.ngAnimateSwap || r.for, function(r) {
              a && e.leave(a), s && (s.$destroy(), s = null), (r || 0 === r) && (s = t.$new(), o(s,
                function(t) {
    ...
    t.module("ngAnimate", []).directive("ngAnimateSwap", Ie).directive("ngAnimateChildren", ge).factory(
      "$$rAFScheduler", ve).provider("$$animateQueue", ke).provider("$$animation", Ne).provider(
      "$animateCss", Te).provider("$$animateCssDriver", Ce).provider("$$animateJs", xe).provider(
      "$$animateJsDriver", Se);
