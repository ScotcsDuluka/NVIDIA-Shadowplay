...
function(module, exports, require) {
  ...
  var r,
    ...
    I = !! function() {
      try {
        var e = A.resolve(1),
          t = (e.constructor = {})[require(5)("species")] = function(e) {
            e(k, k);
          };
        return (M || "function" == typeof PromiseRejectionEvent) && e.then(k) instanceof t && 0 !== S.indexOf(
          "6.6") && _.indexOf("Chrome/66") === -1;
      } catch (e) {}
    }(),
    O = function(e) {
      var t;
        ...
        y(function() {
          for (var r = e._v, i = 1 == e._s, o = 0, a = function(t) {
              var n,
                ...
                l = t.domain;
              try {
                s ? (i || (2 == e._h && L(e), e._h = 1), s === !0 ? n = r : (l && l.enter(), n = s(r),
                  l && (l.exit(), a = !0)), n === t.promise ? u(T("Promise-chain cycle")) : (o = O(
                  n)) ? o.call(n, c, u) : c(n)) : u(r);
              } catch (e) {
                l && !a && l.exit(), u(e);
              }
            }; n.length > o;) a(n[o++]);
  ...
  I || (A = function(e) {
    ...
    1;
  }, r.prototype = require(197)(A.prototype, {
    then: function(e, t) {
      var n = N(v(this, A));
      return n.ok = "function" != typeof e || e, n.fail = "function" == typeof t && t, n.domain = M ?
        C.domain : void 0, this._c.push(n), this._a && this._a.push(n), this._s && D(this, !1), n
        .promise;
    },
    catch: function(e) {
    ...
    Promise: A
  }), require(38)(A, w), require(198)(w), a = require(2)[w], d(d.S + d.F * !I, w, {
    reject: function(e) {
      var t = N(this),
        n = t.reject;
  ...
  }), d(d.S + d.F * !(I && require(188)(function(e) {
    A.all(e).catch(k);
  })), w, {
    all: function(e) {
      var t = this,
