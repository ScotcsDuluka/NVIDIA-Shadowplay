...
// ==================================================================
// VENDOR MODULE 148
// service $resolve | service $templateFactory | directive uiView | directive uiView | directive uiSref | directive uiSrefActive | directive uiSrefActiveEq | provider $urlMatcherFactory | provider $urlRouter | provider $state | provider $view | provider $uiViewScroll | value $stateParams | filter isState | filter includedByState | defines angular.module("ui.router.util")
...
function(module, exports) {
   ...
   */
  "undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module
      .exports = "ui.router"),
    function(e, t, n) {
      "use strict";
      ...
      function m(e, t) {
        ...
        this.study = function(c) {
          function h(e, n) {
            if (y[n] !== o) {
              if (g.push(n), y[n] === r) throw g.splice(0, s(g, n)), new Error("Cyclic dependency: " + g
                .join(" -> "));
          ...
          return U(c, h), c = g = y = null,
            function(r, o, a) {
              ...
              o.$$inheritedValues && i(b, f(o.$$inheritedValues, m)), F(y, o.$$promises), o.$$values ? (_ =
                i(b, f(o.$$values, m)), g.$$inheritedValues = f(o.$$values, m), s()) : (o
                .$$inheritedValues && (g.$$inheritedValues = f(o.$$inheritedValues, m)), o.then(s, c));
              for (var $ = 0, w = v.length; $ < w; $ += 3) r.hasOwnProperty(v[$]) ? s() : u(v[$], v[$ + 1],
                v[$ + 2]);
              return g;
            };
      ...
      function v(e, t, n) {
        this.fromConfig = function(e, t, n) {
          return O(e.template) ? this.fromString(e.template, t) : O(e.templateUrl) ? this.fromUrl(e
            .templateUrl, t) : O(e.templateProvider) ? this.fromProvider(e.templateProvider, t, n) : null;
      ...
      function g(e, t, i) {
        function o(t, n, r, i) {
          ...
          if (!/^\w+(-+\w+)*(?:\[\])?$/.test(t)) throw new Error("Invalid parameter name '" + t +
            "' in pattern '" + e + "'");
        ...
        function s(i, o) {
          var a, s, c, u, l;
          return a = i[2] || i[3], l = t.params[a], c = e.substring(f, i.index), s = o ? i[4] : i[4] || (
            "*" == i[1] ? ".*" : null), u = H.type(s || "string") || r(H.type("string"), {
        ...
        this.source = e;
        for (var g, y, b;
          (c = u.exec(e)) && (g = s(c, !1), !(g.segment.indexOf("?") >= 0));) y = o(g.id, g.type, g.cfg,
            "path"), d += a(g.segment, y.type.pattern.source, y.squash, y.isOptional), h.push(g.segment), f =
          u.lastIndex;
        b = e.substring(f);
        var E = b.indexOf("?");
        if (E >= 0) {
        ...
        d += a(b) + (t.strict === !1 ? "/?" : "") + "$", h.push(b), this.regexp = new RegExp(d, t
          .caseInsensitive ? "i" : n), this.prefix = h[0], this.$$paramNames = v;
      }
      ...
      function b() {
        ...
        var d,
          ...
          w = {
            ...
            date: {
              encode: function(e) {
                return this.is(e) ? [e.getFullYear(), ("0" + (e.getMonth() + 1)).slice(-2), ("0" + e
                  .getDate()).slice(-2)].join("-") : n;
              },
              decode: function(e) {
        ...
        b.$$getDefaultValue = function(e) {
          ...
          function o(e) {
            var t = P(e) ? a(e) : [],
              n = s(t, "value") === -1 && s(t, "type") === -1 && s(t, "squash") === -1 && s(t, "array") ===
              -1;
            return n && (e = {
              value: e
          ...
          function u(t, n, r) {
            ...
            return n ? n : t.type ? t.type instanceof y ? t.type : new y(t.type) : "config" === r ? E.any :
              E.string;
          }
          ...
          function f(e, t) {
            ...
            if (n === !0 || R(n)) return n;
            throw new Error("Invalid squash policy: '" + n +
          ...
          function g() {
            if (!d) throw new Error("Injectable functions cannot be called at configuration time");
            var e = d.invoke(r.$$fn);
            if (null !== e && e !== n && !$.type.is(e)) throw new Error("Default value (" + e +
              ") for parameter '" + $.id + "' is not an instance of Type (" + $.type.name + ")");
            return e;
          }
          ...
          r = o(r), t = u(r, t, i);
          var w = l();
          t = w ? t.$asArray(w, "search" === i) : t, "string" !== t.name || w || "path" !== i || r.value !==
            n || (r.value = "");
          var T = r.value !== n,
            C = f(r, T),
            x = m(r, w, T, C);
      ...
      function E(e, r) {
        ...
        function s(r, i, o, a) {
          ...
          return d || h(), {
            ...
            push: function(e, t, i) {
              var o = e.format(t || {});
              null !== o && t && t["#"] && (o += "#" + t["#"]), r.url(o), p = i && i.$$avoidResync ? r
                .url() : n, i && i.replace && r.replace();
            },
            href: function(n, i, o) {
              ...
              var c = n.format(i);
              if (o = o || {}, a || null === c || (c = "#" + e.hashPrefix() + c), null !== c && i && i[
                  "#"] && (c += "#" + i["#"]), c = s(c, a, o.absolute), !o.absolute || !c) return c;
              var u = !a && c ? "/" : "",
                l = r.port();
              return l = 80 === l || 443 === l ? "" : ":" + l, [r.protocol(), "://", r.host(), l, u, c]
                .join("");
            }
          };
        }
        ...
        this.rule = function(e) {
          ...
          var n,
            s = R(t);
          if (R(e) && (e = r.compile(e)), !s && !D(t) && !L(t)) throw new Error(
      ...
      function _(e, i) {
        ...
        function v(t) {
          ...
          var i = n.indexOf(".") !== -1 ? n.substring(0, n.lastIndexOf(".")) : R(t.parent) ? t.parent : P(t
            .parent) && R(t.parent.name) ? t.parent.name : "";
        ...
        function y(e) {
          for (var t = e.split("."), n = T.$current.name.split("."), r = 0, i = t.length; r < i; r++) "*" ===
            t[r] && (n[r] = "*");
          return "**" === t[0] && (n = n.slice(s(n, t[1])), n.unshift("**")), "**" === t[t.length - 1] && (n
              .splice(s(n, t[t.length - 2]) + 1, Number.MAX_VALUE), n.push("**")), t.length == n.length && n
            .join("") === t.join("");
        }

        function b(e, t) {
          return R(e) && !O(t) ? A[e] : D(t) && R(e) ? (A[e] && !A.$delegates[e] && (A.$delegates[e] = A[e]),
            A[e] = t, this) : this;
        }
        ...
        function _(e, i, o, s, d, h, m, v, b) {
          function E(t, n, r, o) {
            ...
            return s.then(function() {
              return s !== T.transition ? x : (t.options.$retry = !0, T.transitionTo(t.to, t.toParams, t
                .options));
            }, function() {
              return M;
            }), m.update(), s;
          ...
          return w.locals = {
            ...
            if (o.reload) {
              if (R(o.reload) || P(o.reload)) {
                ...
                if (o.reload && !L) throw new Error("No such reload state '" + (R(o.reload) ? o.reload : o
                  .reload.name) + "'");
            ...
            if (n = l(t.params.$$keys(), n || {}), o.notify && e.$broadcast("$stateChangeStart", t.self, n,
                u.self, d).defaultPrevented) return e.$broadcast("$stateChangeCancel", t.self, n, u.self,
              d), m.update(), A;
            for (var U = i.when(I), H = M; H < C.length; H++, N = C[H]) I = D[H] = r(I), U = _(N, n, N ===
              t, U, I, o);
            var B = T.transition = U.then(function() {
              var r, i, a;
              if (T.transition !== B) return x;
              for (r = p.length - 1; r >= M; r--) a = p[r], a.self.onExit && s.invoke(a.self.onExit, a
                .self, a.locals.globals), a.locals = null;
              for (r = M; r < C.length; r++) i = C[r], i.locals = D[r], i.self.onEnter && s.invoke(i
                .self.onEnter, i.self, i.locals.globals);
              return g && (n["#"] = g), T.transition !== B ? x : (T.$current = t, T.current = t.self, T
                .params = n, j(T.params, h), T.transition = null, o.location && t.navigable && m.push(
                  t.navigable.url, t.navigable.locals.globals.$stateParams, {
                    $$avoidResync: !0,
                    replace: "replace" === o.location
                  }), o.notify && e.$broadcast("$stateChangeSuccess", t.self, n, u.self, d), m.update(
                  !0), T.current);
            }, function(r) {
              return T.transition !== B ? x : (T.transition = null, a = e.$broadcast(
                  "$stateChangeError", t.self, n, u.self, d, r), a.defaultPrevented || m.update(), i
                .reject(r));
            });
            return B;
          }, T.is = function(e, t, r) {
            ...
            return o && o.url !== n && null !== o.url ? m.href(o.url, l(i.params.$$keys().concat("#"),
            t || {}), {
              absolute: r.absolute
            }) : null;
          }, T.get = function(e, t) {
        ...
        function $(e, t, n, r, i, o) {
          ...
          if (!o.reload && e === n && (i === n.locals || e.self.reloadOnSearch === !1 && a(n, r, t))) return !
            0;
        }
        var w,
          T,
          ...
          A = {
            ...
            data: function(e) {
              return e.parent && e.parent.data && (e.data = e.self.data = F({}, e.parent.data, e.data)), e
                .data;
            },
            url: function(e) {
              var t = e.url,
              ...
              if (R(t)) return "^" == t.charAt(0) ? i.compile(t.substring(1), n) : (e.parent.navigable || w)
                .url.concat(t, n);
            ...
            params: function(e) {
              return e.parent && e.parent.params ? F(e.parent.params.$$new(), e.ownParams) : new H
              .ParamSet();
            },
            views: function(e) {
              var t = {};
        ...
        w = v({
          ...
          views: null,
          abstract: !0
        }), w.navigable = null, this.decorator = b, this.state = E, this.$get = _, _.$inject = [
        ...
        function e(e, t) {
          return {
            load: function(n, r) {
              ...
              return r = F(o, r), r.view && (i = t.fromConfig(r.view, r.params, r.locals)), i && r.notify &&
                e.$broadcast("$viewContentLoading", r), i;
            }
          };
        }
          ...
          l = {
            ...
            compile: function(n, o, s) {
              return function(n, o, c) {
                function u() {
                  d && (d.remove(), d = null), h && (h.$destroy(), h = null), f && (g.leave(f,
                function() {
                    d = null;
                  }), d = f, f = null);
                }
                  ...
                  if (a || y !== p) {
                    ...
                    var b = s(l, function(e) {
                      g.enter(e, o, function() {
                        h && h.$emit("$viewContentAnimationEnded"), (t.isDefined(v) && !v || n
                          .$eval(v)) && r(e);
                      }), u();
                    });
            ...
            return function(i, a, s) {
              ...
              if (l) {
                ...
                if (l.$$controller) {
                  ...
                  l.$$controllerAs && (i[l.$$controllerAs] = f), a.data("$ngControllerController", f), a
                    .children().data("$ngControllerController", f);
                }
                d(i);
              }
            };
      ...
      function S(e, t) {
        ...
        if (r && (e = t + "(" + r[1] + ")"), n = e.replace(/\n/g, " ").match(/^([^(]+?)\s*(\((.*)\))?$/), !
          n || 4 !== n.length) throw new Error("Invalid state ref '" + e + "'");
        return {
          state: n[1],
          paramExpr: n[3] || null
        };
        ...
        return {
          ...
          link: function(i, o, a, s) {
            var c = S(a.uiSref, e.current.name),
              u = null,
              l = A(o) || e.$current,
              d = "[object SVGAnimatedString]" === Object.prototype.toString.call(o.prop("href")) ?
              "xlink:href" : "href",
              f = null,
      ...
      var O = t.isDefined,
        ...
        F = t.extend,
        j = t.copy;
      t.module("ui.router.util", ["ng"]), t.module("ui.router.router", ["ui.router.util"]), t.module(
          "ui.router.state", ["ui.router.router", "ui.router.util"]), t.module("ui.router", [
          "ui.router.state"]), t.module("ui.router.compat", ["ui.router"]), m.$inject = ["$q", "$injector"], t
        .module("ui.router.util").service("$resolve", m), v.$inject = ["$http", "$templateCache",
      ...
      g.prototype.concat = function(e, t) {
          ...
          for (o = 0; o < c; o++) {
            ...
            if (l) {
              ...
              L(g) || (g = [g]), g = p(g, encodeURIComponent).join("&" + d + "="), u += (a ? "&" : "?") + (d +
                "=" + g), a = !0;
            }
          }
          return u;
          ...
          function r(e, t) {
            ...
            this.encode = s(r(e, "encode")), this.decode = s(r(e, "decode")), this.is = s(r(e, "is"), !0),
              this.equals = c(r(e, "equals")), this.pattern = e.pattern, this.$normalize = s(r(e,
                "$normalize")), this.name = e.name, this.$arrayMode = t;
          }
          if (!e) return this;
          ...
          "$urlMatcherFactory",
          function(e) {}
        ]), E.$inject = ["$locationProvider", "$urlMatcherFactoryProvider"], t.module("ui.router.router")
        .provider("$urlRouter", E), _.$inject = ["$urlRouterProvider", "$urlMatcherFactoryProvider"], t
        .module("ui.router.state").value("$stateParams", {}).provider("$state", _), $.$inject = [], t.module(
          "ui.router.state").provider("$view", $), t.module("ui.router.state").provider("$uiViewScroll", w), T
        .$inject = ["$state", "$injector", "$uiViewScroll", "$interpolate"], C.$inject = ["$compile",
          "$controller", "$state", "$interpolate"
        ], t.module("ui.router.state").directive("uiView", T), t.module("ui.router.state").directive("uiView",
          C), M.$inject = ["$state", "$timeout"], k.$inject = ["$state", "$stateParams", "$interpolate"], t
        .module("ui.router.state").directive("uiSref", M).directive("uiSrefActive", k).directive(
          "uiSrefActiveEq", k), N.$inject = ["$state"], I.$inject = ["$state"], t.module("ui.router.state")
        .filter("isState", N).filter("includedByState", I);
