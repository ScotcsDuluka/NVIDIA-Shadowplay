...
function(module, exports, require) {
  ! function(e, r) {
    ...
    function o(e) {
      function o(e, t) {
        return function(n) {
          var r,
            ...
            c = 0,
            u = e.length;
          for (n instanceof Date || (n = new Date(+n)); ++s < u;) 37 === e.charCodeAt(s) && (a.push(e
              .slice(c, s)), null != (i = we[r = e.charAt(++s)]) ? r = e.charAt(++s) : i = "e" === r ?
            " " : "0", (o = t[r]) && (r = o(n, i)), a.push(r), c = s + 1);
      ...
      function a(e, o) {
        return function(a) {
          ...
          if (!o || "Z" in l || (l.Z = 0), "p" in l && (l.H = l.H % 12 + 12 * l.p), void 0 === l.m && (l
              .m = "q" in l ? l.q : 0), "V" in l) {
            if (l.V < 1 || l.V > 53) return null;
            "w" in l || (l.w = 1), "Z" in l ? (c = r(i(l.y, 0, 1)), u = c.getUTCDay(), c = u > 4 || 0 ===
              u ? t.utcMonday.ceil(c) : t.utcMonday(c), c = t.utcDay.offset(c, 7 * (l.V - 1)), l.y = c
              .getUTCFullYear(), l.m = c.getUTCMonth(), l.d = c.getUTCDate() + (l.w + 6) % 7) : (c = n(
                i(l.y, 0, 1)), u = c.getDay(), c = u > 4 || 0 === u ? t.timeMonday.ceil(c) : t
              .timeMonday(c), c = t.timeDay.offset(c, 7 * (l.V - 1)), l.y = c.getFullYear(), l.m = c
              .getMonth(), l.d = c.getDate() + (l.w + 6) % 7);
          } else("W" in l || "U" in l) && ("w" in l || (l.w = "u" in l ? l.u % 7 : "W" in l ? 1 : 0), u =
            "Z" in l ? r(i(l.y, 0, 1)).getUTCDay() : n(i(l.y, 0, 1)).getDay(), l.m = 0, l.d = "W" in l ?
            (l.w + 6) % 7 + 7 * l.W - (u + 5) % 7 : l.w + 7 * l.U - (u + 6) % 7);
      ...
      function s(e, t, n, r) {
        for (var i, o, a = 0, s = t.length, c = n.length; a < s;) {
          ...
          if (i = t.charCodeAt(a++), 37 === i) {
            if (i = t.charAt(a++), o = it[i in we ? t.charAt(a++) : i], !o || (r = o(e, n, r)) < 0) return -
              1;
      ...
      return nt.x = o(Fe, nt), nt.X = o(je, nt), nt.c = o(Ue, nt), rt.x = o(Fe, rt), rt.X = o(je, rt), rt
        .c = o(Ue, rt), {
          format: function(e) {
            var t = o(e += "", nt);
    ...
    function Y(e, n) {
      var r = e.getDay();
      return e = r >= 4 || 0 === r ? t.timeThursday(e) : t.timeThursday.ceil(e), a(e.getFullYear() % 1e4, n,
        4);
    }
    ...
    function pe(e, n) {
      var r = e.getUTCDay();
      return e = r >= 4 || 0 === r ? t.utcThursday(e) : t.utcThursday.ceil(e), a(e.getUTCFullYear() % 1e4,
        n, 4);
    }
    ...
    function be(t) {
      return $e = o(t), e.timeFormat = $e.format, e.timeParse = $e.parse, e.utcFormat = $e.utcFormat, e
        .utcParse = $e.utcParse, $e;
    }
    ...
    e.isoFormat = Ae, e.isoParse = Me, e.timeFormatDefaultLocale = be, e.timeFormatLocale = o, Object
