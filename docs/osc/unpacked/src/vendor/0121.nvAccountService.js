...
// ==================================================================
// VENDOR MODULE 121
// service nvAccountService | provider nvAccountEndpoints | defines angular.module("nvAngularAccountSdk")
// webpack factory params: module, exports
// ------------------------------------------------------------------

function(module, exports) {
  "use strict";
  angular.module("nvAngularAccountSdk", ["nvAngularHttpEndpoint"]), angular.module("nvAngularAccountSdk")
    .service("nvAccountService", ["nvAccountEndpoints", function(e) {
      var t = this;
      t.storeJarvisUserToken = function(n) {
        return e.setUserToken({}, {
          ...
          if (n.userInfo && n.userInfo.dataTracking) return t.setUserTelemetryConsent(n.userInfo
            .userId, n.userInfo.dataTracking);
        });
        ...
        return e.getUserTelemetryConsent({
          ...
          return e ? e.data : $q.reject(
            "NvAccount User PrivacySettings endpoint returned empty response!");
        });
        ...
        return e.getClientTelemetryConsent({
          ...
          return e ? e.data : $q.reject(
            "NvAccount Client PrivacySettings endpoint returned empty response!");
        });
      };
