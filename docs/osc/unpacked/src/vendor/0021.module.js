...
function(module, exports, require) {
  ! function(e, r) {
    ...
    function n(e, t, n, r, i) {
      var o = e * e,
        a = o * e;
      return ((1 - 3 * e + 3 * o - a) * t + (4 - 6 * o + 3 * a) * n + (1 + 3 * e + 3 * o - 3 * a) * r + a *
        i) / 6;
    }
    ...
    function _(e, t) {
      var n,
        r,
        i,
        o = W.lastIndex = Y.lastIndex = 0,
        a = -1,
        s = [],
        c = [];
      for (e += "", t += "";
        (n = W.exec(e)) && (r = Y.exec(t));)(i = r.index) > o && (i = t.slice(o, i), s[a] ? s[a] += i : s[++
        a] = i), (n = n[0]) === (r = r[0]) ? s[a] ? s[a] += r : s[++a] = r : (s[++a] = null, c.push({
        i: a,
        x: g(n, r)
      })), o = Y.lastIndex;
      return o < t.length && (i = t.slice(o), s[a] ? s[a] += i : s[++a] = i), s.length < 2 ? c[0] ? E(c[0]
        .x) : b(t) : (t = c.length, function(e) {
    ...
    function $(e, n) {
      var r,
        i = typeof n;
      return null == n || "boolean" === i ? o(n) : ("number" === i ? g : "string" === i ? (r = t.color(n)) ?
        (n = r, q) : _ : n instanceof t.color ? q : n instanceof Date ? v : h(n) ? f : Array.isArray(n) ?
        m : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? y : g)(e, n);
    }
    ...
    function x(e, t, n, r, i, o) {
      var a, s, c;
      return (a = Math.sqrt(e * e + t * t)) && (e /= a, t /= a), (c = e * n + t * r) && (n -= e * c, r -=
        t * c), (s = Math.sqrt(n * n + r * r)) && (n /= s, r /= s, c /= s), e * r < t * n && (e = -e,
        t = -t, c = -c, a = -a), {
        translateX: i,
        translateY: o,
    ...
    function S(e) {
      return "none" === e ? X : (j || (j = document.createElement("DIV"), H = document.documentElement, B =
          document.defaultView), j.style.transform = e, e = B.getComputedStyle(H.appendChild(j), null)
        .getPropertyValue("transform"), H.removeChild(j), e = e.slice(7, -1).split(","), x(+e[0], +e[1], +
          e[2], +e[3], +e[4], +e[5]));
    }

    function A(e) {
      return null == e ? X : (z || (z = document.createElementNS("http://www.w3.org/2000/svg", "g")), z
        .setAttribute("transform", e), (e = z.transform.baseVal.consolidate()) ? (e = e.matrix, x(e.a, e
          .b, e.c, e.d, e.e, e.f)) : X);
    }
    ...
    function M(e, t, n, r) {
      ...
      return function(t, n) {
        var r = [],
          i = [];
        return t = e(t), n = e(n), o(t.translateX, t.translateY, n.translateX, n.translateY, r, i), a(t
            .rotate, n.rotate, r, i), s(t.skewX, n.skewX, r, i), c(t.scaleX, t.scaleY, n.scaleX, n.scaleY,
            r, i), t = n = null,
          function(e) {
    ...
    function U(e, t) {
      for (var n = 0, r = t.length - 1, i = t[0], o = new Array(r < 0 ? 0 : r); n < r;) o[n] = e(i, i = t[++
        n]);
      return function(e) {
    ...
    e.interpolate = $, e.interpolateArray = p, e.interpolateBasis = r, e.interpolateBasisClosed = i, e
      .interpolateCubehelix = se, e.interpolateCubehelixLong = ce, e.interpolateDate = v, e
      .interpolateDiscrete = w, e.interpolateHcl = oe, e.interpolateHclLong = ae, e.interpolateHsl = re, e
      .interpolateHslLong = ie, e.interpolateHue = T, e.interpolateLab = R, e.interpolateNumber = g, e
      .interpolateNumberArray = f, e.interpolateObject = y, e.interpolateRgb = q, e.interpolateRgbBasis = G,
      e.interpolateRgbBasisClosed = V, e.interpolateRound = C, e.interpolateString = _, e
      .interpolateTransformCss = Q, e.interpolateTransformSvg = J, e.interpolateZoom = O, e.piecewise = U, e
      .quantize = F, Object.defineProperty(e, "__esModule", {
        value: !0
      });
  });
}
