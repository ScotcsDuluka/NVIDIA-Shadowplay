...
function(module, exports, require) {
  ! function(e, n) {
    ...
    function i(e, t) {
      null == t && (t = o);
      for (var n = 0, r = e.length - 1, i = e[0], a = new Array(r < 0 ? 0 : r); n < r;) a[n] = t(i, i = e[++
        n]);
      return a;
    }
    ...
    function p(e, t, n) {
      ...
      for (var r = -1, i = 0 | Math.max(0, Math.ceil((t - e) / n)), o = new Array(i); ++r < i;) o[r] = e +
        r * n;
      return o;
    }
    ...
    function m(e, t, n) {
      ...
      if (a > 0)
        for (e = Math.ceil(e / a), t = Math.floor(t / a), o = new Array(i = Math.ceil(t - e + 1)); ++s < i;)
          o[s] = (e + s) * a;
      else
        for (e = Math.floor(e * a), t = Math.ceil(t * a), o = new Array(i = Math.ceil(e - t + 1)); ++s < i;)
          o[s] = (e - s) / a;
    ...
    function v(e, t, n) {
      var r = (t - e) / Math.max(0, n),
        ...
        o = r / Math.pow(10, i);
      return i >= 0 ? (o >= H ? 10 : o >= B ? 5 : o >= z ? 2 : 1) * Math.pow(10, i) : -Math.pow(10, -i) / (
        o >= H ? 10 : o >= B ? 5 : o >= z ? 2 : 1);
    }
    ...
    function b() {
      ...
      return e.value = function(n) {
        ...
        return arguments.length ? (r = "function" == typeof t ? t : f(Array.isArray(t) ? F.call(t) : t),
          e) : r;
      }, e;
    }
    ...
    function _(e, n, r) {
      return e = j.call(e, c).sort(t), Math.ceil((r - n) / (2 * (E(e, .75) - E(e, .25)) * Math.pow(e.length,
        -1 / 3)));
    }
    ...
    function k(e, t, n) {
      for (var r, i, o = (null == n ? e.length : n) - (t = null == t ? 0 : +t); o;) i = Math.random() * o--
        | 0, r = e[o + t], e[o + t] = e[i + t], e[i + t] = r;
      return e;
    }
    ...
    var R = n(t),
      ...
      B = Math.sqrt(10),
      z = Math.sqrt(2);
    e.bisect = P, e.bisectRight = P, e.bisectLeft = L, e.ascending = t, e.bisector = n, e.cross = a, e
      .descending = s, e.deviation = l, e.extent = d, e.histogram = b, e.thresholdFreedmanDiaconis = _, e
      .thresholdScott = $, e.thresholdSturges = y, e.max = w, e.mean = T, e.median = C, e.merge = x, e.min =
      S, e.pairs = i, e.permute = A, e.quantile = E, e.range = p, e.scan = M, e.shuffle = k, e.sum = N, e
      .ticks = m, e.tickIncrement = v, e.tickStep = g, e.transpose = I, e.variance = u, e.zip = D, Object
