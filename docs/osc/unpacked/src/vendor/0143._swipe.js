...
// ==================================================================
// VENDOR MODULE 143
// factory $swipe | directive ngClick | provider $touch | defines angular.module("ngTouch")
  ...
  ! function(e, t) {
    ...
    function r(e, n) {
      ...
      this.ngClickOverrideEnabled = function(o) {
        return t.isDefined(o) ? (o && !i && (i = !0, a.$$moduleName = "ngTouch", n.directive("ngClick", a),
      ...
      return {
        bind: function(t, i, o) {
          ...
          d && t.on(d, function(e) {
            ...
            if (l && c) {
              var n = e(t);
              if (a += Math.abs(n.x - u.x), s += Math.abs(n.y - u.y), u = n, !(a < r && s < r))
                return s > a ? (l = !1, void(i.cancel && i.cancel(t))) : (t.preventDefault(),
                  void(i.move && i.move(n, t)));
            }
    ...
    var a = ["$parse", "$timeout", "$rootElement", function(e, r, i) {
      ...
      function s(e) {
        if (!(Date.now() - l > m)) {
          var t = e.touches && e.touches.length ? e.touches : [e],
            r = t[0].clientX,
            i = t[0].clientY;
          r < 1 && i < 1 || f && f[0] === r && f[1] === i || (f && (f = null), "label" === n(e.target) &&
            (f = [r, i]), a(d, r, i) || (e.stopPropagation(), e.preventDefault(), e.target && e.target
              .blur && e.target.blur()));
        }
      }
      ...
      function u(e, t) {
        d || (i[0].addEventListener("click", s, !0), i[0].addEventListener("touchstart", c, !0), d = []),
          l = Date.now(), a(d, e, t);
      }
      var l,
        d,
      ...
      return function(n, r, i) {
        ...
        r.on("touchstart", function(e) {
          f = !0, a = e.target ? e.target : e.srcElement, 3 == a.nodeType && (a = a.parentNode), r
            .addClass(g), s = Date.now();
          var t = e.originalEvent || e,
            n = t.touches && t.touches.length ? t.touches : [t],
            i = n[0];
          ...
          var n = Date.now() - s,
            d = e.originalEvent || e,
            m = d.changedTouches && d.changedTouches.length ? d.changedTouches : d.touches && d
            .touches.length ? d.touches : [d],
            v = m[0],
            g = v.clientX,
            y = v.clientY,
            b = Math.sqrt(Math.pow(g - c, 2) + Math.pow(y - l, 2));
          f && n < h && b < p && (u(g, y), a && a.blur(), t.isDefined(i.disabled) && i.disabled !==
            !1 || r.triggerHandler("click", [e])), o();
