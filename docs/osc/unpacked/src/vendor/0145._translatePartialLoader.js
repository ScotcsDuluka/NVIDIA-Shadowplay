...
// ==================================================================
// VENDOR MODULE 145
// provider $translatePartialLoader
...
function(module, exports, require) {
  ...
  ! function(n, o) {
    ...
    function e() {
      ...
      function i(e, t) {
        for (var n in t) t[n] && t[n].constructor && t[n].constructor === Object ? (e[n] = e[n] || {}, i(e[
          n], t[n])) : e[n] = t[n];
        return e;
      }
      ...
      e.prototype.parseUrl = function(e, t) {
        return angular.isFunction(e) ? e(this.name, t) : e.replace(/\{part\}/g, this.name).replace(
          /\{lang\}/g, t);
      ...
      this.addPart = function(r, i) {
      ...
      }, this.isPartAvailable = r, this.$get = ["$rootScope", "$injector", "$q", "$http", function(s, c,
        u, l) {
        var d = function(e) {
          ...
          return angular.forEach(s, function(n) {
            r.push(n.getTable(e.key, u, l, e.$http, e.urlTemplate, t)), n.urlTemplate = e
              .urlTemplate;
        ...
        return d.addPart = function(r, i) {
          ...
          return t(r) ? a[r].isActive || (a[r].isActive = !0, s.$emit(
            "$translatePartialLoaderStructureChanged", r)) : (a[r] = new e(r, i), s.$emit(
            "$translatePartialLoaderStructureChanged", r)), d;
          ...
          if (t(e)) {
            ...
            if (r) {
              var o = c.get("$translate"),
                u = o.loaderCache();
              "string" == typeof u && (u = c.get(u)), "object" == typeof u && angular.forEach(a[e]
                .tables,
                function(t, n) {
