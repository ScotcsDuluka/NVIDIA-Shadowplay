  ...
  (function(e) {
    (function(e) {
      "Window" in this || ! function(e) {
          e.constructor ? e.Window = e.constructor : (e.Window = e.constructor = Function(
            "return function(){}")()).prototype = this;
        }(this), "Document" in this || (this.HTMLDocument ? this.Document = this.HTMLDocument : (this
          .Document = this.HTMLDocument = document.constructor = Function("return function(){}")(), this
          .Document.prototype = document)), "Element" in this && "HTMLElement" in this || ! function() {
          function t() {
            return d-- || clearTimeout(l), !(!document.body || document.body.prototype || !
              /(complete|interactive)/.test(document.readyState)) && (s(document, !0), l && document
              .body.prototype && clearTimeout(l), !!document.body.prototype);
          }
          var n, r, i, o, a, s, c, u, l, d;
          return window.Element && !window.HTMLElement ? (window.HTMLElement = window.Element, e) : (
            window.Element = window.HTMLElement = Function("return function(){}")(), n = document
            .appendChild(document.createElement("body")), r = n.appendChild(document.createElement(
              "iframe")), i = r.contentWindow.document, o = Element.prototype = i.appendChild(i
              .createElement("*")), a = {}, s = function(e, t) {
              var n,
                r,
                i,
                o = e.childNodes || [],
              ...
              for (; i = t && o[++c];) s(i, t);
              return e;
            }, c = document.getElementsByTagName("*"), u = document.createElement, d = 100, o
            .attachEvent("onpropertychange", function(e) {
              for (var t, n = e.propertyName, r = !a.hasOwnProperty(n), i = o[n], s = a[n], u = -
                1; t = c[++u];) 1 === t.nodeType && (r || t[n] === s) && (t[n] = i);
              a[n] = i;
            }), o.constructor = Element, o.hasAttribute || (o.hasAttribute = function(e) {
              return null !== this.getAttribute(e);
            }), t(!0) || (document.onreadystatechange = t, l = setInterval(t, 25)), document
          ...
          Object.defineProperty = function(i, o, a) {
            var s, c, u, l;
            if (e && (i === window || i === document || i === Element.prototype ||
              i instanceof Element)) return e(i, o, a);
            if (s = o + "", c = "value" in a || "writable" in a, u = "get" in a && typeof a.get, l =
              "set" in a && typeof a.set, null === i || !(i instanceof Object || "object" == typeof i))
        ...
        function(e) {
          ...
          window.Event = Window.prototype.Event = function(t, n) {
            ...
            return "createEvent" in document ? (r = document.createEvent("Event"), i = !(!n || n
                .bubbles === e) && n.bubbles, o = !(!n || n.cancelable === e) && n.cancelable, r
              .initEvent(t, i, o), r) : (r = document.createEventObject(), r.type = t, r.bubbles = !(!
                n || n.bubbles === e) && n.bubbles, r.cancelable = !(!n || n.cancelable === e) && n
              .cancelable, r);
            ...
            writable: !0,
            value: r
          }), "createEvent" in document || (window.addEventListener = Window.prototype
            .addEventListener = Document.prototype.addEventListener = Element.prototype
            .addEventListener = function() {
              ...
              e._events || (e._events = {}), e._events[r] || (e._events[r] = function(n) {
                  ...
                  for (n.preventDefault = function() {
                    ...
                    }, n.currentTarget = e, n.relatedTarget = n.fromElement || null, n.target = n
                    .target || n.srcElement || e, n.timeStamp = new Date().getTime(), n.clientX && (n
                      .pageX = n.clientX + document.documentElement.scrollLeft, n.pageY = n.clientY +
                      document.documentElement.scrollTop); ++a < s && !n.cancelImmediate;) a in o && (
                    r = o[a], -1 !== t(i, r) && "function" == typeof r && r.call(e, n));
                }, e._events[r].list = [], e.attachEvent && e.attachEvent("on" + r, e._events[r])), e
                ._events[r].list.push(i);
            ...
            .removeEventListener = Element.prototype.removeEventListener = function() {
              var e,
                ...
                r = arguments[0],
                i = arguments[1];
              n._events && n._events[r] && n._events[r].list && (e = t(n._events[r].list, i), -1 !==
                e && (n._events[r].list.splice(e, 1), n._events[r].list.length || (n.detachEvent && n
                  .detachEvent("on" + r, n._events[r]), delete n._events[r])));
            }, window.dispatchEvent = Window.prototype.dispatchEvent = Document.prototype
            .dispatchEvent = Element.prototype.dispatchEvent = function(e) {
              var t, n, r;
              ...
              try {
                ...
                do e.currentTarget = t, "_events" in t && "function" == typeof t._events[n] && t
                  ._events[n].call(t, e), "function" == typeof t["on" + n] && t["on" + n].call(t, e),
                  t = 9 === t.nodeType ? t.parentWindow : t.parentNode; while (t && !e.cancelBubble);
              }
              return !0;
            });
        }(), "CustomEvent" in this && ("function" == typeof this.CustomEvent || ("" + this.CustomEvent)
          .indexOf("CustomEventConstructor") > -1) || (this.CustomEvent = function(e, t) {
          if (!e) throw Error(
          ...
          if (t = t || {
            ...
            n = document.createEvent("CustomEvent"), n.initCustomEvent(e, t.bubbles, t.cancelable, t
              .detail);
          } catch (r) {
            n = document.createEvent("Event"), n.initEvent(e, t.bubbles, t.cancelable), n.detail = t
              .detail;
          } else n = new Event(e, t), n.detail = t && t.detail || null;
          return n;
        }, CustomEvent.prototype = Event.prototype);
    }).call("object" == typeof window && window || "object" == typeof self && self || "object" ==
      typeof e && e || {}), ! function(e) {
      ! function() {
        function t(e) {
          var t,
            n = i.exec(e)[1];
          return r.test(n) ? "" : (t = o.exec(n), null === t || 0 === t.length ? "" : (n = t[0], 0 === n
            .indexOf(a) ? n.substr(4) : n));
        }
        ...
        e.cookieDomain = t(window.location.hostname), n("clientCode"), n("serverDomain"), n(
          "cookieDomain"), n("crossDomain"), n("timeout"), n("globalMboxAutoCreate"), n(
          "visitorApiTimeout"), n("enabled"), n("defaultContentHiddenStyle"), n(
          "defaultContentVisibleStyle"), n("bodyHidingEnabled"), n("bodyHiddenStyle"), n("imsOrgId"), n(
          "overrideMboxEdgeServer"), n("optoutEnabled");
        ...
        function n(t) {
          t.fn.showElement = function() {
            ...
            return r && (";" !== r[r.length - 1] && (r += ";"), i.unshift(t.trim(r))), n.addClass(Ns),
              n.attr("style", i.join(" "));
        ...
        function c(e) {
          ...
          return U(c) ? e : (t = {}, n = [], i = o(e), a = e.split("?")[0], C(i.queryParams, function(e,
            n) {
            return t[n] = e;
        ...
        function h(e, t, n) {
          C(e, function(e, r) {
            F(e) ? (t.push(r), h(e, t, n), t.pop()) : B(t) ? n[r] = e : n[t.concat(r).join(".")] =
            e;
          });
        }
        ...
        function _() {
          ...
          return n[14] = "4", n[19] = r.substr(3 & n[19] | 8, 1), n[8] = n[13] = n[18] = n[23] = "-",
            t = n.join(""), t.replace(/-/g, "");
        }
        ...
        function Se(t, n) {
          ...
          return {
            ...
            delayCallback: function(e) {
              for (var n = arguments.length, r = Array(n > 1 ? n - 1 : 0), i = 1; n > i; i++) r[i -
                1] = arguments[i];
        ...
        function Ne(e, t, n, r) {
          return function() {
            var i = r.crossDomain !== ai,
              o = e(),
              a = {};
            return a[Ai] = o.screenHeight, a[Mi] = o.screenWidth, a[Si] = o.colorDepth, a[Ii] = o
              .width, a[ki] = o.height, a[Ni] = o.timeOffset, a[ji] = n, a[Vi] = r.version, a[Ui] = t
              .location.hostname, a[Gi] = t.location.href, a[Bi] = t.referrer, i && (a[Pi] = r
                .crossDomain), a;
          };
        }
        ...
        function Ve(e) {
          var t = e.split("#");
          return B(t) || t.length < 3 ? null : isNaN(parseInt(t[2], 10)) ? null : qe(i(t[0]), i(t[1]), +
            t[2]);
        }
          ...
          var o = e.cookieDomain,
            ...
            s = {
              ...
              setCookie: function(e, t, r) {
                var s, c, u;
                a || N(e) || L(t) || D(t) || O(r) && (s = n(ao), c = new Date(), u = Math.ceil(r + c
                  .getTime() / 1e3), s[e] = qe(e, t, u), i(o, s));
              },
        ...
        function dt(e, t, n, r, i, o) {
          ...
          function s(s) {
            var u,
              ...
              f = {},
              h = t();
            return a(h, c), a(i.getTargetPageParametersAll(), c), ut(Hi, n.getId(), c), ut(qi, r
            .getId(), c), ut(zi, ct(), c), C(c, function(e, t) {
              return f[t] = e;
        ...
        function gt(e, t, n, r, i, o, a) {
          function s(e) {
            return "CustomEvent" in e && ("function" == typeof e.CustomEvent || ("" + e.CustomEvent)
        ...
        function bt(e, t, n) {
          function r(t) {
            var n = void 0,
              r = pe();
            return D(e.Visitor) ? (r.reject(), r.promise()) : L(e.Visitor) ? (r.reject(), r.promise()) :
              P(e.Visitor.getInstance) ? (n = e.Visitor.getInstance(g), F(n) && P(n.isAllowed) && n
                .isAllowed() ? (t.visitor = n, r.resolve(t)) : r.reject(), r.promise()) : (r.reject(), r
                .promise());
          }
          ...
          function c(e, t, n) {
            C(e, function(e, r) {
              F(e) ? (t.push(r), c(e, t, n), t.pop()) : B(t) ? n[s(r)] = e : n[s(t.concat(r).join(
                "."))] = e;
            });
          }
          ...
          function u(e) {
            var t, n;
            return P(e.getCustomerIDs) ? (t = e.getCustomerIDs(), F(t) ? (n = {}, c(t, [], n),
              n) : {}) : {};
          }

          function l(e) {
            var t = {};
            return k(e.trackingServer) && (t[vo] = e.trackingServer), k(e.trackingServerSecure) && (t[
              go] = e.trackingServerSecure), t;
          }
        ...
        function Ct(e, t, n) {
          ...
          return function(i) {
            var o,
              ...
              c = pe(),
              u = wt(i, Oo);
            return u.status === Qi ? (t.error(Eo, u.message), c.reject(), c.promise()) : (i.type = i
              .type || Do.JSON, u = r(i), u.status === Qi ? (t.error(u.message), c.reject(), c
                .promise()) : (o = i.type.toLowerCase(), a = Ie(i.timeout, n.timeout), o === Do
                .JSON && (s.xhrFields = {
                  withCredentials: !0
                }), o === Do.JSONP && k(i.jsonp) && (s.jsonp = i.jsonp), k(i.method) && (s.method =
                  i.method), F(i.params) && (s.data = i.params), s.timeout = a, s.dataType = o, s
                .url = i.url, t.log(Eo, "params:", i), e.getAjax(s).then(function(e, n) {
                  return t.log(Eo, n, i.url), e;
                }, function(e, n, r) {
                  return k(r) ? (t.error(Eo, n + ":", r), Oe(n, r)) : 0 === e.status ? (t.log(Eo,
                    Xi + ":", "cancelled"), Oe(Xi, "cancelled")) : {
                    jqXHR: e,
                    textStatus: n
                  };
                })));
        ...
        function Dt(e, t) {
          return It(kt()), It(Mt(e)), {
            build: function(e, n) {
              var r, i, o, a;
              return H(e) ? (t.log(Vo, Xi + ": no element."), Wi) : (r = e.tagName.toLowerCase(),
                i = Nt(r, n), i.status === Qi ? (t.log(Vo, Xi + ": " + i.message), Wi) : (o = Ot(
                    r), a = o.valid(e), a.status === Qi ? (t.log(Vo, Xi + ": " + a.message), Wi) :
                  o.getAction(e)));
            }
          };
        }
        ...
        function an(e) {
          function t(t) {
            var n,
              ...
              u = t.elements,
              l = t.offers;
            return B(u) || !R(l) ? me(eo) : (n = on(l), F(n) ? (r = n.plugins, i = n.content, o = n
              .clickToken, a = T(u, function(t, n) {
                return function() {
                  var a = {
                    name: c,
                    element: t,
        ...
        function pn(e) {
          return k(e[na.CSS_SELECTOR]) && !(e[na.ACTION] === ta.TRACK_CLICK || e[na.ACTION] === ta
            .PREPEND_CONTENT || e[na.ACTION] === ta.APPEND_CONTENT || e[na.ACTION] === ta
            .INSERT_AFTER || e[na.ACTION] === ta.INSERT_BEFORE);
        }

        function mn(e) {
          return e[na.ACTION] === ta.REPLACE_CONTENT || !pn(e) || e.action === ta.SET_STYLE &&
            "visibility" === e[na.PROPERTY];
        }
          ...
          return {
            build: function(n) {
              var r,
                ...
                o = En(n),
                a = n[na.URL];
              return I(n[na.INCLUDE_ALL_URL_PARAMETERS]) && n[na.INCLUDE_ALL_URL_PARAMETERS] && (r =
                u(e.location.search.substring(1)), a = c(a, r)), I(n[na.PASS_MBOX_SESSION]) && n[na
        ...
        function Mn() {
          return {
            build: function(e) {
              var t = _n(e),
                n = ia.HTML;
              return e[na.CONTENT_TYPE] === ia.TEXT && (n = ia.TEXT), t[na.CONTENT_TYPE] = n, t[na
                .CONTENT] = e[na.CONTENT], t;
            },
            valid: function(e) {
              return vn(e) && yn(e);
            }
        ...
        function In() {
          return {
            build: function(e) {
              var t = En(e);
              return t[na.CONTENT] = e[na.CONTENT], k(e[na.SELECTOR]) ? t[na.SELECTOR] = e[na
                .SELECTOR] : t[na.SELECTOR] = "head", t;
            },
            valid: function(e) {
              return gn(e) && yn(e);
            }
        ...
        function Dn(e, t) {
          ...
          n.find(":first").attr("id", e), t[na.CONTENT] = n.html(), t[na.SELECTOR] = t[na.SELECTOR]
            .replace(ha, "");
        }
        ...
        function Rn() {
          return {
            build: function(e) {
              ...
              return R(n) && 2 === n.length ? Dn(n[1], t) : bn(e) && (t[na.CONTENT] = '<img src="' +
                e[na.VALUE] + '" />'), t;
            },
            valid: function(e) {
        ...
        function Pn(e, t) {
          var n = {},
            r = Rn(),
            i = On();
          return n[ta.APPEND_CONTENT] = i, n[ta.CUSTOM_CODE] = In(), n[ta.INSERT_AFTER] = r, n[ta
              .INSERT_BEFORE] = r, n[ta.MOVE] = Nn(), n[ta.SET_ATTRIBUTE] = kn(), n[ta.SET_CONTENT] =
            Mn(), n[ta.SET_STYLE] = An(), n[ta.RESIZE] = Sn(), n[ta.PREPEND_CONTENT] = i, n[ta.REMOVE] =
            xn(), n[ta.REARRANGE] = Cn(), n[ta.REPLACE_CONTENT] = i, n[ta.TRACK_CLICK] = Tn(), n[ta
              .REDIRECT] = wn(e, t), n;
        }
        ...
        function jn(t, n, r, i, o) {
          ...
          function c(e, a) {
            ...
            }(), "object" == typeof s) ? s.v : (B(a) ? (o.log("All selectors have been found"), Jt(e,
              Te(n))) : (u = T(a, function(e) {
        ...
        function qn(e, t, n, r, i, o, a, s) {
          ...
          function h(e) {
            var t,
              ...
              a = d(o);
            return !!F(a[0]) && (t = a[0], r = n.getStrategyByAction(ta.REDIRECT), i.trigger(gi), r(t),
              !0);
          }
          ...
          function v(t) {
            var n,
              ...
              g = Hn(t.offers);
            return B(g) ? me(eo) : (n = Bn(g), f(n), h(n) ? me(Zi) : (i = d(n), p(i), o = [], a = hn(i),
              s = T(a, function(e) {
          ...
          return {
            handle: function(e) {
              var i,
                ...
                a,
                s = e.content;
              return F(s) ? (i = s.duration, O(i) || (i = Ea), o = s.message, N(o) && (o = _a), He(t,
                lo, o, {
                  expires: 1e3 * i,
                  domain: r
        ...
        function yr(e) {
          var t = e.split(".");
          return 2 !== t.length || N(t[1]) ? null : (t = t[1].split("_"), 2 !== t.length || N(t[0]) ?
            null : t[0]);
        }
        ...
        function Er(e, t, n) {
          var r, i, o;
          t.overrideMboxEdgeServer && (gr(e) || (r = yr(n), N(r) || (i = t
            .overrideMboxEdgeServerTimeout, o = br(t, r), He(e, uo, o, {
              expires: i
            }))));
        }
        ...
        function xr(e, t) {
          function n(n) {
            var r,
              ...
              s,
              c = wt(n, Ca);
            return c.status === Qi ? (t.error($a, c.message), ve()) : (r = de(n.element || n.selector ||
              "head"), i = x(r, j), o = n.offer, a = n.mbox, s = T(e, function(e) {
              return Cr(e, a, i, o);
            }), $e(s));
          }
          return n;
        ...
        function Ar(e, t, n, r, i, o, a) {
          ...
          return function(t) {
            var n,
              ...
              d = c.status,
              f = c.message;
            return o.log("box " + t.mbox + " isEnabled: " + e.isEnabled()), d === Qi ? (o.error(Sa,
              f), ve(c)) : e.isEnabled() ? (n = t.mbox, r = Ie(t.timeout, a.timeout), s = F(t
                .params) ? Sr(t.params) : {}, s[Fi] = n, s[Li] = e.requests.incrementAndGet(), o
              .log(Sa, "params:", s), l({
        ...
        function Rr(e, t, n, r, i, o, a) {
          return function(s) {
            var c,
              ...
              h,
              p = wt(s, Aa);
            return p.status === Qi ? void o.error(Ma, p.message) : e.isEnabled() ? (c = s.type, u = k(
                c), l = s.selector, d = k(l), f = Ie(s.timeout, a.timeout), u && d ? void Or(n, r,
                s, f) : (h = t.event, F(h) ? void Dr(n, r, s, h, f) : void Nr(n, s, Wi, f))) :
              void Mr(i, o, s);
          };
        }
        ...
        function Lr(t, n, r, i, o, a, s, c) {
          ...
          function l(e, n, r) {
            var i = e.status,
              o = e.message;
            i === Ji ? s.log(Na, "request disabled:", i, o) : s.error(Na, "request error:", i, o), Zt(n,
              o, Te(t)), m(r);
          }
          ...
          function f(e, r) {
            ...
            if (t.isEnabled() || t.isMboxEdit()) {
              ...
              if (!le("#" + e)) return i = Te(t), Qt(r, ci + ' (no element with such id: "' + e + '").',
                i), void s.error(Na, ci + ":", 'mboxDefine("' + e + '", "' + r + '")');
              for (o = de("#" + e), o.addClass(Jr + r), c = arguments.length, u = Array(c > 2 ? c - 2 :
                  0), l = 2; c > l; l++) u[l - 2] = arguments[l];
          ...
          function h(e) {
            var r, i, o, u, l;
            for (r = arguments.length, i = Array(r > 1 ? r - 1 : 0), o = 1; r > o; o++) i[o - 1] =
              arguments[o];
            if (t.isEnabled()) {
              if (u = wt({
                  mbox: e
              ...
              l = n.findByKey(e), C(l, function(t) {
                var n = a.mergeParameters(a.getTargetPageParameters(e), a.getParametersFromArray(
                i));
            ...
            if (t.isEnabled() || t.isMboxEdit()) {
              ...
              if (i = a.findLastMboxNode(e), !le(i)) return o = Te(t), u = ci +
                " (previous element is not a div.mboxDefault).", Qt(e, u, o), void s.error(Na, ci +
                  ":", 'mboxCreate("' + e + '")');
              for (i.addClass(Jr + e), l = arguments.length, f = Array(l > 1 ? l - 1 : 0), h = 1; l >
                h; h++) f[h - 1] = arguments[h];
              p = a.mergeParameters(a.getTargetPageParameters(e), a.getParametersFromArray(f)), Pr(p, e,
                t.requests.incrementAndGet()), n.add(e, {
                name: e,
                params: p,
                node: i
        ...
        function Wr(t, n) {
          ...
          return function(e) {
            var n, i, o, a;
            Br(e), n = e.name, zr(e.name), i = e.modules, qr(i, r), o = e.register, Gr(o), t[Da] = t[
              Da] || {}, a = [], C(i, function(e) {
              return a.push(r[e]);
          ...
          Is = function(e, t) {
            ...
            function t(e) {
              var t = !!e && "length" in e && e.length,
                n = bt.type(e);
              return "function" !== n && !bt.isWindow(e) && ("array" === n || 0 === t || "number" ==
            ...
            function s(e, t, n, r, i, a) {
              ...
              if (null == r && null == i ? (i = n, r = n = void 0) : null == i && ("string" ==
                  typeof n ? (i = r, r = void 0) : (i = r, r = n, n = void 0)), i === !1) i = o;
              else if (!i) return e;
            ...
            function l(e, t, n, r) {
              function i(s) {
                ...
                return o[s] = !0, bt.each(e[s] || [], function(e, s) {
                  var u = s(t, n, r);
                  return "string" != typeof u || a || o[u] ? a ? !(c = u) : void 0 : (t.dataTypes
                    .unshift(u), i(u), !1);
                }), c;
              }
              var o = {},
            ...
            function h(e, t, n, r) {
              ...
              for (o = l.shift(); o;)
                if (e.responseFields[o] && (n[e.responseFields[o]] = t), !c && r && e.dataFilter && (
                    t = e.dataFilter(t, e.dataType)), c = o, o = l.shift())
                  if ("*" === o) o = c;
                  else if ("*" !== c && c !== o) {
                if (a = u[c + " " + o] || u["* " + o], !a)
                  for (i in u)
            ...
            function p(e, t) {
              var n = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t || "*") :
            ...
            function y(e, t) {
              return bt.nodeName(e, "table") && bt.nodeName(11 !== t.nodeType ? t : t.firstChild,
            ...
            function $(e, t) {
              ...
              "input" === n && ge.test(e.type) ? t.checked = e.checked : ("input" === n ||
            ...
            function w(e, t, n, r) {
              ...
              var i,
                ...
                h = t[0],
                m = bt.isFunction(h);
              if (m || d > 1 && "string" == typeof h && !gt.checkClone && Me.test(h)) return e.each(
                function(i) {
                  var o = e.eq(i);
                  m && (t[0] = h.call(this, i, o.html())), w(o, t, n, r);
                });
              if (d && (i = v(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes
                  .length && (i = o), o || r)) {
                for (a = bt.map(p(i, "script"), b), s = a.length; d > l; l++) c = i, l !== f && (c =
                  bt.clone(c, !0, !0), s && bt.merge(a, p(c, "script"))), n.call(e[l], c, l);
                if (s)
                  for (u = a[a.length - 1].ownerDocument, bt.map(a, E), l = 0; s > l; l++) c = a[l],
                    be.test(c.type || "") && !Q.access(c, "globalEval") && bt.contains(u, c) && (c
                      .src ? bt._evalUrl && bt._evalUrl(c.src) : bt.globalEval(c.textContent.replace(
                        Ne, "")));
              }
              return e;
            }
            ...
            function T(e, t, n) {
              for (var r, i = t ? bt.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r
                .nodeType || bt.cleanData(p(r)), r.parentNode && (n && bt.contains(r.ownerDocument,
                  r) && m(p(r, "script")), r.parentNode.removeChild(r));
              return e;
            }
            ...
            function C(e, t, n) {
              ...
              if (void 0 === n && 1 === e.nodeType)
                if (r = "data-" + t.replace(Oe, "-$&").toLowerCase(), n = e.getAttribute(r),
                  "string" == typeof n) {
                  try {
                    n = "true" === n || "false" !== n && ("null" === n ? null : +n + "" === n ? +n :
                      Ie.test(n) ? bt.parseJSON(n) : n);
                  } catch (e) {}
                  $e.set(e, t, n);
                } else n = void 0;
              return n;
            ...
            function x(e, t, n) {
              var r,
                ...
                a,
                s = e.style;
              return n = n || je(e), a = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== a &&
                void 0 !== a || bt.contains(e.ownerDocument, e) || (a = bt.style(e, t)), n && !gt
                .pixelMarginRight() && Le.test(a) && Re.test(t) && (r = s.width, i = s.minWidth, o = s
                  .maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s
            ...
            function S(e, t, n, r) {
              ...
              if (l && l[3] !== u) {
                u = u || l[3], n = n || [], l = +c || 1;
                do o = o || ".5", l /= o, bt.style(e, t, l + u); while (o !== (o = s() / c) && 1 !==
                  o && --a);
              }
              return n && (l = +l || +c || 0, i = n[1] ? l + (n[1] + 1) * n[2] : +n[2], r && (r.unit =
                u, r.start = l, r.end = i)), i;
            }
            ...
            function M(e) {
              ...
              return n || (n = A(e, t), "none" !== n && n || (ze = (ze || bt(
                  ...
                  t = ze[0].contentDocument, t.write(), t.close(), n = A(e, t), ze.detach()), qe[
                e] = n), n;
            }
            ...
            function N() {
              ut.removeEventListener("DOMContentLoaded", N), e.removeEventListener("load", N), bt
                .ready();
            }
            ...
            function D(e, t, n, r, i) {
              for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 >
                o; o += 2) "margin" === n && (a += bt.css(e, n + Ue[o], !0, i)), r ? ("content" ===
                n && (a -= bt.css(e, "padding" + Ue[o], !0, i)), "margin" !== n && (a -= bt.css(e,
                  "border" + Ue[o] + "Width", !0, i))) : (a += bt.css(e, "padding" + Ue[o], !0, i),
                "padding" !== n && (a += bt.css(e, "border" + Ue[o] + "Width", !0, i)));
              return a;
            }
            ...
            function R(t, n, r) {
              ...
              if (ut.msFullscreenElement && e.top !== e && t.getClientRects().length && (o = Math
                  .round(100 * t.getBoundingClientRect()[n])), 0 >= o || null == o) {
            ...
            function P(e, t) {
              for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] =
                Q.get(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style
                  .display = ""), "" === r.style.display && Fe(r) && (o[a] = Q.access(r,
                  "olddisplay", M(r.nodeName)))) : (i = Fe(r), "none" === n && i || Q.set(r,
                  "olddisplay", i ? n : bt.css(r, "display"))));
            ...
            return bt.fn = bt.prototype = {
                ...
                for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" ==
                  typeof a || bt.isFunction(a) || (a = {}), s === c && (a = this, s--); c > s; s++)
                  if (null != (e = arguments[s]))
                    for (t in e) n = a[t], r = e[t], a !== r && (u && r && (bt.isPlainObject(r) || (
                        i = bt.isArray(r))) ? (i ? (i = !1, o = n && bt.isArray(n) ? n : []) : o =
                        n && bt.isPlainObject(n) ? n : {}, a[t] = bt.extend(u, o, r)) : void 0 !==
                      r && (a[t] = r));
                return a;
              }, bt.extend({
                ...
                isPlainObject: function(e) {
                  ...
                  if (e.constructor && !vt.call(e.constructor.prototype, "isPrototypeOf"))
                  return !1;
                  for (t in e);
                ...
                type: function(e) {
                  return null == e ? e + "" : "object" == typeof e || "function" == typeof e ? pt[
                    mt.call(e)] || "object" : typeof e;
                },
                globalEval: function(e) {
                  var t,
                    n = eval;
                  e = bt.trim(e), e && (1 === e.indexOf("use strict") ? (t = ut.createElement(
                      "script"), t.text = e, ut.head.appendChild(t).parentNode.removeChild(t)) :
                    n(e));
                },
                ...
                makeArray: function(e, n) {
                  var r = n || [];
                  return null != e && (t(Object(e)) ? bt.merge(r, "string" == typeof e ? [e] :
                    e) : ft.call(r, e)), r;
                },
                ...
                proxy: function e(t, n) {
                  var r, i, e;
                  return "string" == typeof n && (r = t[n], n = t, t = r), bt.isFunction(t) ? (i =
                    lt.call(arguments, 2), e = function() {
                      return t.apply(n || this, i.concat(lt.call(arguments)));
                    }, e.guid = t.guid = t.guid || bt.guid++, e) : void 0;
                },
                now: Date.now,
                support: gt
              }), "function" == typeof Symbol && (bt.fn[Symbol.iterator] = ct[Symbol.iterator]), bt
              .each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),
                  ...
                  if (!r && ((t ? t.ownerDocument || t : j) !== I && N(t), t = t || I, D)) {
                    if (11 !== m && (u = ge.exec(e)))
                      if (i = u[1]) {
                        ...
                        } else if (p && (a = p.getElementById(i)) && U(t, a) && a.id === i) return n
                          .push(a), n;
                      } else {
                        if (u[2]) return J.apply(n, t.getElementsByTagName(e)), n;
                        if ((i = u[3]) && _.getElementsByClassName && t.getElementsByClassName)
                        return J.apply(n, t.getElementsByClassName(i)), n;
                      }
                    if (_.qsa && !G[e + " "] && (!R || !R.test(e))) {
                      if (1 !== m) p = t, h = e;
                      else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(be, "\\$&") : t.setAttribute(
                            "id", s = F), d = C(e), o = d.length, c = fe.test(s) ? "#" + s : "[id='" +
                          s + "']"; o--;) d[o] = c + " " + f(d[o]);
                ...
                function a(e, t) {
                  var n = t && e,
                    r = n && 1 === e.nodeType && 1 === t.nodeType && (~t.sourceIndex || W) - (~e
                      .sourceIndex || W);
                  if (r) return r;
                  if (n)
                    for (; n = n.nextSibling;)
                ...
                function h(e, t, n) {
                  ...
                  return t.first ? function(t, n, o) {
                    ...
                    if (a) {
                      ...
                      for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                          if (u = t[F] || (t[F] = {}), c = u[t.uniqueID] || (u[t.uniqueID] = {}), (
                              s = c[r]) && s[0] === H && s[1] === o) return l[2] = s[2];
                ...
                function v(e, t, n, r, i) {
                  for (var o, a = [], s = 0, c = e.length, u = null != t; c > s; s++)(o = e[s]) && (!
                    n || n(o, r, i)) && (a.push(o), u && t.push(s));
                  return a;
                }

                function g(e, t, n, i, o, a) {
                  return i && !i[F] && (i = g(i)), o && !o[F] && (o = g(o, a)), r(function(r, a, s,
                  c) {
                    var u,
                      l,
                      d,
                      ...
                      b = n ? o || (r ? e : p || i) ? [] : a : y;
                    if (n && n(y, b, s, c), i)
                      for (u = v(b, h), i(u, [], s, c), l = u.length; l--;)(d = u[l]) && (b[h[
                        l]] = !(y[h[l]] = d));
                    if (r) {
                      if (o || e) {
                        if (o) {
                        ...
                        for (l = b.length; l--;)(d = b[l]) && (u = o ? ee(r, d) : f[l]) > -1 && (
                          r[u] = !(a[u] = d));
                      }
                    } else b = v(b === a ? b.splice(p, b.length) : b), o ? o(null, a, b, c) : J
                      .apply(a, b);
                  });
                }

                function y(e) {
                  for (var t, n, r, i = e.length, o = $.relative[e[0].type], a = o || $.relative[" "],
                      s = o ? 1 : 0, c = h(function(e) {
                        return e === t;
                      }, a, !0), u = h(function(e) {
                        return ee(t, e) > -1;
                      }, a, !0), l = [function(e, n, r) {
                        var i = !o && (r || n !== A) || ((t = n).nodeType ? c(e, n, r) : u(e, n,
                        r));
                        return t = null, i;
                      }]; i > s; s++)
                    if (n = $.relative[e[s].type]) l = [h(p(l), n)];
                      ...
                      if (n = $.filter[e[s].type].apply(null, e[s].matches), n[F]) {
                        ...
                        return g(s > 1 && p(l), s > 1 && f(e.slice(0, s - 1).concat({
                          value: " " === e[s - 2].type ? "*" : ""
                        })).replace(se, "$1"), n, r > s && y(e.slice(s, r)), i > r && y(e = e
                          .slice(r)), i > r && f(e));
                      }
                      l.push(n);
                    }
                ...
                var E,
                  ...
                  he = {
                    ...
                    CHILD: RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + ne +
                      ...
                      "*\\)|)", "i"),
                    bool: RegExp("^(?:" + te + ")$", "i"),
                    needsContext: RegExp("^" + ne +
                      "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + ne + "*((?:-\\d)?\\d*)" +
                      ne + "*\\)|)(?=[^-]|$)", "i")
                  },
                ...
                _ = t.support = {}, T = t.isXML = function(e) {
                  ...
                  return r !== I && 9 === r.nodeType && r.documentElement ? (I = r, O = I
                    .documentElement, D = !T(I), (n = I.defaultView) && n.top !== n && (n
                      .addEventListener ? n.addEventListener("unload", $e, !1) : n.attachEvent &&
                      n.attachEvent("onunload", $e)), _.attributes = i(function(e) {
                      return e.className = "i", !e.getAttribute("className");
                    }), _.getElementsByTagName = i(function(e) {
                      return e.appendChild(I.createComment("")), !e.getElementsByTagName("*")
                        .length;
                    }), _.getElementsByClassName = ve.test(I.getElementsByClassName), _.getById =
                    i(function(e) {
                      return O.appendChild(e).id = F, !I.getElementsByName || !I
                        .getElementsByName(F).length;
                      ...
                      return void 0 !== t.getElementsByTagName ? t.getElementsByTagName(e) : _
                      ...
                      return void 0 !== t.getElementsByClassName && D ? t.getElementsByClassName(
                        e) : void 0;
                      ...
                      O.appendChild(e).innerHTML = "<a id='" + F + "'></a><select id='" + F +
                        ...
                        .querySelectorAll("[msallowcapture^='']").length && R.push("[*^$]=" +
                          ne + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || R
                        .push("\\[" + ne + "*(?:value|" + te + ")"), e.querySelectorAll(
                          "[id~=" + F + "-]").length || R.push("~="), e.querySelectorAll(
                          ":checked").length || R.push(":checked"), e.querySelectorAll("a#" +
                          F + "+*").length || R.push(".#.+[+~]");
                    }), i(function(e) {
                      var t = I.createElement("input");
                      t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name",
                        "D"), e.querySelectorAll("[name=d]").length && R.push("name" + ne +
                        "*[*^$|!~]?="), e.querySelectorAll(":enabled").length || R.push(
                        ":enabled", ":disabled"), e.querySelectorAll("*,:x"), R.push(",.*:");
                    })), (_.matchesSelector = ve.test(L = O.matches || O.webkitMatchesSelector ||
                      O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && i(
                      function(e) {
                        _.disconnectedMatch = L.call(e, "div"), L.call(e, "[s!='']:x"), P.push(
                          "!=", oe);
                      }), R = R.length && RegExp(R.join("|")), P = P.length && RegExp(P.join(
                    "|")), t = ve.test(O.compareDocumentPosition), U = t || ve.test(O.contains) ?
                    function(e, t) {
                      ...
                      return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e
                        ...
                        .compareDocumentPosition(e) === n ? e === I || e.ownerDocument === j &&
                        U(j, e) ? -1 : t === I || t.ownerDocument === j && U(j, t) ? 1 : M ? ee(
                          M, e) - ee(M, t) : 0 : 4 & n ? -1 : 1);
                    } : function(e, t) {
                      if (e === t) return k = !0, 0;
                      var n,
                        r = 0,
                        ...
                        s = [e],
                        c = [t];
                      if (!i || !o) return e === I ? -1 : t === I ? 1 : i ? -1 : o ? 1 : M ? ee(M,
                        e) - ee(M, t) : 0;
                      if (i === o) return a(e, t);
                  ...
                  if ((e.ownerDocument || e) !== I && N(e), n = n.replace(le, "='$1']"), _
                    .matchesSelector && D && !G[n + " "] && (!P || !P.test(n)) && (!R || !R.test(n))
                    ) try {
                    var r = L.call(e, n);
                  ...
                  return void 0 !== r ? r : _.attributes || !D ? e.getAttribute(t) : (r = e
                  ...
                  preFilter: {
                    ATTR: function(e) {
                      return e[1] = e[1].replace(Ee, _e), e[3] = (e[3] || e[4] || e[5] || "")
                        .replace(Ee, _e), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0,
                          4);
                    },
                    CHILD: function(e) {
                    ...
                    PSEUDO: function(e) {
                      var t,
                        n = !e[6] && e[2];
                      return he.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n &&
                        de.test(n) && (t = C(n, !0)) && (t = n.indexOf(")", n.length - t) - n
                          .length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(
                          0, 3));
                    }
                  },
                  filter: {
                        ...
                        if (v) {
                          ...
                          if (p = [a ? v.firstChild : v.lastChild], a && y) {
                            for (f = v, d = f[F] || (f[F] = {}), l = d[f.uniqueID] || (d[f
                                .uniqueID] = {}), u = l[e] || [], h = u[0] === H && u[1], b =
                              h && u[2], f = h && v.childNodes[h]; f = ++h && f && f[m] || (b =
                                h = 0) || p.pop();)
                              if (1 === f.nodeType && ++b && f === t) {
                                l[e] = [H, h, b];
                                break;
                              }
                          } else if (y && (f = t, d = f[F] || (f[F] = {}), l = d[f.uniqueID] ||
                              (d[f.uniqueID] = {}), u = l[e] || [], h = u[0] === H && u[1], b =
                              h), b === !1)
                            for (;
                              (f = ++h && f && f[m] || (b = h = 0) || p.pop()) && ((s ? f
                                .nodeName.toLowerCase() !== g : 1 !== f.nodeType) || !++b || (
                                y && (d = f[F] || (f[F] = {}), l = d[f.uniqueID] || (d[f
                                  .uniqueID] = {}), l[e] = [H, b]), f !== t)););
                    ...
                    PSEUDO: function(e, n) {
                      var i,
                        o = $.pseudos[e] || $.setFilters[e.toLowerCase()] || t.error(
                          "unsupported pseudo: " + e);
                      return o[F] ? o(n) : o.length > 1 ? (i = [e, e, "", n], $.setFilters
                  ...
                  pseudos: {
                    ...
                    lang: r(function(e) {
                      return fe.test(e || "") || t.error("unsupported lang: " + e), e = e
                        .replace(Ee, _e).toLowerCase(),
                        function(t) {
                          var n;
                          do
                    ...
                    focus: function(e) {
                      return e === I.activeElement && (!I.hasFocus || I.hasFocus()) && !!(e
                ...
                return d.prototype = $.filters = $.pseudos, $.setFilters = new d(), C = t.tokenize =
                  function(e, n) {
                    var r,
                      i,
                      o,
                    ...
                    for (s = e, c = [], u = $.preFilter; s;) {
                      (!r || (i = ce.exec(s))) && (i && (s = s.slice(i[0].length) || s), c.push(
                      o = [])), r = !1, (i = ue.exec(s)) && (r = i.shift(), o.push({
                        value: r,
                        type: i[0].replace(se, " ")
                      }), s = s.slice(r.length));
                      for (a in $.filter) !(i = he[a].exec(s)) || u[a] && !(i = u[a](i)) || (r = i
                        .shift(), o.push({
                          value: r,
                          type: a,
                          matches: i
                    ...
                    var n,
                      ...
                      o = G[e + " "];
                    if (!o) {
                      for (t || (t = C(e)), n = t.length; n--;) o = y(t[n]), o[F] ? r.push(o) : i
                        .push(o);
                    ...
                    if (n = n || [], 1 === d.length) {
                      if (o = d[0] = d[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && _
                        .getById && 9 === t.nodeType && D && $.relative[o[1].type]) {
                        if (t = ($.find.ID(a.matches[0].replace(Ee, _e), t) || [])[0], !t) return n;
                        u && (t = t.parentNode), e = e.slice(o.shift().value.length);
                      }
                      for (i = he.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !$.relative[
                          s = a.type]);)
                        if ((c = $.find[s]) && (r = c(a.matches[0].replace(Ee, _e), ye.test(o[0]
                            .type) && l(t.parentNode) || t))) {
                          if (o.splice(i, 1), e = r.length && f(o), !e) return J.apply(n, r), n;
                          break;
                        }
                    }
                    return (u || x(e, d))(r, t, !D, n, !t || ye.test(e) && l(t.parentNode) || t), n;
                  }, _.sortStable = F.split("").sort(V).join("") === F, _.detectDuplicates = !!k, N(),
              ...
              }(e), bt.find = j, bt.expr = j.selectors, bt.expr[":"] = bt.expr.pseudos, bt
              .uniqueSort = bt.unique = j.uniqueSort, bt.text = j.getText, bt.isXMLDoc = j.isXML, bt
              .contains = j.contains, H = bt.expr.match.needsContext, B = /^.[^:#\[\.,]*$/, bt
              .filter = function(e, t, n) {
                ...
                find: function(e) {
                  ...
                  return r = this.pushStack(n > 1 ? bt.unique(r) : r), r.selector = this
                    .selector ? this.selector + " " + e : e, r;
                },
                filter: function(e) {
                ...
                is: function(e) {
                  return !!n(this, "string" == typeof e && H.test(e) ? bt(e) : e || [], !1)
                  .length;
                }
                ...
                if (n = n || z, "string" == typeof e) {
                  if (r = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] :
                    q.exec(e), !r || !r[1] && t) return !t || t.jquery ? (t || n).find(e) : this
                    .constructor(t).find(e);
                  if (r[1]) {
                    if (t = t instanceof bt ? t[0] : t, bt.merge(this, bt.parseHTML(r[1], t && t
                        .nodeType ? t.ownerDocument || t : ut, !0)), F.test(r[1]) && bt.isPlainObject(
                        t))
                      for (r in t) bt.isFunction(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                    return this;
                  }
                  return i = ut.getElementById(r[2]), i && i.parentNode && (this.length = 1, this[0] =
                    i), this.context = ut, this.selector = e, this;
                }
                return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : bt
                  .isFunction(e) ? void 0 !== n.ready ? n.ready(e) : e(bt) : (void 0 !== e.selector &&
                    (this.selector = e.selector, this.context = e.context), bt.makeArray(e, this));
              }, G.prototype = bt.fn, z = bt(ut), V = /\S+/g, W = e.location, Y = bt.now(), K = /\?/,
              bt.parseJSON = function(e) {
                ...
                return (!n || n.getElementsByTagName("parsererror").length) && bt.error(
                  "Invalid XML: " + t), n;
              }, X = function(e) {
                ...
                cache: function(e) {
                  ...
                  return t || (t = {}, X(e) && (e.nodeType ? e[this.expando] = t : Object
                ...
                access: function(e, t, n) {
                  var r;
                  return void 0 === t || t && "string" == typeof t && void 0 === n ? (r = this.get(
                    e, t), void 0 !== r ? r : this.get(e, bt.camelCase(t))) : (this.set(e, t, n),
                    void 0 !== n ? n : t);
                },
                remove: function(e, t) {
                  var n,
                  ...
                  if (void 0 !== o) {
                    if (void 0 === t) this.register(e);
                      ...
                      bt.isArray(t) ? r = t.concat(t.map(bt.camelCase)) : (i = bt.camelCase(t), t in
                          o ? r = [t, i] : (r = i, r = r in o ? [r] : r.match(V) || [])), n = r
                        .length;
                      for (; n--;) delete o[r[n]];
                    }
                    (void 0 === t || bt.isEmptyObject(o)) && (e.nodeType ? e[this.expando] =
              ...
              /^([^.]*)(?:\.(.+)|)/, bt.event = {
                ...
                add: function(e, t, n, r, i) {
                  var o,
                    ...
                    v = Q.get(e);
                  if (v)
                    for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = bt
                        .guid++), (c = v.events) || (c = v.events = {}), (a = v.handle) || (a = v
                        .handle = function(t) {
                          return void 0 !== bt && bt.event.triggered !== t.type ? bt.event.dispatch
                            .apply(e, arguments) : void 0;
                        }), t = (t || "").match(V) || [""], u = t.length; u--;) s = ee.exec(t[
                      u]) || [], h = m = s[1], p = (s[2] || "").split(".").sort(), h && (d = bt
                        .event.special[h] || {}, h = (i ? d.delegateType : d.bindType) || h, d = bt
                        .event.special[h] || {}, l = bt.extend({
                          type: h,
                          origType: m,
                          data: r,
                          handler: n,
                          ...
                          namespace: p.join(".")
                        }, o), (f = c[h]) || (f = c[h] = [], f.delegateCount = 0, d.setup && d.setup
                          .call(e, r, p, a) !== !1 || e.addEventListener && e.addEventListener(h, a)
                          ), d.add && (d.add.call(e, l), l.handler.guid || (l.handler.guid = n
                          .guid)), i ? f.splice(f.delegateCount++, 0, l) : f.push(l), bt.event
                        .global[h] = !0);
                },
                remove: function(e, t, n, r, i) {
                  ...
                  if (v && (c = v.events)) {
                    for (t = (t || "").match(V) || [""], u = t.length; u--;)
                      if (s = ee.exec(t[u]) || [], h = m = s[1], p = (s[2] || "").split(".").sort(),
                        h) {
                        for (d = bt.event.special[h] || {}, h = (r ? d.delegateType : d.bindType) ||
                          h, f = c[h] || [], s = s[2] && RegExp("(^|\\.)" + p.join(
                            "\\.(?:.*\\.|)") + "(\\.|$)"), a = o = f.length; o--;) l = f[o], !i &&
                          m !== l.origType || n && n.guid !== l.guid || s && !s.test(l.namespace) ||
                          r && r !== l.selector && ("**" !== r || !l.selector) || (f.splice(o, 1), l
                            .selector && f.delegateCount--, d.remove && d.remove.call(e, l));
                        a && !f.length && (d.teardown && d.teardown.call(e, p, v.handle) !== !1 ||
                          bt.removeEvent(e, h, v.handle), delete c[h]);
                      } else
                ...
                dispatch: function(e) {
                  ...
                  if (s[0] = e, e.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this,
                      e) !== !1) {
                    for (a = bt.event.handlers.call(this, e, c), t = 0;
                      (i = a[t++]) && !e.isPropagationStopped();)
                      for (e.currentTarget = i.elem, n = 0;
                        (o = i.handlers[n++]) && !e.isImmediatePropagationStopped();)(!e
                        .rnamespace || e.rnamespace.test(o.namespace)) && (e.handleObj = o, e
                        .data = o.data, r = ((bt.event.special[o.origType] || {}).handle || o
                          .handler).apply(i.elem, s), void 0 !== r && (e.result = r) === !1 && (e
                  ...
                  if (s && c.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
                    for (; c !== this; c = c.parentNode || this)
                      if (1 === c.nodeType && (c.disabled !== !0 || "click" !== e.type)) {
                        for (r = [], n = 0; s > n; n++) o = t[n], i = o.selector + " ", void 0 ===
                          r[i] && (r[i] = o.needsContext ? bt(i, this).index(c) > -1 : bt.find(i,
                            this, null, [c]).length), r[i] && r.push(o);
                        r.length && a.push({
                          elem: c,
                          handlers: r
                        });
                ...
                mouseHooks: {
                  ...
                  filter: function(e, t) {
                    ...
                    return null == e.pageX && null != t.clientX && (n = e.target.ownerDocument ||
                        ut, r = n.documentElement, i = n.body, e.pageX = t.clientX + (r && r
                          .scrollLeft || i && i.scrollLeft || 0) - (r && r.clientLeft || i && i
                          .clientLeft || 0), e.pageY = t.clientY + (r && r.scrollTop || i && i
                          .scrollTop || 0) - (r && r.clientTop || i && i.clientTop || 0)), e
                      .which || void 0 === o || (e.which = 1 & o ? 1 : 2 & o ? 3 : 4 & o ? 2 : 0),
                      e;
                  }
                },
                fix: function(e) {
                  ...
                  for (a || (this.fixHooks[i] = a = Z.test(i) ? this.mouseHooks : J.test(i) ? this
                      .keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e =
                    new bt.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
                  return e.target || (e.target = ut), 3 === e.target.nodeType && (e.target = e
                    .target.parentNode), a.filter ? a.filter(e, o) : e;
                },
                special: {
                  load: {
                    noBubble: !0
                  ...
                  click: {
                    trigger: function() {
                      return "checkbox" === this.type && this.click && bt.nodeName(this, "input") ?
                        (this.click(), !1) : void 0;
                    },
                    _default: function(e) {
                ...
                return this instanceof bt.Event ? (e && e.type ? (this.originalEvent = e, this.type =
                    e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e
                    .defaultPrevented && e.returnValue === !1 ? i : o) : this.type = e, t && bt
                  .extend(this, t), this.timeStamp = e && e.timeStamp || bt.now(), void(this[bt
                    .expando] = !0)) : new bt.Event(e, t);
              }, bt.Event.prototype = {
                ...
                bt.event.special[e] = {
                  ...
                  handle: function(e) {
                    var n,
                      ...
                      i = e.relatedTarget,
                      o = e.handleObj;
                    return (!i || i !== r && !bt.contains(r, i)) && (e.type = o.origType, n = o
                ...
                off: function(e, t, n) {
                  var r, i;
                  if (e && e.preventDefault && e.handleObj) return r = e.handleObj, bt(e
                  ...
                  return (t === !1 || "function" == typeof t) && (n = t, t = void 0), n === !1 &&
                    (n = o), this.each(function() {
                ...
                trigger: function(t, n, r, i) {
                  ...
                  if (a = s = r = r || ut, 3 !== r.nodeType && 8 !== r.nodeType && !te.test(h + bt
                      .event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."), h = p
                      .shift(), p.sort()), u = h.indexOf(":") < 0 && "on" + h, t = t[bt.expando] ?
                      t : new bt.Event(h, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t
                      .namespace = p.join("."), t.rnamespace = t.namespace ? RegExp("(^|\\.)" + p
                        .join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target ||
                      (t.target = r), n = null == n ? [t] : bt.makeArray(n, [t]), d = bt.event
                      .special[h] || {}, i || !d.trigger || d.trigger.apply(r, n) !== !1)) {
                    if (!i && !d.noBubble && !bt.isWindow(r)) {
                      for (c = d.delegateType || h, te.test(c + h) || (a = a.parentNode); a; a = a
                        .parentNode) f.push(a), s = a;
                      s === (r.ownerDocument || ut) && f.push(s.defaultView || s.parentWindow ||
                        e);
                    }
                    for (o = 0;
                      (a = f[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? c : d
                      .bindType || h, l = (Q.get(a, "events") || {})[t.type] && Q.get(a,
                      "handle"), l && l.apply(a, n), l = u && a[u], l && l.apply && X(a) && (t
                        .result = l.apply(a, n), t.result === !1 && t.preventDefault());
                    return t.type = h, i || t.isDefaultPrevented() || d._default && d._default
                      .apply(f.pop(), n) !== !1 || !X(r) || u && bt.isFunction(r[h]) && !bt
                      .isWindow(r) && (s = r[u], s && (r[u] = null), bt.event.triggered = h, r[h]
                      (), bt.event.triggered = void 0, s && (r[u] = s)), t.result;
                  }
                },
                ...
                var t,
                  ...
                  u = function() {
                    for (i = e.once, r = t = !0; a.length; s = -1)
                      for (n = a.shift(); ++s < o.length;) o[s].apply(n[0], n[1]) === !1 && e
                        .stopOnFalse && (s = o.length, n = !1);
                    ...
                    add: function() {
                      return o && (n && !t && (s = o.length - 1, a.push(n)), function t(n) {
                        bt.each(n, function(n, r) {
                          bt.isFunction(r) ? e.unique && l.has(r) || o.push(r) : r && r
                            .length && "string" !== bt.type(r) && t(r);
                        });
                        ...
                        return bt.Deferred(function(n) {
                          bt.each(t, function(t, o) {
                            ...
                            i[o[1]](function() {
                              ...
                              e && bt.isFunction(e.promise) ? e.promise().progress(n
                                .notify).done(n.resolve).fail(n.reject) : n[o[0] +
                                "With"](this === r ? n.promise() : this, a ? [e] :
                                arguments);
                            });
                          }), e = null;
                        }).promise();
                ...
                when: function(e) {
                  var t,
                    ...
                    u = function(e, n, r) {
                      return function(i) {
                        n[e] = this, r[e] = arguments.length > 1 ? lt.call(arguments) : i, r ===
                          t ? c.notifyWith(n, r) : --s || c.resolveWith(n, r);
                      };
                    };
                  if (a > 1)
                    for (t = Array(a), n = Array(a), r = Array(a); a > i; i++) o[i] && bt
                      .isFunction(o[i].promise) ? o[i].promise().progress(u(i, n, t)).done(u(i, r,
                        o)).fail(c.reject) : --s;
                  return s || c.resolveWith(r, o), c.promise();
                }
              }), ne = /#.*$/, re = /([?&])_=[^&]*/, ie = /^(.*?):[ \t]*([^\r\n]*)$/gm, oe =
              /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, ae = /^(?:GET|HEAD)$/, se =
              /^\/\//, ce = {}, ue = {}, le = "*/".concat("*"), de = ut.createElement("a"), de.href =
              W.href, bt.extend({
                active: 0,
                lastModified: {},
                etag: {},
                ...
                ajax: function(t, n) {
                  function r(t, n, r, s) {
                    var u,
                      ...
                      $,
                      T = n;
                    2 !== w && (w = 2, c && e.clearTimeout(c), i = void 0, a = s || "", C
                      .readyState = t > 0 ? 4 : 0, u = t >= 200 && 300 > t || 304 === t, r && (
                        _ = f(m, C, r)), _ = h(m, _, C, u), u ? (m.ifModified && ($ = C
                          .getResponseHeader("Last-Modified"), $ && (bt.lastModified[o] = $),
                          $ = C.getResponseHeader("etag"), $ && (bt.etag[o] = $)), 204 === t ||
                        "HEAD" === m.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (
                          T = _.state, l = _.data, p = _.error, u = !p)) : (p = T, (t || !T) &&
                        (T = "error", 0 > t && (t = 0))), C.status = t, C.statusText = (n ||
                      T) + "", u ? y.resolveWith(v, [l, T, C]) : y.rejectWith(v, [C, T, p]), C
                      .statusCode(E), E = void 0, d && g.trigger(u ? "ajaxSuccess" :
                        "ajaxError", [C, m, u ? l : p]), b.fireWith(v, [C, T]), d && (g.trigger(
                        "ajaxComplete", [C, m]), --bt.active || bt.event.trigger("ajaxStop")));
                  }
                  ...
                  if (y.promise(C).complete = b.add, C.success = C.done, C.error = C.fail, m.url =
                    ((t || m.url || W.href) + "").replace(ne, "").replace(se, W.protocol + "//"),
                    m.type = n.method || n.type || m.method || m.type, m.dataTypes = bt.trim(m
                      .dataType || "*").toLowerCase().match(V) || [""], null == m.crossDomain) {
                    u = ut.createElement("a");
                    try {
                      u.href = m.url, u.href = u.href, m.crossDomain = de.protocol + "//" + de
                        .host != u.protocol + "//" + u.host;
                    } catch (e) {
                      m.crossDomain = !0;
                    }
                  }
                  if (m.data && m.processData && "string" != typeof m.data && (m.data = bt.param(m
                      .data, m.traditional)), l(ce, m, n, C), 2 === w) return C;
                  d = bt.event && m.global, d && 0 === bt.active++ && bt.event.trigger(
                      "ajaxStart"), m.type = m.type.toUpperCase(), m.hasContent = !ae.test(m
                    .type), o = m.url, m.hasContent || (m.data && (o = m.url += (K.test(o) ? "&" :
                      "?") + m.data, delete m.data), m.cache === !1 && (m.url = re.test(o) ? o
                      .replace(re, "$1_=" + Y++) : o + (K.test(o) ? "&" : "?") + "_=" + Y++)), m
                    .ifModified && (bt.lastModified[o] && C.setRequestHeader("If-Modified-Since",
                      bt.lastModified[o]), bt.etag[o] && C.setRequestHeader("If-None-Match", bt
                      .etag[o])), (m.data && m.hasContent && m.contentType !== !1 || n
                      .contentType) && C.setRequestHeader("Content-Type", m.contentType), C
                    .setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m
                      .accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + le +
                        "; q=0.01" : "") : m.accepts["*"]);
                  for (p in m.headers) C.setRequestHeader(p, m.headers[p]);
                  if (m.beforeSend && (m.beforeSend.call(v, C, m) === !1 || 2 === w)) return C
                    .abort();
                  T = "abort";
                  for (p in {
                      success: 1,
                ...
                var i,
                  o,
                  a,
                  s = t.jsonp !== !1 && (he.test(t.url) ? "url" : "string" == typeof t.data && 0 ===
                    (t.contentType || "").indexOf("application/x-www-form-urlencoded") && he.test(t
                      .data) && "data");
                return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = bt.isFunction(t
                    .jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s]
                  .replace(he, "$1" + i) : t.jsonp !== !1 && (t.url += (K.test(t.url) ? "&" :
                    ...
                    void 0 === o ? bt(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n
                        .jsonpCallback, fe.push(i)), a && bt.isFunction(o) && o(a[0]), a = o =
                      void 0;
                  }), "script") : void 0;
              }), bt.ajaxSetup({
                accepts: {
                ...
                0: 200,
                1223: 204
              }, me = bt.ajaxSettings.xhr(), gt.cors = !!me && "withCredentials" in me, gt.ajax =
              me = !!me, bt.ajaxTransport(function(t) {
                var n, r;
                    ...
                    n = function(e) {
                        return function() {
                          n && (n = r = s.onload = s.onerror = s.onabort = s
                            ...
                            "error" === e ? "number" != typeof s.status ? o(0, "error") : o(
                              s.status, s.statusText) : o(pe[s.status] || s.status, s
                ...
                } else if (void 0 !== i && (o = !0, bt.isFunction(i) || (s = !0), l && (s ? (n.call(t,
                    i), n = null) : (l = n, n = function(e, t, n) {
                    return l.call(bt(e), n);
                  })), n))
                  for (; u > c; c++) n(t[c], r, s ? i : i.call(t[c], c, n(t[c], r)));
                return o ? t : l ? n.call(t) : u ? n(t[0], r) : a;
              }, ge = /^(?:checkbox|radio)$/i, ye = /<([\w:-]+)/, be = /^$|\/(?:java|ecma)script/i,
              Ee = {
                ...
                _default: [0, "", ""]
              }, Ee.optgroup = Ee.option, Ee.tbody = Ee.tfoot = Ee.colgroup = Ee.caption = Ee.thead,
              Ee.th = Ee.td, _e = /<|&#?\w+;/,
              function() {
                ...
                n.setAttribute("type", "radio"), n.setAttribute("checked", "checked"), n.setAttribute(
                    "name", "t"), t.appendChild(n), gt.checkClone = t.cloneNode(!0).cloneNode(!0)
                  .lastChild.checked, t.innerHTML = "<textarea>x</textarea>", gt.noCloneChecked = !!t
                ...
                closest: function(e, t) {
                  for (var n, r = 0, i = this.length, o = [], a = H.test(e) || "string" !=
                      typeof e ? bt(e, t || this.context) : 0; i > r; r++)
                ...
                index: function(e) {
                  return e ? "string" == typeof e ? ht.call(bt(e), this[0]) : ht.call(this, e
                      .jquery ? e[0] : e) : this[0] && this[0].parentNode ? this.first().prevAll()
                    .length : -1;
                },
                add: function(e, t) {
                ...
                bt.fn[e] = function(n, r) {
                  ...
                  return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = bt
                    .filter(r, i)), this.length > 1 && (xe[e] || bt.uniqueSort(i), Ce.test(e) &&
                    i.reverse()), this.pushStack(i);
                };
              }), Se = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,
              Ae = /<script|<style|<link/i, Me = /checked\s*(?:[^=]|=\s*.checked.)/i, ke =
              /^true\/(.*)/, Ne = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, bt.extend({
                ...
                clone: function e(t, n, r) {
                  ...
                  if (!(gt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || bt.isXMLDoc(
                      t)))
                    for (s = p(e), a = p(t), i = 0, o = a.length; o > i; i++) $(a[i], s[i]);
                  if (n)
                    if (r)
                      for (a = a || p(t), s = s || p(e), i = 0, o = a.length; o > i; i++) _(a[i],
                        s[i]);
                    else _(t, e);
                ...
                cleanData: function(e) {
                  for (var t, n, r, i = bt.event.special, o = 0; void 0 !== (n = e[o]); o++)
                    if (X(n)) {
                      if (t = n[Q.expando]) {
                        if (t.events)
                          for (r in t.events) i[r] ? bt.event.remove(n, r) : bt.removeEvent(n, r,
                            t.handle);
                        n[Q.expando] = void 0;
                      }
                ...
                empty: function() {
                  for (var e, t = 0; null != (e = this[t]); t++) 1 === e.nodeType && (bt
                    .cleanData(p(e, !1)), e.textContent = "");
                  return this;
                },
                clone: function(e, t) {
                ...
                html: function(e) {
                  return ve(this, function(e) {
                    ...
                    if ("string" == typeof e && !Ae.test(e) && !Ee[(ye.exec(e) || ["", ""])[1]
                      ...
                      try {
                        for (; r > n; n++) t = this[n] || {}, 1 === t.nodeType && (bt
                          .cleanData(p(t, !1)), t.innerHTML = e);
                        t = 0;
                      } catch (e) {}
                    }
                ...
                replaceWith: function() {
                  ...
                  return w(this, arguments, function(t) {
                    ...
                    bt.inArray(this, e) < 0 && (bt.cleanData(p(this)), n && n.replaceChild(t,
                      this));
                  }, e);
                }
              }), bt.each({
                ...
                bt.fn[e] = function(e) {
                  for (var n, r = [], i = bt(e), o = i.length - 1, a = 0; o >= a; a++) n = a ===
                    o ? this : this.clone(!0), bt(i[a])[t](n), ft.apply(r, n.get());
                ...
                var r = F.exec(e),
                  i = !n && [];
                return r ? [t.createElement(r[1])] : (r = v([e], t, i), i && i.length && bt(i)
                .remove(), bt.merge([], r.childNodes));
                ...
                data: function e(t, n) {
                  var r,
                    ...
                    a = o && o.attributes;
                  if (void 0 === t) {
                    if (this.length && (e = $e.get(o), 1 === o.nodeType && !Q.get(o,
                        "hasDataAttrs"))) {
                      for (r = a.length; r--;) a[r] && (i = a[r].name, 0 === i.indexOf("data-") &&
                        (i = bt.camelCase(i.slice(5)), C(o, i, e[i])));
                  ...
                  return "object" == typeof t ? this.each(function() {
                    ...
                    var n, r;
                    if (o && void 0 === e) {
                      if (n = $e.get(o, t) || $e.get(o, t.replace(Oe, "-$&").toLowerCase()),
                        void 0 !== n) return n;
                      ...
                      var n = $e.get(this, r);
                      $e.set(this, r, e), t.indexOf("-") > -1 && void 0 !== n && $e.set(
                        this, t, e);
                    });
                ...
                "^(?:([+-])=|)(" + De + ")([a-z%]*)$", "i"), Le = RegExp("^(" + De +
                ")(?!px)[a-z%]+$", "i"), Ue = ["Top", "Right", "Bottom", "Left"], Fe = function(e,
              t) {
                return e = t || e, "none" === bt.css(e, "display") || !bt.contains(e.ownerDocument,
                e);
              }, je = function(t) {
              ...
              function() {
                function t() {
                  ...
                  n = "1%" !== t.top, o = "2px" === t.marginLeft, r = "4px" === t.width, s.style
                    .marginRight = "50%", i = "4px" === t.marginRight, Be.removeChild(a);
                }
                var n,
                  r,
                  i,
                ...
                s.style && (s.style.backgroundClip = "content-box", s.cloneNode(!0).style
                  .backgroundClip = "", gt.clearCloneStyle = "content-box" === s.style
                  .backgroundClip, a.style.cssText =
                  ...
                  a.appendChild(s), bt.extend(gt, {
                    ...
                    reliableMarginRight: function() {
                      var t,
                        n = s.appendChild(ut.createElement("div"));
                      return n.style.cssText = s.style.cssText =
                        "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0",
                        n.style.marginRight = n.style.width = "0", s.style.width = "1px", Be
                        .appendChild(a), t = !parseFloat(e.getComputedStyle(n).marginRight), Be
                ...
                ready: function(e) {
                  (e === !0 ? --bt.readyWait : bt.isReady) || (bt.isReady = !0, e !== !0 && --bt
                    .readyWait > 0 || (Ge.resolveWith(ut, [bt]), bt.fn.triggerHandler && (bt(ut)
                      .triggerHandler("ready"), bt(ut).off("ready"))));
                }
              }), bt.ready.promise = function(t) {
                return Ge || (Ge = bt.Deferred(), "complete" === ut.readyState || "loading" !== ut
                    .readyState && !ut.documentElement.doScroll ? e.setTimeout(bt.ready) : (ut
                      .addEventListener("DOMContentLoaded", N), e.addEventListener("load", N))), Ge
                  .promise(t);
                ...
                style: function e(t, n, r, i) {
                  if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var o,
                      ...
                      c = bt.camelCase(n),
                      e = t.style;
                    return n = bt.cssProps[c] || (bt.cssProps[c] = I(c) || c), s = bt.cssHooks[
                      n] || bt.cssHooks[c], void 0 === r ? s && "get" in s && void 0 !== (o = s
                        .get(t, !1, i)) ? o : e[n] : (a = typeof r, "string" === a && (o = Pe
                        .exec(r)) && o[1] && (r = S(t, n, o), a = "number"), void(null != r &&
                        r === r && ("number" === a && (r += o && o[3] || (bt.cssNumber[c] ? "" :
                          "px")), gt.clearCloneStyle || "" !== r || 0 !== n.indexOf(
                          "background") || (e[n] = "inherit"), s && "set" in s && void 0 === (
                          r = s.set(t, r, i)) || (e[n] = r))));
                  }
                },
                css: function(e, t, n, r) {
                  var i,
                    ...
                    a,
                    s = bt.camelCase(t);
                  return t = bt.cssProps[s] || (bt.cssProps[s] = I(s) || s), a = bt.cssHooks[t] ||
                    bt.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i =
                      x(e, t, r)), "normal" === i && t in Ye && (i = Ye[t]), "" === n || n ? (o =
                      parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i;
                }
                ...
                bt.cssHooks[t] = {
                  ...
                  set: function(e, n, r) {
                    ...
                    return a && (i = Pe.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                      n = bt.css(e, t)), O(e, n, a);
                  }
                };
              }), bt.cssHooks.marginLeft = k(gt.reliableMarginLeft, function(e, t) {
                return t ? (parseFloat(x(e, "marginLeft")) || e.getBoundingClientRect().left - He(
                e, {
                  marginLeft: 0
                }, function() {
                ...
                css: function(e, t) {
                  return ve(this, function(e, t, n) {
                    var r,
                      ...
                      a = 0;
                    if (bt.isArray(t)) {
                      for (r = je(e), i = t.length; i > a; a++) o[t[a]] = bt.css(e, t[a], !1,
                        r);
                      return o;
                    }
              ...
              function() {
                ...
                e.type = "checkbox", gt.checkOn = "" !== e.value, gt.optSelected = n.selected, t
                  .disabled = !0, gt.optDisabled = !n.disabled, e = ut.createElement("input"), e
                  .value = "t", e.type = "radio", gt.radioValue = "t" === e.value;
                ...
                attr: function(e, t, n) {
                  var r,
                    i,
                    o = e.nodeType;
                  if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? bt.prop(e,
                    t, n) : (1 === o && bt.isXMLDoc(e) || (t = t.toLowerCase(), i = bt
                      .attrHooks[t] || (bt.expr.match.bool.test(t) ? Qe : void 0)), void 0 !==
                    n ? null === n ? void bt.removeAttr(e, t) : i && "set" in i && void 0 !==
                    (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in
                    i && null !== (r = i.get(e, t)) ? r : (r = bt.find.attr(e, t), null == r ?
                      void 0 : r));
                },
                attrHooks: {
                  type: {
                ...
                removeAttr: function(e, t) {
                  var n,
                    ...
                    o = t && t.match(V);
                  if (o && 1 === e.nodeType)
                    for (; n = o[i++];) r = bt.propFix[n] || n, bt.expr.match.bool.test(n) && (e[
                      r] = !1), e.removeAttribute(n);
                }
              }), Qe = {
                set: function(e, t, n) {
                ...
                Je[t] = function(e, t, r) {
                  var i, o;
                  return r || (o = Je[t], Je[t] = i, i = null != n(e, t, r) ? t.toLowerCase() :
                    null, Je[t] = o), i;
                };
                ...
                prop: function(e, t, n) {
                  var r,
                    i,
                    o = e.nodeType;
                  if (3 !== o && 8 !== o && 2 !== o) return 1 === o && bt.isXMLDoc(e) || (t = bt
                      .propFix[t] || t, i = bt.propHooks[t]), void 0 !== n ? i && "set" in i &&
                ...
                propHooks: {
                  tabIndex: {
                    get: function(e) {
                      ...
                      return t ? parseInt(t, 10) : Ze.test(e.nodeName) || et.test(e.nodeName) && e
                        .href ? 0 : -1;
                    }
                  }
                },
              ...
              }), bt.each(["tabIndex", "readOnly", "maxLength", "cellSpacing", "cellPadding",
                ...
                toggleClass: function(e, t) {
                  ...
                  return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this
                    .removeClass(e) : bt.isFunction(e) ? this.each(function(n) {
                      bt(this).toggleClass(e.call(this, n, L(this), t), t);
                    }) : this.each(function() {
                      var t, r, i, o;
                      if ("string" === n)
                        for (r = 0, i = bt(this), o = e.match(V) || []; t = o[r++];) i.hasClass(
                        ...
                        t || e === !1 ? "" : Q.get(this, "__className__") || ""));
                    });
                },
                hasClass: function(e) {
                  var t,
                    ...
                    r = 0;
                  for (t = " " + e + " "; n = this[r++];)
                    if (1 === n.nodeType && (" " + L(n) + " ").replace(tt, " ").indexOf(t) > -1)
                      return !0;
                  return !1;
                }
              }), nt = /\r/g, bt.fn.extend({
                val: function(e) {
                  ...
                  return arguments.length ? (r = bt.isFunction(e), this.each(function(n) {
                    var i;
                    1 === this.nodeType && (i = r ? e.call(this, n, bt(this).val()) : e,
                      null == i ? i = "" : "number" == typeof i ? i += "" : bt.isArray(
                      i) && (i = bt.map(i, function(e) {
                        return null == e ? "" : e + "";
                      })), t = bt.valHooks[this.type] || bt.valHooks[this.nodeName
                        .toLowerCase()], t && "set" in t && void 0 !== t.set(this, i,
                        "value") || (this.value = i));
                  })) : i ? (t = bt.valHooks[i.type] || bt.valHooks[i.nodeName.toLowerCase()],
                ...
                valHooks: {
                  ...
                  select: {
                    get: function(e) {
                      for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e
                          .type || 0 > i, a = o ? null : [], s = o ? i + 1 : r.length, c = 0 > i ?
                          s : o ? i : 0; s > c; c++)
                        if (n = r[c], (n.selected || c === i) && (gt.optDisabled ? !n.disabled :
                            null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !bt
                    ...
                    set: function(e, t) {
                      for (var n, r, i = e.options, o = bt.makeArray(t), a = i.length; a--;) r =
                        i[a], (r.selected = bt.inArray(bt.valHooks.option.get(r), o) > -1) && (
                          n = !0);
              ...
              /^(?:submit|button|image|reset|file)$/i, st = /^(?:input|select|textarea|keygen)/i, bt
              .param = function(e, t) {
                var n,
                  r = [],
                  i = function(e, t) {
                    t = bt.isFunction(t) ? t() : null == t ? "" : t, r[r.length] = encodeURIComponent(
                      e) + "=" + encodeURIComponent(t);
                  };
                if (void 0 === t && (t = bt.ajaxSettings && bt.ajaxSettings.traditional), bt.isArray(
                    e) || e.jquery && !bt.isPlainObject(e)) bt.each(e, function() {
                ...
                serializeArray: function() {
                  return this.map(function() {
                    ...
                    var e = this.type;
                    return this.name && !bt(this).is(":disabled") && st.test(this.nodeName) &&
                      !at.test(e) && (this.checked || !ge.test(e));
                  }).map(function(e, t) {
                    var n = bt(this).val();
        ...
        t(Is), n(Is), Qr = 6e4, Jr = "mbox-name-", Zr = "mboxDefault", ei =
          "/m2/{clientCode}/mbox/json", ti = 250, ni = "Mbox name is not present or is too long.", ri =
          "the mbox environment is disabled.", ii = "-clicked", oi = "x-only", ai = "disabled", si =
          "mboxedge", ci = "Content container not found", ui =
          /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
          li = /(?:^|&)([^&=]*)=?([^&]*)/gi, di = ["source", "protocol", "authority", "userInfo",
            "user", "password", "host", "port", "relative", "path", "directory", "file", "query",
            "anchor"
          ], fi = "at-data-src", hi = "at-script-marker", pi = "at-id-body-style", mi =
          "at-flicker-control", vi = "at-id-default-content-style", gi = "redirect:event", yi =
          "show:body", bi = "ready:dom", Ei = "script", _i = function(e, t) {
            return de(e).find(t);
          }, $i = "mboxMCAVID", wi = "mboxAAMB", Ti = "mboxMCGLH", Ci = "mboxMCGVID", xi = "mboxMCSDID",
          Si = "colorDepth", Ai = "screenHeight", Mi = "screenWidth", ki = "browserHeight", Ni =
          "browserTimeOffset", Ii = "browserWidth", Oi = "mboxCallback", Di = "mboxTarget", Ri =
          "clickTrackId", Pi = "mboxXDomain", Li = "mboxCount", Ui = "mboxHost", Fi = "mbox", ji =
          "mboxPage", Hi = "mboxSession", Bi = "mboxReferrer", zi = "mboxTime", qi = "mboxPC", Gi =
          "mboxURL", Vi = "mboxVersion", Wi = function() {}, Yi =
          "//cdn.tt.omtrdc.net/cdn/target-vec.js", Ki = "success", Xi = "warning", Qi = "error", Ji =
          "optout", Zi = !1, eo = !0, to = "mboxDebug", no = "mboxDisable", ro = "mboxEdit", io =
          "[Target]", oo = "check", ao = "mbox", so = "PC", co = "session", uo = "mboxEdgeServer", lo =
          "mboxDisabled", fo = RegExp("('|\")"), ho = "https://", po = "Visitor Api:", mo = "vst.", vo =
          mo + "trk", go = mo + "trks", yo = "Options argument is required", bo = {
          ...
          ' unknown method "{0}"', wo = Eo + ' unknown type "{0}"', To = Eo +
          " timeout param is not a number", Co = Eo + ' invalid method "{0}" for request type "{1}"',
          xo = Eo + " invalid params, should be object", So = "mbox", Ao = "type", Mo = "method", ko =
          "jsonp", No = "params", Io = "timeout", Oo = [bo.OPTIONS_IS_REQUIRED, bo
            .URL_PARAM_IS_MANDATORY
          ], Do = {
            JSON: "json",
            JSONP: "jsonp",
            SCRIPT: "script"
            ...
            valid: function(e) {
              var t = e[Mo],
                n = e[Ao];
              return k(t) ? D(Ro[t.toUpperCase()]) ? De($o.replace("{0}", t)) : t.toUpperCase() !== Ro
                .GET && n !== Do.JSON ? De(Co.replace("{0}", t).replace("{1}", n)) : Pe() : Pe();
            }
          }, Uo = {
            valid: function(e) {
          ...
          "Invalid initialization. Cannot access document.location.", Vo = "DEFINED-BEHAVIOR-BUILDER:",
          Wo = 'cannot preventDefault. Unsupported event: "{0}" for "{1}" element.', Yo =
          "undefined element type or event type.", Ko =
          'cannot preventDefault. Unsupported tag: "{0}".', Xo = {}, Qo = {}, Jo = "fetch()", Zo =
          "script", ea = "img", ta = {
          ...
          "at-request-failed", la = "at-content-rendering-succeeded", da =
          "at-content-rendering-failed", fa = /CLKTRK#(\S+)/, ha = /CLKTRK#(\S+)\s/, pa = 50, ma =
          "applied:", va = "polling:end", ga = "target", ya = "traces", ba = "___" + ga + "_" + ya, Ea =
          86400, _a = "3rd party cookies disabled", $a = "applyOffer():", wa =
          "Either element or selector is redundant", Ta = "offer parameter is mandatory", Ca = [bo
            .OPTIONS_IS_REQUIRED, Et("offer", R, Ta), _t(Tr, wa)
          ], xa = [bo.OPTIONS_IS_REQUIRED, bo.MBOX_OPTION_PARAM_VALIDATOR], Sa = "getOffer():", Aa = [bo
            .OPTIONS_IS_REQUIRED, bo.MBOX_OPTION_PARAM_VALIDATOR
          ], Ma = "Track Event:", ka = [bo.MBOX_PARAM_VALIDATOR], Na = "Classic:", Ia =
          "DOM node ID not provided for mbox:", Oa =
          "Unable to load target-vec.js for experience creation.", Da = "ext", Ra = RegExp(
            "^[a-zA-Z]+$"), Pa = [bo.SUCCESS_PARAM_IS_MANDATORY, bo.ERROR_PARAM_IS_MANDATORY], La =
          "getOffer():", Ua = "success callback throws error", Fa = "error callback throws error",
          ja = [So, Io, No], Ha = window, Ba = Ha.document, za = Se(Ha, e), qa = za.generateId(), Ga =
          Ne(ke(Ha, Ba), Ba, qa, e), Va = je(Ha, Ba, za), Wa = Xe(Ba), Ya = Ze(Wa, e), Ka = rt(Ba, Wa,
            za, e), Xa = dt(Ba, Ga, Ka, Ya, za, e), Qa = vt(Ba, za, e), Ja = gt(Ha, Ba, Wa, za, e, Ka,
            Ya), Za = yt(), es = bt(Ha, Va, e), ts = Ct(za, Va, e), ns = St(xt(Ja, Xa, ts), es), rs =
          At(ns, za, Va, e), is = Dt(Ba, Va), os = Rt(za, Va), as = Gt(os), ss = Vt(), cs = Kt(rs, Wt(
            Va), is), us = tn(as, ss, cs, Ja), ls = rn(ss, cs), ds = an(us), fs = cn(za), hs = Kt(rs,
            un(e), is), ps = Ht(os, za, hs, Va), ms = Pn(Ha, Ka), vs = Ln(ms), gs = Un(Ha), ys = Fn(ps,
            Va, Ja), bs = jn(ys, Ja, gs, za, Va), Es = qn(ss, vs, ps, ys, za, Va, Ja, bs), _s = [fs, Es,
            ds, ls
          ], $s = ur(Qa), ws = dr($s, _s), Ha.adobe = Ha.adobe || {}, Ha.adobe.target = {}, Ha.adobe
          .target.VERSION = e.version, Ts = {
            tntId: _r(Ba, e, Ya),
            sessionId: vr(Ka),
            error: mr(Ja),
            disabled: pr(Ba, Ja),
            trace: hr(Ha)
          }, Cs = $r(), xs = wr(Ts, za), Ss = xr(_s, Va), As = Ar(Ja, ns, xs, $s, za, Va, e), Ms = Rr(
            Ja, Ha, rs, is, za, Va, e), Ha.adobe.target.applyOffer = Ss, Ha.adobe.target.trackEvent =
          Ms, ks = Lr(Ja, Za, ns, xs, ws, za, Va, Cs), Ha.mboxDefine = ks.createMbox, Ha.mboxUpdate = ks
          .fetchAndDisplayMbox, Ha.mboxCreate = ks.createFetchAndDisplayMbox, Fr(Ja, Ha, ts, Va), jr(Ja,
            Cs, As, Ss, za, e), Hr(Ha.adobe.target), Xr(Ha.adobe.target, As, Cs, Va), za.onDomReady(za
            .triggerDomReady()), Ja.isEnabled() && Ce();
      }(this.adobe = {});
    }({
      clientCode: "nvidia",
