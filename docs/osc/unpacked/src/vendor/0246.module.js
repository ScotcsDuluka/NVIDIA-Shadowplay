  ...
  ! function(e, r) {
    ...
    function x(e, t) {
      ...
      if (mn) {
        ...
        var a,
          ...
          u = o[0] * Hn * c,
          l = zn(s) > 180;
        l ^ (c * fn < u && u < c * e) ? (a = o[1] * Hn, a > dn && (dn = a)) : (u = (u + 360) % 360 - 180,
            l ^ (c * fn < u && u < c * e) ? (a = -o[1] * Hn, a < un && (un = a)) : (t < un && (un = t), t >
              dn && (dn = t))), l ? e < fn ? I(cn, e) > I(cn, ln) && (ln = e) : I(e, ln) > I(cn, ln) && (
            cn = e) : ln >= cn ? (e < cn && (cn = e), e > ln && (ln = e)) : e > fn ? I(cn, e) > I(cn, ln) &&
          (ln = e) : I(e, ln) > I(cn, ln) && (cn = e);
    ...
    function R(e) {
      ...
      if (dn = ln = -(cn = un = 1 / 0), vn = [], f(e, sr), n = vn.length) {
        for (vn.sort(O), t = 1, r = vn[0], o = [r]; t < n; ++t) i = vn[t], D(r, i[0]) || D(r, i[1]) ? (I(r[
            0], i[1]) > I(r[0], r[1]) && (r[1] = i[1]), I(i[0], r[1]) > I(r[0], r[1]) && (r[0] = i[0])) : o
          .push(r = i);
        for (a = -(1 / 0), n = o.length - 1, t = 0, r = o[n]; t <= n; r = i, ++t) i = o[t], (s = I(r[1], i[
          0])) > a && (a = s, cn = i[0], ln = r[1]);
      }
    ...
    function j(e, t) {
      ...
      var n = Vn(t),
        ...
        i = n * Qn(e),
        o = Qn(t),
        a = Gn(Zn((a = In * o - On * i) * a + (a = On * r - Nn * o) * a + (a = Nn * i - In * r) * a), Nn *
          r + In * i + On * o);
      bn += a, wn += a * (Nn + (Nn = r)), Tn += a * (In + (In = i)), Cn += a * (On + (On = o)), L(Nn, In,
        On);
    }
    ...
    function G(e, t) {
      ...
      var n = Vn(t),
        ...
        d = a(l),
        f = l && -d / l;
      xn += f * s, Sn += f * c, An += f * u, bn += d, wn += d * (Nn + (Nn = r)), Tn += d * (In + (In = i)),
        Cn += d * (On + (On = o)), L(Nn, In, On);
    }
    ...
    function V(e) {
      ...
      var t = xn,
        ...
        r = An,
        i = t * t + n * n + r * r;
      return i < Pn && (t = wn, n = Tn, r = Cn, bn < Rn && (t = En, n = _n, r = $n), i = t * t + n * n + r *
        r, i < Pn) ? [NaN, NaN] : [Gn(n, t) * Hn, a(r / Zn(i)) * Hn];
    }
    ...
    function te(e, t, n, r, i, o) {
      if (n) {
        var a = Vn(t),
          s = Qn(t),
          c = r * n;
        null == i ? (i = t + r * jn, o = t - c / 2) : (i = ne(a, i), o = ne(a, o), (r > 0 ? i < o : i >
          o) && (i += r * jn));
        for (var u, l = i; r > 0 ? l > o : l < o; l -= c) u = y([a, -s * Vn(l), -s * Qn(l)]), e.point(u[0],
          u[1]);
      }
    }
    ...
    function se(e, t, n, r, i) {
      ...
      if (e.forEach(function(e) {
          if (!((t = e.length - 1) <= 0)) {
            ...
            s.push(n = new ae(r, e, null, !0)), c.push(n.o = new ae(r, null, n, !1)), s.push(n = new ae(a,
              e, null, !1)), c.push(n.o = new ae(a, null, n, !0));
          }
        }), s.length) {
    ...
    function le(e, t) {
      ...
      for (var u = 0, l = e.length; u < l; ++u)
        if (f = (d = e[u]).length)
          for (var d, f, h = d[f - 1], p = ue(h), m = h[1] / 2 + Fn, v = Qn(m), g = Vn(m), y = 0; y < f; ++
            y, p = $, v = C, g = x, h = E) {
            var E = d[y],
              $ = ue(E),
              w = E[1] / 2 + Fn,
              ...
              k = M > Ln,
              N = v * C;
            if (Er.add(Gn(N * A * Qn(M), g * x + N * Vn(M))), s += k ? S + A * jn : S, k ^ p >= n ^ $ >=
              n) {
              var I = _(b(h), b(E));
              T(I);
              var O = _(o, I);
          ...
          if (m.pop(), h.push(m), m = null, s)
            if (1 & i) {
              if (n = a[0], (t = n.length - 1) > 0) {
                for (b || (o.polygonStart(), b = !0), o.lineStart(), e = 0; e < t; ++e) o.point((r = n[
                  e])[0], r[1]);
                o.lineEnd();
              }
        ...
        var h,
          ...
          E = {
            ...
            polygonEnd: function() {
              ...
              var e = le(h, i);
              p.length ? (b || (o.polygonStart(), b = !0), se(p, he, e, r, o)) : e && (b || (o
                .polygonStart(), b = !0), o.lineStart(), r(null, null, 1, o), o.lineEnd()), b && (o
                .polygonEnd(), b = !1), p = h = null;
            },
            sphere: function() {
    ...
    function he(e, t) {
      return ((e = e.x)[0] < 0 ? e[1] - Un - Rn : Un - e[1]) - ((t = t.x)[0] < 0 ? t[1] - Un - Rn : Un - t[
        1]);
    }
    ...
    function pe(e) {
      ...
      return {
        ...
        point: function(o, a) {
          var s = o > 0 ? Ln : -Ln,
            c = zn(o - n);
          zn(c - Ln) < Rn ? (e.point(n, r = (r + a) / 2 > 0 ? Un : -Un), e.point(i, r), e.lineEnd(), e
            .lineStart(), e.point(s, r), e.point(o, r), t = 0) : i !== s && c >= Ln && (zn(n - i) <
            Rn && (n -= i * Rn), zn(o - s) < Rn && (o -= s * Rn), r = me(n, r, o, a), e.point(i, r), e
            .lineEnd(), e.lineStart(), e.point(s, r), t = 0), e.point(n = o, r = a), i = s;
        },
        lineEnd: function() {
          e.lineEnd(), n = r = NaN;
        },
    ...
    function me(e, t, n, r) {
      var i,
        o,
        a = Qn(e - n);
      return zn(a) > Rn ? qn((Qn(t) * (o = Vn(r)) * Qn(n) - Qn(r) * (i = Vn(t)) * Qn(e)) / (i * o * a)) : (
        t + r) / 2;
    }

    function ve(e, t, n, r) {
      var i;
      if (null == e) i = n * Un, r.point(-Ln, i), r.point(0, i), r.point(Ln, i), r.point(Ln, 0), r.point(Ln,
        -i), r.point(0, -i), r.point(-Ln, -i), r.point(-Ln, 0), r.point(-Ln, i);
      ...
      function r(e) {
        ...
        return {
          ...
          point: function(d, f) {
            ...
            if (!t && (s = a = m) && e.lineStart(), m !== a && (h = i(t, p), (!h || oe(t, h) || oe(p,
                h)) && (p[2] = 1)), m !== a) l = 0, m ? (e.lineStart(), h = i(p, t), e.point(h[0], h[
              1])) : (h = i(t, p), e.point(h[0], h[1], 2), e.lineEnd()), t = h;
            else if (u && t && c ^ m) {
              var g;
              v & r || !(g = i(p, t, !0)) || (l = 0, c ? (e.lineStart(), e.point(g[0][0], g[0][1]), e
                .point(g[1][0], g[1][1]), e.lineEnd()) : (e.point(g[1][0], g[1][1]), e.lineEnd(), e
                .lineStart(), e.point(g[0][0], g[0][1], 3)));
      ...
      function i(e, t, n) {
        ...
        if (!(C < 0)) {
          ...
          var O = k - M,
            D = zn(O - Ln) < Rn,
            R = D || O < Rn;
          if (!D && I < N && (A = N, N = I, I = A), R ? D ? N + I > 0 ^ S[1] < (zn(S[0] - M) < Rn ? N : I) :
            N <= S[1] && S[1] <= I : O > Ln ^ (M <= S[0] && S[0] <= k)) {
            var P = w(v, (-g + x) / T);
            return $(P, p), [S, y(P)];
          }
        }
        ...
        if (a = i - s, h || !(a < 0)) {
          ...
          if (a = r - c, p || !(a > 0)) {
            ...
            if (a = o - c, p || !(a < 0)) {
              ...
              return d > 0 && (e[0] = s + d * h, e[1] = c + d * p), f < 1 && (t[0] = s + f * h, t[1] = c +
                f * p), !0;
            }
          }
        }
    ...
    function be(e, n, r, i) {
      ...
      function s(t, i) {
        return zn(t[0] - e) < Rn ? i > 0 ? 0 : 3 : zn(t[0] - r) < Rn ? i > 0 ? 2 : 1 : zn(t[1] - n) < Rn ?
          i > 0 ? 1 : 0 : i > 0 ? 3 : 2;
      }
      ...
      function u(e, t) {
        var n = s(e, 1),
          r = s(t, 1);
        return n !== r ? n - r : 0 === n ? t[1] - e[1] : 1 === n ? e[0] - t[0] : 2 === n ? e[1] - t[1] : t[
          0] - e[0];
      }
      return function(s) {
        function u(e, t) {
        ...
        function l() {
          for (var t = 0, n = 0, r = g.length; n < r; ++n)
            for (var o, a, s = g[n], c = 1, u = s.length, l = s[0], d = l[0], f = l[1]; c < u; ++c) o = d,
              a = f, l = s[c], d = l[0], f = l[1], a <= i ? f > i && (d - o) * (i - a) > (f - a) * (e -
              o) && ++t : f <= i && (d - o) * (i - a) < (f - a) * (e - o) && --t;
          return t;
        }
        ...
        function f() {
          ...
          (n || r) && (s.polygonStart(), n && (s.lineStart(), a(null, null, 1, s), s.lineEnd()), r && se(
            v, c, e, a, s), s.polygonEnd()), S = s, v = g = y = null;
        }
    ...
    function Ee() {
      ...
      return n = {
        ...
        extent: function(s) {
          return arguments.length ? (r = +s[0][0], i = +s[0][1], o = +s[1][0], a = +s[1][1], e = t =
            null, n) : [
            [r, i],
            [o, a]
          ];
    ...
    function Me(e, t) {
      for (var n, r, i, o = 0, a = e.length; o < a; o++) {
        ...
        if (o > 0 && (i = xe(e[o], e[o - 1]), i > 0 && n <= i && r <= i && (n + r - i) * (1 - Math.pow((n -
            r) / i, 2)) < Pn * i)) return !0;
        n = r;
      }
      return !1;
    ...
    function Pe() {
      ...
      function n() {
        return t.range(Wn(a / g) * g, o, g).map(h).concat(t.range(Wn(l / y) * y, u, y).map(p)).concat(t
          .range(Wn(i / m) * m, r, m).filter(function(e) {
            return zn(e % g) > Rn;
      ...
      return e.lines = function() {
        ...
        return arguments.length ? (a = +t[0][0], o = +t[1][0], l = +t[0][1], u = +t[1][1], a > o && (t =
          a, a = o, o = t), l > u && (t = l, l = u, u = t), e.precision(b)) : [
          [a, l],
          [o, u]
        ];
      }, e.extentMinor = function(t) {
        return arguments.length ? (i = +t[0][0], r = +t[1][0], c = +t[0][1], s = +t[1][1], i > r && (t =
          i, i = r, r = t), c > s && (t = c, c = s, s = t), e.precision(b)) : [
          [i, c],
          [r, s]
        ];
      }, e.step = function(t) {
        ...
        return arguments.length ? (b = +t, d = De(c, s, 90), f = Re(i, r, b), h = De(l, u, 90), p = Re(a,
          o, b), e) : b;
      }, e.extentMajor([
        [-180, -90 + Rn],
        [180, 90 - Rn]
    ...
    function Ze(e, t) {
      var n = e - yr,
        r = t - br,
        i = Zn(n * n + r * r);
      Hr += i * (yr + e) / 2, Br += i * (br + t) / 2, zr += i, i = br * e - yr * t, qr += i * (yr + e),
        Gr += i * (br + t), Vr += 3 * i, Ge(yr = e, br = t);
    }
    ...
    function ot(e, t) {
      function n(e) {
        return e && ("function" == typeof o && i.pointRadius(+o.apply(this, arguments)), f(e, r(i))), i
          .result();
      }
      var r,
        i,
      ...
      return n.area = function(e) {
        ...
        return arguments.length ? (i = null == e ? (t = null, new rt()) : new et(t = e), "function" !=
          typeof o && i.pointRadius(o), n) : t;
    ...
    function ut(e, t, n) {
      ...
      return e.scale(150).translate([0, 0]), null != r && e.clipExtent(null), f(n, e.stream(Lr)), t(Lr
        .result()), null != r && e.clipExtent(r), e;
    }
      ...
      function n(r, i, o, s, c, u, l, d, f, h, p, m, v, g) {
        ...
        if (E > 4 * t && v--) {
          var _ = s + h,
            ...
            N = M - i,
            I = b * k - y * N;
          (I * I / E > t || zn((y * k + b * N) / E - .5) > .3 || s * h + c * p + u * m < ni) && (n(r, i, o,
            s, c, u, A, M, x, _ /= T, $ /= T, w, v, g), g.point(A, M), n(A, M, x, _, $, w, l, d, f, h, p,
            m, v, g));
        }
      }
      return function(t) {
        ...
        function o(r, i) {
          var o = b([r, i]),
            a = e(r, i);
          n(g, y, v, E, _, $, g = a[0], y = a[1], v = r, E = o[0], _ = o[1], $ = o[2], ti, t), t.point(g,
            y);
        }
    ...
    function _t(e) {
      ...
      return t.stream = function(e) {
          ...
          return arguments.length ? (M = null == e ? (A = s = c = u = null, Fe) : be(A = +e[0][0], s = +e[0]
            [1], c = +e[1][0], u = +e[1][1]), i()) : null == A ? null : [
            [A, s],
            [c, u]
          ];
        }, t.scale = function(e) {
          ...
          return arguments.length ? (E = e[0] % 360 * Bn, _ = e[1] % 360 * Bn, $ = e.length > 2 ? e[2] %
            360 * Bn : 0, r()) : [E * Hn, _ * Hn, $ * Hn];
        }, t.angle = function(e) {
    ...
    function Tt(e, t) {
      ...
      return n.invert = function(e, t) {
        var n = s - t,
          r = Gn(e, zn(n)) * Jn(n);
        return n * i < 0 && (r -= Ln * Jn(e) * Jn(n)), [r / i, a((o - (e * e + n * n) * i * i) / (2 *
        i))];
      }, n;
    }
    ...
    function xt() {
      return Ct().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-.6,
        38.7
      ]);
    }
    ...
    function At() {
      ...
      return e.invert = function(e) {
        var t = c.scale(),
          ...
          r = (e[0] - n[0]) / t,
          i = (e[1] - n[1]) / t;
        return (i >= .12 && i < .234 && r >= -.425 && r < -.214 ? u : i >= .166 && i < .234 && r >= -
          .214 && r < -.115 ? l : c).invert(e);
      }, e.stream = function(e) {
        ...
        return arguments.length ? (c.scale(t), u.scale(.35 * t), l.scale(t), e.translate(c.translate())) :
          c.scale();
    ...
    function Rt(e) {
      ...
      return o.scale = function(e) {
        ...
        return arguments.length ? (null == e ? l = n = r = i = null : (l = +e[0][0], n = +e[0][1], r = +e[
          1][0], i = +e[1][1]), t()) : null == l ? null : [
          [l, n],
          [r, i]
        ];
      }, t();
    ...
    function zt(e, t) {
      var n = a(li * Qn(t)),
        r = n * n,
        i = r * r * r;
      return [e * Vn(n) / (li * (ai + 3 * si * r + i * (7 * ci + 9 * ui * r))), n * (ai + si * r + i * (ci +
        ui * r))];
    }
    ...
    function Wt() {
      ...
      return t.invert = function(e) {
        ...
        return arguments.length ? (b = null == t ? (m = i = o = a = null, Fe) : be(m = +t[0][0], i = +t[0]
          [1], o = +t[1][0], a = +t[1][1]), e()) : null == m ? null : [
          [m, i],
          [o, a]
        ];
      }, t.scale = function(t) {
    ...
    function Yt(e, t) {
      var n = t * t,
        r = n * n;
      return [e * (.8707 - .131979 * n + r * (-.013791 + r * (.003971 * n - .001529 * r))), t * (1.007226 +
        n * (.015085 + r * (-.044475 + .028874 * n - .005916 * r)))];
    }
    ...
    var nn,
      ...
      sr = {
        ...
        polygonEnd: function() {
          or.polygonEnd(), sr.point = C, sr.lineStart = S, sr.lineEnd = A, rr < 0 ? (cn = -(ln = 180),
            un = -(dn = 90)) : ar > Rn ? dn = 90 : ar < -Rn && (un = -90), gn[0] = cn, gn[1] = ln;
        },
        sphere: function() {
          cn = -(ln = 180), un = -(dn = 90);
        }
    ...
    var ur,
      ...
      Wr = {
        ...
        result: function() {
          var e = Vr ? [qr / Vr, Gr / Vr] : zr ? [Hr / zr, Br / zr] : jr ? [Ur / jr, Fr / jr] : [NaN,
          NaN];
      ...
      point: function(e, t) {
        switch (this._point) {
          ...
          case 1:
            ...
            break;
          default:
            null == this._circle && (this._circle = it(this._radius)), this._string.push("M", e, ",", t,
              this._circle);
        }
      },
      result: function() {
    ...
    zt.invert = function(e, t) {
        for (var n, r, i, o = t, s = o * o, c = s * s * s, u = 0; u < di && (r = o * (ai + si * s + c * (
              ci + ui * s)) - t, i = ai + 3 * si * s + c * (7 * ci + 9 * ui * s), o -= n = r / i, s = o * o,
            c = s * s * s, !(zn(n) < Pn)); ++u);
        ...
        do {
          var o = r * r,
            a = o * o;
          r -= n = (r * (1.007226 + o * (.015085 + a * (-.044475 + .028874 * o - .005916 * a))) - t) / (
            1.007226 + o * (.045255 + a * (-.311325 + .259866 * o - .005916 * 11 * a)));
        } while (zn(n) > Rn && --i > 0);
        return [e / (.8707 + (o = r * r) * (-.131979 + o * (-.013791 + o * o * o * (.003971 - .001529 *
          o)))), r];
      ...
      .geoAzimuthalEqualAreaRaw = ii, e.geoAzimuthalEquidistant = It, e.geoAzimuthalEquidistantRaw = oi, e
      .geoBounds = R, e.geoCentroid = V, e.geoCircle = re, e.geoClipAntimeridian = _r, e.geoClipCircle = ge,
      e.geoClipExtent = Ee, e.geoClipRectangle = be, e.geoConicConformal = Ut, e.geoConicConformalRaw = Lt,
      e.geoConicEqualArea = Ct, e.geoConicEqualAreaRaw = Tt, e.geoConicEquidistant = Bt, e
      .geoConicEquidistantRaw = Ht, e.geoContains = Oe, e.geoDistance = xe, e.geoEqualEarth = qt, e
      .geoEqualEarthRaw = zt, e.geoEquirectangular = jt, e.geoEquirectangularRaw = Ft, e.geoGnomonic = Vt, e
      .geoGnomonicRaw = Gt, e.geoGraticule = Pe, e.geoGraticule10 = Le, e.geoIdentity = Wt, e
      .geoInterpolate = Ue, e.geoLength = Ce, e.geoMercator = Dt, e.geoMercatorRaw = Ot, e
      .geoNaturalEarth1 = Kt, e.geoNaturalEarth1Raw = Yt, e.geoOrthographic = Qt, e.geoOrthographicRaw = Xt,
      e.geoPath = ot, e.geoProjection = Et, e.geoProjectionMutator = _t, e.geoRotation = ee, e
      .geoStereographic = Zt, e.geoStereographicRaw = Jt, e.geoStream = f, e.geoTransform = at, e
