...
function(module, exports, require) {
  ...
  function o() {
    for (var e = 1; e < arguments.length; e++) {
      var t = arguments[e];
      if (t)
        for (var n in t) t.hasOwnProperty(n) && (L(t[n]) ? arguments[0][n] = t[n].slice() : arguments[0][n] =
          t[n]);
    }
    return arguments[0];
  }
  ...
  var L = Array.isArray || function(e) {
    ...
    U = function() {
      function e(t) {
        (0, l.default)(this, e), this.INDEXEDDB = I.INDEXEDDB, this.LOCALSTORAGE = I.LOCALSTORAGE, this
          .WEBSQL = I.WEBSQL, this._defaultConfig = o({}, R), this._config = o({}, this._defaultConfig, t),
          this._driverSet = null, this._initDriver = null, this._ready = !1, this._dbInfo = null, this
          ._wrapLibraryMethodsWithReady(), this.setDriver(this._config.driver);
      }
      return (0, f.default)(e, [{
        ...
        value: function(e) {
          if ("object" === ("undefined" == typeof e ? "undefined" : (0, c.default)(e))) {
            ...
            for (var t in e) "storeName" === t && (e[t] = e[t].replace(/\W/g, "_")), this._config[t] =
              e[t];
        ...
        value: function(e, t, n) {
          var r = new A.default(function(t, n) {
            try {
              ...
              "_support" in e && (l = e._support && "function" == typeof e._support ? e
              ._support() : A.default.resolve(!!e._support)), l.then(function(n) {
                P[r] = n, N[r] = e, t();
              }, n);
            } catch (e) {
              n(e);
        ...
        value: function(e, t, n) {
          ...
          return this._driverSet = s.then(function() {
            ...
            return o._dbInfo = null, o._ready = null, o.getDriver(e).then(function(e) {
              o._driver = e._driver, r(), o._wrapLibraryMethodsWithReady(), o._initDriver = i(
                a);
            });
          }).catch(function() {
            r();
