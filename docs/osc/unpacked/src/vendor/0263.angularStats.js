...
// ==================================================================
// VENDOR MODULE 263
// directive angularStats | defines angular.module("angularStats")
// webpack factory params: module, exports, require
// ------------------------------------------------------------------

function(module, exports, require) {
  ! function(t, r) {
    module.exports = r(require(24));
  }(this, function(e) {
    return function(e) {
      function t(r) {
      ...
      function s(e) {
        if (e !== !1 && e.autoload || (sessionStorage.removeItem(S), localStorage.removeItem(S), e !==
            !1)) return e.position = e.position || "top-left", e = C.extend({
          htmlId: null,
          rootScope: void 0,
      ...
      function c(e) {
        ...
        function a(t, n) {
          ...
          if (O = m(n) ? O : n, p.text(I).css({
            ...
            f > 0 && (f = 0, s.fillStyle = "#333", s.fillRect(g.width - 1, 0, 1, g.height)), s
              .fillStyle = o, s.fillRect(g.width - 1, Math.max(0, g.height - i), 2, 2);
          }
        }
        ...
        function c() {
          if (l.active) {
            ...
            e.putImageData(t, 0, 0), e.fillStyle = f++ > 2 ? "black" : "#333", e.fillRect(g.width - 1,
              0, 1, g.height);
          }
        }
        e = void 0 !== e ? e : {};
        ...
        if (A && (A.$el && A.$el.remove(), A.active = !1, A = null), e = s(e)) {
          ...
          l.$el = C.element("<div" + h +
              "><canvas></canvas><div><span></span> | <span></span></div></div>").css(e.styles), d
            .append(l.$el);
          ...
          return P.digestLength.ngStatsAddToCanvas = function(e) {
            ...
            a(e);
          }, t("digest", P.digestLength), t("watches", P.watchCount, !0), n("digest", P
            .digestLength), n("watches", P.watchCount, !0), c(), x.$$phase || x.$digest(), u;
        }
      }
          ...
          link: function(n, r, o) {
            function a() {
              if (o.hasOwnProperty("digestLength")) {
                var e = r;
                o.digestLength && (e = C.element(r[0].querySelector(o.digestLength))), P
                  .digestLength["ngStatsDirective" + f] = function(t) {
            ...
            function s() {
              if (o.hasOwnProperty("watchCount")) {
                var t,
                  i = r;
                if (n.watchCount && (i = C.element(r[0].querySelector(o.watchCount))), n
                  .watchCountRoot)
            ...
            function c() {
              o.hasOwnProperty("onWatchCountUpdate") && (P.watchCount["ngStatsDirectiveUpdate" +
                f] = function(e) {
            ...
            function u() {
              o.hasOwnProperty("onDigestLengthUpdate") && (P.digestLength[
                "ngStatsDirectiveUpdate" + f] = function(e) {
            ...
            function l() {
              delete P.digestLength["ngStatsDirectiveUpdate" + f], delete P.watchCount[
                  "ngStatsDirectiveUpdate" + f], delete P.digestLength["ngStatsDirective" + f],
                delete P.watchCount["ngStatsDirective" + f];
            }
            i();
            var f = t++;
