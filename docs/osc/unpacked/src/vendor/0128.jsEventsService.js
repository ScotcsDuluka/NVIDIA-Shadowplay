...
// ==================================================================
// VENDOR MODULE 128
// service jsEventsService | provider jsEventsEndpoints | constant EVENTS_DATA | constant EVENTS_DB_NAMES | constant EVENTS_RETURN_CODE | constant GDPR_LEVEL | constant USER_CONSENT_LEVEL | constant GDPR_CONSENT | constant PLATFORM_TYPE | defines angular.module("nvJsEvents")
...
function(module, exports, require) {
  ...
  var i = require(26),
    ...
    c = require(25),
    u = r(c);
  angular.module("nvJsEvents", ["nvAngularHttpEndpoint", "crimson", "underscore", "nvDbService",
    "ngEventAggregator"
    ...
    return {
      ...
      $get: ["NvEndpointFactory", "$q", "$http", "$log", function(a, s, c, u) {
        ...
        h.info("jsEventsEndpoints created"), f.setUrlGenerator(function(n) {
          return h.info("server" + t), n.url.startsWith("/dev/") ? t + n.url : t + "/" + e + n
            .url;
          ...
          var n = {};
          return null != t && hasOwnProperty.call(t, "sync") && (t.sync === !0 && (n.sync = !0),
            delete t.sync), n;
          ...
          if (e.sync) {
            try {
              ...
              r.open("POST", e.url, !1), r.setRequestHeader("Content-Type",
                "application/json;charset=UTF-8"), r.setRequestHeader("X-Event-Protocol",
                "1.1"), r.onload = function(e) {
                n.resolve({});
  ...
  }]), angular.module("nvJsEvents").service("jsEventsService", ["jsEventsEndpoints", "$log", "EVENTS_DATA",
    "_", "dbService", "EVENTS_DB_NAMES", "dbCacheService", "EVENTS_RETURN_CODE", "$interval", "$window",
    "GDPR_LEVEL", "USER_CONSENT_LEVEL", "GDPR_CONSENT", "PLATFORM_TYPE", "$q",
    function(e, t, n, r, i, a, c, l, d, f, h, p, m, v, g) {
      ...
      function $() {
        pe.timerPromise && d.cancel(pe.timerPromise), pe.timerPromise = null, fe.event(
      ...
      function T(e, t, n, r) {
        ...
        return i.getGlobalStore(t).getItem(n).then(function(a) {
          var s = {},
            c = function(e) {
              if (fe.event("jsEvents backlog response", e), 0 === s.eventsToBeSent) return i
                .getGlobalStore(t).removeItem(n), o.resolve();
            },
            u = function(e) {
              return fe.error("Failed to send backlog events for :", n, t, ".ErrorInfo: status", e
                .status), o.reject("error");
            };
          ...
          }, void w(s)) : (e !== p.FULL && fe.event("cannot send for backlog key", n, e, a), i
            .getGlobalStore(t).removeItem(n), o.resolve());
        }).catch(function(e) {
          return fe.event("detail data not available for backlog key", n), i.getGlobalStore(t)
      ...
      function C(e, t, n, r) {
        ...
        var i = g.defer(),
          ...
          s = {},
          c = function(e) {
            if (fe.event("jsEvents wls backlog response", e), 0 === s.eventsToBeSent) return E(t, (0, u
              .default)(n)), i.resolve();
          },
          l = function(e) {
            return fe.error("Failed to send wls backlog events for :", n, ".ErrorInfo: status", e.status),
              i.reject();
          };
        ...
        }, w(s), i.promise) : (fe.event("nothing to send for backlog key", n, e), E(a
          .EVENTS_DETAIL_STORE, (0, u.default)(n)), E(a.EVENTS_DETAIL_STORE_TECHNICAL, (0, u.default)(
          n)), E(a.EVENTS_DETAIL_STORE_BEHAVIORAL, (0, u.default)(n)), i.resolve());
      }
        ...
        i.getGlobalStore(a.EVENTS_COMMON_STORE).getItem(e).then(function(t) {
          t && t.common ? x(e.userId || "undefined", !1).then(function(n) {
            var r,
              o,
              s = null;
            t.common.gdprTechOptIn = pe.getString(n.technical), t.common.gdprBehOptIn = pe
              .getString(n.behavioral), t.common.deviceGdprTechOptIn = pe.getString(ae.technical),
              t.common.deviceGdprBehOptIn = pe.getString(ae.behavioral), r = T(n.functional, a
                .EVENTS_DETAIL_STORE, e, t), o = T(n.technical, a.EVENTS_DETAIL_STORE_TECHNICAL,
                e, t), s = T(n.behavioral, a.EVENTS_DETAIL_STORE_BEHAVIORAL, e, t), g.all([r, o,
                s]).then(function() {
      ...
      function A(e) {
        ...
        t ? x(e.userId || "undefined", !1).then(function(n) {
          ...
          s.common.gdprTechOptIn = pe.getString(n.technical), s.common.gdprBehOptIn = pe.getString(n
            ...
            .deviceGdprBehOptIn = pe.getString(ae.behavioral), r = C(n.functional, a
              .EVENTS_DETAIL_STORE, e, s), i = C(n.technical, a.EVENTS_DETAIL_STORE_TECHNICAL, e, s),
            o = C(n.behavioral, a.EVENTS_DETAIL_STORE_BEHAVIORAL, e, s), g.all([r, i, o]).then(
              function() {
                E(a.EVENTS_COMMON_STORE, (0, u.default)(e));
              });
        }) : (fe.event("nothing to send for wls backlog key", e), E(a.EVENTS_COMMON_STORE, (0, u
          .default)(e)));
      }
      ...
      function M() {
        ...
        fe.event("cleanUpDbStore excluding session for", e), i.getGlobalStore(a.EVENTS_COMMON_STORE)
          .iterate(function(t, n, r) {
            if (fe.event("Key#", r, "key ", n), "_version" === n) fe.event("_version to be skipped", n);
            else {
              var i = JSON.parse(n);
              "" === i.sessionId || i.sessionId === e.sessionId ? fe.event("key not to be processed",
                i) : S(n);
            }
          }).then(function() {
      ...
      function k() {
        ...
        for (n = 0; n < f.localStorage.length; ++n)
          if (t = f.localStorage.key(n), t.match("^" + a.EVENTS_COMMON_STORE)) {
            ...
            "" === r.sessionId || r.sessionId === e.sessionId ? fe.event("key not to be processed", r) :
              A(r);
          }
      }
      ...
      function D(e, t, n, r) {
        ...
        var i = c.getCachedGlobalItem(t, n),
          o = {},
          a = function(e) {
            0 === o.eventsToBeSent && null === pe.timerPromise && _(), fe.event(
              "jsEvents batched response", e);
            var r = JSON.parse(e.config.data);
            O(r.events, t, n);
          },
          s = function(e) {
            0 === o.eventsToBeSent && null === pe.timerPromise && _(), fe.error(
              "Failed to send events for :", n, ".ErrorInfo: status", e.status);
          };
        e === p.FULL && r && i && i.events && i.events.length > 0 ? (o = {
          ...
          }, $(), w(o)) : e !== p.FULL && (ce === !0 || "undefined" === ee) && i && i.events && i.events
          .length > 0 && (fe.event("deleting events as userConsent is", e), i.events.splice(0, i.events
            .length), i.persist_());
      }
      ...
      function R(e) {
        var t = ["Windows", "Win16", "Win32"],
          ...
          i = ["Android"],
          o = r.findWhere(t, e);
        return o ? v.WINDOWS : (o = r.findWhere(n, e)) ? v.MAC : (o = r.findWhere(i, e), o ? v.ANDROID : v
          .WINDOWS);
      }

      function P() {
        var e = angular.merge({}, n.EVENT_COMMON);
        return e.clientId = e.clientId.replace("{CLIENTID}", Q), e.clientVer = e.clientVer.replace(
            "{CLIENTVER}", J), e.deviceId = e.deviceId.replace("{DEVICEID}", Z), e.userId = e.userId
          .replace("{USERID}", ee), e.sessionId = e.sessionId.replace("{SESSIONID}", te), e
          .eventSchemaVer = e.eventSchemaVer.replace("{EVENTSCHEMAVER}", ne), e.platform = R(f.navigator
            .platform), null != e.platform && (e.eventProtocol = "1.1"), e;
      }
      ...
      function L(e, t, n) {
        ...
        return !(c.length !== l.length && !n) && r.every(t, function(t, i) {
          return "object" === ("undefined" == typeof t ? "undefined" : (0, o.default)(t)) ?
            "object" === (0, o.default)(e[i]) && L(e[i], t, n) : r.has(e, i);
        });
      }

      function U(e) {
        var t = angular.merge({}, n.EXPERIENCE_CONTROL_EXPERIMENT_CONTEXT);
        return L(e, t, !1) === !1 ? (fe.event("mismatch", t, e), l.INVALID_EXPERIMENT_FORMAT) : (angular
          .merge(t, e), t);
      }

      function F(e) {
        var t = angular.merge({}, n.EXPERIENCE_CONTROL_EXPERIMENT);
        return L(e, t, !0) === !1 ? (fe.event("mismatch", t, e), l.INVALID_EXPERIMENT_FORMAT) : (angular
          .merge(t, e), t);
      }
      ...
      function j(e) {
        ...
        return fe.event("experiments for key", n, e), n.length > 0 && (t = n), fe.event(
          "activeExperiments", t), t;
      }
      ...
      function B() {
        pe.offline || angular.equals(ae, m.NONE) || "unknown" === le ? fe.info(
          "Device offline or No Functional consent. No clean job happened.", ae) : (_(), M(), k(),
          ue = !1);
      }
      ...
      function q(e, t) {
        ...
        var i = [];
        i.push(e), n.gdprTechOptIn = oe.technical, n.gdprBehOptIn = oe.behavioral, n.deviceGdprTechOptIn =
          pe.getString(ae.technical), n.deviceGdprBehOptIn = pe.getString(ae.behavioral), n.events = i;
      ...
      function G(e, t, n) {
        ...
        e.gdprLevel === h.TECHNICAL && (s = a.EVENTS_DETAIL_STORE_TECHNICAL), e.gdprLevel === h
          .BEHAVIORAL && (s = a.EVENTS_DETAIL_STORE_BEHAVIORAL);
        var l;
      ...
      pe.offline = !1, pe.defaultErrorCallback = function(e) {
        ...
        if (t && t.common) x(ee || "undefined", !0).then(function(n) {
          t.common.gdprTechOptIn = pe.getString(n.technical), t.common.gdprBehOptIn = pe.getString(n
            ...
            .deviceGdprBehOptIn = pe.getString(ae.behavioral), D(n.functional, a
              .EVENTS_DETAIL_STORE, e, t), D(n.technical, a.EVENTS_DETAIL_STORE_TECHNICAL, e, t), D(
              n.behavioral, a.EVENTS_DETAIL_STORE_BEHAVIORAL, e, t);
        });
        ...
        if (fe.event("experienceControlInfo IDb", n), o) {
          ...
          if (s) {
            var d = o.indexOf(s);
            if (d !== -1) return fe.event("experienceControlInfo already exist"), l
        ...
        if (n && n.experiments && n.experiments.length > 0) {
          ...
          if (i) {
            ...
            o !== -1 && (fe.event("matching experiment found"), n.experiments.splice(o, 1), n
            .persist_());
        ...
        r.forEach(e, function(e) {
          ...
          fe.event("previously cached consent", n.userConsent), n.userConsent = e.userConsent, n
            .persist_(), fe.event("updated consent", e.userConsent);
        }), ce = !0, B();
        ...
        !te && e.clientSessionId && (ue = !0), Q = e.clientProductId, J = e.clientProductVer, te = e
          .clientSessionId, Z = e.clientDeviceId, ee = e.clientUserId, se = !1, ne = e.eventSchemaVer,
          Z && fe.info("Device Id:", Z, "set for client:", Q), H(), x(ee, !0);
        var t = (0, u.default)({
            sessionId: te || "undefined",
            userId: ee || "undefined"
          }),
        ...
        i = n, b(a.EVENTS_COMMON_STORE, t, i), pe.offline || angular.equals(ae, m.NONE) || "unknown" ===
          le ? fe.info("Device offline or No Functional consent. No clean job happened.", ae) : (_(),
            ue && (M(), k(), ue = !1));
      }, this.sendEventDetail = function(t, n, i) {
        if (de === !0) return l.SWITCH_AND_PURGE_IN_PROGRESS;
        if (t && n) {
          if (i = i || {}, i && !i.anonymize && angular.equals(ae, m.NONE) || n && r.isUndefined(n
              .gdprLevel)) return fe.info("Functional consent not received, discarding event", t, n
              .gdprLevel), r.isFunction(i.afterDone) && i.afterDone(), l
          ...
          if ("unknown" !== le && t.immediateRequest === !0 && pe.offline === !1) {
            ...
            if (a = i && i.anonymize ? p.FULL : V(n.gdprLevel), fe.event(
                "attempting to send immediate event for userId:", ee, " userconsent: ", oe), a !== p
              .FULL) return ee && "undefined" !== ee && se === !1 ? (W(n, o, i), fe.event(
              "Event stored as userConsent not synced yet", a, se)) : (r.isFunction(i.afterDone) &&
              i.afterDone(), fe.error("Event cannot be sent due to reason:", a)), a;
            var s = q(n, i);
            ...
            i.appExit === !0 && (c.sync = !0), e.sendEvent(c, s).then(function(e) {
              ...
              fe.error("Failed to send eventdata for:", t.name, ".ErrorInfo: status", e.status,
                ", data", e.config && e.config.data), W(n, o, i);
            });
          } else W(n, o, i);
          return l.OK;
        }
