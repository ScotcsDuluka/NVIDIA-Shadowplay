...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.nvCameraService = void 0;
  var o = require(8),
    r = i(o),
    a = require(370),
    l = i(a),
    ...
    c = require(64),
    u = i(c),
    f = require(2) /* app/2 — WINDOW_STYLES (constant) */;
  require(17) /* app/17 — localSdk (provider) */, require(12) /* app/12 — oscDisplayService (service) */, require(91) /* app/91 — gamepadService (service) */, require(25) /* app/25 — hardwareService (service) */, require(61) /* app/61 — settingsService (service) */, require(23) /* app/23 — oscNotificationService (service) */, require(4) /* app/4 — shadowPlayService (service) */, require(92) /* app/92 — gfwslService (service) */;
  var m = f.ngMainCommonModule.service("nvCameraService", ["$q", "$state", "$log", "$timeout", "$window",
    "$filter", "$http", "$interval", "eventAggregator", "gfwslService", "socketService",
    "oscDisplayService", "shadowPlayService", "oscNotificationService", "nvCameraEndpoints",
    "settingsService", "telemetryService", "gamepadService", "hardwareService", "cefService",
    "oscService", "nisEndpoints", "dvcEndpoints", "HOTKEY_EVENTS", "NVCAMERA_EVENTS",
    "NOTIFIER_SELECTIONS", "COMMON_EVENTS", "SHADOWPLAY_EVENTS", "OSC_CONFIG",
    ...
    "TELEMETRY_OSC_ANSEL_GAMEPAD_TYPE", "TELEMETRY_OSC_TRIGGER_MODE", "NVCAMERA_MODE",
    "TELEMETRY_OSC_MENU_TYPE", "NVCAMERA_STATUS", "TELEMETRY_OSC_AVAILABLE_STATUS",
    "TELEMETRY_OSC_FILTER_CONTROL_TYPES", "TELEMETRY_OSC_SCREEN_STATE", "OSC_KEYBOARD",
    function(e, t, n, i, o, a, s, c, f, m, g, p, h, b, x, v, y, w, S, E, k, T, C, O, A, I, M, R, P, D, N,
      L, F, U, z, G, V, H, B, Y, $, W, j, K) {
      function q(t) {
        ...
        return Ke.callbackMap.set("captureControlChange", function(e) {
          i.cancel(Yt), Yt = void 0, Ke.callbackMap.delete("captureControlChange"), r.resolve(e), qe
            .info("Capture control successfully set to ", t), Ce();
          ...
          qe.info("Set Capture control: ", e.status), Yt && i.cancel(Yt), Yt = i(function() {
            r.reject(Ht.NVCAMERA_TIMED_OUT), Ke.callbackMap.delete("captureControlChange"), t &&
              xt && (Wt = {}, Wt.time = new Date().getTime(), Wt.modeType = at), qe.info(
      ...
      function X() {
        ...
        if (xt) {
          ...
          var o = !1;
          n.then(function(t) {
            return t === Y.OK || t === Y.OK_MODSONLY || t === Y.ALREADY_ENABLED ? (t !== Y
              .ALREADY_ENABLED && (o = !0), Ke.captureScreenshot("regular", !1)) : e.reject(!1);
          }).then(function() {
            if (t = a("translate")("l10n.screenshot"), b.show(I
                .PHOTOGRAPHIC_SCREENSHOT_SAVED_TO_GALLERY, t), o) {
              var e = Ce();
              jt = i(function() {
                xe(e);
              }, Qe);
            ...
            qe.info("NvCamera session declined for hdrScreenshot ", e), b.show(I
            .HDR_ERROR_SCREENSHOT);
          });
      ...
      function Z() {
        kt && _t > 0 && (Ke.modsSlots[_t - 1] = se(_t), Ke.lastActiveSlot = -1, Ke.lastSlot = -1, Ke
          .modsIsEnabled = !1, Ke.modsActiveSlot = void 0, qe.info("cleared filter slot ", _t), kt = !1,
          _t = void 0);
      }
      ...
      function Q(e, t, n) {
        ...
        var i,
          o = "";
        "LaunchFailure" === e ? (i = L.anselUILaunchFailure, at === H.gameFilter && yt++) : i = L
          .appNotSupported, x.getNvCameraConfigValues().then(function(e) {
            o = "isUILaunchError:" + n + ", isNvCameraOnBus:" + xt + ", isAttemptTooEarly:" + fn +
              ", fatalErrorCode:" + wt + ", IPCenabledRegkey:" + e.data.ipcEnabled +
              ", FreestyleEnabledRegkey:" + e.data.freestyleEnabled + ", IsFirstFreestyleFailure:" + (
                1 === yt) + ", isSLI:" + sn + ", graphicsAPI:" + dn + ", reason:" + t + ", cmsId:" + gt,
              Me(i, o, at, n);
          });
      }
      ...
      function te() {
        ...
        return S.getSystemInfo().then(function(t) {
          if (t) return !(parseFloat(t.DriverVersion, 10) < e) || (qe.info(
            "AnselLite min driver failed", t.DriverVersion), !1);
        });
      }

      function ne() {
        return v.getExperimentalSetting().then(function(e) {
          return it = (!Ke.hasVariableAvailability() || e) && bt, dt = P.anselLite && it, te().then(
            function(e) {
              return dt = dt && e, Ve().then(function(e) {
                return pt = e, qe.info("isRTXUpResAvailable: ", pt), x.setIPCEnabled({}, {
                  enable: it
                }).then(function() {
                  f.trigger(A.AVAILABILITY_CHANGED), qe.info("Setting Ansel HKeys status: ",
                    it);
                  ...
                  if (qe.info("NvCamera setConfig failed:", e), it && e.data && e.data
                    .code) {
      ...
      function ie() {
        qe.info("refreshStateVariables"), Ke.UIRunning = !1, Ke.modsIsEnabled = !1, Ke.modsActiveSlot =
          void 0, Qt = -1, Ke.lastActiveSlot = -1, Ke.lastSlot = -1, Ke.setupFilterStackEvents(!1), cn = !
          1, gn = !1, en = void 0, $t = void 0, Wt = void 0, wt = 0, kt = !1, _t = void 0, Ke
          .checkReshadeSupport(), Pe();
      }
      ...
      function oe() {
        ...
        n = 0 === yt ? "NeverFailed" : 0 === vt ? "AlwaysFailed" : "SometimesFailed", r += n, r +=
          ", Attempts:" + t + ", Failures:" + yt;
      ...
      function re(e) {
        qe.info("onGameAppExit invoked. UIRunning = " + Ke.getUIRunning() + " ,app proc ID " + e
          .exitedAppPID), ut === e.exitedAppPID && (ut = void 0), ft === e.exitedAppPID && (qe.info(
      ...
      function ae(e) {
        qe.info("onGameAppStarted invoked", e), gt = e.startedAppCmsID, ut && ut === ft || (le().then(
            function(t) {
              qe.info(" HTTP chroma response ", (0, r.default)(t.data)), t.data && t.data.data ? (
              Tt = [], Ct = [], t.data.data.forEach(function(e) {
                e.isFreeStyleSupported === !1 && Tt.push(e.cms_appId), e.isDeepDVCAllowed === !
                  1 && Ct.push(e.cms_appId);
              }), ct = !Tt.includes(gt), Ke.isdeepDVCChromaAllowListed = !Ct.includes(gt), ct && (
                ft = e.startedAppPID), Ke.isdeepDVCChromaAllowListed && (mt = e.startedAppPID)) : (
                ct = !!Tt && !Tt.includes(gt), ct && (ft = e.startedAppPID), Ke
                .isdeepDVCChromaAllowListed = !!Ct && !Ct.includes(gt), Ke
                .isdeepDVCChromaAllowListed && (mt = e.startedAppPID)), gt || (Ke
                .isdeepDVCChromaAllowListed = !1);
            },
            function(t) {
              403 === t.status || 404 === t.status ? (ct = !!Tt && !Tt.includes(gt), ct && (ft = e
                    .startedAppPID), Ke.isdeepDVCChromaAllowListed = !!Ct && !Ct.includes(gt), Ke
                  .isdeepDVCChromaAllowListed && (mt = e.startedAppPID)) : (ct = !1, Ke
                  .isdeepDVCChromaAllowListed = !1), gt || (Ke.isdeepDVCChromaAllowListed = !1), qe
                .info("HTTP chroma request failed", t);
            }), qe.info(" HTTP chroma isFreeStyleChromaWhilteListed ", Ke
          .isFreeStyleChromaWhilteListed), qe.info(" HTTP chroma isdeepDVCChromaAllowListed ", Ke
            .isdeepDVCChromaAllowListed));
      }
      ...
      function ce() {
        function t() {
          qe.info("loadSlot for game: ", en), Ke.persistSlots[en] && "Desktop" !== en || (qe.info(
              "Filter persistSlots data not present for game"), Ke.persistSlots[en] = de()), Jt[en] &&
            "Desktop" !== en || (qe.info("modsData not present for game"), Jt[en] = {
              modsIsEnabled: !1,
              lastSlot: -1
        ...
        return Ke.callbackMap.set("procInfo", function(e) {
          Ke.callbackMap.delete("procInfo"), i.cancel(a), e && e.procPath && (e.procPath.length > 1 &&
            (en = e.procPath), e.procId && (ut = e.procId)), t(), r.resolve(!0);
      ...
      function fe(e) {
        if (qe.info("applySetOfFiltersAndAttributes, isSetMultipleFilterAPISupported:", Ot), Ot) Ke
          ...
          for (var t = 0; t < e.length; t++) St ? Ke.setFilterAndAttributes(e[t], t) : Ke.setFilterType(e[
            t].id, t);
      }
      ...
      function me(t) {
        Ke.modsSlots.forEach(function(e) {
            ...
            e.activeFilterStack.forEach(function(t) {
              ...
              visibleInCombo: !0
            }), e.activeFilterStack.length > 0 ? (e.activeFilter = e.activeFilterStack[0], e
              .activeIndex = 0) : (e.activeFilter = void 0, e.activeIndex = -1);
          }), f.off(A.FILTERS, me), f.trigger(A.MODS_FILTERS_LOADED, t), Qt >= 0 && Qt <= Ke
          .NUM_MODS_SLOTS - 1 ? Ke.applySlot(Ke.modsSlots[Qt]) : Qt != Ke.ANSEL_MOD_SLOT ? Ke.applySlot(
            void 0) : (nn = e.defer(), Pe()), Qt = -1, rn && rn.resolve();
      }

      function ge(e) {
        if (qe.info("Mods Filter Settings"), e.id === tt || !Ke.modsActiveSlot) return void(e.stackIdx ==
          on && Pe());
        ...
        return i ? (e.controls.forEach(function(t) {
          ...
          if ("pulldown" === t.type ? t.dataType = "int" : Array.isArray(i.savedConfigs[r]) || (i
            ...
            for (var a = 0; a < t.currentValue.length; a++) t.currentValue[a] = o(t.currentValue[
              a]), t.minValue[a] = o(t.minValue[a]), t.maxValue[a] = o(t.maxValue[a]), t
              .defaultValue[a] = o(t.defaultValue[a]), t.stepSize[a] = o(t.stepSize[a]), 0 === t
              .stepSize[a] && (t.stepSize[a] = t.maxValue[a] / 100);
          var l = void 0 !== i.savedConfigs[r];
          if (l) Ke.setFilterAttribute(n, e.stackIdx, t.id, i.savedConfigs[r], t.type, t.dataType),
            "pulldown" === t.type ? t.currentId = i.savedConfigs[r][0] : t.currentValue = i
            .savedConfigs[r];
            ...
            for (var s = !1, a = 0; a < t.currentValue.length; a++) {
              ...
              t.currentValue[a] > t.maxValue[a] && (t.currentValue[a] = t.maxValue[a]), t
                .currentValue[a] < t.minValue[a] && (t.currentValue[a] = t.minValue[a]), t
                .currentValue[a] !== d && (s = !0);
            }
          ...
          "Current filter application response , index : ", e.stackIdx), void(e.stackIdx == on && (
        Pe(), qe.info("Mods filterslot application complete")))) : void qe.info(
          "attributes against unknown filter: ", e);
      }

      function pe() {
        (Ke.lastActiveSlot < 0 || Ke.lastActiveSlot >= Ke.NUM_MODS_SLOTS) && (Ke.lastActiveSlot = 0), (Ke
          .lastSlot < 0 || Ke.lastSlot >= Ke.NUM_MODS_SLOTS) && (Ke.lastSlot = 0);
      }

      function he(e) {
        return !k.onlineState || k.onlineState.online !== !0 || ct && ut === ft ? !(!k.onlineState || k
          .onlineState.online !== !1 || !Et || e) && (qe.info(
          "Feature not available in offline mode for this app"), !0) : (qe.info(
          "Feature not available, app blacklisted in ChromaDB"), !0);
      }
      ...
      function be(t, n) {
        ...
        return Ke.callbackMap.set("available", function(n) {
          if (i.cancel(Kt), Ke.callbackMap.delete("available"), n) {
            ...
            if ("sdk" == t) {
              if (n.indexOf(t) === -1) {
                ...
                if (he(n.indexOf("allowOffline") !== -1)) return void o.reject(Ht
                  .FEATURE_NOT_AVAILABLE);
                r = !1;
              } else at = H.gamePhoto, r = !0;
            } else if (n.indexOf(t) === -1 || he(n.indexOf("allowOffline") !== -1)) return void o
              .reject(Ht.FEATURE_NOT_AVAILABLE);
          ...
          qe.info("getAvailableFlag status = ", e.status), Kt = i(function() {
            o.reject(Ht.NVCAMERA_TIMED_OUT), Ke.callbackMap.delete("available"), xt && ($t = {},
              $t.modeType = at, $t.time = new Date().getTime());
          }, r);
        }), o.promise;
      }
      ...
      function ve(t) {
        ...
        return t ? x.getFreeStyleSupportForGame({}, {
          ...
          return qe.info("getFreeStyleSupportForGame response : ", e), n.isFreeStyleWhiteListed = e
            .data.freestyleWhitelisted, n.isAnselWhiteListed = e.data.anselWhitelisted, n;
        }, function(e) {
      ...
      function ye(e, t) {
        ...
        return at === H.anselLite && e === Ht.FEATURE_NOT_ENABLED ? void te().then(function(e) {
          return e ? void(Ke.hasVariableAvailability() || (i = I.WARNING_SUPPORTED_GAME_REQUIRED, n(
            i))) : (o = a("translate")("l10n.openAnsel"), void n(I.FEATURE_UPDATE_DRIVER, o));
        }) : void h.appCaptureProcessInfo(r).then(function(o) {
          return sn = parseInt(m.isSLIDevice()), dn = o.graphicsAPI, qe.info("drsInfo = ", o), sn &&
            9 === dn || 1 === dn ? (n(I.WARNING_SUPPORTED_GAME_REQUIRED), Q("Unsupported", e, t),
              void qe.info("Unsupported config error [graphicsAPI, isSLI] = ", dn, sn)) : void(e ===
              Ht.SESSION_NOT_ALLOWED ? n(I.WARNING_PHOTOGRAPHY_NOT_ALLOWED) : e === Ht
              .NVCAMERA_ERROR ? (n(I.ERROR_NVCAMERA_LAUNCH_FAILED), Q("LaunchFailure", e, t)) : ve(o
                .drsName).then(function(o) {
                var r = !1;
                r = o.isFreeStyleWhiteListed, r && ct ? (i = I.ERROR_NVCAMERA_LAUNCH_FAILED, n(i),
                  Q("LaunchFailure", e, t)) : (Ke.getSharpnessSliderSupport() || Ke
                  .getVibranceSliderSupport() ? we(!0, !0) : (i = I
                    .WARNING_SUPPORTED_GAME_REQUIRED, n(i)), Q("Unsupported", e, t));
              }));
        }).catch(function() {
      ...
      function we(n, i) {
        function o() {
          return at = H.gameFilter, Ke.modsIsEnabled && !n ? be("mods").then(function() {
            ...
            if (i === Y.OK || i === Y.OK_MODSONLY || i === Y.ALREADY_ENABLED) return ce().then(
              function() {
                if (Ke.modsSupported = !0, !n) return pe(), Qt = Ke.lastSlot, Ke.enableModsMode(
                  !0).then(function() {
                  return xe(!0);
                });
                var e = {
            ...
            if (!Ke.getSharpnessSliderSupport() && !Ke.getVibranceSliderSupport()) return e.reject(
              i);
        ...
        return n = n || !1, i = i || !1, qe.info("Mods toggle launchUI = ", n, ", useRelaxedTimeout = ",
            i), Ke.isModsOn() ? Ke.hasVariableAvailability() || Ke.modsEnableStatus ? cn ? e.when(!1) : Ke
          .UIRunning ? (qe.info("NvCamera UI already up"), e.when(!1)) : (cn = !0, o().then(function() {
          ...
          })) : (n && ("uiTrigger" === rt ? p.openOSC("main.preferences.mods") : b.show(I.ENABLE_MODS)),
            qe.info("Mods is disabled by user, returning"), e.when(!1)) : e.when(!1);
      }
      ...
      function Se(t) {
        function n(t) {
          ...
          return be("mods").then(function(i) {
            return i !== Y.OK && i !== Y.OK_MODSONLY ? e.reject(i) : (pe(), n = void 0 === t ||
              null === t ? (Ke.lastActiveSlot + 1) % Ke.NUM_MODS_SLOTS : t, Ke.enableModsMode(!0));
          }).then(function() {
        ...
        return Ke.isModsOn() && (Ke.hasVariableAvailability() || Ke.modsEnableStatus) ? !Ke
          .modsIsEnabled || Ke.UIRunning || cn ? e.when(!1) : (Ke.modsActiveSlot && (Ft.currentSlotID = Ke
            .modsActiveSlot.id, Ft.currentSlotFilters = Ke.getStackedFilterDisplayNames(Ke
              .modsActiveSlot)), cn = !0, at = H.gameFilter, n(t).then(function() {
            cn = !1, vt++, qe.info("Mods slot switch successfull"), Ke.modsActiveSlot && (Ft
                .newSlotID = Ke.modsActiveSlot.id, Ft.newSlotFilters = Ke
                .getStackedFilterDisplayNames(Ke.modsActiveSlot), y.push(D
                  .OSC_FREESTYLE_FILTERS_SLOT_CHANGED, Ft)), h.getModsActiveStatus() && Ke
              .sendModsAppliedTelemetry();
          }, function(e) {
        ...
        wt = 0, $t = void 0, Wt = void 0, Ke.isGfeAnselSupported().then(function(t) {
          ...
          if (un = !0, mn && i.cancel(mn), fn = !0, mn = i(function() {
            ...
            Ke.callbackMap.set("getAvailableForAnselPoster", function(t) {
              Ke.callbackMap.delete("getAvailableForAnselPoster"), i.cancel(Kt), t && t.indexOf(
                "sdk") !== -1 && (ke().then(function(e) {
                200 !== e.status && qe.error(
                "Ansel App process info could not be fetched.");
      ...
      function Ce() {
        var e = !1;
        return Ke.modsActiveSlot && Ke.modsActiveSlot.activeFilterStack && Ke.modsActiveSlot
          .activeFilterStack.length > 0 && (e = !0), h.setModsActiveStatus(e), e;
      }

      function Oe(n) {
        function i() {
          return rt = n, Ke.isOn() ? (y.startPerf(U.anselBringup), Ke.sendStartTimerTelemetry(D
            .OSC_MENU_LAUNCH), qe.info("launching NvCamera UI: "), be("sdk").then(function(n) {
            if (n === Y.OK || n === Y.OK_ANSEL || n === Y.ALREADY_ENABLED || n === Y.OK_MODSONLY &&
              dt && at === H.anselLite) return ce().then(function() {
              var e = {
                lastState: t.current.name,
                lastParams: t.params,
            ...
            n === Y.PROCESS_DECLINED || n === Y.OK_MODSONLY ? (i = Ht.SESSION_NOT_ALLOWED, qe.info(
              "NvCamera not allowed: ", n)) : (i = Ht.NVCAMERA_ERROR, qe.info("NvCamera error: ",
              n));
      ...
      function Ae(t) {
        return Ke.hasVariableAvailability() || Ke.modsEnableStatus ? void i(function() {
          ...
          })) : (Ke.modsIsEnabled && Ke.lastSlot > -1 && (Ke.modsIsEnabled = !1, Ke.modsActiveSlot =
            void 0, i = !0), n = e.when(!0)), n.then(function() {
            return i ? (qe.info("Applying mods filter slot", Ke.lastSlot + 1), void we(!1, !0)
              .finally(function() {
                et = Ze, qe.info("Mods automatic filter application complete"), Nt
                  .persistedFilters = $.yes;
              })) : void(et = Ze);
          });
      ...
      function Ie(e) {
        "started" === e.screenshot ? (Ke.shotCount = e.shotCount, Ke.percentDone = 0, f.trigger(A
            .SCREENSHOT_CAPTURE_STARTED)) : "progress" === e.screenshot ? (Ke.currentShot = e.currentShot,
            Ke.percentDone = Ke.currentShot / Ke.shotCount * 100, f.trigger(A
              .SCREENSHOT_CAPTURE_INPROGRESS, Ke.percentDone)) : "shotFinished" === e.screenshot ? (Ke
            .percentDone = 100, f.trigger(A.SCREENSHOT_CAPTURE_INPROGRESS, Ke.percentDone), i(function() {
              f.trigger(A.SCREENSHOT_CAPTURE_FINISHED), f.trigger(A.SCREENSHOT_CAPTURE_DONE, e
                .captureType);
            }, 500)) : "finished" === e.screenshot ? f.trigger(A.SCREENSHOT_CAPTURE_FILE_WRITE_DONE, e) :
          "cancel" === e.screenshot ? void 0 !== Ke.callbackMap.get("cancelScreenshotCapture") ? Ke
          .callbackMap.get("cancelScreenshotCapture")(e.status) : qe.info("cancel: No callback") : e
          .status == Y.FAILED_TO_SAVE_SHOT_NO_SPACE_LEFT ? f.trigger(A.SCREENSHOT_CAPTURE_FAILED, {
      ...
      function Me(e, t, n, i) {
        qe.info("sendAnselErrorTelemetry errorValue:", e, " errorString:", t, ", mode:", n), i = i || Ke
          .UIRunning, S.getSystemInfo().then(function(o) {
      ...
      function Re(e) {
        if (_.isUndefined(e) || _.isNull(e) || _.isUndefined(e.type) || _.isNull(e.type)) return void qe
          .info("processNotifications: undefined or null data, data.type");
        qe.info("processNotifications: ", e);
        var t,
          n = !1;
        t = "errorResponse" === e.type ? Ke.errorTelemetryMap[e.errorType] : Ke.errorTelemetryMap[e
          .status];
        var i = "";
        if (t && (t !== L.appFatalError && t !== L.appNonFatalError || (i = "errorCode:" + e.code +
            " errorReason:" + e.errorReason + " filename and line:" + e.fileName + ": " + e.line, t ===
            L.appFatalError && (Ke.modsActiveSlot && Ke.modsActiveSlot.id > 0 && (qe.info(
                "Nvcamera meets fatal error, clearing slot no. ", Ke.modsActiveSlot.id,
                " on menu close"), kt = !0, _t = Ke.modsActiveSlot.id, Pe()), wt = e.code, "invalid" ===
              st ? n = !0 : st = "invalid")), n || Me(t, i, at)), "settingsList" === e.type)
          for (var o = 0; o < e.settings.length; o++) "SnapshotsDir" === e.settings[o].name && (ot = e
            .settings[o].value);
        ...
        } else if ("procInfo" === e.type) void 0 !== Ke.callbackMap.get(e.type) && Ke.callbackMap.get(e
          .type)(e);
        else if ("currentFilter" === e.type) e.status === Y.OK ? f.trigger(A.CURRENT_FILTER_SETTINGS, e) :
          e.status !== Y.ALREADY_SET || Ke.UIRunning !== !0 && Ke.modsIsEnabled !== !0 || (Ke
            .getCurrentFilterAttribute(e.stackIdx), Ke.modsIsEnabled && f.trigger(A
              .CURRENT_FILTER_SETTINGS, e));
        else if ("setFilterAttribute" === e.type) qe.info("setFilterAttribute: ", e.status);
        else if ("filterAndAttributes" === e.type) qe.info("setFilterAndAttributes for stackIndex " + e
            .stackIdx + " nvcamera status = " + (e.status === Y.OK ? "Success" : "Failure")), Ke
          .modsActiveSlot && f.trigger(A.MODS_FILTER_SETTINGS_READY, e), e.stackIdx != on || Ot || Pe();
          ...
          var d,
            u,
            m = function(e) {
              e.length > 0 && (b.show(I.WARNING_NVCAMERA_FILTER_DISPLAY_INFO, e[0]), e.length > 1 && c(
                function(t) {
          ...
          if (Ke.modsActiveSlot && (u = _.findIndex(Ke.modsActiveSlot.activeFilterStack, {
            ...
            }), u > -1 && (d = Ke.modsActiveSlot.activeFilterStack[u], e.status === Y
              .ERROR_FILEPARSING && (Ke.modsHelper.activateFilter(Ke.modsActiveSlot, d), Ke.modsHelper
                .removeActiveItem(Ke.modsActiveSlot), f.trigger(A.UPDATE_UI_DATA)))), on === u && Pe(),
            d && !d.isWarningMessageDisplayed) {
            for (qe.info("filter addition warning", e.messageStringsArray), d
              .isWarningMessageDisplayed = !0, e.messageStringsArray.shift(), o = 0; o < e
              .messageStringsArray.length; o++) e.messageStringsArray[o] = e.messageStringsArray[o]
              .replace(d.id, d.title);
      ...
      function De(e, t, n, i, o) {
        i.tabIndex = 0, i.id = t.id, i.textPosition = "header-right", i.footerLeft = t.minValue[n], i
          .footerRight = t.maxValue[n], i.range = {
            min: t.minValue[n],
            max: t.maxValue[n]
          }, i.uiRange = {
            min: t.uiMinValueV1 ? t.uiMinValueV1 : [t.uiMinValue],
            max: t.uiMaxValueV1 ? t.uiMaxValueV1 : [t.uiMaxValue]
          }, i.measureUnit = t.measureUnit || "", i.step = t.stepSize[n], i.default = t.defaultValue[n], i
          .value = t.currentValue[n], i.dataType = t.dataType, i.text = Ke.controlValue, i.dimension = n,
          "int" === t.dataType && (i.step = 1), i.onChange = function(n) {
            o && ("Brightness" === n.title ? o.brightness = Math.round(100 * n.value) : "Contrast" === n
              .title ? o.contrast = Math.round(100 * n.value) : "Vibrance" === n.title ? o.vibrance =
              Math.round(100 * n.value) : "Sketch" === n.title ? o.sketch = Math.round(100 * n.value) :
              "Color enhancer" === n.title ? o.colorEnhancer = Math.round(100 * n.value) :
              "Vignette" === n.title ? o.vignette = Math.round(100 * n.value) : o
              .filterAttributesValues = (100 * n.value).toString());
            var i = Ke.modsHelper.activateFilter(Ke.modsActiveSlot, e),
              r = "" + e.id + "#" + t.id;
            e.savedConfigs[r][n.dimension] = n.value, Ke.setFilterAttribute(e.id, i, n.id, e.savedConfigs[
              r], t.type, t.dataType);
          };
      }

      function Ne(e, t, n, i) {
        i.id = t.id, i.dataType = t.dataType, i.dimension = n, i.value = t.currentValue[n], i.min = t
          .minValue[n], i.max = t.maxValue[n], i.step = .01, i.placeholderText = "", i.onChange =
          function(n) {
            var i = parseFloat(n.value),
              o = Ke.modsHelper.activateFilter(Ke.modsActiveSlot, e),
              r = "" + e.id + "#" + t.id;
            e.savedConfigs[r][n.dimension] = i, Ke.setFilterAttribute(e.id, o, n.id, e.savedConfigs[r], t
              .type, t.dataType);
          };
      }
      ...
      function Le() {
        ...
        qe.info("Registering nvcamera notification events"), g.register(e, t), f.on(t, Re), f.on(M
            ...
            .CHECK_AND_INIT_ACTION, _e), f.on(R.HDR_SCREENSHOT, X), f.on(O.NVCAMERAUI, Oe), f.on(O
            .MODS_TOGGLE, we), f.on(O.MODS_CYCLE, Se), f.on(O.MODS_PRESET1, Fe), f.on(O.MODS_PRESET2, Ue),
          f.on(O.MODS_PRESET3, ze), f.on(O.MODS_SHOWUI, Ee), f.on(M.ONLINE, Ge);
      }
      ...
      function Ge() {
        return bt = !1, it = !1, m.getFeature(lt).then(function(e) {
          ...
          return qe.error("GFWSL endpoint failed, proceed with OSC initialization", e), bt = P
            .nvCamera, ne();
        });
      }
      ...
      function Ye(e) {
        qe.info("sendImageSharpeningTelemetry: ", e), Gt.controlValue = e, Gt.CMSId = gt, E
          .isInDesktopMode().then(function(e) {
            Gt.gameLaunchMode = e === !0 ? j.desktop : j.fullscreen, qe.info(
              "Inside sendImageSharpeningTelemetry: ", Gt), y.push(D
              .OSC_ANSEL_FILTER_CONTROL_SETTINGS, Gt);
          });
      }
      ...
      Ke.errorTelemetryMap = (je = {}, (0, u.default)(je, Y.FAILED_TO_START, L.failedToStart), (0, u
        .default)(je, Y.NO_SPACE_LEFT, L.noSpaceLeft), (0, u.default)(je, Y.PERMISSION_DENIED, L
        .permissionDenied), (0, u.default)(je, Y.INVALID_REQUEST, L.invalidRequest), (0, u.default)(
        je, Y.FAILED_TO_PROCESS, L.failedToProcess), (0, u.default)(je, Y.PROCESS_DECLINED, L
        .processDeclined), (0, u.default)(je, Y.ALREADY_ENABLED, L.alreadyEnabled), (0, u.default)(je,
        Y.ALREADY_DISABLED, L.alreadyDisabled), (0, u.default)(je, Y.OUT_OF_RANGE, L.outOfRange), (0,
        u.default)(je, Y.ALREADY_SET, L.alreadySet), (0, u.default)(je, Y.INCOMPATIBLE_VERSION, L
        .incompatibleVersion), (0, u.default)(je, Y.APP_FATAL_ERROR, L.appFatalError), (0, u.default)(
        je, Y.APP_NON_FATAL_ERROR, L.appNonFatalError), (0, u.default)(je, Y
        .NGX_FEATURE_NOT_SUPPORTED, F.ngxFeatureNotSupported), (0, u.default)(je, Y.NGX_OUT_OF_DATE, F
        .ngxOutOfDate), (0, u.default)(je, Y.NGX_OUT_OF_GPU_MEMORY, F.ngxOutOfGpuMemory), (0, u
        .default)(je, Y.SCREENSHOT_TIMEOUT_FAILURE, F.timeoutFailure), (0, u.default)(je, Y
        .SCREENSHOT_GENERIC_FAILURE, F.generalFailure), je);
      var Ht = {
      ...
      Ke.sendStartTelemetry = function() {
        y.endPerfAfterDigest(U.anselBringup), y.startTimer(D.OSC_ANSEL_NAVIGATION), y.push(D
          .OSC_ANSEL_TYPE, {
            type: N.full
          }), st = "valid";
        ...
        e = e ? $.yes : $.no, t = t ? $.yes : $.no, n = n ? $.yes : $.no, i || (i = G.None), qe.info(
          "Input used for navigation ? [keyboard, mouse, gamepad, controllerType]", Dt.KEYBOARD, Dt
          .MOUSE, Dt.GAMEPAD, i);
        ...
        e === D.OSC_MENU_LAUNCH ? y.startTimer(D.OSC_MENU_LAUNCH) : e === D
          .OSC_ANSEL_SCREENSHOT_CANCELLED && y.startTimer(D.OSC_ANSEL_SCREENSHOT_CANCELLED);
      }, Ke.sendEndTimerTelemetry = function(e, t) {
        var n = V.hotkey,
          i = "";
        i = "nvcamera" === t ? B.ansel : "nvcameralite" === t ? B.ansellite : B.freestyle;
        var o = "";
        "uiTrigger" === rt && (n = V.ui), e === D.OSC_ANSEL_SCREENSHOT_CANCELLED && E.isInDesktopMode()
          .then(function(t) {
            Lt.gameLaunchMode = t === !0 ? j.desktop : j.fullscreen, e === D
              .OSC_ANSEL_SCREENSHOT_CANCELLED && y.endTimer(D.OSC_ANSEL_SCREENSHOT_CANCELLED, {
                info: Lt
              });
          ...
          }), "nvcamera" === t || "nvcameralite" === t ? h.sendHotkeyTelemetry(h.HotkeyShortcuts
            .NVCAMERAUI) : (h.sendHotkeyTelemetry(h.HotkeyShortcuts.MODSUI), h.sendHotkeyTelemetry(h
            .HotkeyShortcuts.MODSPRESETCYCLE));
      }, Ke.sendScreenshotParams = function(e) {
        Lt = e;
      }, Ke.sendScreenshotTelemetry = function(e) {
        E.isInDesktopMode().then(function(t) {
          Lt.gameLaunchMode = t === !0 ? j.desktop : j.fullscreen, e === D
            .OSC_ANSEL_SCREENSHOT_STARTED && y.push(D.OSC_ANSEL_SCREENSHOT_STARTED, Lt);
        });
      ...
      Ke.hasVariableAvailability = function() {
            ...
            n.forEach(function(e) {
              if (e && e.controls && e.controls.length) {
                ...
                n && (o.filterName = n[0]), o.CMSId = gt, e.controls.forEach(function(e) {
                  ...
                  var t = 0;
                  "sidebar-slider" === e.type ? (o.controlType = W.slider, t = J(e.value, e
                      .range.min, e.range.max, e.measureUnit)) : "sidebar-boolean" === e.type ?
                    (o.controlType = W.boolean, t = 1 == e.value ? 1 : 0) : (o.controlType = W
                      .unknown, t = e.value), t && (o.controlValue = Math.round(100 * (
                      parseFloat(t) + l.default)) / 100), E.isInDesktopMode().then(function(e) {
        ...
        for (var e = {
          ...
          if (Ke.modsSlots[t] && Ke.modsSlots[t].activeFilterStack.length > 0) switch (e.usedSlots++,
            t) {
            case 0:
        ...
        return Ke.modsActiveSlot ? (e.activeSlot = Ke.modsActiveSlot.id, e.activeFilters = Ke
          .getStackedFilterDisplayNames(Ke.modsActiveSlot)) : e.activeSlot = 0, qe.info(
          "modSlotsInfo : ", e), e;
      }, Ke.sendModsAppliedTelemetry = function(e) {
        Ke.modsActiveSlot && 0 !== Ke.modsActiveSlot.activeFilterStack.length && S.getSystemInfo().then(
          function(t) {
            var n = e ? "Yes" : "No";
            Nt.gameName = "DDVersion: " + t.DriverVersion + ", usingMenu = " + n;
            var i = Ke.getModsSlotInfo();
            i && (Ke.sendFilterTelemetry(i.slot1Filters, 1, "mods"), Ke.sendFilterTelemetry(i
                .slot2Filters, 2, "mods"), Ke.sendFilterTelemetry(i.slot3Filters, 3, "mods"), Nt
              .usedSlots = i.usedSlots, Nt.slot1Filters = i.slot1Filters, Nt.slot2Filters = i
              .slot2Filters, Nt.slot3Filters = i.slot3Filters, Nt.activeSlot = i.activeSlot, Nt
              .activeFilters = i.activeFilters, "Yes" === n ? Nt.usedMenu = $.yes : Nt.usedMenu = $
              .no), S.getSystemInfo().then(function(e) {
              e && (Nt.installedDDVersion = e.DriverVersion), 0 !== Nt.activeSlot && (qe.info(
                  "modsAppliedTelemetryParam:", Nt), y.push(D.OSC_FREESTYLE_FILTERS_APPLIED,
                Nt));
      ...
      Ke.setModsStatusToNvcamera = function(e) {
        return x.setModsEnabled({}, {
          ...
          Ke.modsEnableStatus = e, p.setLocalStorage(qt, e), qe.info(
            "setModsStatusToNvcamera enable  = ", e);
      ...
      Ke.applySlot = function(t) {
        ...
        Ke.modsActiveSlot = t;
        var n;
        return n = t && Ot && 0 !== t.activeFilterStack.length ? e.resolve(200) : Ke.resetEntireStack(),
          n.then(function(e) {
            return 200 !== e ? void Pe() : (t ? (t.id - 1 !== Ke.ANSEL_MOD_SLOT && (Ke
                  .lastActiveSlot = t.id - 1, Ke.lastSlot = t.id - 1), t.activeFilterStack.length >
                0 && (on = Math.max(on, t.activeFilterStack.length - 1), fe(t.activeFilterStack))) :
              Ke.lastActiveSlot = -1, void(on < 0 && Pe()));
          }).catch(function(e) {
        ...
        activateFilter: function(e, t) {
          return e ? (e.activeFilter = t, e.activeIndex = _.indexOf(e.activeFilterStack, e
            .activeFilter), e.activeIndex) : -1;
        },
        addCurrentFilter: function(t) {
          ...
          return Ke.setFilterType(o, i).then(function(e) {
            qe.info("Current filter response received, slot index : ", i), 0 === i && (t
                .activeFilter = t.selectedFilter), t.selectedFilter.visibleInCombo = !1, t
              .activeFilterStack.push(t.selectedFilter), Ke.modsHelper.activateFilter(t, t
                .selectedFilter), t.selectedFilter = void 0;
            for (var n = _.indexOf(t.filters, t.selectedFilter), o = !1; !o && ++n < t.filters
              .length;) t.filters[n].visibleInCombo && (t.selectedFilter = t.filters[n], o = !0);
            for (; !o && --n >= 0;) t.filters[n].visibleInCombo && (t.selectedFilter = t.filters[
              n], o = !0);
          });
        },
        ...
        moveActiveItemDown: function(t) {
          ...
          if (!t || !t.activeFilter || t.activeIndex === t.activeFilterStack.length - 1) return e
            .when(!1);
          var i = t.activeIndex;
        ...
        removeActiveItem: function(t) {
          ...
          t.activeFilter.visibleInCombo = !0, t.activeFilter.isWarningMessageDisplayed = !1, t
            .selectedFilter || (t.selectedFilter = t.activeFilter);
          var n = t.activeIndex;
          return t.activeFilterStack.splice(n, 1), fe(t.activeFilterStack), Ke.resetFilterAtIdx(t
            .activeFilterStack.length), n >= t.activeFilterStack.length && (n = t.activeFilterStack
            .length - 1), n >= 0 ? Ke.modsHelper.activateFilter(t, t.activeFilterStack[n]) : (t
            .activeFilter = void 0, t.activeIndex = -1), e.when(!0);
        },
        ...
        downDisabled: function(e) {
          var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
          return t ? this.upDisabled(e) : !e || !e.activeFilter || e.activeIndex >= e
            .activeFilterStack.length - 1;
        },
      ...
      Ke.setupFilterStackEvents = function(e) {
        e !== ln && (e ? (f.on(A.FILTERS, me), f.on(A.CURRENT_FILTER_SETTINGS, ge)) : (f.off(A.FILTERS,
          me), f.off(A.CURRENT_FILTER_SETTINGS, ge)), ln = e);
        ...
        return t === Ke.modsIsEnabled ? e.when(!0) : t ? v.getLanguage().then(function(e) {
          ...
          return Ke.modsIsEnabled = !0, rn = e.defer(), Ke.getSupportedFilterTypes().then(
        function() {
      ...
      Ke.sendAnselScreenshotErrorTelemetry = function(e) {
        qe.info("sendAnselScreenshotErrorTelemetry errorValue:", e), S.getSystemInfo().then(function(
        t) {
        ...
        var t = "#" == e.measureUnit ? "" : e.measureUnit,
          n = e.value;
        if (("#" === e.measureUnit || "" === e.measureUnit || "%" === e.measureUnit || "°" === e
            .measureUnit) && e.uiRange && void 0 !== e.uiRange.min && void 0 !== e.uiRange.max) {
          var i = (e.value - e.range.min) / (e.range.max - e.range.min) * (e.uiRange.max[e.dimension] -
            e.uiRange.min[e.dimension]) + e.uiRange.min[e.dimension];
          n = "%" === e.measureUnit || "°" === e.measureUnit ? Math.round(i) : Math.round(1e4 * i) /
          1e4;
        }
        return n + t;
        ...
        if ("slider" === e.type) {
          if (o.title = e.displayName, 1 === r) o.type = "sidebar-slider", De(t, e, 0, o, i);
            ...
            for (var a = 0; a < r; a++) {
              var l = {};
              De(t, e, a, l, i), l.title = e.controlDisplayName ? e.controlDisplayName[a] : "", o
                .subcontrols.push(l);
            }
          }
        } else if ("boolean" === e.type) e.currentValue = _.map(e.currentValue, function(e) {
            return 1 == e || e === !0;
          }), o.id = e.id, o.title = e.displayName, o.type = "sidebar-boolean", o.dimension = 0, o
          .default = nt, o.value = e.currentValue[o.dimension], o.dataType = e.dataType, o.onChange =
          function(i) {
            var o = Ke.modsHelper.activateFilter(Ke.modsActiveSlot, t);
            t.savedConfigs[n][i.dimension] = i.value, Ke.setFilterAttribute(t.id, o, i.id, t
              .savedConfigs[n], e.type, e.dataType);
          }, o.onKeyDown = function(e) {
            (o.value && e.keyCode === K.LEFT_ARROW || !o.value && e.keyCode === K.RIGHT_ARROW) && (o
              .value = !o.value, o.onChange(o)), Ke.setNavigationInputDevice(["keyboard"], [!0]);
          };
          ...
          for (var a = 0; a < r; a++) {
            var l = {};
            Ne(t, e, a, l), l.title = e.controlDisplayName ? e.controlDisplayName[a] : "", o.subcontrols
              .push(l);
          }
        }
        t.controls.push(o);
        ...
        return x.getMultipleFilterAPISupport().then(function(e) {
          Ot = e.data.isSetMultipleFilterAPISupported, qe.info("Multiple set filter API support: ",
            Ot);
        }, function(e) {
          qe.info("checkSetMultipleFilterAPISupport error: ", e);
        });
        ...
        if (_.isNull(It)) {
          ...
          It = t.then(function(e) {
            ...
            return qe.error("failed to get NIS state info", t), Ke.nisSystemSupport = !1, e.reject(
              t);
          }).finally(function() {
            It = null;
          });
        ...
        if (_.isNull(It)) {
          ...
          It = t.then(function(e) {
            qe.info("Sharpness For Desktop response: ", e), Ke.sharpnessValuesForGame(e.data
              .sharpen);
          }).catch(function(t) {
            return qe.error("failed to get nis state info", t), e.reject(t);
          }).finally(function() {
        ...
        if (_.isNull(Rt)) {
          ...
          Rt = t.then(function(e) {
            qe.info("DeepDVC system support response: ", e), Ke.deepDVCSystemSupport = e.data
              .supported;
          }).catch(function(t) {
            return qe.error("failed to get DeepDVC state info", t), Ke.deepDVCSystemSupport = !1, e
              .reject(t);
          }).finally(function() {
            Rt = null;
          });
        ...
        qe.info("sendDeepDVCTelemetry: ", e), Vt.controlValue = e, Vt.CMSId = gt, E.isInDesktopMode()
          .then(function(e) {
            Vt.gameLaunchMode = e === !0 ? j.desktop : j.fullscreen, y.push(D
              .OSC_ANSEL_FILTER_CONTROL_SETTINGS, Vt);
          });
      };
    }
  ]);
  exports.nvCameraService = m;
}
