...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.PreferencesPrivacyControlController = void 0;
  ...
  var o = i.ngMainModule.controller("PreferencesPrivacyControlController", ["$log", "$scope", "$state", "$q",
    "shadowPlayService", "broadcastService", "sdkService", "eventAggregator", "KEYBOARD_EVENTS",
    "OSC_KEYBOARD", "BROADCAST_STATES",
    function(e, t, n, i, o, r, a, l, s, d, c) {
      ...
      u.entries = {
        ...
        }, u.privacyControlStatus = !1, u.oldPrivacyControlStatus = !1, u.setPrivacyControlStatus =
        function() {
      ...
      u.initPreferencesPrivacyControl = function() {
        return m().then(function(e) {
          return u.settingsDisabled = e[0] || e[1] || e[3] || e[2] === c.ACTIVE || e[2] === c
            .PAUSED, o.getDesktopCaptureSupported();
        }).then(function(e) {
          return f.info("Privacy control supported: ", e), o.getDesktopCaptureEnabled();
        }).then(function(e) {
          f.info("Privacy control enabled: ", e), u.privacyControlStatus = e, u
            .oldPrivacyControlStatus = e;
        }, function(e) {
  ...
  exports.PreferencesPrivacyControlController = o;
}
