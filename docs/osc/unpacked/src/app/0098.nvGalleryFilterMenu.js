...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.nvGalleryFilterMenu = void 0;
  var r = require(3),
    a = o(r),
    l = require(1) /* app/1 — main (module) */,
    s = require(330),
    d = i(s);
  require(183) /* app/183 — GalleryFilterMenuController (controller) */, require(5) /* app/5 — hoverFocus (directive) */;
  var c = l.ngMainModule.directive("nvGalleryFilterMenu", ["$document", "$filter", "$window", "$log",
    function(e, t, n, i) {
      ...
      return {
        ...
        link: function(i, r, l) {
          ...
          var p = (g - (f + 60)).toFixed(0),
            h = g - p - 10;
          i.leftWidth = p.toString() + "px", i.rightWidth = h.toString() + "px", o.info("Left width: ",
            i.leftWidth), o.info("Right width: ", i.rightWidth);
        }
      };
    }
  ]);
  exports.nvGalleryFilterMenu = c;
}
