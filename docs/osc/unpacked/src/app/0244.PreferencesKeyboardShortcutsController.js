...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.PreferencesKeyboardShortcutsController = void 0;
  var r = require(109),
    a = o(r),
    l = require(375),
    s = o(l),
    d = require(3),
    c = i(d),
    u = require(1) /* app/1 — main (module) */;
  require(4) /* app/4 — shadowPlayService (service) */, require(34) /* app/34 — keyboardService (service) */, require(32) /* app/32 — broadcastService (service) */, require(12) /* app/12 — oscDisplayService (service) */, require(22) /* app/22 — octoolService (service) */;
  var f = u.ngMainModule.controller("PreferencesKeyboardShortcutsController", ["$q", "$log", "$scope",
    "$state", "$timeout", "$filter", "eventAggregator", "shadowPlayService", "$stateParams",
    "broadcastService", "keyboardService", "nvCameraService", "oscDisplayService", "octoolService",
    "KEYBOARD_EVENTS", "OSC_KEYBOARD", "NVCAMERA_EVENTS", "COMMON_EVENTS", "piplConfigService",
    function(e, t, n, i, o, r, l, d, u, f, m, g, p, h, b, x, v, y, w) {
      function S(e) {
        return d.getHotkeyShortcut(e.hotkeyId).then(function(t) {
          e.hotkeyKeys = t.keys, c.isUndefined(t.keys) ? e.hotkeyStr = "" : e.hotkeyStr = m
            .shortcutToStr(t.keys);
        }, function(t) {
      ...
      function O(e) {
        I.info("Connect status:", e.isConnectEnabled), A.isConnectEnabled = e.isConnectEnabled, A
          .categories.Broadcast.visible = A.isConnectEnabled, f.getCustomOverlaySupportType().then(
            function(e) {
              2 === e && (A.categories.BroadcastOverlays.visible = A.isConnectEnabled, c.each(A.shortcuts,
                function(e) {
      ...
      var A = this;
      A.title = "l10n.settings", A.icon = "icon-settings", A.status = "", A
        .showDuplicateShortcutMessage = !1, A.errorTxt = "", A.errorTimeout = null, A.minutesToSave = 5, A
        .errorDisplayTime = 3e3, A.isConnectEnabled = !1;
      ...
      A.categories = {
        ...
        w.isConnectEnabled().then(function(e) {
          ...
          t.push(d.setHotkeyMonitoringEnabled(!1).then(function(e) {}, function(e) {
            ...
            2 === t && (A.categories.BroadcastOverlays.visible = A.isConnectEnabled, c.each(A
              .shortcuts,
              function(e) {
                "l10n.toggleOverlay" === e.name && (e.catId = "BroadcastOverlays"),
                  "BroadcastOverlays" === e.catId && (e.visible = A.isConnectEnabled);
        ...
        return M[0] = 0, c.each(A.shortcuts, function(e) {
          var n = t && "" === e.hotkeyStr,
            ...
            l = n || i || o || a;
          e == c.first(A.shortcuts) || l || r.push(d.setHotkeyShortcut(e.hotkeyId, t ? M : e
            .default));
        ...
        return c.isEqual(t.hotkeyKeys, t.default) ? e.when() : void d.setHotkeyShortcut(t.hotkeyId, t
        ...
        if (A.selectedShortCut && !e.repeat && e.keyCode !== x.ENTER) {
          e.preventDefault(), e.stopImmediatePropagation(), e.stopPropagation(), A.errorTimeout && (o
            .cancel(A.errorTimeout), A.errorTimeout = null);
          var t = m.normalizeModifier(e.keyCode);
          M.indexOf(t) === -1 && M.push(t), I.debug("keyCode: " + e.keyCode + "(0x" + e.keyCode
            .toString(16) + "), key: " + e.key + ", normalized key: " + t + ", code: " + e.code +
            ", ctrlKey: " + e.ctrlKey + ", altKey: " + e.altKey + ", shiftKey: " + e.shiftKey +
            ", metaKey: " + e.metaKey + ", repeat: " + e.repeat + ", isModifierOnly: " + m
            .isModifierOnly(e));
        }
        ...
        if (!R && A.selectedShortCut && e.keyCode !== x.ENTER) {
          ...
          d.setHotkeyShortcut(i.hotkeyId, M).then(function(e) {
            ...
            I.error("ERROR in saving shortcut " + i.hotkeyId, e && e.data ? e.data.message : e), e
              .data.code === d.SHADOWPLAY_ERRORCODES.ET_INVALID_DATA && (A
                .showDuplicateShortcutMessage = !0, A.errorTxt = "l10n.keyboardShortcutUsedByGFN", A
                .errorTimeout = o(function() {
                  A.showDuplicateShortcutMessage = !1, A.errorTimeout = null;
        ...
        A.errorTimeout && (o.cancel(A.errorTimeout), A.errorTimeout = null), A.enableEscapeEvent(!1),
          l.off(v.AVAILABILITY_CHANGED, A.updateNvCameraVisibility), l.off(y.PIPL_CONFIG_UPDATED, O),
          d.setHotkeyMonitoringEnabled(!0).then(function(e) {}, function(e) {
            I.error("ERROR in enabling hotkey monitoring");
          });
      });
    }
  ]);
  exports.PreferencesKeyboardShortcutsController = f;
}
