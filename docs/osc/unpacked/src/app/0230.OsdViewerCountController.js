...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.OsdViewerCountController = void 0;
  var i = require(1) /* app/1 — main (module) */;
  require(35) /* app/35 — osdService (service) */;
  var o = i.ngMainModule.controller("OsdViewerCountController", ["$log", "$scope", "$element", "$timeout",
    "eventAggregator", "osdService", "shadowPlayEndpoints", "COMMON_EVENTS", "SHADOWPLAY_EVENTS",
    "CONNECT_EVENTS",
    function(e, t, n, i, o, r, a, l, s, d) {
      ...
      function f() {
        b.visible || (b.reactionCount = 0, b.commentCount = 0, b.viewerCount = 0, b.savedWidth = 0), b
          .visible = r.anythingBroadcasting, u();
      }
      ...
      var b = this;
      b.visible = !1, b.reactionCount = 0, b.reactions = [], b.commentCount = 0, b.savedWidth = 0, b
        .viewerCount = 0;
      e.getInstance("osc/ViewerCountController");
      o.on(l.OSD_SETTINGS_CHANGED, f), o.on(s.VIEWER_COUNT_UPDATE, m), o.on(d.FACEBOOK_REACTIONS, g), o
        .on(d.FACEBOOK_COMMENTS, p), h(), t.$on("$destroy", function() {
          o.off(l.OSD_SETTINGS_CHANGED, f), o.off(s.VIEWER_COUNT_UPDATE, m), o.off(d.FACEBOOK_REACTIONS,
            g), o.off(d.FACEBOOK_COMMENTS, p);
        });
    }
  ]);
  exports.OsdViewerCountController = o;
}
