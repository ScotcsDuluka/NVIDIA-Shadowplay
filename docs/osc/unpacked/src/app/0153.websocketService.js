    ...
    o = i.ngMainCommonModule.provider("websocketService", [function() {
      function e(e, t, n) {
        ...
        this.flush = function() {
          ...
          i.onopen = t, i.onclose = n, i.onmessage = r, i.onerror = a, o("opened mock server url=" + e),
      ...
      function t(e, t, n, i) {
        ...
        this.open = function() {
          n ? (o.webSocket = r[e], o.webSocket ? o.webSocket.mockOpen(c, u, f, m) : (a(
            "Cannot find mock server"), u())) : (o.webSocket = new WebSocket(e), o.webSocket.onopen =
            c, o.webSocket.onclose = u, o.webSocket.onmessage = f, o.webSocket.onerror = m);
        }, this.close = function() {
