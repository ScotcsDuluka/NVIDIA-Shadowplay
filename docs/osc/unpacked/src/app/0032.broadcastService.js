...
function(module, exports, require) {
  ...
  require(87), require(11), require(25) /* app/25 — hardwareService (service) */, require(4) /* app/4 — shadowPlayService (service) */, require(23) /* app/23 — oscNotificationService (service) */, require(20) /* app/20 — socketService (provider) */, require(12) /* app/12 — oscDisplayService (service) */;
  var c = require(304),
    u = o(c),
    f = require(305),
    m = o(f),
    g = require(306),
    p = o(g),
    h = d.ngMainCommonModule.service("broadcastService", ["$q", "$log", "$interval", "$timeout",
      "shadowPlayService", "keyboardService", "connectService", "shadowPlayEndpoints", "hardwareService",
      "oscService", "errorDialogService", "oscNotificationService", "socketService", "eventAggregator",
      "oscDisplayService", "telemetryService", "cefService", "NOTIFIER_SELECTIONS", "BROADCAST_STATES",
      "HOTKEY_EVENTS", "SHADOWPLAY_EVENTS", "TELEMETRY_OSC_EVENT_NAMES", "TELEMETRY_OSC_PERF_ID",
      "TELEMETRY_OSC_TOGGLE_STATE", "TELEMETRY_OSC_SCREEN_STATE", "TELEMETRY_OSC_QUALITY_SETTING",
      "TELEMETRY_OSC_MIC_MODE", "TELEMETRY_OSC_BOOLEAN_STATUS", "TELEMETRY_OSC_AVAILABLE_STATUS",
      "OSC_CONFIG",
      function(e, t, n, i, o, r, l, d, c, f, g, h, b, x, v, y, w, S, E, k, _, T, C, O, A, I, M, R, P, D) {
        function N(e) {
          ...
          e.status === !0 && (o.isBroadcastStartActive = !1, w.isInDesktopMode().then(function(e) {
            e ? (t ? ae = T.OSC_BROADCAST_TWITCH_SESSION_DURATION_DT : r && (ae = T
                ...
                .OSC_BROADCAST_TWITCH_SESSION_DURATION_FS : r && (ae = T
                  .OSC_BROADCAST_YOUTUBE_SESSION_DURATION_FS), be = A.fullscreen), ae && y
              .startBroadcast(ae);
          }), y.startBroadcast(T.OSC_SESSION), o.getWebcamShown().then(function(e) {
            e ? (t ? y.push(T.OSC_BROADCAST_TWITCH_CAMERA) : r && y.push(T
              .OSC_BROADCAST_YOUTUBE_CAMERA), xe.camera = O.on) : xe.camera = O.off;
          ...
          }, 60 * pe * 1e3)))), e.status === !1 && (oe || (oe = !0, X.stopBroadcast()), j(!1), oe = !1,
            angular.isDefined(Q) && n.cancel(Q), J = !1, ae && y.endBroadcast(ae), y.endBroadcast(T
              .OSC_SESSION, {
                provider: Z.name,
                screenState: be
        ...
        function F(e, t) {
          ...
          return o < 10 && (o = "0" + o), r < 10 && (r = "0" + r), a < 10 && (a = "0" + a), o + ":" + r +
            ":" + a;
        }
        ...
        function U(e) {
          ...
          var o = null;
          re ? re = !1 : ((t || n || i) && e.status === !0 ? (X._broadcastState = E.PAUSED, o = S
            .BROADCAST_PAUSED) : (t || n || i) && e.status === !1 ? (X._broadcastState = E.ACTIVE, o = S
            .BROADCAST_RESUMED) : te.error("broadcastPauseNotifier (other): ", e), o && (h.show(o, de),
            x.trigger(_.STATUS_CHANGE_BROADCAST)));
        }

        function z(e) {
          var t = null;
          "updateTitle" === e.sessionEvent ? se || "useProfiledTitle" !== e.titleSource &&
            "useWindowTitle" !== e.titleSource ? se ? te.info(
              "Broadcast title has already been set to 'non-Desktop' value.") : te.info(
              "Update broadcast title (data.titleSource): Unknown.") : d.getBroadcastTitle().then(function(
              e) {
              t = e.data.title, s.isUndefined(t) || s.isNull(t) || (X.updateBroadcastTitle(t).then(
                function() {
                  te.info("Update broadcast title (new title): ", t), X.setDescription(t),
                    "Desktop" !== t && (se = !0);
                }), xe.gameTitle = t), X.getViewerCount();
            }) : "streamerBroadcastStop" === e.sessionEvent ? (te.info("Streamer stopped the broadcast"), y
              .push(T.OSC_BROADCAST_STOPPED_AUTO_ADAPT, ce), le = "streamerBroadcastStop", X.stopBroadcast()
              ) : "spTelemetry" === e.sessionEvent && "broadcastAutoAdaptTriggered" === e.spTelemetryName &&
            y.push(T.OSC_BROADCAST_AUTO_ADAPT_TRIGGER);
        }
        ...
        function G() {
          X.getBroadcastPreference().then(function(e) {
            ...
            t.id >= 0 && (ne = null, ne = X.getBroadcastSessionStatus(), ne.then(function(e) {
              e === !0 ? (te.info("Hotkey : Stop broadcast"), X.stopBroadcast()) : X
                .tryStartBroadcast(!0);
            }));
          });
        }
        ...
        function q() {
          ...
          te.info("Registering broadcast notification events"), b.register(e, i), b.register(t, o), b
            .register(n, r), x.on(i, N), x.on(o, U), x.on(r, z), x.on(k.GAMECAST, G), x.on(k.PAUSERESUME,
            V), x.on(k.CUSTOMOVERLAYA, B), x.on(k.CUSTOMOVERLAYB, Y), x.on(k.CUSTOMOVERLAYC, $), x.on(k
              .CUSTOMOVERLAY, H), Se = !0;
        }
        var X = this;
        ...
        X.maxViewerCount = 0, X.CustomOverlaySupportTypePreference = [{
          ...
          return o.isBroadcastRecordSupported().then(function(e) {
            return e || te.info("isAnythingBlocking: Broadcast Record Support"), !e || o
              .isBroadcastBlocking();
          }).then(function(e) {
          ...
          if (f.onlineState && f.onlineState.online === !1) return te.info("No Internet connection"),
            void g.show("l10n.systemRequirement", "l10n.notificationCoplayNetworkUnavailable");
          var n = !0;
          return X.isAnythingBlocking().then(function(e) {
            ...
            return te.info("tryStartBroadcast: Desktop Record not supported on MSHybrids"), e.reject(!
              1);
          });
          ...
          if (te.info("startBroadcast (portal): ", t.portal.name), this._currentPortalName = de = t.portal
            .name, Z = l.endpoints[t.portal.providerName], null === Z) return e.reject();
          ...
          return X._broadcastState = E.ACTIVE, n = S.BROADCAST_STARTED, xe.customOverlayState = O.off, X
            .maxViewerCount = 0, j(!0), o.getMicMode().then(function(e) {
              t.portal.providerName === l.providerNames.TWITCH ? y.push(T.OSC_BROADCAST_TWITCH,
                "mic: " + e) : t.portal.providerName === l.providerNames.GOOGLE ? y.push(T
                .OSC_BROADCAST_YOUTUBE, "mic: " + e) : r = 80, xe.micMode = e;
            }), h.show(n, de), x.trigger(_.STATUS_CHANGE_BROADCAST), oe = !1, Z.getRtmpUrl(t).then(
              function(e) {
                return i = e, i && i.includes("rtmps") && t.portal.providerName === l.providerNames
                  .FACEBOOK && (r = 443), te.info("success " + i), te.info("rtmp port:" + r), d
                  .setBroadcastSessionParamV1({
                    type: "live"
                  }, {
                    sessionUrl: i,
              ...
              Z.postRtmpProcess().then(function() {
                ...
                J = e.data.enable, te.info("Viewers overlay enable : ", J), X
                  .startUpdateViewerCountInterval();
              }), X.setDescription();
            }, function(e) {
              if (te.info("broadcast start error:", e), X._broadcastState = E.STOPPED, h.show(S
                  .BROADCAST_FAILED, t.portal.title), x.trigger(_.STATUS_CHANGE_BROADCAST), X
                .isBroadcastActive().then(function(e) {
                ...
                try {
                  if (!s.isUndefined(e.data.error.errors[0].reason) && !s.isNull(e.data.error.errors[0]
                      .reason)) return void(0 === e.data.error.errors[0].reason.localeCompare(
                    "liveStreamingNotEnabled") && h.show(S.BROADCAST_YOUTUBE_LIVE_STREAMING));
                } catch (e) {}
                if (!s.isUndefined(e.statusText) && !s.isNull(e.statusText)) return void(0 === e
                  .statusText.localeCompare("Bad Request") && h.show(S.BROADCAST_LOGIN, t.portal
                    .title));
              }
            });
          ...
          y.startPerf(C.providerStop), o.isBroadcastStartActive || X.isBroadcastActive().then(function(
          e) {
            if (e && !oe) return ie === !0 ? (te.info(
                "Broadcast is in pause state.Resume before stop"), re = !0, X.resumeBroadcast()
              .then(function(e) {
                if (e === !1) return te.info("Stop broadcast after resume is success"), oe = !0,
                  d.setBroadcastSessionStatus({}, {
                    status: !1
                  });
              }, function(e) {
            ...
            y.endPerf(C.providerStop, Z.name), "streamerBroadcastStop" === le ? (i = S
                ...
                .BROADCAST_ENDED_TIMEOUT, le = null) : i = S.BROADCAST_STOPPED, X._broadcastState = E
              .STOPPED, h.show(i, de), x.trigger(_.STATUS_CHANGE_BROADCAST), Z.stopBroadcast(),
              angular.isDefined(Q) && n.cancel(Q), J = !1, x.off(_.BROADCAST_DISPLAY_VIEWER_COUNT, K),
              xe.provider = Z.name, o.getModsActiveStatus() && (xe.freestyleActive = P.yes), X
              .overlayCount = 0;
            for (var l = [], d = 1; d <= 3; d++) l.push(X.getMultipleCustomOverlayEnabled(d).then(
              function(e) {
                e && X.overlayCount++;
              },
              function() {}));
            e.all(l).then(function() {
              t = " CustomOverlayCount:" + X.overlayCount, r ? y.push(T
                .OSC_BROADCAST_TWITCH_CUSTOM_OVERLAY, t) : a ? y.push(T
                .OSC_BROADCAST_YOUTUBE_CUSTOM_OVERLAY, t) : s && y.push(T
                .OSC_BROADCAST_FACEBOOK_CUSTOM_OVERLAY, t), X.overlayCount > 0 && (xe
                .customOverlayState = O.on), X.maxViewerCount = 0, o.addOverlayTelemetryData(xe,
                !0), y.push(T.OSC_BROADCAST_END, xe);
        ...
        X.getBRRecordTime = function() {
            ...
            s.isNull(Z) || Z.getCurrentViewerCount().then(function(e) {
              null != e && (J === !0 && e != ee && (X.updateViewerCountImage(e), ee = e), X
                .maxViewerCount < e && (X.maxViewerCount = e, d.setBroadcastViewerCountMax({}, {
            ...
            if (x.trigger(_.VIEWER_COUNT_UPDATE, e), !D.osd || !Z || Z.name !== l.providerNames.FACEBOOK) {
              ...
              i.src = u.default, n.clearRect(0, 0, t.width, t.height), i.onload = function() {
                ...
                n.drawImage(o, i.width, 0, 10 * a.length, o.height), n.font = "12pt Segoe", n.fillStyle =
                  "white", n.fillText(a, 35, 20), r.src = p.default;
              }, r.onload = function() {
            ...
            return X.broadcastPreference ? e.when(X.broadcastPreference) : d.getBroadcastProvider().then(
              function(e) {
                return e.data.provider;
              });
          }, X.setBroadcastPreference = function(t) {
            return X.broadcastPreference === t ? e.when(X.broadcastPreference) : d
          ...
          }, X.isMultipleCustomOverlayEnabled = [void 0, void 0, void 0], X
          .getMultipleCustomOverlayEnabled = function(t) {
            return void 0 !== X.isMultipleCustomOverlayEnabled[t - 1] ? e.when(X
              .isMultipleCustomOverlayEnabled[t - 1]) : d.getCustomOverlayEnabledV1({
              index: t
            }).then(function(e) {
              return X.isMultipleCustomOverlayEnabled[t - 1] = e.data.enable, X
                .isMultipleCustomOverlayEnabled[t - 1];
            });
          }, X.setCustomOverlayEnabled = function(t) {
            return X.isCustomOverlayEnabled === t ? e.when(X.isCustomOverlayEnabled) : d
            ...
            return X.isMultipleCustomOverlayEnabled[n - 1] === t ? e.when(X.isMultipleCustomOverlayEnabled[
              n - 1]) : d.setCustomOverlayEnabledV1({
              index: n
            }, {
              enable: t
            }).then(function(e) {
              return X.isMultipleCustomOverlayEnabled[n - 1] = t, X.isMultipleCustomOverlayEnabled[n -
                1];
            });
          }, X.customOverlayFilePath = null, X.getCustomOverlayFilePath = function() {
            return X.customOverlayFilePath ? e.when(X.customOverlayFilePath) : d.getCustomOverlayPath()
              .then(function(e) {
                return X.customOverlayFilePath = e.data.path, X.customOverlayFilePath;
              });
          }, X.multipleCustomOverlayFilePath = [null, null, null], X.getMultipleCustomOverlayFilePath =
          function(t) {
            return X.multipleCustomOverlayFilePath[t - 1] ? e.when(X.multipleCustomOverlayFilePath[t - 1]) :
              d.getCustomOverlayPathV1({
                index: t
              }).then(function(e) {
                return X.multipleCustomOverlayFilePath[t - 1] = e.data.path, X
                  .multipleCustomOverlayFilePath[t - 1];
              });
          }, X.setCustomOverlayFilePath = function(t) {
            return X.customOverlayFilePath === t ? e.when(X.customOverlayFilePath) : d
              ...
              X.isAnythingBlocking().then(function(e) {
                if (te.info("isAnythingBlocking to start this session (trigger)? : ", e), !e) return o
                  .getCurrentSettingsBR(n).then(function(e) {
                    var n = {};
                    ce = "", n.quality = e.quality, n.resolution = e.resolution.split(" ")[0], n
                      .bitrate = e.bitrateBps, n.framerate = e.framerate, n.portal = i, angular
                      .isDefined(t.title) ? (n.title = t.title, he = !0) : he = !1, n.privacy = t
                      .privacy, n.destinationType = t.destinationType, n.destination = t
                      .destination;
                    var o = X.startBroadcast(n);
                    xe.privacy = n.privacy.id, ce = " Quality:" + e.quality, ce += " Resolution:" +
                      e.resolution, ce += " BitRate:" + e.bitrateBps, ce += " FPS:" + e.framerate,
                      1 === n.portal.id ? y.push(T.OSC_BROADCAST_TWITCH_QUALITY, ce) : 2 === n
                      .portal.id && y.push(T.OSC_BROADCAST_YOUTUBE_QUALITY, ce), xe.quality = e
                      .quality, xe.resolution = e.resolution, xe.bitRate = e.bitrateBps, xe.fps = e
                      .framerate, xe.provider = Z.name, l.setServiceParameters(t, i.name), o.then(
                        function() {
        ...
        var Se = !1;
        X.init = function() {
          return te.info("Initialize BroadcastService"), q(), X.portals = l.getServices(l.serviceTypes
            .STREAMING), s.each(X.portals, function(e) {
