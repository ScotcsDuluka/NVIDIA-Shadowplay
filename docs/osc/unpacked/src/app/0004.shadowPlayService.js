...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.shadowPlayService = void 0;
  var r = require(108),
    a = o(r),
    l = require(8),
    s = o(l),
    ...
    u = require(3),
    f = i(u),
    m = require(2) /* app/2 — WINDOW_STYLES (constant) */;
  require(23) /* app/23 — oscNotificationService (service) */, require(17) /* app/17 — localSdk (provider) */, require(20) /* app/20 — socketService (provider) */, require(11), require(34) /* app/34 — keyboardService (service) */, require(49) /* app/49 — ugcService (service) */, require(93) /* app/93 — quietMode2Service (service) */;
  var g = m.ngMainCommonModule.service("shadowPlayService", ["$q", "$log", "$document", "$filter", "$state",
    ...
    "oscGalleryService", "eventAggregator", "keyboardService", "telemetryService", "hardwareService",
    "$timeout", "ugcService", "oscDisplayService", "sdkService", "gameProfileService",
    "quietMode2Service", "OSC_CONFIG", "DEFAULT_VIDEO_TAGS", "NOTIFIER_SELECTIONS", "OSC_MODE",
    "HOTKEY_EVENTS", "SHADOWPLAY_EVENTS", "WINDOW_EVENTS", "COPLAY_STATE", "TELEMETRY_OSC_EVENT_NAMES",
    "TELEMETRY_OSC_PERF_ID", "TELEMETRY_OSC_CAPTURE_TYPE", "NVCAMERA_EVENTS", "TELEMETRY_CAPTURE_ACTION",
    "TELEMETRY_OVERLAY_LOCATION", "TELEMETRY_OSC_AVAILABLE_STATUS", "TELEMETRY_OSC_MENU_TYPE",
    "NGX_NOTIFICATIONS",
    function(e, t, n, i, o, r, l, d, u, m, g, p, h, b, x, v, y, w, S, E, k, _, T, C, O, A, I, M, R, P, D,
      N, L, F, U, z, G, V) {
      function H() {
        we.shortcuts = {
          saveRecord: {
      ...
      function B(e) {
        var t = z.no;
        if (we.getModsActiveStatus() && (t = z.yes), e === F.saveInstantReplay || e === F
          .saveManualCapture) {
          var n = {
            action: e,
            freestyleActive: t
      ...
      function W(e, t) {
        ...
        return o < 10 && (o = "0" + o), r < 10 && (r = "0" + r), a < 10 && (a = "0" + a), "mr" === t ? o +
          ":" + r + ":" + a : r + ":" + a;
      }
      ...
      function K(e, t) {
        return n.on("dragover", function(e) {
          ...
          if (i.stopPropagation(), i.preventDefault(), !i.dataTransfer.files || !i.dataTransfer.files[
              0]) return void Se.info("bad drop, no file list");
          var o = i.dataTransfer.files[0];
          o.name === e ? t(o) : Se.info("bad drag file: " + e + " " + o.name), n.off("dragover"), n
            .off("drop");
      ...
      function X(e, t) {
        var n = e.fullFilename,
          i = n.lastIndexOf(".");
        i >= 0 && (n = n.slice(0, i)), n += "-" + Math.floor(t.startMs / 1e3) + "-" + Math.floor(t
          .durationMs / 1e3) + ".mp4", we.trimVideo(e.fullFilename, n, t.startMs, t.durationMs).then(
          function() {
            e.fullFilename = n, g.resetVideoParams(), q(e);
          },
          function(e) {
            f.isUndefined(e) || f.isNull(e) || Se.info("Video trim failure: " + e.data), g
              .resetVideoParams();
        ...
        return Se.info("uploadFile"), Ie(e, _.autoUploadMs).then(function() {
          if (Se.info("Recording uploading"), _.autoUploadMs > 0) {
            ...
            if (Se.info(e), e > _.autoUploadMs) {
              var t = {};
              t.startMs = e - _.autoUploadMs, t.durationMs = _.autoUploadMs, t.trimmed = !0, Se.info(
                t), X(g.fileToProcess, t);
            } else q(g.fileToProcess);
          }
          p.off(I.RECORDING_SAVED, Q);
        }, function(e) {
          Se.info("Recording cannot be uploaded"), p.off(I.RECORDING_SAVED, Q), we.handleNodeError(e
            .data);
        });
      }
      ...
      function ie(e, t) {
        t && (t.enable ? we.cachedOverlayPositions[e] = t.position : we.cachedOverlayPositions[e] = U
          .nowhere);
      }

      function oe(e, t) {
        f.each(we.shortcuts, function(n) {
          if (n.hotkeyId === e) return n.hotkeyKeys = t, n.hotkeyStr = h.shortcutToStr(t), void(n
            .hotkeyStr = "None" === n.hotkeyStr ? "" : n.hotkeyStr);
        });
      }

      function re(e) {
        if (e === _e.OSC_ERR_NO_VALID_GAME_RUNNING && we.DTCaptureSupported === !1 && we
          .notebookCoProc === !0) return "PID" === we.captureState ? l.show(C
          .WARNING_SUPPORTED_GAME_REQUIRED) : l.show(C.WARNING_FULLSCREEN_GAME_REQUIRED);
      }
      ...
      function le(e) {
        e && e.notifier && e.notifier === C.OPEN_SHARE && we.getHotkeyShortcut(we.HotkeyShortcuts
          .OPENSHARE).then(function(t) {
          if (!f.isUndefined(t.keys)) {
            ...
            l.show(e.notifier, n), k.getStateInfo(!0).then(function(e) {
              ...
              t.supported && t.enabled ? v(function() {
                l.flipTo(C.WHISPER_MODE_ENABLED_GAMESTART, t.fanVolumeMode, t.baseFrameRate),
                  v(function() {
                    ae();
                  }, 3500);
              }, 3500) : ae();
      ...
      function de(e) {
        e.status === !0 ? (Se.info("instantReplayNotifier (true): ", e), l.show(C.INSTANT_REPLAY_STARTED),
          we.mainMenuData.instantReplayEnabled = !0, p.trigger(I.STATUS_CHANGE_RECORD), b.endPerf(D
            .providerTrigger, N.instantReplay)) : e.status === !1 ? (Se.info(
            "instantReplayNotifier (false): ", e), l.show(C.INSTANT_REPLAY_STOPPED), we.mainMenuData
          .instantReplayEnabled = !1, p.trigger(I.STATUS_CHANGE_RECORD), b.endPerf(D.providerStop, N
            .instantReplay)) : Se.error("instantReplayNotifier (other): ", e);
      }
      ...
      function ce(e) {
        E.updateDRSProfileInfo(), void 0 !== e.started && e.started === !0 || void 0 !== e.restarted && e
          .restarted === !0 ? (Se.info("instantReplayRecordingNotifier (true): ", e), we.mainMenuData
            .instantReplayRunning = !0, p.trigger(I.IR_RECORDING_STATE_CHANGED), p.trigger(I
              .STATUS_CHANGE_RECORD)) : void 0 !== e.started && e.started === !1 ? (Se.info(
              "instantReplayRecordingNotifier (false): ", e), we.mainMenuData.instantReplayRunning = !1, p
            .trigger(I.IR_RECORDING_STATE_CHANGED), p.trigger(I.STATUS_CHANGE_RECORD)) : Se.error(
            "instantReplayRecordingNotifier (other): ", e);
      }
      ...
      function ge(e) {
        e.status === !0 ? (Se.info("recordNotifier (true): ", e), l.show(C.RECORD_STARTED), we
          .mainMenuData.manualRecordEnabled = !0, p.trigger(I.STATUS_CHANGE_RECORD), b.endPerf(D
            .providerTrigger, N.manualRecord)) : e.status === !1 ? (Se.info("recordNotifier (false): ",
          e), l.show(C.RECORD_STOPPED), we.mainMenuData.manualRecordEnabled = !1, p.trigger(I
          .STATUS_CHANGE_RECORD)) : Se.error("recordNotifier (other): ", e);
      }

      function pe(e) {
        if (e.notification === ke.SCREENSHOT) {
          if (Se.info("processNotification: Screenshot; result = ", e.result), we
            .onScreenShotCapturedCallback) return we.onScreenShotCapturedCallback(e), void(we
            .onScreenShotCapturedCallback = void 0);
          e.result === _e.OSC_SUCCESS ? (l.show(C.SCREENSHOT_SAVED_TO_GALLERY), B(F.takeScreenshot)) : (e
            .result === _e.OSC_ERR_NO_VALID_GAME_RUNNING ? we.tryStartScreenshot() : re(e.result), b
            .push(P.OSC_SHADOWPLAY_CAPTURE_ERROR, {
              action: F.takeScreenshot,
              errorDetail: (0, s.default)(e.result)
            }));
        } else if (e.notification === ke.RECORDING_SAVED) Se.info(
          "processNotification: Recording saved; result = ", e.result), e.result === _e.OSC_SUCCESS ? (p
          .trigger(I.RECORDING_SAVED, e.file), we.expectIRSave ? (we.expectIRSave = !1, b.endPerf(D
            .providerPause, N.instantReplay)) : (we.expectManualSave || b.startPerf(D.providerStop), we
            .expectManualSave = !1, b.endPerf(D.providerStop, N.manualRecord))) : (e.result !== _e
          .OSC_ERR_NO_VALID_GAME_RUNNING && re(e.result), b.push(P.OSC_SHADOWPLAY_CAPTURE_ERROR, {
        ...
        } else e.notification === V.AI_SUPER_RES_PROGRESS ? void 0 !== e.progress && we
          .onNGXShotCapturedCallback && we.onNGXShotCapturedCallback(e) : e.notification === ke
          .RECORD_HDR_ERROR ? l.show(C.HDR_ERROR_RECORD) : e.notification === ke.BROADCAST_HDR_ERROR ? l
          .show(C.HDR_ERROR_BROADCAST) : e.notification === ke.SCREENSHOT_HDR_ERROR ? p.trigger(I
            .HDR_SCREENSHOT) : e.notification === ke.HL_HDR_ERROR ? l.show(C.HDR_ERROR_HL) : Se.error(
            "processNotification: Notification = " + e.notification + "; result = " + e.result);
      }
      ...
      function be(e) {
        return we.getHotkeyShortcut(e.hotkeyId).then(function(t) {
          e.hotkeyKeys = t.keys, f.isUndefined(t.keys) ? e.hotkeyStr = "" : (e.hotkeyStr = h
            .shortcutToStr(t.keys), e.hotkeyStr = "None" === e.hotkeyStr ? "" : e.hotkeyStr);
        }, function(t) {
      ...
      function ve() {
        ...
        Se.info("Registering shadowplay notification events"), d.register(e, l), d.register(t, s), d
          .register(n, c), d.register(i, u), d.register(o, f), d.register(r, m), d.register(a, g), p.on(l,
            de), p.on(s, ce), p.on(c, fe), p.on(u, me), p.on(f, ge), p.on(m, pe), p.on(g, le), p.on(I
            .FILE_READY_TO_UPLOAD, j), p.on(A.MANUAL, J), _.autoUploadMs > 0 ? p.on(A.DVR, we
            .uploadInstantReplay) : p.on(A.DVR, we.saveInstantReplay), p.on(A.CAMERA, we.toggleWebcam), p
          .on(A.MIC_PTT_DOWN, ee), p.on(A.MIC_PTT_UP, te), p.on(A.MIC_TOGGLE, ne), p.on(A.DVR_TOGGLE, $),
          p.on(A.SCREENSHOT, we.checkAndCaptureScreenshot), p.on(M.DISPLAY_HOTKEY, se);
      }
      var ye,
        we = this,
      ...
      var ke = (ye = {
        ...
        }, (0, c.default)(ye, "GAME_STARTED", "gameAppStarted"), (0, c.default)(ye,
          "SCREENSHOT_HDR_ERROR", "screenshotHDRError"), (0, c.default)(ye, "RECORD_HDR_ERROR",
          "recordHDRError"), (0, c.default)(ye, "BROADCAST_HDR_ERROR", "broadcastHDRError"), (0, c
          .default)(ye, "HL_HDR_ERROR", "hlHDRError"), ye),
        _e = {
          OSC_SUCCESS: 0,
          ET_NO_ERROR: 1,
          ET_GENERIC: 2,
      ...
      we.SHADOWPLAY_ERRORCODES = _e, we.getPreferredTwitchIngestServer = function() {
        ...
        return we.spRunning ? e.when(we.spRunning) : r.isRunning().then(function(e) {
          return we.spRunning = e.data.launch, Se.info("Is ShadowPlay running: ", we.spRunning), we
            .spRunning;
        });
        ...
        return we.DTCaptureSupported === !0 ? e.when(!0) : we.notebookCoProc === !0 ? u
        .isInDesktopMode().then(function(e) {
          return Se.info("isInDesktopMode :", e), Se.info("CaptureState :", we.captureState),
            "PID" === we.captureState || !e || (Se.info(
              "For notebooks, record is supported in fullscreen only"), l.show(C
        ...
        return r.getRecordBroadcastConcurrencySupport().then(function(e) {
          ...
          return !t && we.isBroadcastActive().then(function(e) {
            ...
            return t === !0 ? (l.show(C.WARNING_BROADCAST_STOP_TO_USE_FEATURE), Se.info(
                "isBroadcastBlocking: broadcast acvtive"), !0) : !!we.isBroadcastStartActive &&
              (Se.info("isBroadcastBlocking: start active"), !0);
          });
        });
        ...
        return r.getHDRActiveState().then(function(e) {
          ...
          var t = e.data.active;
          return t === !0 && (Se.info("sending disbale hdr notification"), l.show(C
            .HDR_ERROR_BROADCAST), !0);
        });
        ...
        return r.getRecordBroadcastConcurrencySupport().then(function(t) {
          ...
          return !n && e.all([we.isIREnabled(), we.isIRActive(), we.isMRActive(), S
            .isHighlightsActive()
          ]).then(function(e) {
            var t = e[0],
              n = e[1],
              i = e[2],
              o = e[3];
            return t || n ? (l.show(C.WARNING_INSTANT_REPLAY_STOP_TO_USE_FEATURE), !0) : i ? (l
              .show(C.WARNING_RECORDING_STOP_TO_USE_FEATURE), !0) : !!o && (we
        ...
        return r.getRecordGamestreamConcurrencySupport().then(function(t) {
          var n = t.data.support;
          return !n && e.all([we.isIREnabled(), we.isIRActive(), we.isMRActive(), we
            .isBroadcastActive()
          ]).then(function(e) {
            var t = e[0],
              n = e[1],
            ...
            return t || n ? (l.show(C.WARNING_INSTANT_REPLAY_STOP_TO_USE_FEATURE), !0) : i ? (l
              .show(C.WARNING_RECORDING_STOP_TO_USE_FEATURE), !0) : !(!o && !we
              .isBroadcastStartActive) && (l.show(C.WARNING_BROADCAST_STOP_TO_USE_FEATURE), !
              0);
          });
        });
      };
      ...
      we.setCoplayState = function(e) {
        ...
        return e.all([u.isInDesktopMode(), we.getDesktopCaptureEnabled()]).then(function(t) {
          var n = t[0],
            i = t[1],
            o = !1;
          return Se.info("DesktopMode, dtCaptureEnabled : ", n, i), !(!n || i) && Y().then(function(
            t) {
            return o = t, !o && (we.notebookCoProc !== !0 || ("PID" === we.captureState ? (l
              .show(C.WARNING_SUPPORTED_GAME_REQUIRED), Se.info(
        ...
        return B(F.turnOnInstantReplay), b.startPerf(D.providerTrigger), e.all([we
          .isBroadcastRecordSupported(), we.isBroadcastBlocking(), we.isCoplayBlocking()
        ]).then(function(e) {
          var t = e[0],
            n = e[1] || we.isBroadcastStartActive,
            i = e[2];
          if (t && !n && !i) return u.isInDesktopMode().then(function(e) {
            e ? we.telemetryDVRFSMode = P.OSC_CAPTURE_DVR_SESSION_DURATION_DT : we
              .telemetryDVRFSMode = P.OSC_CAPTURE_DVR_SESSION_DURATION_FS;
        ...
        return B(F.turnOffInstantReplay), b.startPerf(D.providerStop), we.setInstantReplayRecording(!1)
          .then(function() {
        ...
        return we.expectIRSave = !0, B(F.saveInstantReplay), b.startPerf(D.providerPause), r
          .saveInstantReplay().then(function(e) {
      ...
      we.getIRRecordTime = function() {
        ...
        return we.usersDirectory ? e.when(we.usersDirectory) : r.getCustomOverlayDefaultPath().then(
          function(e) {
      ...
      var Ie = function(e, t) {
        ...
        return m.getMetaData(e, o, l, 0, a, !1, !0).then(function(e) {
          return void 0 !== a[0] ? (g.setFileToProcess(a[0]), g.setParentGalleryState(!1), 0 ===
            t && p.trigger(I.FILE_READY_TO_UPLOAD, Ee.isUploadTargetServiceKnown(g.fileToProcess
              .file.type)), !0) : (Se.error("uploadRecordedFile getMetaData failed!"), !1);
        });
      };
      we.uploadInstantReplay = function() {
        ...
        return p.on(I.RECORDING_SAVED, Q), we.stopAndSaveManualRecord().then({}, function(e) {
          Se.info("Manual recording cannot be uploaded"), p.off(I.RECORDING_SAVED, Q), we
            .handleNodeError(e.data);
        });
      }, we.startManualRecord = function() {
        return B(F.startManualCapture), b.startPerf(D.providerTrigger), e.all([we
          .isBroadcastRecordSupported(), we.isBroadcastBlocking(), we.isCoplayBlocking()
        ]).then(function(e) {
          var t = e[0],
            n = e[1] || we.isBroadcastStartActive,
        ...
        return e.all([we.isBroadcastActive(), we.isIRActive(), we.isIREnabled(), we.isMRActive(), S
          ...
          return we.runState = {
              ...
              manualRecord: e[3],
              highlights: e[4]
            }, we.runState.broadcast === !0 ? (t === !0 && l.show(C
              .WARNING_BROADCAST_STOP_TO_CUSTOMIZE), !1) : we.runState.instantReplay === !0 || we
            .runState.manualRecord === !0 ? (t === !0 && l.show(C
              .WARNING_RECORDING_STOP_TO_CUSTOMIZE), !1) : we.runState.highlights !== !0 || (t === !
              0 && we.appCaptureProcessInfo().then(function(e) {
      ...
      we.getMicMode = function() {
          ...
          return "off" === e && (t = "game"), we.mainMenuData.audioMode = t, r.setAudioMode({}, {
            ...
            Se.info("error setting microphone mode: ", t), Me = "off", we.mainMenuData.micMode = e, p
              .trigger(I.MIC_STATUS_CHANGE, Me);
          });
          ...
          return r.getAudioSettings().then(function(e) {
            ...
            return Se.error("Error getting audio settings: ", e), we.audioSettings
              .systemVolumePercent = 100, we.audioSettings.separateTracks = !1, we.audioSettings;
          });
          ...
          return we.isMTAAvailCached === !0 ? e.when(we.isMTAAvail) : r.getAudioSettings().then(
        function() {
            return Se.info("Multi-Track Audio is available"), we.isMTAAvail = !0, we
              .isMTAAvailCached = !0, we.isMTAAvail;
          }, function(e) {
            return Se.info("Multi-Track Audio is NOT available"), we.isMTAAvail = !1, we
              .isMTAAvailCached = !0, we.isMTAAvail;
          });
          ...
          return r.getWebcamPresent().then(function(e) {
            return Se.info("Webcam present : ", e.data.present), we.mainMenuData.webcamPresent = e
              .data.present, e.data.present;
          });
        }, we.getWebcamShown = function() {
          return r.getWebcamShown().then(function(e) {
            return Se.info("Webcam showing : ", e.data.shown), we.mainMenuData.webcamShown = e.data
              .shown, e.data.shown;
          });
          ...
          e = e || {}, t && (e.viewersOverlayPos = we.cachedOverlayPositions.viewer), e.fpsOverlayPos = we
            .cachedOverlayPositions.fps, e.cameraOverlayPos = we.cachedOverlayPositions.webcam, e
            .statusOverlayPos = we.cachedOverlayPositions.record;
        ...
        }, a.default && (0, a.default)(we.IndicatorOverlayEnum), we.getIndicatorOverlaySupported =
        function(e) {
          ...
          return we.isBroadcast2KSupported() ? f.isNull(we.broadcast2KEnabled) ? r.getBroadcast2KEnabled()
            .then(function(e) {
              return we.broadcast2KEnabled = e.data.enable, Se.info("getBroadcast2KEnabled: ", e.data
          ...
          return r.getMainViewData({}, {
            ...
            return we.mainMenuData.webcamPresent = e.data.webcamPresent, we.mainMenuData.webcamShown =
              e.data.webcamShown, we.mainMenuData.micPresentCount = e.data.micPresentCount, we
              .mainMenuData;
          }, function(e) {
      ...
      we.setModsActiveStatus = function(e) {
        ...
        }, we.DTCaptureSupported = !1, we.notebookCoProc = !1, we.broadcast2KSupported = !1, we
        .supported8K60 = !1, we.captureState = "", we.init = function() {
          return Se.info("Initialize ShadowPlayService"), ve(), we.isSPRunning().then(function(e) {
            ...
            if (Se.info("Desktop Support Reason: ", e.data), we.DTCaptureSupported = e.data.support, !
              we.DTCaptureSupported) {
              var t = e.data.unsupportReason;
              (t.indexOf("notebookDriver") >= 0 || t.indexOf("notebookCoProc") >= 0 || t.indexOf(
                "notebookDGpu") >= 0 || t.indexOf("hideCheckboxAOSP") >= 0) && (we.notebookCoProc = !
                0);
            }
            return r.getBroadcast2KSupported();
          }).then(function(e) {
            return Se.info("Broadcast2K Support : ", e.data), we.broadcast2KSupported = e.data
              .support, we.getMainViewDataInit();
          }).then(function() {
