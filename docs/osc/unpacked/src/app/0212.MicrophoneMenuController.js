...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.MicrophoneMenuController = void 0;
  var r = require(8),
    a = o(r),
    l = require(3),
    s = i(l),
  ...
  var c = d.ngMainModule.controller("MicrophoneMenuController", ["$scope", "$state", "$log", "$timeout",
    ...
    function(e, t, n, i, o, r, l) {
      ...
      var c = n.getInstance("main.microphone/microphonecontroller"),
        u = !1;
      d.disableBoost = !1, d.disableMicSelect = !1, d.disableVolume = !1, d.settingsChanged = !1, d
        .throttleTime = 333, d.numOfMics = 0, d.Items = [], d.item = null, d.ItemsUponEntry = [], d
        .initialIndex = 0, d.sliders = {
          min: 0,
          max: 100,
          step: 1,
          ...
          if (c.info("undoSettings Entered!"), d.settingsChanged === !0) {
            ...
            s.forEach(d.ItemsUponEntry, function(t) {
                d.initialIndex !== t.index ? (d.item = t, c.info("Undoing index: " + d.item.index +
                  " mic: " + d.item.name), d.saveSettings()) : e = t;
              }), d.item = e, c.info("Undoing index: " + d.item.index + " mic: " + d.item.name), d
              .saveSettings();
          }
        }, d.back = function() {
          ...
          c.info("Initialize Microphone VM"), r.getMicrophoneSettingsAll().then(function(e) {
            ...
            d.item = e, d.initialIndex = d.item.index, d.enableEscapeEvent(!0), u = !0, d
              .checkMicSelect(), d.checkBoost(), d.checkVolume(), c.info("Microphone initialized");
          }, function(e) {
  ...
  exports.MicrophoneMenuController = c;
}
