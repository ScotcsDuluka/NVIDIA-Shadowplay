...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.PreferencesOverlaysController = void 0;
  var i = require(1) /* app/1 — main (module) */;
  require(4) /* app/4 — shadowPlayService (service) */, require(35) /* app/35 — osdService (service) */, require(22) /* app/22 — octoolService (service) */;
  var o = i.ngMainModule.controller("PreferencesOverlaysController", ["$log", "$scope", "$state",
    "$stateParams", "osdService", "octoolService", "eventAggregator", "KEYBOARD_EVENTS", "OSC_KEYBOARD",
    "PERFTOOL_EVENTS",
    function(e, t, n, i, o, r, a, l, s, d) {
      ...
      u.cameraSizes = {
        ...
        u.overlaySettings = o.overlaySettings, u.editorQuadrantMouseover = "Nowhere", u
          .perfOverlayViews = r.overlayViews.filter(function(e) {
            return e.enabled;
          }), i.selectedOverlay && u.overlaySettings[i.selectedOverlay].supported ? u.setToggleItem(i
            .selectedOverlay) : u.overlaySettings.Camera.supported ? u.setToggleItem("Camera") : u
          .setToggleItem("Status");
        ...
        return "Camera" === e ? u.overlaySettings[e].icon[t] : "Performance" === e && "FPS" === u
          .overlaySettings.Performance.view ? u.overlaySettings.FPS.icon : u.overlaySettings[e].icon;
        ...
        var t = 0;
        return u.overlaySettings[u.selectedToggleItem].supported ? u.isEditorQuadrantSelected(e) ? t =
          1 : e === u.editorQuadrantMouseover && (t = .5) : t = 0, {
            margin: "3px",
            opacity: t,
        ...
        return u.overlaySettings[u.selectedToggleItem].enabled && e === u.overlaySettings[u
          .selectedToggleItem].position;
        ...
        return f.info("Setting editor quadrant for toggle item " + u.selectedToggleItem + " as " + e),
          "Nowhere" === e ? void f.error("Invalid position") : void(u.isEditorQuadrantSelected(e) || (u
            .overlaySettings[u.selectedToggleItem].position = e, u.overlaySettings[u
              .selectedToggleItem].enabled = !0, o.overlaySettings = u.overlaySettings, o
            .saveOverlaySettings(u.selectedToggleItem)));
      }, u.isToggleItemOff = function() {
        return !u.overlaySettings[u.selectedToggleItem].enabled;
      }, u.setToggleItemOff = function() {
        f.info("Setting toggle item " + u.selectedToggleItem + " off"), u.isToggleItemOff() || (u
          .overlaySettings[u.selectedToggleItem].enabled = !1, o.overlaySettings = u.overlaySettings,
          o.saveOverlaySettings(u.selectedToggleItem));
      }, u.isCamera = function() {
        ...
        f.info("Setting perf overlay view to " + e.id), u.isPerformanceSelected() && (u
          .isPerfOverlayViewSet(e) || (u.overlaySettings[u.selectedToggleItem].view = e.id, o
            .overlaySettings = u.overlaySettings, o.saveOverlaySettings(u.selectedToggleItem), r
            .overlayViewUpdated = !0));
      }, u.isCameraSizeThis = function(e) {
        return u.isCamera() && e === u.overlaySettings[u.selectedToggleItem].size;
      }, u.setCameraSize = function(e) {
        return f.info("Setting camera size to " + e), "NoSize" === e ? void f.error(
          "Invalid camera size") : void("Camera" === u.selectedToggleItem && (u.isCameraSizeThis(e) ||
          (u.overlaySettings[u.selectedToggleItem].size = e, o.overlaySettings = u.overlaySettings,
            o.saveOverlaySettings(u.selectedToggleItem))));
      }, u.isPreviewIconVisibleHere = function(e, t) {
        return u.isSettingSupported(e) && u.overlaySettings[e].enabled && t === u.overlaySettings[e]
          .position;
        ...
        i.lastState ? "octoolmenu" === i.lastState ? r.launchOCToolMenu() : n.go(i.lastState, i
          .lastParams) : n.go("main.preferences");
      }, u.keyDownItem = function(e, t) {
        e.keyCode === s.TAB && (e.shiftKey || "Viewers" !== t || u.setEditorQuadrantMouseover(
          "LeftTop"));
      ...
      }, a.on(l.ESCAPE, u.done), a.on(d.PERF_OVERLAY_VISIBILITY_CHANGED, c), t.$on("$destroy",
      function() {
        a.off(l.ESCAPE, u.done), a.off(d.PERF_OVERLAY_VISIBILITY_CHANGED, c);
      });
    }
  ]);
  exports.PreferencesOverlaysController = o;
}
