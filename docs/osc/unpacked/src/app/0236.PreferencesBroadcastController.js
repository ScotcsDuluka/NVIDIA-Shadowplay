...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.PreferencesBroadcastController = void 0;
  var i = require(1) /* app/1 — main (module) */;
  require(4) /* app/4 — shadowPlayService (service) */, require(32) /* app/32 — broadcastService (service) */, require(11), require(25) /* app/25 — hardwareService (service) */;
  var o = i.ngMainModule.controller("PreferencesBroadcastController", ["$scope", "$log", "$state",
    "$stateParams", "$filter", "$q", "broadcastService", "shadowPlayService", "twitchService",
    "eventAggregator", "hardwareService", "galleryService", "KEYBOARD_EVENTS", "VIDEO_STATE",
    "OSC_KEYBOARD", "OSC_MODE", "BROADCAST_STATES",
    function(e, t, n, i, o, r, a, l, s, d, c, u, f, m, g, p, h) {
      ...
      b.title = "l10n.settings", b.icon = "icon-settings", b.status = "", b.settingsDisabled = !1, b
        .settingsData = {}, b.blDisabled = "", b.maxCustomOverlays = [1, 2, 3], b
        .multipleCustomOverlayFileSize = ["", "", ""], b.multipleCustomOverlayFilePath = [o("translate")(
          "l10n.slotEmpty", {
            slotNumber: 1
          ...
          slotNumber: 3
        })], b.lastSelectedFilePath = "", b.broadcastControlStatus = !0, b.setBroadcastControlStatus =
        function() {
          a.setBroadcastPreference(b.broadcastControlStatus ? "AlwaysAsk" : "DoNotBroadcast").then(
            function(e) {
      ...
      b.initPreferencesBroadcast = function() {
        return a.getBroadcastPreference().then(function(e) {
          b.selectedBroadcastTargetName = e, x.info("Broadcast Preference: " + b
              .selectedBroadcastTargetName), b.broadcastControlStatus = "DoNotBroadcast" !== b
            .selectedBroadcastTargetName;
          ...
          b.ingestServers = e, l.getPreferredTwitchIngestServer().then(function(e) {
            ...
            (n < 0 || !b.ingestServers[n].availability) && (n = s.getClosestIngestServer(b
              .ingestServers)), (n < 0 || !b.ingestServers[n].availability) && (n = s
              .getDefaultServer(b.ingestServers)), b.selectedIngestServerName = t[n];
          });
        ...
        if (1 === b.CustomOverlaySupportType) return void a.getCustomOverlayEnabled().then(function(e) {
          b.isCustomOverlayEnabled = e, x.info("Broadcast Custom Overlay enabled = ", b
              .isCustomOverlayEnabled), b.customOverlayFilePath = "", b.isCustomOverlayEnabled &&
            a.getCustomOverlayFilePath().then(function(e) {
        ...
        if (2 === b.CustomOverlaySupportType) {
          ...
          for (var e = function(e) {
              a.getMultipleCustomOverlayEnabled(e).then(function(t) {
                b.isMultipleCustomOverlayEnabled[e - 1] = t, b.multipleCustomOverlayFilePath[e -
                    1] = b.slot[e - 1], b.multipleCustomOverlayFileSize[e - 1] = "", b
                  .isMultipleCustomOverlayEnabled[e - 1] && a.getMultipleCustomOverlayFilePath(e)
                  .then(function(t) {
                    b.multipleCustomOverlayFilePath[e - 1] = t, x.info(
                      " Broadcast Multiple Custom Overlay PNG file = ", b
                      .multipleCustomOverlayFilePath[e - 1]), u.getGalleryImageFileDimensions(
                      t).then(function(t) {
                      if (t) {
                        var n = t.width,
                          i = t.height,
                          ...
                          r = i.toString(),
                          a = o;
                        a = a.concat(" x "), a = a.concat(r), b
                          .multipleCustomOverlayFileSize[e - 1] = a, x.info(
                            " Broadcast Multiple Custom Overlay PNG file size = ", b
        ...
        l.setPreferredTwitchIngestServer(b.selectedIngestServerName), x.info("Setting ingest server " +
          b.selectedIngestServerName);
        ...
        a.setMultipleCustomOverlayEnabled(!1, e), b.isMultipleCustomOverlayEnabled[e - 1] = !1, b
          .multipleCustomOverlayFilePath[e - 1] = b.slot[e - 1], b.multipleCustomOverlayFileSize[e -
          1] = "";
        ...
        t.length > 0 && i.lastIndexOf("\\") > 0 ? (t = t.slice(0, t.lastIndexOf("\\")), i = i.slice(i
          .lastIndexOf("\\") + 1)) : (i = "", t = b.userDir + "\\Pictures");
        var r = {
        ...
        var t = o("translate")("l10n.broadcastLive") + " > " + o("translate")("l10n.broadcastOverlay"),
          i = "",
          r = "";
        e >= 1 && e <= 3 && b.isMultipleCustomOverlayEnabled[e - 1] ? (i = b
          .multipleCustomOverlayFilePath[e - 1], r = b.multipleCustomOverlayFilePath[e - 1], i
          .length > 0 && i.lastIndexOf("\\") > 0 && (i = i.slice(0, i.lastIndexOf("\\")), r = r.slice(
            r.lastIndexOf("\\") + 1))) : (i = b.lastSelectedFilePath, i = i.slice(0, i.lastIndexOf(
          "\\")), r = ""), i.length <= 0 && (r = "", i = b.userDir + "\\Pictures");
        var a = {
          parentView: "main.preferences.broadcast",
          heading: t,
          init: r,
  ...
  exports.PreferencesBroadcastController = o;
}
