...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.sdkService = void 0;
  var o = require(3),
    r = i(o),
    a = require(2) /* app/2 — WINDOW_STYLES (constant) */;
  require(20) /* app/20 — socketService (provider) */, require(17) /* app/17 — localSdk (provider) */;
  var l = a.ngMainCommonModule.service("sdkService", ["$log", "$filter", "$q", "eventAggregator",
    "highlightsEndpoints", "shadowPlayEndpoints", "socketService", "oscDisplayService",
    "oscNotificationService", "telemetryService", "oscGalleryService", "NOTIFIER_SELECTIONS",
    "HIGHLIGHTS_EVENTS", "TELEMETRY_OSC_EVENT_NAMES", "CONFIRMATION_TYPE", "HIGHLIGHT_PERMISSIONS",
    "GALLERY_FILEPROCESS", "TELEMETRY_OSC_AVAILABLE_STATUS",
    function(e, t, n, i, o, a, l, s, d, c, u, f, m, g, p, h, b, x) {
      ...
      function y(e) {
        ...
        if ("openSummary" === t) {
        ...
        } else if ("requestPermissions" === t) E.shortName = e.shortName, E.scopes = e.scopes, v(e
          .displayName);
        ...
        } else if ("HighlightsMoveStarted" === t) E.totalMoveCount = r.propertyOf(e)(
          "totalHighlightsCount"), i.trigger(m.MOVE_STARTED);
          ...
          E.totalMoveCount = 0, i.trigger(m.MOVE_INPROGRESS, u), i.trigger(m.MOVE_DONE);
            ...
            DRSName: e.drsName,
            DRSProfileName: e.displayName
          }) : "createInstance" === t ? (E.sdkInstance.shortName = e.shortName, E.sdkInstance
            .drsProfileName = e.displayName, E.sdkInstance.drsName = e.drsName) : "destroyInstance" ===
          t && (E.sdkInstance.shortName = "", E.sdkInstance.drsProfileName = "", E.sdkInstance.drsName =
            "");
      }
      ...
      E.delayedHighlight = [], E.sdkInstance = {}, E.getSDKInstance = function() {
        ...
        if ("video" === e.file.type) {
          ...
          k.info("Video trim parameters: " + o.trimmed + " " + o.startMs + " " + o.durationMs), o
            .trimmed && (t = o.startMs, n = o.durationMs, i = !0);
        }
        var r = e.moment.savedToGallery ? b.COPY : b.MOVE,
          a = r === b.MOVE ? "Move" : "Copy";
        k.info("Highlight to Gallery: " + a + " Filename: " + e.fullFilename), E
          .importHighlightToGallery(e, r, t, n).then(function(t) {
            "" !== t && (k.info("Import HL to gallery: ", t), i === !1 && r === b.MOVE && (e
              .fullFilename = t, e.file.name = t, e.moment.filename = t, e.moment
              .savedToGallery = !0, e.moment.filename = t), "video" === e.file.type ? d.show(f
              .RECORD_STOPPED_AND_SAVED_TO_GALLERY) : d.show(f.SCREENSHOT_SAVED_TO_GALLERY));
          });
        var l = 0;
