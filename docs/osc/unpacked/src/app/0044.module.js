...
function(module, exports, require) {
  ! function(e, n) {
    ...
    function o(e, t) {
      null == t && (t = r);
      for (var n = 0, i = e.length - 1, o = e[0], a = new Array(i < 0 ? 0 : i); n < i;) a[n] = t(o, o = e[++
        n]);
      return a;
    }
    ...
    function g(e, t, n) {
      ...
      for (var i = -1, o = 0 | Math.max(0, Math.ceil((t - e) / n)), r = new Array(o); ++i < o;) r[i] = e +
        i * n;
      return r;
    }
    ...
    function p(e, t, n) {
      ...
      if (a > 0)
        for (e = Math.ceil(e / a), t = Math.floor(t / a), r = new Array(o = Math.ceil(t - e + 1)); ++l < o;)
          r[l] = (e + l) * a;
      else
        for (e = Math.floor(e * a), t = Math.ceil(t * a), r = new Array(o = Math.ceil(e - t + 1)); ++l < o;)
          r[l] = (e - l) / a;
    ...
    function h(e, t, n) {
      var i = (t - e) / Math.max(0, n),
        ...
        r = i / Math.pow(10, o);
      return o >= 0 ? (r >= V ? 10 : r >= H ? 5 : r >= B ? 2 : 1) * Math.pow(10, o) : -Math.pow(10, -o) / (
        r >= V ? 10 : r >= H ? 5 : r >= B ? 2 : 1);
    }
    ...
    function v() {
      ...
      return e.value = function(n) {
        ...
        return arguments.length ? (i = "function" == typeof t ? t : f(Array.isArray(t) ? z.call(t) : t),
          e) : i;
      }, e;
    }
    ...
    function w(e, n, i) {
      return e = G.call(e, s).sort(t), Math.ceil((i - n) / (2 * (y(e, .75) - y(e, .25)) * Math.pow(e.length,
        -1 / 3)));
    }
    ...
    function I(e, t, n) {
      for (var i, o, r = (null == n ? e.length : n) - (t = null == t ? 0 : +t); r;) o = Math.random() * r--
        | 0, i = e[r + t], e[r + t] = e[o + t], e[o + t] = i;
      return e;
    }
    ...
    var N = n(t),
      ...
      H = Math.sqrt(10),
      B = Math.sqrt(2);
    e.bisect = L, e.bisectRight = L, e.bisectLeft = F, e.ascending = t, e.bisector = n, e.cross = a, e
      .descending = l, e.deviation = c, e.extent = u, e.histogram = v, e.thresholdFreedmanDiaconis = w, e
      .thresholdScott = S, e.thresholdSturges = x, e.max = E, e.mean = k, e.median = _, e.merge = T, e.min =
      C, e.pairs = o, e.permute = O, e.quantile = y, e.range = g, e.scan = A, e.shuffle = I, e.sum = M, e
      .ticks = p, e.tickIncrement = h, e.tickStep = b, e.transpose = R, e.variance = d, e.zip = D, Object
