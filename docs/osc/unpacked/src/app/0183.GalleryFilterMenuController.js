...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.GalleryFilterMenuController = void 0;
  var i = require(1) /* app/1 — main (module) */;
  require(11);
  var o = i.ngMainModule.controller("GalleryFilterMenuController", ["$scope", "$log", "$timeout",
    "oscGalleryService", "eventAggregator", "shadowPlayService", "KEYBOARD_EVENTS", "GALLERY_SUBTYPES",
    "OSC_KEYBOARD",
    function(e, t, n, i, o, r, a, l, s) {
      ...
      c.setupMenu = function() {
        ...
        c.initialized === !0 && c.enableEscapeEvent(!0), c.filterOpen = !1, i
          .setCurrentFolderDisplaySetting(c.item.id), c.controlButtons();
        ...
        c.itemid = i.getCurrentFolderDisplaySetting(), c.item = e.Items.find(c.findItemId), c
          .setFilterData();
      }, c.initialize = function() {
        return u.info("Initialize Gallery Filter VM"), c.item = e.Items[0], r
        ...
        c.nvChangeFilter !== e.nvChangeFilter && (c.preText = e.nvChangeFilter.preText, c
          .enableFilter = e.nvChangeFilter.enableFilter);
      }, !0), e.$on("$destroy", function() {
        c.enableEscapeEvent(!1);
      });
    }
  ]);
  exports.GalleryFilterMenuController = o;
}
