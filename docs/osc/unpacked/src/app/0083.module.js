  ...
  ! function(e, n) {
    ...
    t.prototype = n.prototype = {
      ...
      bezierCurveTo: function(e, t, n, i, o, r) {
        this._ += "C" + +e + "," + +t + "," + +n + "," + +i + "," + (this._x1 = +o) + "," + (this
          ._y1 = +r);
      },
        ...
        if (null === this._x1) this._ += "M" + (this._x1 = e) + "," + (this._y1 = t);
          ...
          if (Math.abs(f * d - c * u) > r && a) {
            var g = n - l,
              ...
              w = y / v,
              S = y / x;
            Math.abs(w - 1) > r && (this._ += "L" + (e + w * u) + "," + (t + w * f)), this._ += "A" +
              a + "," + a + ",0,0," + +(f * g > u * p) + "," + (this._x1 = e + S * d) + "," + (this
                ._y1 = t + S * c);
      ...
      arc: function(e, t, n, l, s, d) {
        ...
        null === this._x1 ? this._ += "M" + f + "," + m : (Math.abs(this._x1 - f) > r || Math.abs(this
          ._y1 - m) > r) && (this._ += "L" + f + "," + m), n && (p < 0 && (p = p % o + o), p > a ?
          this._ += "A" + n + "," + n + ",0,1," + g + "," + (e - c) + "," + (t - u) + "A" + n + "," +
          n + ",0,1," + g + "," + (this._x1 = f) + "," + (this._y1 = m) : p > r && (this._ += "A" +
            n + "," + n + ",0," + +(p >= i) + "," + g + "," + (this._x1 = e + n * Math.cos(s)) + "," +
            (this._y1 = t + n * Math.sin(s))));
      },
