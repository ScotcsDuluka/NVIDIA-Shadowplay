...
function(module, exports, require) {
  ! function(e, n) {
    ...
    function o(e, t) {
      return function(n, i) {
        for (var o = n.length, r = [], a = 0, l = e[0], s = 0; o > 0 && l > 0 && (s + l + 1 > i && (l =
            Math.max(1, i - s)), r.push(n.substring(o -= l, o + l)), !((s += l + 1) > i));) l = e[a = (a +
          1) % e.length];
    ...
    function d(e, t) {
      ...
      var o = i[0],
        ...
        l = o.length;
      return a === l ? o : a > l ? o + new Array(a - l + 1).join("0") : a > 0 ? o.slice(0, a) + "." + o
    ...
    function c(e, t) {
      ...
      var o = i[0],
        r = i[1];
      return r < 0 ? "0." + new Array(-r).join("0") + o : o.length > r + 1 ? o.slice(0, r + 1) + "." + o
        .slice(r + 1) : o + new Array(r - o.length + 2).join("0");
    }
    ...
    function f(e) {
      function t(e) {
        function t(e) {
          ...
          if ("c" === k) c = C(e) + c, e = "";
            ...
            e = +e;
            var g = e < 0 || 1 / e < 0;
            if (e = isNaN(e) ? h : C(Math.abs(e), w), E && (e = s(e)), g && 0 === +e && "+" !== o && (g = !
                1), d = (g ? "(" === o ? o : p : "-" === o || "(" === o ? "" : o) + d, c = ("s" === k ? S[
                8 + x / 3] : "") + c + (g && "(" === o ? ")" : ""), O)
        ...
        var n = e.fill,
          ...
          E = e.trim,
          k = e.type;
        "n" === k ? (v = !0, k = "g") : y[k] || (void 0 === w && (w = 12), E = !0, k = "g"), (u || "0" ===
          n && "=" === i) && (u = !0, n = "0", i = "=");
        var _ = "$" === r ? d : "#" === r && /[boxX]/.test(k) ? "0" + k.toLowerCase() : "",
          T = "$" === r ? c : /[%p]/.test(k) ? g : "",
          C = y[k],
          O = /[defgprs%]/.test(k);
        return w = void 0 === w ? 6 : /[gprs]/.test(k) ? Math.max(1, Math.min(21, w)) : Math.max(0, Math
          .min(20, w)), t.toString = function() {
          return e + "";
        }, t;
      }
      ...
      var l = void 0 === e.grouping || void 0 === e.thousands ? u : o(w.call(e.grouping, Number), e
          .thousands + ""),
    ...
    m({
      ...
      .precisionFixed = g, e.precisionPrefix = p, e.precisionRound = h, Object.defineProperty(e,
        "__esModule", {
          value: !0
        });
  });
