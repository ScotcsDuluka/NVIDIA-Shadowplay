...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.gamepadService = void 0;
  var o = require(3),
    r = i(o),
    a = require(2) /* app/2 — WINDOW_STYLES (constant) */,
    l = a.ngMainCommonModule.service("gamepadService", ["$log", "$window", "$rootScope", "$timeout",
      "OSC_KEYBOARD", "cefService", "eventAggregator", "GAMEPAD_EVENTS",
      function(e, t, n, i, o, a, l, s) {
        ...
        function u() {
          return h ? (h = !1, m("Left", !1), m("Right", !1), E = "None", void p.info(
            "Gamepad Polling stopped")) : (d.poll(), void window.requestAnimationFrame(u));
        }
        ...
        return d.poll = function() {
          ...
          for (e = 0; e != n.length; ++e) {
            ...
            if (o) {
              ...
              for (u in d.BUTTON_MAPPING) {
                ...
                if (m[k] && ("L1" === u && m[k].pressed && l.trigger(s.LEFT_BUMPER), "R1" === u && m[k]
                    .pressed && l.trigger(s.RIGHT_BUMPER)), c.buttons[u] !== _) {
              ...
              for (u in d.AXIS_MAPPING) {
                ...
                for (var C in T) {
                  var O = T[C],
                    _ = O < h.length ? h[O] : 0;
                  c[u][C] !== _ && (c[u][C] = _, "LS" === u ? (_ > b || _ < -b) && (v = !0) : "RS" ===
                    u && (_ > x || _ < -x) && (v = !0));
                }
              }
              delete i[c.index], y && (++d.count, p.info("Poll: Connected")), v && (l.trigger(s
                .NAVIGATION), r.each(w, function(e, t) {
          ...
          "start" === e ? (p.info("OSC Opening, start polling gamepad"), c(!0), u()) : "stop" === e && (c(
            !1), p.info("OSC Closing, stop polling gamepad"));
        }, d.getControllerDeviceInfo = function() {
          return E;
        }, p.info("Gamepad Service entered"), d.$inject = ["$rootScope"], d.init = function() {
          p.info("Initialize Gamepad"), d.$rootScope = n, d.manual = !1, d.gamepads = {}, d.count = 0,
