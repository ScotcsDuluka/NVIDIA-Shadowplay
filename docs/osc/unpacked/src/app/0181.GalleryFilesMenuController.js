...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.GalleryFilesMenuController = void 0;
  var o = require(3),
    r = i(o),
    a = require(1) /* app/1 — main (module) */;
  require(4) /* app/4 — shadowPlayService (service) */, require(11), require(26) /* app/26 — telemetryService (service) */;
  var l = a.ngMainModule.controller("GalleryFilesMenuController", ["$scope", "$state", "$log", "$document",
    "$timeout", "oscDisplayService", "oscGalleryService", "eventAggregator", "shadowPlayService",
    "galleryService", "telemetryService", "cefService", "KEYBOARD_EVENTS", "GALLERY_STATE",
    "OSC_KEYBOARD", "GALLERY_TYPES", "GALLERY_AUDIOTYPES", "GALLERY_SUBTYPES",
    "TELEMETRY_OSC_EVENT_NAMES", "TELEMETRY_OSC_PERF_ID", "piplConfigService", "COMMON_EVENTS",
    function(e, t, n, i, o, a, l, s, d, c, u, f, m, g, p, h, b, x, v, y, w, S) {
      function E(e, t, n) {
        n === y.galleryFullLoad ? u.endGalleryPerf(e, t, c.wasCached ? y.galleryCached : n) : c
          .wasCached || u.endGalleryPerf(e, t, n);
      }
      ...
      var C = this;
      C.title = "l10n.gallery", C.icon = "icon-gallery", C.status = "", C.folders = [], C.files = [], C
        .thumbs = [], C.recentFiles = [], C.populatedRecentFilesFolder = [], C.videoName = 0, C
        .folderIndex = 0, C.folder = "", C.fileIndex = 0, C.showRecent = !1, C.recentLines = 0, C
        .recentFileIndex = "", C.buttonText = "", C.contentHeight = "600px", C.outlineHeight = "630px", C
        .initialized = !1, C.abortLoading = !1, C.rowSize = 4, C.maxRows = 4, C.disableRemoveButton = !0,
        C.disableUploadButton = !1, C.disableBackButton = !1, C.disableLocationButton = !0, C
        .currentFolderVideos = 0, C.currentFolderImages = 0, C.foundItems = !1, C.enableFilter = !1, C
        .topRow = 0, C.displayFileString = "", C.monitoringFirstLoad = !1, C.numMonitoredFiles = 0, C
        .isConnectEnabled = !1;
      ...
      C.filterData = "", C.setfilterDataPreText = function() {
        ...
        C.item = e.item, C.updateFilterView(), C.enableEscapeEvent(!e.filterOpen), e.filterTabExit === !
          0 && C.processFilterTab();
        ...
        C.fileIndex = t, C.displayFileString = e.path + "\\" + e.folder, C.disableLocationButton = !1, C
          .recentFileIndex = "", O.info("SelectFolder - SingleClick or Mouseover function"), C
          .folderIndex = t, l.setCurrentFolderIndex(t), l.setCurrentFolder(e), C.folder = e, C
          .videoName = e.folder, C.setfilterDataPreText(), l.setCurrentFileIndex(0), l
          .setRecentFileIndex(-1), C.disableRemoveButton = !0, C.buttonText = "l10n.open", C
        ...
        if (e >= 0 && e < C.files.length)
          if (C.filteredView.getFilteredIndex(e) > 0) {
            ...
            t ? C.selectFile(t, t.index, !1) : (C.displayFileString = "", C.disableLocationButton = !0,
              C.disableRemoveButton = !0);
          }
      };
      var A = function() {
      ...
      A.prototype.getItemAtIndex = function(e) {
        ...
        return n < 0 ? null : n + t < 0 || n + t >= this.numItems ? null : C.files[this.filteredMap[n +
          t].index];
        ...
        c.getFolderData(C.useFolder, t, this.PAGE_SIZE).then(angular.bind(this, function() {
          ...
          for (var n = t + this.PAGE_SIZE, i = t; i < n && i < C.files.length; i++) C.files[i] = c
            .getPopulateFolderReference()[i], this.loadedPages[e].push(C.files[i]), C
            .numMonitoredFiles++, i === C.fileIndex && C.selectFile(C.files[i], i, !1);
        ...
        return C.items = C.useFolder.videos + C.useFolder.screenshots, C.filteredView = new A(), C
          .currentFolderVideos = C.useFolder.videos, C.currentFolderImages = C.useFolder.screenshots, O
          .info("OpenFolder items:" + C.items), c.getRawFolderData(C.useFolder, !0).then(function() {
        ...
        u.startPerf(y.galleryPopulateFiles), C.monitoringFirstLoad = !0, C.numMonitoredFiles = 0, O
          .info("OpenFolder - DoubleClick or Button function"), l.setGalleryState(g.FILES), C
          .foundItems = !1, C.folderIndex = void 0 === t ? C.folderIndex : t, C.useFolder = void 0 ===
          e ? C.folder : e;
        var n = C.useFolder.path + "\\" + C.useFolder.folder;
        return c.checkCachedData(n).then(function() {
          return C.openFolderDelayed();
        }).then(function() {
          O.info("OpenFolder - Complete"), E(y.galleryPopulateFiles, C.files.length, y
            .galleryFirstScreen);
        });
      }, C.isActiveFolderIndex = function(e) {
        return C.folderIndex === e;
      }, C.checkIfUploadUnsupported = function(e) {
        return !!e && void 0 !== e.audiotype && (e.audiotype === b.SEPARATE || e.file.subtype === x
          .EXR || e.file.subtype == x.SUPER_RESOLUTION_OVERSIZED);
      }, C.selectFile = function(e, t, n) {
        C.file = e, C.displayFileString = e.fullFilename, C.disableLocationButton = !1, O.info(
          " selectFile : ", e), l.setHevc(e.hevc), n ? (C.fileIndex = "", C.recentFileIndex = t, l
          .setCurrentFolderIndex(0), l.setRecentFileIndex(t), C.folderIndex = "", C
          .disableRemoveButton = !1, C.buttonText = "l10n.upload", C.disableUploadButton = C
          .checkIfUploadUnsupported(C.file) || !C.isConnectEnabled) : (C.fileIndex = t, l
          .setCurrentFileIndex(t), C.recentFileIndex = "", C.filteredView.scrollTo(t), C
          .controlButtons());
      }, C.openFile = function(e) {
        C.disableUploadButton || (e && (C.file = e), void 0 === C.file && (C.file = C.files[0]), C
          .file && (u.push(v.OSC_GALLERY_FILE_OPEN), l.setFileToProcess(C.file), C.upload()));
      }, C.open = function() {
        ...
        return C.foundItems && C.file && C.file.fullFilename ? (C.disableRemoveButton = !1, C
          .disableUploadButton = C.checkIfUploadUnsupported(C.file), void(C.disableLocationButton = !
            1)) : (C.disableRemoveButton = !0, C.disableUploadButton = !0, void(C
          .disableLocationButton = !0));
      }, C.isEmpty = function() {
        ...
        return void 0 !== C.item && (1 === C.item.id || 2 === C.item.id && e.type === h.VIDEO || 10 ===
          C.item.id && e.subtype === x.MTA || 5 === C.item.id && e.subtype === C.item.subtype ||
          "undefined" !== e.type && e.type === h.IMAGE && (e.subtype === C.item.subtype || 3 === C
            .item.id && e.subtype === x.HIGHLIGHTS || 3 === C.item.id && e.subtype === x
            .NORMAL_ANSEL || 6 === C.item.id && e.subtype === x.SUPER_RESOLUTION_OVERSIZED));
        ...
        return u.startPerf(y.galleryPopulateFolders), d.getRecordingPaths().then(function(e) {
          ...
          return C.recentFiles = c.recentFiles, C.populatedRecentFilesFolder = c
            .populatedRecentFilesFolder, C.showRecent = 0 !== C.populatedRecentFilesFolder.length, C
            .recentLines = 0 === C.populatedRecentFilesFolder.length ? 0 : C
            .populatedRecentFilesFolder.length <= C.rowSize ? 1 : 2, c.getUsableData(!0);
        }).then(function(e) {
          if (e) {
        ...
        c.getFolderStats(e).then(function(e) {
          e.videos + e.screenshots === 0 ? C.loadDirectoryView() : (C.openFolder(C.folder, C.folder
              .index), C.currentFolderVideos = e.videos, C.currentFolderImages = e.screenshots, C
            .controlButtons());
        }).then({}, function() {
          C.loadDirectoryView();
        });
        ...
        k(e) && (useFile = C.filteredView.getLastItem(), useFile && C.selectFile(useFile, useFile.index,
          !1));
        ...
        if (O.debug("keyDown keyCode: " + n.keyCode), n.keyCode === p.TAB) {
          var r;
          if (2 === o ? r = n.shiftKey ? "button_filter" : "button_upload" : 1 === o ? r = n
            .shiftKey ? "recent" : "button_open" : 0 === o && (r = n.shiftKey ? "button_close" :
              "folders"), "button_upload" === r && C.disableUploadButton && (r = "button_openLoc"),
            angular.element(i[0].getElementById(r)).focus(), "recent" === r) {
          ...
          var f = 0;
          if (n.keyCode === p.RIGHT_ARROW ? f = 1 : n.keyCode === p.LEFT_ARROW ? f = -1 : n
            .keyCode === p.UP_ARROW ? f = 0 - C.rowSize : n.keyCode === p.DOWN_ARROW && (f = C
              .rowSize), 2 === o) return e = C.filteredView.getItemAtOffset(c, f), void(e && C
            .selectFile(e, e.index, !1));
          var m = c + f;
        ...
        c.active(!1), C.abort(!0, "$destroy"), C.enableEscapeEvent(!1), s.off(S.PIPL_CONFIG_UPDATED,
          T), C.initialized = !1;
      });
    }
  ]);
  exports.GalleryFilesMenuController = l;
}
