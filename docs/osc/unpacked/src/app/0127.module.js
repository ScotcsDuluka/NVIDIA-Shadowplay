  ...
  ! function(e, n) {
    ...
    function a(e) {
      ...
      return isNaN(e) ? "Invalid Date" : r(e.getUTCFullYear()) + "-" + o(e.getUTCMonth() + 1, 2) + "-" + o(e
        .getUTCDate(), 2) + (a ? "T" + o(t, 2) + ":" + o(n, 2) + ":" + o(i, 2) + "." + o(a, 3) + "Z" : i ?
        "T" + o(t, 2) + ":" + o(n, 2) + ":" + o(i, 2) + "Z" : n || t ? "T" + o(t, 2) + ":" + o(n, 2) +
        "Z" : "");
    }
    ...
    function l(e) {
      ...
      function r(e, t) {
        function n() {
          ...
          if (e.charCodeAt(i) === u) {
            ...
            return (t = a) >= r ? s = !0 : (n = e.charCodeAt(a++)) === f ? g = !0 : n === m && (g = !0, e
              .charCodeAt(a) === f && ++a), e.slice(i + 1, t - 1).replace(/""/g, '"');
          }
          for (; a < r;) {
      ...
      function b(e) {
        return null == e ? "" : e instanceof Date ? a(e) : x.test(e += "") ? '"' + e.replace(/"/g, '""') +
          '"' : e;
      }
      var x = new RegExp('["' + e + "\n\r]"),
        v = e.charCodeAt(0);
    ...
    e.autoType = s, e.csvFormat = b, e.csvFormatBody = x, e.csvFormatRow = y, e.csvFormatRows = v, e
      .csvFormatValue = w, e.csvParse = p, e.csvParseRows = h, e.dsvFormat = l, e.tsvFormat = _, e
      .tsvFormatBody = T, e.tsvFormatRow = O, e.tsvFormatRows = C, e.tsvFormatValue = A, e.tsvParse = E, e
      .tsvParseRows = k, Object.defineProperty(e, "__esModule", {
        value: !0
      });
  });
}
