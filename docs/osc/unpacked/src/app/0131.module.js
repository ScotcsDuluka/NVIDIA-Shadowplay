...
function(module, exports, require) {
  ! function(e, i) {
    ...
    function r(e) {
      function r(e, t) {
        return function(n) {
          var i,
            ...
            s = 0,
            d = e.length;
          for (n instanceof Date || (n = new Date(+n)); ++l < d;) 37 === e.charCodeAt(l) && (a.push(e
              .slice(s, l)), null != (o = Ee[i = e.charAt(++l)]) ? i = e.charAt(++l) : o = "e" === i ?
            " " : "0", (r = t[i]) && (i = r(n, o)), a.push(i), s = l + 1);
      ...
      function a(e, r) {
        return function(a) {
          ...
          if (!r || "Z" in c || (c.Z = 0), "p" in c && (c.H = c.H % 12 + 12 * c.p), void 0 === c.m && (c
              .m = "q" in c ? c.q : 0), "V" in c) {
            if (c.V < 1 || c.V > 53) return null;
            "w" in c || (c.w = 1), "Z" in c ? (s = i(o(c.y, 0, 1)), d = s.getUTCDay(), s = d > 4 || 0 ===
              d ? t.utcMonday.ceil(s) : t.utcMonday(s), s = t.utcDay.offset(s, 7 * (c.V - 1)), c.y = s
              .getUTCFullYear(), c.m = s.getUTCMonth(), c.d = s.getUTCDate() + (c.w + 6) % 7) : (s = n(
                o(c.y, 0, 1)), d = s.getDay(), s = d > 4 || 0 === d ? t.timeMonday.ceil(s) : t
              .timeMonday(s), s = t.timeDay.offset(s, 7 * (c.V - 1)), c.y = s.getFullYear(), c.m = s
              .getMonth(), c.d = s.getDate() + (c.w + 6) % 7);
          } else("W" in c || "U" in c) && ("w" in c || (c.w = "u" in c ? c.u % 7 : "W" in c ? 1 : 0), d =
            "Z" in c ? i(o(c.y, 0, 1)).getUTCDay() : n(o(c.y, 0, 1)).getDay(), c.m = 0, c.d = "W" in c ?
            (c.w + 6) % 7 + 7 * c.W - (d + 5) % 7 : c.w + 7 * c.U - (d + 6) % 7);
      ...
      function l(e, t, n, i) {
        for (var o, r, a = 0, l = t.length, s = n.length; a < l;) {
          ...
          if (o = t.charCodeAt(a++), 37 === o) {
            if (o = t.charAt(a++), r = ot[o in Ee ? t.charAt(a++) : o], !r || (i = r(e, n, i)) < 0) return -
              1;
      ...
      return nt.x = r(ze, nt), nt.X = r(Ge, nt), nt.c = r(Ue, nt), it.x = r(ze, it), it.X = r(Ge, it), it
        .c = r(Ue, it), {
          format: function(e) {
            var t = r(e += "", nt);
    ...
    function K(e, n) {
      var i = e.getDay();
      return e = i >= 4 || 0 === i ? t.timeThursday(e) : t.timeThursday.ceil(e), a(e.getFullYear() % 1e4, n,
        4);
    }
    ...
    function ge(e, n) {
      var i = e.getUTCDay();
      return e = i >= 4 || 0 === i ? t.utcThursday(e) : t.utcThursday.ceil(e), a(e.getUTCFullYear() % 1e4,
        n, 4);
    }
    ...
    function ve(t) {
      return Se = r(t), e.timeFormat = Se.format, e.timeParse = Se.parse, e.utcFormat = Se.utcFormat, e
        .utcParse = Se.utcParse, Se;
    }
    ...
    e.isoFormat = Oe, e.isoParse = Ae, e.timeFormatDefaultLocale = ve, e.timeFormatLocale = r, Object
