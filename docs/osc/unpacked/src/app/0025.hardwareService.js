  ...
  var l = a.ngMainCommonModule.service("hardwareService", ["$log", "$q", "$filter", "eventAggregator",
    ...
    function(e, t, n, i, o, a) {
      ...
      function d(e) {
        var t, n, i;
        try {
          return r.isString(e) ? (t = e.split("@"), 2 === t.length && (n = t[0].split("x"), 2 === n
            .length) ? i = n[0] + " x " + n[1] + ", " + t[1] + "Hz" : v) : v;
        } catch (e) {
      ...
      function m() {
        return g && (x.info("canceling gethardware request"), o.get.cancel(b), g = null), p
          .reloadSystemInfo();
      }
      var g = null,
        p = this,
      ...
      p.getSystemDescription = function() {
        return p.getSystemInfo().then(function(e) {
          var t = {};
          return t.gpuName = c(e), t.cpuName = r.isString(e.CPUName) ? e.CPUName : v, t
            .driverVersion = r.isString(e.DriverVersion) ? e.DriverVersion : v, t.physicalMemory =
            s(e.PhysicalMemoryCapacity), t.availablePhysicalMemory = s(e.TotalPhysicalMemory), t
            .currentResolution = d(e.CurrentResolution), t.osName = e.OSName, u(t);
        });
