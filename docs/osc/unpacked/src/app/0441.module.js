...
function(module, exports, require) {
  ! function(e, i) {
    ...
    function f() {
      function e() {
        ...
        if (v || (v = e = t.path()), a < r && (n = a, a = r, r = n), a > Ve) {
          if (d > Ye - Ve) v.moveTo(a * Le(l), a * ze(l)), v.arc(0, 0, a, l, s, !y), r > Ve && (v.moveTo(r *
            Le(s), r * ze(s)), v.arc(0, 0, r, s, l, y));
          else {
            var w,
              S,
              E = l,
            ...
            if (I > Ve) {
              var D = o(I / r * ze(A)),
                N = o(I / a * ze(A));
              (C -= 2 * D) > Ve ? (D *= y ? 1 : -1, _ += D, T -= D) : (C = 0, _ = T = (l + s) / 2), (O -=
                2 * N) > Ve ? (N *= y ? 1 : -1, E += N, k -= N) : (O = 0, E = k = (l + s) / 2);
            }
            var L = a * Le(E),
              F = a * ze(E),
              U = r * Le(T),
            ...
            O > Ve ? P > Ve ? (w = u(B, Y, L, F, a, P, y), S = u(V, H, U, z, a, P, y), v.moveTo(w.cx + w
                  .x01, w.cy + w.y01), P < M ? v.arc(w.cx, w.cy, P, Ne(w.y01, w.x01), Ne(S.y01, S.x01), !
                y) : (v.arc(w.cx, w.cy, P, Ne(w.y01, w.x01), Ne(w.y11, w.x11), !y), v.arc(0, 0, a, Ne(w.cy +
                  w.y11, w.cx + w.x11), Ne(S.cy + S.y11, S.cx + S.x11), !y), v.arc(S.cx, S.cy, P, Ne(S
                  .y11, S.x11), Ne(S.y01, S.x01), !y))) : (v.moveTo(L, F), v.arc(0, 0, a, E, k, !y)) : v
              .moveTo(L, F), r > Ve && C > Ve ? R > Ve ? (w = u(U, z, V, H, r, -R, y), S = u(L, F, B, Y, r,
                -R, y), v.lineTo(w.cx + w.x01, w.cy + w.y01), R < M ? v.arc(w.cx, w.cy, R, Ne(w.y01, w
                .x01), Ne(S.y01, S.x01), !y) : (v.arc(w.cx, w.cy, R, Ne(w.y01, w.x01), Ne(w.y11, w.x11), !
                  y), v.arc(0, 0, r, Ne(w.cy + w.y11, w.cx + w.x11), Ne(S.cy + S.y11, S.cx + S.x11), y), v
                .arc(S.cx, S.cy, R, Ne(S.y11, S.x11), Ne(S.y01, S.x01), !y))) : v.arc(0, 0, r, T, _, y) : v
              .lineTo(U, z);
          }
        } else v.moveTo(0, 0);
    ...
    function b() {
      function e(e) {
        var n,
          ...
          u = e.length,
          f = !1;
        for (null == a && (s = l(c = t.path())), n = 0; n <= u; ++n) !(n < u && r(d = e[n], n, e)) === f &&
          ((f = !f) ? s.lineStart() : s.lineEnd()), f && s.point(+i(d, n, e), +o(d, n, e));
    ...
    function x() {
      function e(e) {
        ...
        for (null == d && (u = c(g = t.path())), n = 0; n <= p; ++n) {
          ...
          h && (b[n] = +o(m, n, e), x[n] = +a(m, n, e), u.point(r ? +r(m, n, e) : b[n], l ? +l(m, n, e) : x[
            n]));
        }
    ...
    function w() {
      function e(e) {
        ...
        for (null != i ? g.sort(function(e, t) {
            ...
            return o(e[t], e[n]);
          }), n = 0, d = m ? (b - f * v) / m : 0; n < f; ++n, h = c) s = g[n], u = p[s], c = h + (u > 0 ?
          u * d : 0) + v, p[s] = {
          data: e[s],
          index: n,
          value: u,
    ...
    function I(e) {
      function i() {
        var n,
          ...
          d = o.apply(this, i),
          c = r.apply(this, i);
        if (s || (s = n = t.path()), e(s, +a.apply(this, (i[0] = d, i)), +l.apply(this, i), +a.apply(this, (
            i[0] = c, i)), +l.apply(this, i)), n) return s = null, n + "" || null;
      }
      var o = O,
        r = A,
        a = p,
    ...
    function F() {
      function e() {
        var e;
        if (r || (r = e = t.path()), i.apply(this, arguments).draw(r, +o.apply(this, arguments)), e)
    ...
    function Z(e, t, n) {
      ...
      if (e._l01_a > Ve) {
        ...
        i = (i * l - e._x0 * e._l12_2a + e._x2 * e._l01_2a) / s, o = (o * l - e._y0 * e._l12_2a + e._y2 * e
          ._l01_2a) / s;
      }
      if (e._l23_a > Ve) {
        var d = 2 * e._l23_2a + 3 * e._l23_a * e._l12_a + e._l12_2a,
          c = 3 * e._l23_a * (e._l23_a + e._l12_a);
        r = (r * d + e._x1 * e._l23_2a - t * e._l12_2a) / c, a = (a * d + e._y1 * e._l23_2a - n * e
          ._l12_2a) / c;
      }
    ...
    function me(e) {
      var t,
        ...
        r = new Array(i),
        a = new Array(i);
      for (o[0] = 0, r[0] = 2, a[0] = e[0] + 2 * e[1], t = 1; t < i - 1; ++t) o[t] = 1, r[t] = 4, a[t] = 4 *
        e[t] + 2 * e[t + 1];
      for (o[i - 1] = 2, r[i - 1] = 7, a[i - 1] = 8 * e[i - 1] + e[i], t = 1; t < i; ++t) n = o[t] / r[t -
        1], r[t] -= n, a[t] -= n * a[t - 1];
    ...
    function ve(e, t) {
      if ((o = e.length) > 1)
        for (var n, i, o, r = 1, a = e[t[0]], l = a.length; r < o; ++r)
          for (i = a, a = e[t[r]], n = 0; n < l; ++n) a[n][1] += a[n][0] = isNaN(i[n][1]) ? i[n][0] : i[n][
            1];
    }
    ...
    function Se() {
      function e(e) {
        var n,
          ...
          c = new Array(d);
        for (n = 0; n < d; ++n) {
          for (var u, f = l[n], m = c[n] = new Array(s), g = 0; g < s; ++g) m[g] = u = [0, +r(e[g], f, g,
            e)], u.data = e[g];
          m.key = f;
        }
      ...
      return e.keys = function(i) {
        ...
        return arguments.length ? (i = null == t ? ye : "function" == typeof t ? t : n(We.call(t)), e) :
        i;
      }, e.offset = function(t) {
    ...
    function ke(e, t) {
      if ((l = e.length) > 0)
        for (var n, i, o, r, a, l, s = 0, d = e[t[0]].length; s < d; ++s)
          for (r = a = 0, n = 0; n < l; ++n)(o = (i = e[t[n]][s])[1] - i[0]) > 0 ? (i[0] = r, i[1] = r +=
            o) : o < 0 ? (i[1] = a, i[0] = a += o) : (i[0] = 0, i[1] = o);
    }
      ...
      if ((o = e.length) > 0 && (i = (n = e[t[0]]).length) > 0) {
        for (var n, i, o, r = 0, a = 1; a < i; ++a) {
          for (var l = 0, s = 0, d = 0; l < o; ++l) {
            for (var c = e[t[l]], u = c[a][1] || 0, f = c[a - 1][1] || 0, m = (u - f) / 2, g = 0; g < l; ++
              g) {
              var p = e[t[g]],
                h = p[a][1] || 0,
                b = p[a - 1][1] || 0;
      ...
      ct = {
        draw: function(e, t) {
          var n = Math.sqrt(t / dt),
            ...
            l = -r,
            s = a;
          e.moveTo(i, o), e.lineTo(r, a), e.lineTo(l, s), e.lineTo(at * i - lt * o, lt * i + at * o), e
            .lineTo(at * r - lt * a, lt * r + at * a), e.lineTo(at * l - lt * s, lt * l + at * s), e
            .lineTo(at * i + lt * o, at * o - lt * i), e.lineTo(at * r + lt * a, at * a - lt * r), e
            .lineTo(at * l + lt * s, at * s - lt * l), e.closePath();
        }
      },
    ...
    G.prototype = {
      ...
      lineEnd: function() {
        var e = this._x,
          ...
          n = e.length - 1;
        if (n > 0)
          for (var i, o = e[0], r = t[0], a = e[n] - o, l = t[n] - r, s = -1; ++s <= n;) i = s / n, this
            ._basis.point(this._beta * e[s] + (1 - this._beta) * (o + i * a), this._beta * t[s] + (1 -
              this._beta) * (r + i * l));
    ...
    te.prototype = {
        ...
        lineEnd: function() {
          ...
          if (n)
            if (this._line ? this._context.lineTo(e[0], t[0]) : this._context.moveTo(e[0], t[0]), 2 === n)
              ...
              for (var i = me(e), o = me(t), r = 0, a = 1; a < n; ++r, ++a) this._context.bezierCurveTo(i[
                0][r], o[0][r], i[1][r], o[1][r], e[a], t[a]);
      ...
      }, e.arc = f, e.area = x, e.areaRadial = T, e.curveBasis = V, e.curveBasisClosed = B, e
      .curveBasisOpen = $, e.curveBundle = ft, e.curveCardinal = mt, e.curveCardinalClosed = gt, e
      .curveCardinalOpen = pt, e.curveCatmullRom = ht, e.curveCatmullRomClosed = bt, e.curveCatmullRomOpen =
      xt, e.curveLinear = g, e.curveLinearClosed = ne, e.curveMonotoneX = ce, e.curveMonotoneY = ue, e
      .curveNatural = ge, e.curveStep = he, e.curveStepAfter = xe, e.curveStepBefore = be, e.line = b, e
      .lineRadial = _, e.linkHorizontal = D, e.linkRadial = L, e.linkVertical = N, e.pie = w, e
      .pointRadial = C, e.radialArea = T, e.radialLine = _, e.stack = Se, e.stackOffsetDiverging = ke, e
      .stackOffsetExpand = Ee, e.stackOffsetNone = ve, e.stackOffsetSilhouette = _e, e.stackOffsetWiggle =
      Te, e.stackOrderAppearance = Ce, e.stackOrderAscending = Ae, e.stackOrderDescending = Me, e
      .stackOrderInsideOut = Re, e.stackOrderNone = ye, e.stackOrderReverse = Pe, e.symbol = F, e
      .symbolCircle = je, e.symbolCross = Ke, e.symbolDiamond = Ze, e.symbolSquare = it, e.symbolStar = nt,
      e.symbolTriangle = rt, e.symbolWye = ct, e.symbols = ut, Object.defineProperty(e, "__esModule", {
        value: !0
      });
  });
}
