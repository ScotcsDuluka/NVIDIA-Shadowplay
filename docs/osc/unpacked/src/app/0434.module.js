...
function(module, exports, require) {
  ! function(e, i) {
    i(exports, require(130), require(81), require(38), require(85));
            ...
            d = p + s;
          {
            ...
            if (r.index > a.index) {
              var c = m - r.x - r.vx,
                f = g - r.y - r.vy,
                b = c * c + f * f;
              b < d * d && (0 === c && (c = l(), b += c * c), 0 === f && (f = l(), b += f * f), b = (d - (
                b = Math.sqrt(b))) / b * u, a.vx += (c *= b) * (d = (s *= s) / (h + s)), a.vy += (f *=
                b) * d, r.vx -= c * (d = 1 - d), r.vy -= f * d);
            }
          }
        }
        for (var n, o, a, m, g, p, h, b = r.length, x = 0; x < f; ++x)
          for (o = t.quadtree(r, s, d).visitAfter(i), n = 0; n < b; ++n) a = r[n], p = c[a.index], h = p *
            p, m = a.x + a.vx, g = a.y + a.vy, o.visit(e);
      }
    ...
    function m(e) {
      ...
      function i(t) {
        for (var n = 0, i = e.length; n < v; ++n)
          for (var o, r, a, s, u, f, m, g = 0; g < i; ++g) o = e[g], r = o.source, a = o.target, s = a.x + a
            .vx - r.x - r.vx || l(), u = a.y + a.vy - r.y - r.vy || l(), f = Math.sqrt(s * s + u * u), f = (
              f - c[g]) / f * t * d[g], s *= f, u *= f, a.vx -= s * (m = p[g]), a.vy -= u * m, r.vx += s * (
              m = 1 - m), r.vy += u * m;
      }
      ...
      function o() {
        if (m) {
          var t,
            ...
            a = e.length,
            l = n.map(m, h);
          for (t = 0, g = new Array(o); t < a; ++t) i = e[t], i.index = t, "object" != typeof i.source && (i
              .source = f(l, i.source)), "object" != typeof i.target && (i.target = f(l, i.target)), g[i
              .source.index] = (g[i.source.index] || 0) + 1, g[i.target.index] = (g[i.target.index] || 0) +
            1;
          for (t = 0, p = new Array(a); t < a; ++t) i = e[t], p[t] = g[i.source.index] / (g[i.source
            .index] + g[i.target.index]);
      ...
      function r(t) {
        ...
        for (var r = 0; r < t; ++r)
          for (d += (f - d) * u, g.each(function(e) {
              e(d);
            }), n = 0; n < o; ++n) i = e[n], null == i.fx ? i.x += i.vx *= m : (i.x = i.fx, i.vx = 0),
            null == i.fy ? i.y += i.vy *= m : (i.y = i.fy, i.vy = 0);
        return s;
      }
      ...
      return null == e && (e = []), a(), s = {
        ...
        find: function(t, n, i) {
          var o,
            ...
            d = 0,
            c = e.length;
          for (null == i ? i = 1 / 0 : i *= i, d = 0; d < c; ++d) l = e[d], o = t - l.x, r = n - l.y,
            a = o * o + r * r, a < i && (s = l, i = a);
          return s;
        },
        on: function(e, t) {
    ...
    function b() {
      ...
      function i(e) {
        var t,
          ...
          l = 0;
        if (e.length) {
          for (i = o = r = 0; r < 4; ++r)(t = e[r]) && (n = Math.abs(t.value)) && (a += t.value, l += n,
            i += n * t.x, o += n * t.y);
          e.x = i / l, e.y = o / l;
        } else {
      ...
      function o(e, t, n, i) {
        ...
        var o = e.x - s.x,
          ...
          a = i - t,
          u = o * o + r * r;
        if (a * a / h < u) return u < m && (0 === o && (o = l(), u += o * o), 0 === r && (r = l(), u += r *
            r), u < f && (u = Math.sqrt(f * u)), s.vx += o * e.value * d / u, s.vy += r * e.value * d /
          u), !0;
        if (!(e.length || u >= m)) {
          (e.data !== s || e.next) && (0 === o && (o = l(), u += o * o), 0 === r && (r = l(), u += r * r),
            u < f && (u = Math.sqrt(f * u)));
          do e.data !== s && (a = c[e.data.index] * d / u, s.vx += o * a, s.vy += r * a); while (e = e
            .next);
        }
      }
      var r,
    ...
    function x(e, t, n) {
      ...
      function o() {
        if (r) {
          var t,
            n = r.length;
          for (l = new Array(n), s = new Array(n), t = 0; t < n; ++t) s[t] = +e(r[t], t, r), l[t] = isNaN(s[
            t]) ? 0 : +d(r[t], t, r);
        }
      }
      var r,
        ...
        s,
        d = a(.1);
      return "function" != typeof e && (e = a(+e)), null == t && (t = 0), null == n && (n = 0), i
    ...
    function v(e) {
      ...
      function n() {
        if (i) {
          var t,
            n = i.length;
          for (o = new Array(n), r = new Array(n), t = 0; t < n; ++t) o[t] = isNaN(r[t] = +e(i[t], t, i)) ?
            0 : +l(i[t], t, i);
        }
      }
      var i,
