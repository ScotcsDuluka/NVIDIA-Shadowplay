...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.PreferencesConnectController = void 0;
  var o = require(3),
    r = i(o),
    a = require(1) /* app/1 — main (module) */;
  require(4) /* app/4 — shadowPlayService (service) */, require(11), require(48) /* app/48 — oscService (provider) */, require(46) /* app/46 — errorDialogService (service) */, require(90) /* app/90 — nvFallbackSrc (directive) */;
  var l = a.ngMainModule.controller("PreferencesConnectController", ["$scope", "$state", "$stateParams",
    "$log", "$filter", "oscNotificationService", "connectService", "oscService", "errorDialogService",
    "eventAggregator", "shadowPlayService", "broadcastService", "ugcService", "KEYBOARD_EVENTS",
    "CONNECT_EVENTS", "OSC_KEYBOARD", "NOTIFIER_SELECTIONS",
    function(e, t, n, i, o, a, l, s, d, c, u, f, m, g, p, h, b) {
      ...
      function y() {
        if (w.shouldShowLoginButton(w.selected)) {
          if (s.onlineState && s.onlineState.online === !1) return E.info("No Internet connection"),
            void d.show("l10n.systemRequirement", "l10n.notificationCoplayNetworkUnavailable");
          var e = !1;
          if (S);
          else if (angular.isDefined(w.selected) && null !== w.selected) {
            if (w.isLoggedIntoService(w.selected)) E.info("Logout clicked for service ", w.selected), l
              .logout(w.selected).then(function(e) {
                E.info("Logout successful from service ", w.selected);
              }, function(e) {
                E.error("Logout NOT successful from service ", w.selected, " error:", e);
              });
            else if (E.info("Login clicked for service ", w.selected), m.checkJarvisLoginRequirement(w
                .selected)) a.show(b.CONNECT_LOGIN_TO_GFE);
      ...
      var w = this;
      w.title = "l10n.settings", w.icon = "icon-settings", w.status = "", w.actionText =
        "l10n.connectLogin", w.showBackButton = !0, w.services = l.services, w.sortedServices = r.sortBy(w
          .services, "name"), w.oauthDialogueParams = {}, w.disableLogout = !1;
      var S,
        E = i.getInstance("main.preferences/preferencesconnectcontroller"),
        k = function(e) {
          w.services[e].userLoginTimestamp = o("date")(l.getLoginTimestamp(e), "medium"), l.getUserName(e)
            .then(function(t) {
      ...
      w.updateStatus = function(e) {
        ...
        var t,
          n = e === w.selected;
        w.disableLogout = !1, S ? (w.showBackButton = !1, t = "l10n.cancel") : w.isLoggedIntoService(
          e) ? (w.showBackButton = !0, t = "l10n.connectLogout", x(e)) : (w.showBackButton = !0, t =
        ...
        return angular.isUndefined(e) && (e = w.selected), void 0 !== e && null !== e && l
          .isLoggedIntoService(e);
      ...
      c.on(g.ESCAPE, _), c.on(p.USER_LOGGED_IN, v), c.on(p.USER_LOGGED_OUT, w.updateStatus), c.on(p
        .LOGIN_BLOCKED, w.onLoginBlocked), e.$on("$destroy", function() {
        c.off(g.ESCAPE, _), c.off(p.USER_LOGGED_IN, v), c.off(p.USER_LOGGED_OUT, w.updateStatus), c
          .off(p.LOGIN_BLOCKED, w.onLoginBlocked);
      });
    }
  ]);
  exports.PreferencesConnectController = l;
}
