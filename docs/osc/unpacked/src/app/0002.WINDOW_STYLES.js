...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.ngMainCommonModule = void 0;
  var r = require(3),
    a = o(r),
    l = require(132),
    s = i(l);
  require(471), require(466), require(468), require(265) /* app/265 — EVENTS_DETAIL_DATA (constant) */, require(88), require(469), require(134), require(
    133);
  var d = require(102) /* app/102 — TELEMETRY_OSC_EVENT_NAMES (constant) */,
    c = require(17) /* app/17 — localSdk (provider) */;
  window._ = a, window.localforage = s.default;
  var u = angular.module("main.common", ["crimson", "ngSanitize", "main.config", "main.userConfig",
    "ngMaterial", "pascalprecht.translate", "ngEventAggregator", "ui.router", c.ngLocalSdkModule.name, d
    .ngTelemetryModule.name, "nvJsEvents", "ugc-lib", "events-detail", "nvAngularAccountSdk",
    "nvExperienceControl"
    ...
    MANUALRECORD: "Manual",
    BROADCAST: "Broadcast"
  }).constant("LOCALHOST_ADDR", "http://localhost:").constant("NOTIFICATION_EVENT",
    "notification-service-event").constant("LOCALHOST_PORT", 3e3).constant("TILE_STATUS_BRUSH", {
    NORMAL: "normal",
