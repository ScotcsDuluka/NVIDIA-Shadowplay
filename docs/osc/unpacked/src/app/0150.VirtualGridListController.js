...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.virtualGridListController = void 0;
      ...
      function(e, t, n, i) {
        ...
        function d(e, n) {
          var i,
            o,
            r = a(n, e.getLength());
          for (s(r), t.nvVirtualGridListItems = h, i = 0; i < r; i++) o = l(i, n, e), t
            .nvVirtualGridListItems[i] = o;
        }
        ...
        function u(e) {
          var t = !1;
          e.columnCount && e.columnCount !== p.columnCount && (p.columnCount = e.columnCount, t = !0), e
            .itemWidth && e.itemWidth !== p.itemWidth && (p.itemWidth = e.itemWidth), e.list && e.list !== p
            .list && (p.list = e.list, "[object Array]" === Object.prototype.toString.call(p.list) && (p
              .list = {
                getLength: function() {
              ...
              }), t = !0), p.list.getLength() != p.listLength && (p.listLength = p.list.getLength(), t = !
            0);
  ...
  exports.virtualGridListController = o;
}
