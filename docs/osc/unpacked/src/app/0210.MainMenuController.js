...
// ==================================================================
// APP MODULE 210
// controller MainMenuController | controller mdMenuBar
...
function(module, exports, require) {
  ...
  require(11), require(4) /* app/4 — shadowPlayService (service) */, require(23) /* app/23 — oscNotificationService (service) */, require(12) /* app/12 — oscDisplayService (service) */, require(33) /* app/33 — coplayService (service) */, require(46) /* app/46 — errorDialogService (service) */, require(26) /* app/26 — telemetryService (service) */, require(48) /* app/48 — oscService (provider) */,
    require(40) /* app/40 — nvCameraService (service) */, require(60) /* app/60 — sdkService (service) */, require(22) /* app/22 — octoolService (service) */;
  var l = require(312),
    s = i(l),
    d = require(311),
    c = i(d),
    u = a.ngMainModule.controller("MainMenuController", ["$scope", "$mdMenu", "$state", "$log", "$document",
      "$timeout", "$q", "$filter", "shadowPlayService", "broadcastService", "osdService",
      "oscNotificationService", "oscDisplayService", "eventAggregator", "COMMON_EVENTS", "coplayService",
      "errorDialogService", "telemetryService", "nvCameraService", "octoolService", "quietMode2Service",
      "SHADOWPLAY_EVENTS", "RECORDING_STATES", "AUDIO_STATE", "NVCAMERA_EVENTS", "BROADCAST_STATES",
      "TILE_STATUS_BRUSH", "NOTIFIER_SELECTIONS", "KEYBOARD_EVENTS", "COPLAY_STATE", "COPLAY_EVENTS",
      "OSC_KEYBOARD", "TELEMETRY_OSC_EVENT_NAMES", "TELEMETRY_OSC_CAPTURE_TYPE", "TELEMETRY_OSC_PERF_ID",
      "VIDEO_STATE", "piplConfigService",
      function(e, t, n, i, o, a, l, d, u, f, m, g, p, h, b, x, v, y, w, S, E, k, T, C, O, A, I, M, R, P, D,
        N, L, F, U, z, G) {
        function V() {
          J.micMenu = {
            items: [{
        ...
        function Y(e) {
          return u.isCoplayBlocked().then(function(t) {
            if (!t) return x.getFullscreenPid().then(function(t) {
              0 === t ? v.show("l10n.systemRequirement", "l10n.notificationWarningGameRequired") :
                t < 0 ? v.show("l10n.notice", "l10n.notificationCoplayCommunicationError") : e();
            });
          });
        }
        ...
        function $() {
          ...
          return le = se = !1, w.isGfeAnselSupported().then(function(t) {
            return le = e = t === !0, le && (se = w.isModsOn()), ee.info("GFE-IPC-Ansel Supported? " +
              e), e;
          }, function(t) {
            return ee.error("call to isGfeAnselSupported() returned with message " + (0, r.default)(t)),
              le = e, e;
          });
        }
        ...
        function Z() {
          h.on(k.WEBCAM_STATUS_CHANGE, J.setCameraState), h.on(k.STATUS_CHANGE_RECORD, J
            .setMenuStateRecord), h.on(k.STATUS_CHANGE_BROADCAST, J.setMenuStateBroadcast), h.on(k
              .IR_RECORDING_STATE_CHANGED, J.setIRMenuState), h.on(k.COPLAY_ENABLED_CHANGED, J
              .setCoplayMenuState), h.on(D.COPLAY_STATE_CHANGED, J.setCoplayState), h.on(k
              .MIC_STATUS_CHANGE, J.setMicMenuState), h.on(O.AVAILABILITY_CHANGED, J.setNvCameraMenuState),
            J.enableEscapeEvent(!0);
        }

        function Q(e) {
          ee.info("Connect status:", e.isConnectEnabled), J.isConnectEnabled = e.isConnectEnabled, J.tiles
            .Broadcast.visible = J.isConnectEnabled, J.tiles.Broadcast.enabled = J.isConnectEnabled;
        ...
        J.isConnectEnabled = !1, J.showDiscoveryBanner = function() {
          ...
          return J.showDiscoveryBanner() && J.showScreenshotDiscoveryBanner() && J
            .showNvCameraDiscoveryBanner() && re;
          ...
          ee.info("Blocking: ", e.keyCode), e.preventDefault(), e.stopImmediatePropagation(), e
            .stopPropagation();
        }, J.keyDownMenu = function(e, t) {
          ee.debug("keyDownMenu keyCode: " + t.keyCode + " tile: " + e.name), t.keyCode === N.DOWN_ARROW ?
            (ie = J.isASideTile(e), "gallery-tile" !== e.name && "preferences-tile" !== e.name &&
              "screenshot-tile" !== e.name && "ansel-tile" !== e.name || J.doNotPropogate(t)) : t
            .keyCode === N.RIGHT_ARROW ? e.name === de ? ie = !0 : "ansel-tile" === e.name ? ie = !1 :
            "preferences-tile" === e.name && te === !0 && J.doNotPropogate(t) : t.keyCode === N
            .LEFT_ARROW && ("instant-replay-tile" === e.name ? ie = !0 : "gallery-tile" === e.name && (
              ie = !1));
        }, J.keyDownSubmenu = function(e, t, n, i) {
          ee.debug("keyDownSubmenu keyCode: " + t.keyCode + " tile: " + e.name), t.keyCode === N
            .RIGHT_ARROW ? e.name === de && (ie = !0) : t.keyCode === N.LEFT_ARROW ?
            "instant-replay-tile" === e.name && (ie = !0) : t.keyCode === N.TAB && te === !0 && i(t);
          ...
          y.startPerf(U.customizeScreen), J.custTeleParams = {
            ...
            .custTeleParams) : e === J.tiles.InstantReplay ? (y.push(L.OSC_CAPTURE_DVR_CUSTOMIZE), y
            .push(L.OSC_CAPTURE_CUSTOMIZE, {
              provider: F.instantReplay
            }), n.go("main.preferences.video", J.custTeleParams)) : (y.push(L
            .OSC_CAPTURE_MANUAL_CUSTOMIZE), y.push(L.OSC_CAPTURE_CUSTOMIZE, {
        ...
        J.preferencesOnClick = function() {
          ...
          B(), ee.info("Navigating to Ansel UI using nvcameraservice."), w.launchUIForNvCamera(
            "uiTrigger");
        ...
        var me = function(e) {
          return void 0 !== e && void 0 !== e.webcamPresent ? l.all([l.when(e.webcamPresent), u
            .getWebcamMode()
        ...
        J.setCameraState = function(e) {
          return me(e).then(function(e) {
            var t = e[0],
              n = e[1];
            t ? (n ? J.tiles.Camera.currentState = "On" : J.tiles.Camera.currentState = "Off", m
              .overlaySettings.Camera.enabled = n, m.saveOverlaySettings("Camera")) : (J.tiles
              .Camera.currentState = "Off", J.tiles.Camera.state.Off.items[0].enabled = !1);
          });
        };
        var ge = function(e) {
          return void 0 !== e && void 0 !== e.micMode && void 0 !== e.micPresentCount ? l.all([l.when(e
            .micMode), l.when(e.micPresentCount)]) : l.all([u.getMicMode(), u.getMicCount()]);
        };
        J.setMicMenuState = function(e) {
          return ge(e).then(function(e) {
            var t = e[0],
              n = e[1];
            "ptt" === t ? J.tiles.Mic.currentState = "PTT" : "alwayson" === t ? J.tiles.Mic
              .currentState = "On" : J.tiles.Mic.currentState = "Off", J.micMenu.items.forEach(
                function(e) {
                  e.enabled = 0 !== n;
                });
          });
          ...
          u.isMultiTrackAudioAvailable().then(function(e) {
            u.setAudioState(C.MAIN), e === !0 ? n.go("main.preferences.audio") : n.go(
              "main.microphone");
          });
        };
        var pe = function(e) {
          return void 0 !== e && void 0 !== e.instantReplayEnabled && void 0 !== e.instantReplayRunning ?
            l.all([l.when(e.instantReplayRunning), l.when(e.instantReplayEnabled)]) : l.all([u
            .isIRActive(), u.isIREnabled()]);
        };
        J.setIRMenuState = function(e) {
          return pe(e).then(function(e) {
            var t = e[0],
              n = e[1];
            ee.info("IR Active: " + t + " IR Enabled: " + n), n ? J.tiles.InstantReplay.currentState =
              T.RECORDING : J.tiles.InstantReplay.currentState = T.NOTRECORDING, J.tiles.InstantReplay
              .state.Recording.items[1].enabled = t, J.tiles.InstantReplay.state.Recording.items[2]
              .enabled = t && ae;
          });
        };
        var he = function(e) {
          return void 0 !== e && void 0 !== e.manualRecordEnabled ? l.when(e.manualRecordEnabled) : u
            .isMRActive();
        };
        J.setMRMenuState = function(e) {
          return he(e).then(function(e) {
            ee.info("Rec mode: ", e), e === !0 ? J.tiles.ManualRecord.currentState = T.RECORDING : J
              .tiles.ManualRecord.currentState = T.NOTRECORDING;
          });
          ...
          e === A.ACTIVE || e === A.STOPPED || e === A.PAUSED ? J.tiles.Broadcast.currentState = e : J
            .tiles.Broadcast.currentState = A.STOPPED;
          ...
          return $().then(function(e) {
            ...
            J.tiles.Screenshot.visible = e, J.tiles.Screenshot.enabled = e, J.tiles.Screenshot
              .extraclass = t, J.tiles.Ansel.visible = e, J.tiles.Ansel.enabled = e, J.tiles.Ansel
              .extraclass = t, J.tiles.Mods.enabled = se, J.tiles.Mods.visible = se, J.tiles.Mods
              .extraclass = t;
          });
        };
        var be = function(e) {
        ...
        J.setBroadcastMenuState = function(e) {
          return J.isConnectEnabled ? be(e).then(function(e) {
            J.broadcastPortalPreference = f.getBroadcastPortalFromName(e), J.broadcastPortalPreference
              .id < 0 ? J.tiles.Broadcast.visible = !1 : J.tiles.Broadcast.visible = !0;
          }) : l.when(!1);
        }, J.setHotkeyShortcuts = function(e) {
          var t = J.shortcuts.screenshot,
            n = J.shortcuts.anselOpen;
          return _.isUndefined(t) || _.isUndefined(t.hotkeyKeys) ? (oe = !1, J.screenshotDiscoveryText =
            "", J.screenshotHotkey = "l10n.disabled") : (oe = 1 !== t.hotkeyKeys.length || 0 !== t
            .hotkeyKeys[0], J.screenshotHotkey = t.hotkeyStr, J.screenshotDiscoveryText = d("translate")
            ("l10n.screenshotDiscovery", {
              arg1: J.screenshotHotkey
            })), _.isUndefined(n) || _.isUndefined(n.hotkeyKeys) ? (re = !1, J.inGamePhotographyText =
            "", J.anselHotkey = "l10n.disabled") : (re = 1 !== n.hotkeyKeys.length || 0 !== n
            .hotkeyKeys[0], J.anselHotkey = n.hotkeyStr, J.inGamePhotographyText = d("translate")(
              "l10n.inGamePhotography", {
                arg1: J.anselHotkey
          ...
          var t = l.defer(),
            n = [];
          return n.push(J.fetchMainViewData()), n.push(J.fetchAudioSettings()), n.push(J
          .fetchHotKeyData()), n.push($()), n.push(X()), l.all(n).then(e), t.promise;
        }, J.initialize = function() {
          return ee.info("Initialize Enter"), h.on(b.PIPL_CONFIG_UPDATED, Q), J.fetchInitializeData()
            .then(function(e) {
              return G.isConnectEnabled();
            }).then(function(e) {
              J.isConnectEnabled = e, V(), Z(), W(J.mainMenuData), K(!0), ee.info("Initialized Data: ",
                J.mainMenuData);
            });
        }, J.initialize(), e.$on("$destroy", function() {
          h.off(k.WEBCAM_STATUS_CHANGE, J.setCameraState), h.off(k.STATUS_CHANGE_RECORD, J
            .setMenuStateRecord), h.off(k.STATUS_CHANGE_BROADCAST, J.setMenuStateBroadcast), h.off(k
            .IR_RECORDING_STATE_CHANGED, J.setIRMenuState), h.off(k.COPLAY_ENABLED_CHANGED, J
            .setCoplayMenuState), h.off(D.COPLAY_STATE_CHANGED, J.setCoplayState), h.off(k
            .MIC_STATUS_CHANGE, J.setMicMenuState), h.off(O.AVAILABILITY_CHANGED, J
            .setNvCameraMenuState), h.off(b.PIPL_CONFIG_UPDATED, Q), J.enableEscapeEvent(!1);
        });
      }
    ]);
  exports.MainMenuController = u;
}
