...
function(module, exports, require) {
  ! function(e, n) {
    ...
    e.timeDay = v, e.timeDays = y, e.timeFriday = T, e.timeFridays = P, e.timeHour = b, e.timeHours = x, e
      .timeInterval = t, e.timeMillisecond = a, e.timeMilliseconds = l, e.timeMinute = p, e.timeMinutes = h,
      e.timeMonday = S, e.timeMondays = A, e.timeMonth = N, e.timeMonths = L, e.timeSaturday = C, e
      .timeSaturdays = D, e.timeSecond = m, e.timeSeconds = g, e.timeSunday = w, e.timeSundays = O, e
      .timeThursday = _, e.timeThursdays = R, e.timeTuesday = E, e.timeTuesdays = I, e.timeWednesday = k, e
      .timeWednesdays = M, e.timeWeek = w, e.timeWeeks = O, e.timeYear = F, e.timeYears = U, e.utcDay = B, e
      .utcDays = Y, e.utcFriday = X, e.utcFridays = ie, e.utcHour = V, e.utcHours = H, e.utcMillisecond = a,
      e.utcMilliseconds = l, e.utcMinute = z, e.utcMinutes = G, e.utcMonday = W, e.utcMondays = J, e
      .utcMonth = re, e.utcMonths = ae, e.utcSaturday = Z, e.utcSaturdays = oe, e.utcSecond = m, e
      .utcSeconds = g, e.utcSunday = $, e.utcSundays = Q, e.utcThursday = q, e.utcThursdays = ne, e
      .utcTuesday = j, e.utcTuesdays = ee, e.utcWednesday = K, e.utcWednesdays = te, e.utcWeek = $, e
      .utcWeeks = Q, e.utcYear = le, e.utcYears = se, Object.defineProperty(e, "__esModule", {
        value: !0
      });
  });
}
