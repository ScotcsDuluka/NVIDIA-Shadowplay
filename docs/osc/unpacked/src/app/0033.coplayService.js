...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.coplayService = void 0;
  var o = require(8),
    r = i(o),
    a = require(110),
    l = i(a),
    s = require(2) /* app/2 — WINDOW_STYLES (constant) */;
  require(17) /* app/17 — localSdk (provider) */, require(23) /* app/23 — oscNotificationService (service) */, require(46) /* app/46 — errorDialogService (service) */, require(94) /* app/94 — webrtcP2PService (service) */, require(4) /* app/4 — shadowPlayService (service) */, require(20) /* app/20 — socketService (provider) */, require(61) /* app/61 — settingsService (service) */;
  var d = s.ngMainCommonModule.service("coplayService", ["$window", "$filter", "$timeout", "$log", "$q",
    ...
    "errorDialogService", "cefService", "webrtcP2PService", "shadowPlayService", "telemetryService",
    "COPLAY_STATE", "COPLAY_EVENTS", "COPLAY_CONTROLLER_MAPPING", "OSC_EVENTS", "NOTIFIER_SELECTIONS",
    "SHADOWPLAY_EVENTS", "HOTKEY_EVENTS", "TELEMETRY_OSC_EVENT_NAMES",
    function(e, t, n, i, o, a, s, d, c, u, f, m, g, p, h, b, x, v, y, w, S, E, k) {
      ...
      function P(e) {
        e !== Q && (Q = e, d.trigger(x.COPLAY_STATE_CHANGED), de && e === b.OFF ? A() : de || e !== b
          .ON && e !== b.PAUSED || O(), p.setCoplayState(Q));
      }

      function D(e) {
        void 0 === ("undefined" == typeof e ? "undefined" : (0, l.default)(e)) && f.show("l10n.notice",
            "l10n.notificationCoplayInviteFailed"), P(b.OFF), j.sessionId = "", $.deleteSession(), n
          .cancel(J), J = null;
      }
      ...
      function L() {
        P(b.OFF), te = !1, oe && (n.cancel(oe), n.cancel(re), n.cancel(ae), n.cancel(le)), j.sessionId =
          "", j.serverAddress = "", h.push(k.OSC_GAMESHARE_STOPPED);
      }
      ...
      function U(e) {
        return Q !== b.CREATINGINVITE ? (j.sessionId = e.sessionInfo.sessionId, void $.deleteSession()) :
          (P(b.INVITESENT), j.sessionId = e.sessionInfo.sessionId, j.state = e.sessionInfo.state, j
            .title = e.sessionInfo.gameTitle, j.exePath = e.sessionInfo.gameExePath, j.serverAddress = e
            .sessionInfo.serverAddress, j.processId = e.sessionInfo.processId, j.serverAddress.indexOf(
              "://") === -1 && (j.serverAddress = "wss://" + e.sessionInfo.serverAddress), void(
              "invitePrepared" === e.status && m.setClipboardData(e.invitationLink)));
      }
      ...
      function z(e) {
        if (n.cancel(J), J = null, W.info("create session callback: ", e), "failed" === e.status) {
          ...
          D(!0);
        } else "inviteSent" === e.status || "invitePrepared" === e.status ? U(e) : "sendingInvite" === e
          .status || "preparingInvite" === e.status ? W.info("preparing invite") : W.info(
            "unknown response from coplay: ", e);
      }
      ...
      function G(e) {
        if (W.info("session update: ", e), e.state)
          ...
          P(b.ON), oe = n(function() {
              ...
              $.deleteSession();
            }, 1e3 * (60 * ie - 15)), u.show(w.COPLAY_NOW_PLAYING, K), $.setControllerMapping(), ne && !
            te && F(ne);
        }
      ...
      function Y() {
        ...
        W.info("Registering coplay notification events"), s.register(e, n), s.register(t, i), d.on(n, G),
          d.on(i, z), d.on(y.OSC_STATE, B), d.on(E.MIC_PTT_DOWN, I), d.on(E.MIC_PTT_UP, M), d.on(S
            .MIC_STATUS_CHANGE, R);
      }
      var $ = this,
      ...
      $.getInviteName = function() {
        ...
        "undefined" != typeof n && (i = n), h.push(k.OSC_GAMESHARE_INVITE_EMAIL), u.show(w
          .COPLAY_SENDING_INVITE, e), K = e;
        var o = {
          activeWindow: c.getLastActiveWindow(),
          displayName: i,
          inviteMode: "email",
        ...
        W.info("Initialize CoplayService"), p.getMicMode().then(function(e) {
            ce = e;
          }), $.getControllerMapping(), H(), V(), g.registerRemoteVideoCallback(se, T), g
          .registerHangupCallback(se, _), Y();
      };
    }
  ]);
  exports.coplayService = d;
}
