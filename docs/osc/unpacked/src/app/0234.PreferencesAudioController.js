...
function(module, exports, require) {
  ...
  s.ngMainModule.controller("PreferencesAudioController", ["$log", "$scope", "$state", "$timeout", "$filter",
    "shadowPlayService", "eventAggregator", "$document", "telemetryService", "KEYBOARD_EVENTS",
    "OSC_KEYBOARD", "AUDIO_STATE", "TELEMETRY_OSC_EVENT_NAMES",
    function(e, t, n, i, o, a, s, d, c, u, f, m, g) {
      var p = this;
      p.disableBoost = !1, p.disableMicSelect = !1, p.settingsChanged = !1, p.disableTrackChange = !1, p
        .throttleTime = 333, p.displayWarningMessage = !1, p.numOfMics = 0, p.disableMics = !0, p
        .Items = [], p.item = null, p.ItemsUponEntry = [], p.initialIndex = 0, p.audioSettings = {}, p
        .audioSettingsUponEntry = {}, p.singleTrack = !0, p.undoCount = 0, p.title = "l10n.settings", p
        .icon = "icon-settings", p.status = "", t.textVolume = "l10n.volume", t.textSource =
        "l10n.source", t.textBoost = "l10n.boost", t.leftWidth = "", t.rightWidth = "";
      ...
      p.noMic = {
        ...
        return h.info("Save Audio Settings: ", p.audioSettings), a.setAudioSettings(p.audioSettings)
          .then(function() {
            p.settingsChanged = e, h.info("Save audio settings done");
          });
      }, p.undoSettings = function() {
        if (0 === p.undoCount && (p.undoCount++, h.info("undoSettings Entered!"), p.settingsChanged ===
            !0)) {
          h.info("undoing Settings!");
          var e = null;
          _.forEach(p.ItemsUponEntry, function(t) {
              p.initialIndex !== t.index ? (p.item = t, p.saveSettings(!1)) : e = t;
            }), p.item = e, p.saveSettings(!1), p.audioSettings = p.audioSettingsUponEntry, p
            .saveAudioSettings(!1).then(function() {
        ...
        if (p.disableTrackChange !== !1) {
          ...
          p.singleTrack === !0 ? e.highlights ? a.appCaptureProcessInfo().then(function(e) {
            ...
            }) : e.instantReplay ? p.message = o("translate")("l10n.warningAudioIrT1") : e
            .manualRecord ? p.message = o("translate")("l10n.warningAudioMrT1") : e.broadcast && (p
              .message = o("translate")("l10n.warningAudioBrT1")) : e.highlights ? a
            .appCaptureProcessInfo().then(function(e) {
              p.message = o("translate")("l10n.warningAudioHlT2", {
                arg1: e.profileName
              });
            }) : e.instantReplay ? p.message = o("translate")("l10n.warningAudioIrT2") : e
            .manualRecord ? p.message = o("translate")("l10n.warningAudioMrT2") : e.broadcast && (p
              .message = o("translate")("l10n.warningAudioBrT2"));
        }
        ...
        h.info("Initialize Audio Preferences"), a.getMicrophoneSettingsAll().then(function(e) {
          ...
          return p.item = p.disableMics ? p.noMic : e, p.initialIndex = p.item.index, a
            .getAudioSettings();
        }).then(function(e) {
          return p.audioSettings = e, p.audioSettingsUponEntry = (0, r.default)({}, p
            .audioSettings), a.checkCustomize(!1);
        }).then(function(e) {
          h.info("MTA Track buttons enabled: ", !e), p.disableTrackChange = !e, p.singleTrack = !p
            .audioSettings.separateTracks, p.checkRunState(), p.enableEscapeEvent(!0), p
            .setupDisplay(), angular.element(d[0].getElementById("firstSlider")).focus(), b = !0, p
            .checkMicSelect(), p.checkBoost(), h.info("Microphone initialized");
        }, function(e) {
          h.error("Microphones did not init properly ", e), p.disableMics = !0, p.checkMicSelect(),
            p.checkBoost();
        });
