...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.quietMode2Service = void 0;
  var o = require(3),
    r = i(o),
    a = require(2) /* app/2 — WINDOW_STYLES (constant) */;
  require(99) /* app/99 — quietMode2Endpoints (provider) */;
  var l = a.ngMainCommonModule.service("quietMode2Service", ["$q", "$timeout", "$log", "eventAggregator",
    ...
    function(e, t, n, i, o, a, l, s, d, c) {
      ...
      function f(e) {
        I.info("processStateInfo response:", e), A = e.data, A.fanVolumeMode = m(A.fanVolume), _ && (_
          .resolve(A), t.cancel(T), T = null, _ = null);
      }
      ...
      function p() {
        if (r.isNull(_)) {
          ...
          return n.then(f).catch(function(e) {
            I.error("failed to get quietmode state info", e), _.reject(e), t.cancel(T), T = null, _ =
              null;
          }), T = t(function() {
