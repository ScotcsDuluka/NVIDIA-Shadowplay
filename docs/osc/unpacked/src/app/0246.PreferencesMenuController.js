...
function(module, exports, require) {
  ...
  Object.defineProperty(exports, "__esModule", {
    value: !0
  }), exports.PreferencesMenuController = void 0;
  var o = require(3),
    r = i(o),
    a = require(1) /* app/1 — main (module) */;
  require(4) /* app/4 — shadowPlayService (service) */, require(33) /* app/33 — coplayService (service) */, require(23) /* app/23 — oscNotificationService (service) */;
  var l = a.ngMainModule.controller("PreferencesMenuController", ["$scope", "$state", "$log", "$stateParams",
    "eventAggregator", "COMMON_EVENTS", "shadowPlayService", "oscService", "errorDialogService",
    "coplayService", "telemetryService", "nvCameraService", "octoolService", "piplConfigService",
    "KEYBOARD_EVENTS", "OSC_CONFIG", "OSC_KEYBOARD", "AUDIO_STATE", "VIDEO_STATE",
    "TELEMETRY_OSC_PERF_ID", "TELEMETRY_OSC_EVENT_NAMES", "TELEMETRY_OSC_CAPTURE_TYPE",
      ...
      k.title = "l10n.settings", k.icon = "icon-settings", k.status = "", k.tileIndex = 0, k.tiles = [], k
        .multiTrackAudioAvailable = !1, k.isConnectEnabled = !1, k.initPreferencesMenu = function() {
          g.isConnectEnabled().then(function(e) {
            return k.isConnectEnabled = e, o.on(a.PIPL_CONFIG_UPDATED, E), l
              .isMultiTrackAudioAvailable().then(function(e) {
          ...
          var e = l.isDesktopCaptureSettingShown().then(function(e) {
            ...
            t = 0;
          t = k.getTileIndex("stream-tile"), k.tiles[t].visible = c.shouldShowCoplaySetting(), t = k
            .getTileIndex("hangout-tile"), k.tiles[t].visible = h.hangouts, e.then(function() {
          ...
          if (u.startPerf(y.keyboardShortcutScreen), !e.precondition || e.precondition && e
          .precondition()) {
            var n = null;
            "main.preferences.keyboard-shortcuts" === e.state && (n = function() {
              ...
              "main.preferences.video" !== e.state && "main.preferences.broadcast" !== e.state || (u
                .startPerf(y.customizeScreen), l.setVideoState(v.PREFERENCES), n = function(e) {
          ...
          k.tileIndex = e, t.keyCode === b.TAB && t.shiftKey === !1 ? k.incDown(e, !0) : t.keyCode === b
            .DOWN_ARROW ? k.incDown(e, !1) : t.keyCode === b.UP_ARROW ? k.incUp(e, !1) : t.keyCode === b
            .TAB && t.shiftKey === !0 && k.incUp(e, !0);
        }, o.on(p.ESCAPE, k.back), e.$on("$destroy", function() {
          o.off(p.ESCAPE, k.back), o.off(a.PIPL_CONFIG_UPDATED, E);
        });
    }
  ]);
  exports.PreferencesMenuController = l;
}
