...
function(e, t, n) {
  ...
  var r = n(8),
    ...
    u = n(2);
  n(17), n(88), n(134);
  var f = u.ngMainCommonModule.service("telemetryService", ["$q", "$timeout", "$log", "jsEventsService", "cefService",
    "eventsDetailService", "eventAggregator", "nvAccountService", "gameProfileService", "socketService",
    "ACCOUNT_SOCKET_EVENTS", "ACCOUNT_EVENTS", "GDPR_CONSENT", "OSC_CONFIG", "OSC_BUILD_INFO", "OSC_EVENTS",
    "TELEMETRY_OSC_TOGGLE_STATE", "TELEMETRY_OSC_EVENT_NAMES", "TELEMETRY_OSC_VALID_PROVIDERS",
    "TELEMETRY_OSC_SCREEN_STATE", "TELEMETRY_OSC_BOOLEAN_STATUS", "EVENTS_DETAIL_DATA", "EVENTS_RETURN_CODE",
    "CONNECT_EVENTS", "GALLERY_TYPES", "GALLERY_EVENTS",
    function(e, t, n, i, o, r, l, d, u, f, m, g, p, h, b, x, v, y, w, S, E, k, _, T, C, O) {
      ...
      function I(e, t, n, i, o) {
        for (var a in t)
          if (void 0 === t[a] || null === t[a]) {
            ...
            for (var a in t) void 0 !== t[a] && null !== t[a] || !l.parameters || (t[a] = l.parameters[a]);
            break
      ...
      function P(e) {
        return !(!e || e === _.INVALID_INFO_FOR_EVENT_TYPE || e === _.UNKNOWN_EVENT_TYPE || e === _.UNPROCESSED)
      }
      ...
      var N = this,
        L = [],
        F = [],
        U = [y.OSC_BROADCAST_END, y.OSC_ANSEL_NAVIGATION, y.OSC_ANSEL_SCREENSHOT_COMPLETED, y.OSC_ANSEL_ERROR, y
          .OSC_CAPTURE_EVENT, y.OSC_SHADOWPLAY_CAPTURE_ERROR, y.OSC_GIF_CONVERSION_ATTEMPT, y
          .OSC_FREESTYLE_FILTERS_APPLIED, y.OSC_FREESTYLE_FILTERS_ADDED, y.OSC_FREESTYLE_FILTERS_SLOT_CHANGED, y
          .OSC_MENU_LAUNCH, y.OSC_HOTKEY_SETTINGS_EVENT, y.OSC_ANSEL_FILTER_CONTROL_SETTINGS, y
          .OSC_ANSEL_LITE_SCREENSHOT_TAKEN, y.OSC_ANSEL_SCREENSHOT_STARTED, y.OSC_ANSEL_SCREENSHOT_CANCELLED, y
          .OSC_ANSEL_SCREENSHOT_FAILED, y.OSC_PERFORMANCE_TOOL_LATENCY_METRICS, y.OSC_PERFORMANCE_TOOL_SAMPLE_SIZE,
          y.OSC_PERFORMANCE_TOOL_RESET_AVERAGE, y.OSC_PERFORMANCE_TOOL_LOGGING_SESSION, y
          .OSC_PERFORMANCE_TOOL_OVERLAY_SESSION, y.OSC_PERFORMANCE_TOOL_SETTINGS
        ];
      N.sessionId = "", N.deviceId = "", N.userId = "", N.clientVersion = b.oscPackageVersion, N.clientVersion || (N
        .clientVersion = b.oscclientVersion + "-" + b.gitHash);
      ...
      N.push = function(e, t) {
        ...
        if (t = t || {}, c.findWhere(U, e)) {
          var n = u.getDRSInfo();
          t.info = t.info || {}, t.info.DRSName = n.DRSName || "", t.info.DRSProfileName = n.DRSProfileName || ""
        }
        ...
        if (A(G.TIMER, e, t)) {
          ...
          var s = l.startTime,
            d = I(e, t.info, k, s, r);
          P(d) ? (z.perf(e, s, o), i.sendEventDetail(e, d, r)) : z.error("Telemetry event schema mismatch for ",
            e, t.info)
        }
        ...
        if (A(G.PERF, e, {
          ...
          if (t = t || w[0], !c.contains(w, t)) return void z.error("Invalid provider " + t + "measured");
          var a = {
              appExit: !1,
              negativeDurationLimit: -1e8
            },
          ...
          l.name = e, N.isInDesktopMode().then(function(n) {
            ...
            if (!s || !s.startTime) return void z.error("Attempted to end a performance measurement '" + e +
              "' without starting it!");
            var d = s.startTime;
            s.startTime = null;
            var u = {
              ...
              f = I(l, u, k, d, a);
            P(f) ? (f.parameters.id = e, f.parameters.totalMs = r - d, z.perf(e, d, r, u), i.sendEventDetail(y
              .OSC_AUTOMATED_UI_PERF, f, a)) : z.error("Performance data schema mismatch for ", l, t)
          })
        }
        ...
        N.sessionId = N.sessionId || D(), N.deviceId = N.deviceId || e && e.deviceId, N.userId = N.userId || e &&
          e.userId, i.setEventsCommonData({
        ...
        if (e.error) {
          ...
          var o = "Upload Error: ";
          e.error.status ? (o += "status=" + e.error.status, o += ", statusText=" + e.error.statusText) : o += (0,
            a.default)(e.error), i.info.message = o
        } else n.id = t ? y.OSC_VIDEO_UPLOAD_DURATION.id : y.OSC_IMAGE_UPLOAD_DURATION.id,
          n.enumId = t ? y.OSC_VIDEO_UPLOAD_DURATION.enumId : y.OSC_IMAGE_UPLOAD_DURATION.enumId;
        N.endTimer(n, i)
      ...
      N.updateClientTelemetryConsent = function() {
          return d.getClientTelemetryConsent().then(function(e) {
            ...
            } else z.error("Unable to get consent data from response, disabling all consent for now."), N
              .disableAllConsent()
          }).catch(function(e) {
          ...
          if (z.info("Setting user consent settings to: ", e), e.userId) {
            ...
            N.userId != e.userId && (z.info("Updating telemetry UserId from " + N.userId + " to " + e.userId), N
              .userId = e.userId, N.setEventsCommonData())
          ...
          return d.getJarvisUserToken().then(function(e) {
            return e.userInfo && e.userInfo.userId ? d.getUserTelemetryConsent(e.userInfo.userId).then(function(
              e) {
            ...
            }) : (z.error("No valid logged in user detected, falling back to client consent setting."), N
              .updateClientTelemetryConsent())
          }).catch(function(e) {
            return z.error("Unable to get Jarvis user token, falling back to client consent setting. Error: ",
              e), N.updateClientTelemetryConsent()
          })
        }, N.onUserConsentChanged = function(e) {
          e.userId && (z.info("telemetryService received Accounts module user consent changed notification."), N
            .setUserConsent(e))
        }, N.updateServer = function(e) {
          i.updateServer(e)
        }, N.init = function() {
          return z.info("Initialize TelemetryService"), l.on(x.DESKTOP_STATE, N.saveDesktopMode), l.on(T
            .USER_LOGGED_IN, N.onServiceLogin), l.on(T.BROADCAST_ERROR, N.onBCError), l.on(O.UPLOAD_COMPLETE, N
            .onUploadComplete), f.register(m.USER_CONSENT_CHANGED, g.USER_CONSENT_CHANGED), l.on(g
            .USER_CONSENT_CHANGED, N.onUserConsentChanged), N.updateUserTelemetryConsent()
