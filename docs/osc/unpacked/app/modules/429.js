...
function(e, t, n) {
  ! function(e, n) {
    ...
    function l(e, l) {
      function s(n) {
        var i = null == c ? l.ticks ? l.ticks.apply(l, d) : l.domain() : c,
          ...
          P = I.select("line"),
          D = I.select("text");
        A = A.merge(A.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), I = I
          .merge(R), P = P.merge(R.append("line").attr("stroke", "currentColor").attr(S + "2", w * x)), D = D.merge(R
            .append("text").attr("fill", "currentColor").attr(S, w * f).attr("dy", e === m ? "0em" : e === p ?
              "0.71em" : "0.32em")), n !== O && (A = A.transition(n), I = I.transition(n), P = P.transition(n), D = D
            .transition(n), M = M.transition(n).attr("opacity", b).attr("transform", function(e) {
            ...
            })), M.remove(), A.attr("d", e === h || e == g ? v ? "M" + w * v + "," + _ + "H0.5V" + T + "H" + w * v :
            "M0.5," + _ + "V" + T : v ? "M" + _ + "," + w * v + "V0.5H" + T + "V" + w * v : "M" + _ + ",0.5H" + T), I
          .attr("opacity", 1).attr("transform", function(e) {
            return E(C(e))
          }), P.attr(S + "2", w * x), D.attr(S, w * f).text(s), O.filter(a).attr("fill", "none").attr("font-size", 10)
          .attr("font-family", "sans-serif").attr("text-anchor", e === g ? "start" : e === h ? "end" : "middle"), O
          .each(function() {
            this.__axis = C
          })
      }
    ...
    var f = Array.prototype.slice,
      ...
      h = 4,
      b = 1e-6;
    e.axisTop = s, e.axisRight = d, e.axisBottom = c, e.axisLeft = u, Object.defineProperty(e, "__esModule", {
      value: !0
    })
  })
}
