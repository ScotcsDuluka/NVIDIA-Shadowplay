// ─────────────────────────────────────────────────────────────
// APP MODULE 260
// role       : controller FolderBrowserController
// requires   : (none)
...
function(e, t, n) {
  ...
  Object.defineProperty(t, "__esModule", {
    value: !0
  }), t.FolderBrowserController = void 0;
  var o = n(3),
    r = i(o),
    a = n(1);
  n(25), n(4), n(11);
  var l = a.ngMainModule.controller("FolderBrowserController", ["$q", "$scope", "$state", "$stateParams", "$log",
    "$filter", "$document", "hardwareService", "eventAggregator", "shadowPlayService", "galleryService",
    "RECORDING_PATH_TYPES", "KEYBOARD_EVENTS", "OSC_KEYBOARD",
    function(e, t, n, i, o, a, l, s, d, c, u, f, m, g) {
      function p(e) {
        ...
        i && i.currentPath ? t = i : e && e.currentPath ? t = e : (O.error(
            ...
            ), t = e || i), T.parentView = t.parentView, T.heading = t.heading, T.callbackFunction = t.callback, T
          .initialVal = t.init, T.callbackParam = t.callbackParam, T.currentPath = t.currentPath, T.pathType = t
          .pathType, T.includeFiles = t.includeFiles || !1, T.match = t.match || ".png", T.pathType || (T
            .showWarningMessage = !1)
      }

      function h() {
        T.abort = !0, T.parentView ? n.go(T.parentView) : T.callbackFunction && T.callbackFunction(void 0, T
          .callbackParam)
      }
      ...
      function x(e) {
        var t = e;
        return T.pathType !== f.TEMP_FILES && T.pathType !== f.HIGHLIGHTS || !t.endsWith("\\") || (t = t.slice(0, t
          .length - 1)), t
      }
      ...
      function _(e) {
        if (!T.includeFiles && !T.dirFolderData[e].isFile) {
          ...
          u.isDirectoryWritable(t).then(function(n) {
            T.dirFolderData[e] && t === T.currentPath + "\\" + T.dirFolderData[e].folder && (T.dirFolderData[e]
              .isReadOnly = !n)
          })
        }
      }
      ...
      var C, O = o.getInstance("osc/RecordingsFolderBrowserController"),
        A = "TOP_LEVEL_DRIVES",
        I = 12;
      T.currentPath = "", T.currentFolder = "", T.pathType = "", T.dirFolderData = [], T.thumbnailList = [], T
        .focusedFolderID = -1, T.hoveredFolderID = -1, T.activeFolderID = -1, T.abort = !1, T.loadCount = 0, T
        .rowSize = 5, T.displayWarning = !1, T.doneDisable = !1;
      var M = 4096,
        R = 4096;
      T.initialize = function(e) {
        ...
        return n === f.VIDEOS || n === f.TEMP_FILES || n === f.HIGHLIGHTS || n === f.FILE_LOGGING || T
          .includeFiles ? ("" === t && (O.error("ERROR, invalid current path"), t = "C:\\"), T.pathType = n, T
            .currentPath = x(t), void T.loadData(!0)) : (O.error("ERROR, invalid path type"), void h())
      }, T.reload = function() {
        ...
        if (T.currentPath === A) return s.getSystemInfo().then(function(e) {
          ...
          T.loadCount === n && r.each(e.drives, function(e, t) {
            var n = {};
            n.index = t, n.folder = e.name, n.icon = w(e.type), n.isFile = !1, T.dirFolderData.push(n)
          })
        }, function(e) {
        ...
        !T.includeFiles && e && (c = T.currentFolder = T.currentPath.slice(0, T.currentPath.lastIndexOf("\\")),
          l = T.currentPath.slice(T.currentPath.lastIndexOf("\\") + 1), T.currentPath = T.currentFolder, T
          .currentFolder = T.currentPath.slice(0, T.currentPath.lastIndexOf("\\"))), u.getGalleryFolderListing(
          c, !1, i, o).then(function(e) {
          if (T.loadCount === n) {
            var i = 0;
            ...
            r.each(e.files, function(e) {
              if (t(e)) {
                var n = {};
                n.index = i++, n.folder = e.name, n.icon = "icon-browser_file_png", n.isFile = !0, n
                  .isFileInvalid = !1, n.warningText = void 0;
                ...
                }), T.dirFolderData.push(n), T.thumbnailList.push(n), e.name === T.initialVal && (T
                  .focusedFolderID = i - 1, T.activeFolderID = i - 1)
              }
        ...
        T.activeFolderID = e, T.isInvalidFolder(e) || (T.focusedFolderID = e, T.dirFolderData[e].isFile ? T
          .selectFolder() : T.openFolder())
        ...
        if (T.currentPath !== A) {
          ...
          T.includeFiles ? T.currentPath = T.currentPath.slice(0, T.currentPath.lastIndexOf("\\")) : (T
            .currentPath = T.currentFolder, T.currentFolder = T.currentPath.slice(0, T.currentPath.lastIndexOf(
              "\\"))), T.reload()
        }
      }, T.openFolder = function() {
        if (T.focusedFolderID !== -1) {
          var e = "";
          T.currentPath !== A && (e = T.currentPath + "\\"), e += T.dirFolderData[T.focusedFolderID].folder, T
            .currentPath === A && (e = e.split("\\")[0]), T.currentPath = e, T.currentFolder = T.currentPath
            .slice(0, T.currentPath.lastIndexOf("\\")), T.reload()
        }
        ...
        if (!(T.currentPath === A || T.includeFiles && T.isInvalidFolder(T.focusedFolderID))) {
          ...
          if (T.focusedFolderID !== -1 && (t = t + "\\" + T.dirFolderData[T.focusedFolderID].folder), !T
            ...
            if (T.includeFiles || T.pathType === f.HIGHLIGHTS) return void(r.isUndefined(T.callbackFunction) ?
            h() : T.pathType === f.HIGHLIGHTS ? T.callbackFunction(t, T.callbackParam) : T.callbackFunction(t,
                T.callbackParam).then(function() {
                h()
              }));
            t = b(t), T.pathType === f.FILE_LOGGING && (T.callbackFunction(t, T.callbackParam), h()), c
              .getRecordingPaths().then(function(e) {
                ...
                if (t === n) O.info("Old " + T.pathType + " recording path and new one are the same: " + t),
              h();
                else {
        ...
        T.hoveredFolderID = e,
          T.displayWarning = !1, T.isInvalidFolder(e) && (T.displayWarning = !0, T.warningText = T.dirFolderData[
            e].warningText)
        ...
        } else if (n.keyCode === g.ENTER) T.doubleClickFolder(t), T.focusedFolderID = -1, angular.element(l[0]
          .getElementById("button_done")).focus(), T.dontPropagateEvent(n);
        else if (n.keyCode >= g.LEFT_ARROW && n.keyCode <= g.DOWN_ARROW) {
          var o = 0;
          n.keyCode === g.RIGHT_ARROW ? o = 1 : n.keyCode === g.LEFT_ARROW ? o = -1 : n.keyCode === g.UP_ARROW ?
            o = 0 - T.rowSize : n.keyCode === g.DOWN_ARROW && (o = T.rowSize);
          var r = T.activeFolderID + o;
          if (r < 0 || r > T.dirFolderData.length - 1) return;
          T.isInvalidFolder(r) ? (T.displayWarning = !0, T.warningText = T.dirFolderData[r].warningText) : T
            .displayWarning = !1, T.singleClickFolder(r)
        }
      }, 100), T.cancel = function() {
        h()
      }, T.isDoneDisabled = function() {
        return T.includeFiles ? !T.dirFolderData[T.focusedFolderID] || !T.dirFolderData[T.focusedFolderID]
          .isFile || T.hoveredFolderID >= 0 && T.isInvalidFolder(T.hoveredFolderID) || T.isInvalidFolder(T
            .activeFolderID) ? T.doneDisable = !0 : T.doneDisable = !1 : T.currentPath === A ? T.doneDisable = !
          0 : T.focusedFolderID >= 0 && T.dirFolderData[T.focusedFolderID].isReadOnly ? T.doneDisable = !0 : T
          .doneDisable = !1, T.doneDisable
      }, d.on(m.ESCAPE, T.cancel), t.$on("$destroy", function() {
        d.off(m.ESCAPE, T.cancel)
      })
    }
  ]);
  t.FolderBrowserController = l
}
