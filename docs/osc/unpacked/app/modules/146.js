// ─────────────────────────────────────────────────────────────
// APP MODULE 146
// role       : service oscGalleryService
// requires   : (none)
...
function(e, t, n) {
  ...
  var r = n(8),
    ...
    d = n(2);
  n(11);
  var c = d.ngMainCommonModule.service("oscGalleryService", ["$q", "$log", "$timeout", "$document", "galleryService",
    "galleryEndpoints", "eventAggregator", "GALLERY_STATE", "GALLERY_EVENTS",
    function(e, t, n, i, o, r, l, d, c) {
      ...
      function g(e, t) {
        ...
        var u = f(c, h.memeParams.topString),
          ...
          p = parseInt(c);
        b.info("Top string at x: " + g + " y: " + p), r.strokeStyle = s, r.lineWidth = m(c), r.strokeText(h
            .memeParams.topString, g, p, u), r.fillStyle = d, r.fillText(h.memeParams.topString, g, p, u), c = l
          .toFixed(0), r.font = c + "px Impact", b.info("Video Font bottom: ", r.font), u = f(c, h.memeParams
            .bottomString);
        var x = .025 * i;
        g = Math.floor(n / 2 - u / 2), p = Math.floor(i - x), b.info("Bottom string at x: " + g + " y: " + p), r
          .strokeStyle = s, r.lineWidth = m(c), r.strokeText(h.memeParams.bottomString, g, p, u), r.fillStyle = d, r
          .fillText(h.memeParams.bottomString, g, p, u), b.info("Canvas created");
        var v = S.toDataURL(o);
      ...
      var h = this,
        ...
        x = null,
        v = null;
      h.deletionList = [], h.fileToProcess = "", h.memeParams = "", h.memeCanvasData = "", h.memePromise = void 0, h
        .galleryState = d.EMPTY, h.isBackGallery = !1, h.momentsFiles = null, h.populatedMomentsFilesFolder = [], h
        .summary = {}, h.setThumbSizes = function() {
          o.thumbSizes = {
            width: 160,
            height: 90
          }
      ...
      h.setInitialVideoDuration = function(e) {
        ...
        h.currentFolder = "", h.currentFileIndex = 0, h.recentFileIndex = -1, h.currentFolderIndex = 0, h
          .currentFolderDisplaySetting = 1
        ...
        h.moments = e, h.moments = s.map(h.moments, function(e, o) {
          ...
          return r.moment.gameName = r.moment.shortName || t, r.moment.drsName = r.moment.drsName || n, r
            .moment.drsProfileName = r.moment.drsProfileName || i, r
        ...
        function r() {
          for (; 0 !== h.populatedMomentsFilesFolder.length;) {
            ...
            t.fullFilename = e.fullFilename, t.file = e.file, t.folder = e.folder, t.index = e.hlIndex, t
              .duration = e.duration, t.date = e.date, t.fileSize = e.fileSize, t.audiotype = e.audiotype, t
              .data = e.data
          }
      ...
      var S = {
        toArrayBuffer: function(e) {
          ...
          var i, o, r, a, l = e.width,
            ...
            v = 0,
            y = 54;
          for (t(19778), n(g), b += 4, n(y), n(40), n(l), n(s), t(1), t(32), b += 24, x = s - 1; x >= 0;) {
            for (o = y + x * f, i = 0; i < d;) a = u[v++], r = a >>> 24, h.setUint32(o + i, a << 8 | r), i += 4;
            x--
          }
          return p
        },
        toDataURL: function(e) {
          for (var t = new Uint8Array(this.toArrayBuffer(e)), n = "", i = 0, o = t.length; i < o;) n += String
            .fromCharCode(t[i++]);
          return btoa(n)
        }
      };
      h.createMeme = function(t) {
        return h.memeParams = t, h.memeCanvasData = "", b.info("Meme params: ", t), 0 === t.width ? void(h
          .memePromise = e.when(h.memeCanvasData)) : void(h.memePromise = n(function() {
        ...
        h.memeStrings = e, void 0 === p(e.source) ? (h.memeStringList.push(e), b.info("Saved meme: ", e)) : b
          .info("Meme already saved: ", e)
        ...
        if (b.info("Source to clear: ", e), void 0 === e) h.memeStrings = {
          ...
          h.memeStringList.forEach(function(e, i) {
            e.source === t && (n = i)
          }), void 0 !== n && (b.info("Removed meme item: ", h.memeStringList[n]), h.memeStringList = s.without(
            h.memeStringList, h.memeStringList[n]), b.info("Array after delete: ", h.memeStringList))
        }
      };
      var E = 80;
