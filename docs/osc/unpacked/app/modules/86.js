...
function(e, t, n) {
  ! function(e, i) {
    i(t, n(45), n(38), n(85), n(39), n(59), n(128))
    ...
    function u(e, t, n) {
      ...
      function r(o) {
        ...
        for (c in d)
          if (m = d[c], m.name === n.name) {
            ...
            m.state === ke ? (m.state = Te, m.timer.stop(), m.on.call("interrupt", e, e.__data__, m.index, m.group),
              delete d[c]) : +c < t && (m.state = Te, m.timer.stop(), m.on.call("cancel", e, e.__data__, m.index, m
              .group), delete d[c])
          ...
          for (n.state = Ee, s = new Array(f = n.tween.length), c = 0, u = -1; c < f; ++c)(m = n.tween[c].value.call(
            e, e.__data__, n.index, n.group)) && (s[++u] = m);
          s.length = u + 1
        }
      }

      function a(t) {
        for (var i = t < n.duration ? n.ease.call(null, t / n.duration) : (n.timer.restart(l), n.state = _e, 1), o = -
            1, r = s.length; ++o < r;) s[o].call(e, i);
      ...
      var s, d = e.__transition;
      d[t] = n, n.timer = i.timer(o, 0, n.time)
    }

    function f(e, t) {
      var n, i, o, r = e.__transition,
        a = !0;
      if (r) {
        t = null == t ? null : t + "";
        for (o in r)(n = r[o]).name === t ? (i = n.state > Se && n.state < _e, n.state = Te, n.timer.stop(), n.on
          .call(i ? "interrupt" : "cancel", e, e.__data__, n.index, n.group), delete r[o]) : a = !1;
    ...
    function x(e, t) {
      var n;
      return ("number" == typeof t ? o.interpolateNumber : t instanceof r.color ? o.interpolateRgb : (n = r.color(
        t)) ? (t = n, o.interpolateRgb) : o.interpolateString)(e, t)
    }
    ...
    function E(e, t, n) {
      ...
      return function() {
        var a, l, s = n(this);
        return null == s ? void this.removeAttribute(e) : (a = this.getAttribute(e), l = s + "", a === l ? null :
          a === i && l === o ? r : (o = l, r = t(i = a, s)))
      }
    }
    ...
    function k(e, t, n) {
      ...
      return function() {
        var a, l, s = n(this);
        return null == s ? void this.removeAttributeNS(e.space, e.local) : (a = this.getAttributeNS(e.space, e
          .local), l = s + "", a === l ? null : a === i && l === o ? r : (o = l, r = t(i = a, s)))
      }
    }
    ...
    function _(e, n) {
      ...
      return this.attrTween(e, "function" == typeof n ? (i.local ? k : E)(i, r, b(this, "attr." + e, n)) : null == n ?
        (i.local ? y : v)(i) : (i.local ? S : w)(i, r, n))
    }
    ...
    function L(e) {
      var t = this._id;
      return arguments.length ? this.each(("function" == typeof e ? D : N)(t, e)) : c(this.node(), t).duration
    }
    ...
    function z(e) {
      ...
      for (var n = this._groups, i = n.length, o = new Array(i), r = 0; r < i; ++r)
        for (var a, l = n[r], s = l.length, d = o[r] = [], c = 0; c < s; ++c)(a = l[c]) && e.call(a, a.__data__, c,
          l) && d.push(a);
    ...
    function W(e) {
      ...
      for (var o = this._groups, r = o.length, a = new Array(r), s = 0; s < r; ++s)
        for (var d, u, f = o[s], m = f.length, g = a[s] = new Array(m), p = 0; p < m; ++p)(d = f[p]) && (u = e.call(d,
          d.__data__, p, f)) && ("__data__" in d && (u.__data__ = d.__data__), g[p] = u, l(g[p], n, i, p, g, c(d,
          i)));
    ...
    function j(e) {
      ...
      for (var o = this._groups, r = o.length, a = [], s = [], d = 0; d < r; ++d)
        for (var u, f = o[d], m = f.length, g = 0; g < m; ++g)
          if (u = f[g]) {
            for (var p, h = e.call(u, u.__data__, g, f), b = c(u, i), x = 0, v = h.length; x < v; ++x)(p = h[x]) && l(
              p, n, i, x, h, b);
            a.push(h), s.push(u)
    ...
    function Q(e, n, i) {
      ...
      return function() {
        var l = t.style(this, e),
          s = i(this),
          d = s + "";
        return null == s && (this.style.removeProperty(e), d = s = t.style(this, e)), l === d ? null : l === o &&
          d === r ? a : (r = d, a = n(o = l, s))
      }
    }

    function J(e, t) {
      var n, i, o, r, a = "style." + t,
        l = "end." + a;
      return function() {
        var s = d(this, e),
          c = s.on,
    ...
    function ee(e, t, n) {
      ...
      return null == t ? this.styleTween(e, q(e, i)).on("end.style." + e, X(e)) : "function" == typeof t ? this
        .styleTween(e, Q(e, i, b(this, "style." + e, t))).each(J(this._id, e)) : this.styleTween(e, Z(e, i, t), n).on(
          "end.style." + e, null)
    }
    ...
    function ue() {
      ...
      return new Promise(function(r, a) {
        ...
        n.each(function() {
          var n = d(this, i),
            o = n.on;
          o !== e && (t = (e = o).copy(), t._.cancel.push(l), t._.interrupt.push(l), t._.end.push(s)), n.on =
            t
        })
      })
    }
    ...
    function he(e) {
      var t, n;
      e instanceof fe ? (t = e._id, e = e._name) : (t = ge(), (n = Ie).time = i.now(), e = null == e ? null : e + "");
