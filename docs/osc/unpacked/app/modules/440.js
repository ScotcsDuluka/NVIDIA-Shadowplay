...
function(e, t, n) {
  ! function(e, i) {
    i(t, n(81), n(44), n(39), n(129), n(84), n(131))
    ...
    function c() {
      function e() {
        var e = r().length,
          ...
          l = s[o - 0],
          d = s[1 - o];
        t = (d - l) / Math.max(1, e - f + 2 * m), u && (t = Math.floor(t)), l += (d - l - t * (e - f)) * g, i = t * (
          1 - f), u && (l = Math.round(l), i = Math.round(i));
        var c = n.range(e).map(function(e) {
          return l + t * e
        });
        return a(o ? c.reverse() : c)
      }
      var t, i, o = d().unknown(void 0),
        r = o.domain,
        a = o.range,
        s = [0, 1],
        u = !1,
    ...
    function v(e, t, i) {
      var o = Math.min(e.length, t.length) - 1,
        ...
        a = new Array(o),
        l = -1;
      for (e[o] < e[0] && (e = e.slice().reverse(), t = t.slice().reverse()); ++l < o;) r[l] = h(e[l], e[l + 1]), a[
        l] = i(t[l], t[l + 1]);
      return function(t) {
    ...
    function E(e, t, i, r) {
      var a, l = n.tickStep(e, t, i);
      switch (r = o.formatSpecifier(null == r ? ",f" : r), r.type) {
        case "s":
          var s = Math.max(Math.abs(e), Math.abs(t));
          return null != r.precision || isNaN(a = o.precisionPrefix(l, s)) || (r.precision = a), o.formatPrefix(r, s);
        case "":
        case "e":
        case "g":
        case "p":
        case "r":
          null != r.precision || isNaN(a = o.precisionRound(l, Math.max(Math.abs(e), Math.abs(t)))) || (r.precision =
            a - ("e" === r.type));
          break;
        case "f":
        case "%":
    ...
    function k(e) {
      ...
      return e.ticks = function(e) {
        ...
        var o, r = t(),
          ...
          s = r[a],
          d = r[l];
        return d < s && (o = s, s = d, d = o, o = a, a = l, l = o), o = n.tickIncrement(s, d, i), o > 0 ? (s = Math
          .floor(s / o) * o, d = Math.ceil(d / o) * o, o = n.tickIncrement(s, d, i)) : o < 0 && (s = Math.ceil(s *
          o) / o, d = Math.floor(d * o) / o, o = n.tickIncrement(s, d, i)), o > 0 ? (r[a] = Math.floor(s / o) * o,
          r[l] = Math.ceil(d / o) * o, t(r)) : o < 0 && (r[a] = Math.ceil(s * o) / o, r[l] = Math.floor(d * o) /
          o, t(r)), e
      }, e
    }
    ...
    function D(e) {
      return e === Math.E ? Math.log : 10 === e && Math.log10 || 2 === e && Math.log2 || (e = Math.log(e), function(
      t) {
        return Math.log(t) / e
      })
    }
    ...
    function L(e) {
      ...
      return a.base = function(e) {
        ...
        if (null == t && (t = 10 === s ? ".0e" : ","), "function" != typeof t && (t = o.format(t)), e === 1 / 0)
          return t;
        null == e && (e = 10);
    ...
    function J(e, t, i, o, r, a, l, s, d) {
      function c(n) {
        return (l(n) < n ? h : a(n) < n ? b : r(n) < n ? x : o(n) < n ? v : t(n) < n ? i(n) < n ? w : E : e(n) < n ?
          k : _)(n)
      }
      ...
      function u(t, i, o, r) {
        if (null == t && (t = 10), "number" == typeof t) {
          ...
          l === T.length ? (r = n.tickStep(i / Ce, o / Ce, t), t = e) : l ? (l = T[a / T[l - 1][2] < T[l][2] / a ? l -
            1 : l], r = l[1], t = l[0]) : (r = Math.max(n.tickStep(i, o, t), 1), t = s)
        }
      ...
      return f.invert = function(e) {
        ...
        var n, i = g(),
          ...
          r = i[i.length - 1],
          a = r < o;
        return a && (n = o, o = r, r = n), n = u(e, o, r, t), n = n ? n.range(o, r + 1) : [], a ? n.reverse() : n
    ...
    function ee() {
      return l.apply(J(r.timeYear, r.timeMonth, r.timeWeek, r.timeDay, r.timeHour, r.timeMinute, r.timeSecond, r
        .timeMillisecond, a.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments)
    }
    ...
    function ne() {
      function e(e) {
        return isNaN(e = +e) ? r : s(0 === i ? .5 : (e = (o(e) - t) * i, d ? Math.max(0, Math.min(1, e)) : e))
      }
      var t, n, i, o, r, a = 0,
        l = 1,
        s = p,
      ...
      return e.domain = function(r) {
          return arguments.length ? (t = o(a = +r[0]), n = o(l = +r[1]), i = t === n ? 0 : 1 / (n - t), e) : [a, l]
        }, e.clamp = function(t) {
    ...
    function ce() {
      function e(e) {
        return isNaN(e = +e) ? l : (e = .5 + ((e = +a(e)) - n) * (e < n ? o : r), u(f ? Math.max(0, Math.min(1, e)) :
          e))
      }
      ...
      return e.domain = function(l) {
          return arguments.length ? (t = a(s = +l[0]), n = a(d = +l[1]), i = a(c = +l[2]), o = t === n ? 0 : .5 / (n -
            t), r = n === i ? 0 : .5 / (i - n), e) : [s, d, c]
        }, e.clamp = function(t) {
        ...
        function(l) {
          return a = l, t = l(s), n = l(d), i = l(c), o = t === n ? 0 : .5 / (n - t), r = n === i ? 0 : .5 / (i - n),
            e
        }
    }
    ...
    var he = Array.prototype,
      ...
      Te = 30 * ke,
      Ce = 365 * ke;
    e.scaleBand = c, e.scalePoint = f, e.scaleIdentity = T, e.scaleLinear = _, e.scaleLog = F, e.scaleSymlog = V, e
      .scaleOrdinal = d, e.scaleImplicit = ve, e.scalePow = W, e.scaleSqrt = j, e.scaleQuantile = K, e.scaleQuantize =
      q, e.scaleThreshold = X, e.scaleTime = ee, e.scaleUtc = te, e.scaleSequential = oe, e.scaleSequentialLog = re, e
      .scaleSequentialPow = le, e.scaleSequentialSqrt = se, e.scaleSequentialSymlog = ae, e.scaleSequentialQuantile =
      de, e.scaleDiverging = ue, e.scaleDivergingLog = fe, e.scaleDivergingPow = ge, e.scaleDivergingSqrt = pe, e
      .scaleDivergingSymlog = me, e.tickFormat = E, Object.defineProperty(e, "__esModule", {
        value: !0
      })
  })
}
