// ─────────────────────────────────────────────────────────────
// APP MODULE 254
// role       : controller PreferencesPerformanceController
// requires   : (none)
...
function(e, t, n) {
  ...
  Object.defineProperty(t, "__esModule", {
    value: !0
  }), t.PreferencesPerformanceController = void 0;
  var i = n(1);
  n(22), n(4), n(34);
  var o = i.ngMainModule.controller("PreferencesPerformanceController", ["octoolService", "$log", "$scope", "$state",
    "eventAggregator", "$timeout", "KEYBOARD_EVENTS", "shadowPlayService", "keyboardService",
    ...
    function(e, t, n, i, o, r, a, l, s, d) {
      function c() {
        l.getHotkeyShortcut(l.HotkeyShortcuts.RESETAVERAGES).then(function(e) {
          ...
          e && e.keys ? (u.isLoggingHotkeyAvailable = !0, u.loggingHotkeyString = s.shortcutToStr(e.keys)) : u
            .isLoggingHotkeyAvailable = !1, "None" === u.loggingHotkeyString && (u.isLoggingHotkeyAvailable = !
              1)
        })
      }
      var u = this;
      ...
      u.initPreferencesPerformanceSettings = function() {
        u.fetchCustAvgSampleSize(), u.getDefaultLoggingPath(), u.getRectAlignmentStatus(), u
          .getFlashIndicatorStatus(), u.isRLA = e.isRLAMonitor, u.isSupportedDD = e.isRLASupportedDD, c()
      }, u.fetchCustAvgSampleSize = function() {
        u.currentCustAvgValue = e.getCustAvgSampleSize(), f.info("Fetched current custom average sample size - " +
          u.currentCustAvgValue)
        ...
        e.updateCustAvgSampleSize(u.currentCustAvgValue), f.info("User changed custom average sample size - " + u
          .currentCustAvgValue)
      }, u.done = function() {
        ...
        u.rectAlignmentStatus = e.getRectAlignStatus(), f.info("Fetched Rectangle Alignment Status - " + u
          .rectAlignmentStatus)
      }, u.toggleFlashIndicatorStatus = function() {
        u.isSupportedDD && (e.setFlashIndicatorSize(u.flashIndicatorStatus), f.info("setFlashIndicatorSize"), e
          .updateFlashIndicatorStatus(u.flashIndicatorStatus), r(function() {
            (e.islatestRFISupported || e.islegacyRFISupported) && e.isRLAMonitor || u.flashIndicatorStatus ||
              e.setFlashIndicatorVisibility(!u.flashIndicatorStatus)
          }, m))
      }, u.getFlashIndicatorStatus = function() {
        u.flashIndicatorStatus = e.getFlashIndicatorStatus(), f.info("Fetched Flash Indicator Status - " + u
  ...
  t.PreferencesPerformanceController = o
}
