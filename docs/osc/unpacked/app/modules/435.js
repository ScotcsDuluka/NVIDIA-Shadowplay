...
function(e, t, n) {
  ! function(e, i) {
    ...
    function p(e, t) {
      ri.point = h, nn = e, on = t, e *= Hn, t *= Hn, rn = e, an = Wn(t = t / 2 + zn),
        ln = Zn(t)
    }
    ...
    function T(e, t) {
      ...
      if (pn) {
        ...
        var a, l = e - fn,
          ...
          d = r[0] * Vn * s,
          c = Bn(l) > 180;
        c ^ (s * fn < d && d < s * e) ? (a = r[1] * Vn, a > un && (un = a)) : (d = (d + 360) % 360 - 180, c ^ (s *
            fn < d && d < s * e) ? (a = -r[1] * Vn, a < dn && (dn = a)) : (t < dn && (dn = t), t > un && (un = t))),
          c ? e < fn ? R(sn, e) > R(sn, cn) && (cn = e) : R(e, cn) > R(sn, cn) && (sn = e) : cn >= sn ? (e < sn && (
            sn = e), e > cn && (cn = e)) : e > fn ? R(sn, e) > R(sn, cn) && (cn = e) : R(e, cn) > R(sn, cn) && (sn =
            e)
    ...
    function N(e) {
      ...
      if (un = cn = -(sn = dn = 1 / 0), hn = [], f(e, li), n = hn.length) {
        for (hn.sort(P), t = 1, i = hn[0], r = [i]; t < n; ++t) o = hn[t], D(i, o[0]) || D(i, o[1]) ? (R(i[0], o[1]) >
          R(i[0], i[1]) && (i[1] = o[1]), R(o[0], i[1]) > R(i[0], i[1]) && (i[0] = o[0])) : r.push(i = o);
        for (a = -(1 / 0), n = r.length - 1, t = 0, i = r[n]; t <= n; i = o, ++t) o = r[t], (l = R(i[1], o[0])) > a &&
          (a = l, sn = o[0], cn = i[1])
      }
    ...
    function G(e, t) {
      ...
      var n = Wn(t),
        ...
        o = n * Zn(e),
        r = Zn(t),
        a = $n(Jn((a = Rn * r - Pn * o) * a + (a = Pn * i - Mn * r) * a + (a = Mn * o - Rn * i) * a), Mn * i + Rn *
          o + Pn * r);
      vn += a, En += a * (Mn + (Mn = i)), kn += a * (Rn + (Rn = o)), _n += a * (Pn + (Pn = r)), F(Mn, Rn, Pn)
    }
    ...
    function $(e, t) {
      ...
      var n = Wn(t),
        ...
        u = a(c),
        f = c && -u / c;
      Tn += f * l, Cn += f * s, On += f * d, vn += u, En += u * (Mn + (Mn = i)), kn += u * (Rn + (Rn = o)), _n += u *
        (Pn + (Pn = r)), F(Mn, Rn, Pn)
    }
    ...
    function W(e) {
      ...
      var t = Tn,
        ...
        i = On,
        o = t * t + n * n + i * i;
      return o < Ln && (t = En, n = kn, i = _n, vn < Nn && (t = yn, n = wn, i = Sn), o = t * t + n * n + i * i, o <
        Ln) ? [NaN, NaN] : [$n(n, t) * Vn, a(i / Jn(o)) * Vn]
    }
    ...
    function te(e, t, n, i, o, r) {
      if (n) {
        var a = Wn(t),
          l = Zn(t),
          s = i * n;
        null == o ? (o = t + i * Gn, r = t - s / 2) : (o = ne(a, o), r = ne(a, r), (i > 0 ? o < r : o > r) && (o +=
          i * Gn));
        for (var d, c = o; i > 0 ? c > r : c < r; c -= s) d = x([a, -l * Wn(c), -l * Zn(c)]), e.point(d[0], d[1])
      }
    }
    ...
    function le(e, t, n, i, o) {
      ...
      if (e.forEach(function(e) {
          if (!((t = e.length - 1) <= 0)) {
            ...
            l.push(n = new ae(i, e, null, !0)), s.push(n.o = new ae(i, null, n, !1)), l.push(n = new ae(a, e, null,
              !1)), s.push(n.o = new ae(a, null, n, !0))
          }
        }), l.length) {
    ...
    function ce(e, t) {
      ...
      for (var d = 0, c = e.length; d < c; ++d)
        if (f = (u = e[d]).length)
          for (var u, f, m = u[f - 1], g = de(m), p = m[1] / 2 + zn, h = Zn(p), b = Wn(p), x = 0; x < f; ++x, g = S,
            h = _, b = T, m = y) {
            var y = u[x],
              S = de(y),
              E = y[1] / 2 + zn,
              ...
              I = A > Fn,
              M = h * _;
            if (yi.add($n(M * O * Zn(A), b * T + M * Wn(A))), l += I ? C + O * Gn : C, I ^ g >= n ^ S >= n) {
              var R = w(v(m), v(y));
              k(R);
              var P = w(r, R);
              k(P);
    ...
    function ue(e, n, i, o) {
      return function(r) {
        ...
        function f() {
          ...
          var e, t, n, i, o = x.clean(),
            a = b.result(),
            l = a.length;
          if (p.pop(), m.push(p), p = null, l)
            if (1 & o) {
              if (n = a[0], (t = n.length - 1) > 0) {
                for (v || (r.polygonStart(), v = !0), r.lineStart(), e = 0; e < t; ++e) r.point((i = n[e])[0], i[
                1]);
                r.lineEnd()
              }
        ...
        var m, g, p, h = n(r),
          ...
          y = {
            ...
            polygonEnd: function() {
              ...
              var e = ce(m, o);
              g.length ? (v || (r.polygonStart(), v = !0), le(g, me, e, i, r)) : e && (v || (r.polygonStart(),
                  v = !0), r.lineStart(), i(null, null, 1, r), r.lineEnd()), v && (r.polygonEnd(), v = !1), g =
                m = null
            },
            sphere: function() {
    ...
    function me(e, t) {
      return ((e = e.x)[0] < 0 ? e[1] - Un - Nn : Un - e[1]) - ((t = t.x)[0] < 0 ? t[1] - Un - Nn : Un - t[1])
    }
    ...
    function ge(e) {
      ...
      return {
        ...
        point: function(r, a) {
          var l = r > 0 ? Fn : -Fn,
            s = Bn(r - n);
          Bn(s - Fn) < Nn ? (e.point(n, i = (i + a) / 2 > 0 ? Un : -Un), e.point(o, i), e.lineEnd(), e.lineStart(),
            e.point(l, i), e.point(r, i), t = 0) : o !== l && s >= Fn && (Bn(n - o) < Nn && (n -= o * Nn), Bn(r -
            l) < Nn && (r -= l * Nn), i = pe(n, i, r, a), e.point(o, i), e.lineEnd(), e.lineStart(), e.point(l,
            i), t = 0), e.point(n = r, i = a), o = l
        },
        lineEnd: function() {
          e.lineEnd(), n = i = NaN
        },
    ...
    function pe(e, t, n, i) {
      var o, r, a = Zn(e - n);
      return Bn(a) > Nn ? Yn((Zn(t) * (r = Wn(i)) * Zn(n) - Zn(i) * (o = Wn(t)) * Zn(e)) / (o * r * a)) : (t + i) / 2
    }

    function he(e, t, n, i) {
      var o;
      if (null == e) o = n * Un, i.point(-Fn, o), i.point(0, o), i.point(Fn, o), i.point(Fn, 0), i.point(Fn, -o), i
        .point(0, -o), i.point(-Fn, -o), i.point(-Fn, 0), i.point(-Fn, o);
      ...
      function i(e) {
        ...
        return {
          ...
          point: function(u, f) {
            ...
            if (!t && (l = a = p) && e.lineStart(), p !== a && (m = o(t, g), (!m || re(t, m) || re(g, m)) && (g[2] =
                1)), p !== a) c = 0, p ? (e.lineStart(), m = o(g, t), e.point(m[0], m[1])) : (m = o(t, g), e.point(
              m[0], m[1], 2), e.lineEnd()), t = m;
            else if (d && t && s ^ p) {
              var b;
              h & i || !(b = o(g, t, !0)) || (c = 0, s ? (e.lineStart(), e.point(b[0][0], b[0][1]), e.point(b[1][0],
                b[1][1]), e.lineEnd()) : (e.point(b[1][0], b[1][1]), e.lineEnd(), e.lineStart(), e.point(b[0][
                0], b[0][1], 3)))
      ...
      function o(e, t, n) {
        ...
        if (!(_ < 0)) {
          ...
          var P = I - A,
            D = Bn(P - Fn) < Nn,
            N = D || P < Nn;
          if (!D && R < M && (O = M, M = R, R = O), N ? D ? M + R > 0 ^ C[1] < (Bn(C[0] - A) < Nn ? M : R) : M <= C[
            1] && C[1] <= R : P > Fn ^ (A <= C[0] && C[0] <= I)) {
            var L = E(h, (-b + T) / k);
            return S(L, g), [C, x(L)]
          }
        }
        ...
        if (a = o - l, m || !(a < 0)) {
          ...
          if (a = i - s, g || !(a > 0)) {
            ...
            if (a = r - s, g || !(a < 0)) {
              ...
              return u > 0 && (e[0] = l + u * m, e[1] = s + u * g), f < 1 && (t[0] = l + f * m, t[1] = s + f * g), !0
            }
          }
        }
      }
    ...
    function ve(e, n, i, o) {
      ...
      function l(t, o) {
        return Bn(t[0] - e) < Nn ? o > 0 ? 0 : 3 : Bn(t[0] - i) < Nn ? o > 0 ? 2 : 1 : Bn(t[1] - n) < Nn ? o > 0 ? 1 :
          0 : o > 0 ? 3 : 2
      }
      ...
      return function(l) {
        ...
        function c() {
          for (var t = 0, n = 0, i = b.length; n < i; ++n)
            for (var r, a, l = b[n], s = 1, d = l.length, c = l[0], u = c[0], f = c[1]; s < d; ++s) r = u, a = f,
              c = l[s], u = c[0], f = c[1], a <= o ? f > o && (u - r) * (o - a) > (f - a) * (e - r) && ++t : f <=
              o && (u - r) * (o - a) < (f - a) * (e - r) && --t;
          return t
        }
        ...
        function f() {
          ...
          (n || i) && (l.polygonStart(), n && (l.lineStart(), a(null, null, 1, l), l.lineEnd()), i && le(h, s, e, a,
            l), l.polygonEnd()), C = l, h = b = x = null
        }
    ...
    function ye() {
      ...
      return n = {
        ...
        extent: function(l) {
          return arguments.length ? (i = +l[0][0], o = +l[0][1], r = +l[1][0], a = +l[1][1], e = t = null, n) : [
            [i, o],
            [r, a]
          ]
        }
    ...
    function Ae(e, t) {
      for (var n, i, o, r = 0, a = e.length; r < a; r++) {
        ...
        if (r > 0 && (o = Te(e[r], e[r - 1]), o > 0 && n <= o && i <= o && (n + i - o) * (1 - Math.pow((n - i) / o,
            2)) < Ln * o)) return !0;
        n = i
      }
      return !1
    ...
    function Le() {
      ...
      function n() {
        return t.range(jn(a / b) * b, r, b).map(m).concat(t.range(jn(c / x) * x, d, x).map(g)).concat(t.range(jn(o /
          p) * p, i, p).filter(function(e) {
          return Bn(e % b) > Nn
        }).map(u)).concat(t.range(jn(s / h) * h, l, h).filter(function(e) {
          return Bn(e % x) > Nn
        }).map(f))
      }
      var i, o, r, a, l, s, d, c, u, f, m, g, p = 10,
        h = p,
        b = 90,
        x = 360,
        v = 2.5;
      return e.lines = function() {
        ...
        return arguments.length ? (a = +t[0][0], r = +t[1][0], c = +t[0][1], d = +t[1][1], a > r && (t = a, a = r,
          r = t), c > d && (t = c, c = d, d = t), e.precision(v)) : [
          [a, c],
          [r, d]
        ]
      }, e.extentMinor = function(t) {
        return arguments.length ? (o = +t[0][0], i = +t[1][0], s = +t[0][1], l = +t[1][1], o > i && (t = o, o = i,
          i = t), s > l && (t = s, s = l, l = t), e.precision(v)) : [
          [o, s],
          [i, l]
        ]
      }, e.step = function(t) {
        ...
        return arguments.length ? (v = +t, u = De(s, l, 90), f = Ne(o, i, v), m = De(c, d, 90), g = Ne(a, r, v),
          e) : v
      }, e.extentMajor([
        [-180, -90 + Nn],
        [180, 90 - Nn]
    ...
    function Je(e, t) {
      var n = e - xi,
        i = t - vi,
        o = Jn(n * n + i * i);
      Vi += o * (xi + e) / 2, Hi += o * (vi + t) / 2, Bi += o, o = vi * e - xi * t, Yi += o * (xi + e), $i += o * (
        vi + t), Wi += 3 * o, $e(xi = e, vi = t)
    }
    ...
    function rt(e, t) {
      function n(e) {
        return e && ("function" == typeof r && o.pointRadius(+r.apply(this, arguments)), f(e, i(o))), o.result()
      }
      var i, o, r = 4.5;
      return n.area = function(e) {
        ...
        return arguments.length ? (o = null == e ? (t = null, new it) : new et(t = e), "function" != typeof r && o
          .pointRadius(r), n) : t
    ...
    function dt(e, t, n) {
      ...
      return e.scale(150).translate([0, 0]), null != i && e.clipExtent(null), f(n, e.stream(Fi)), t(Fi.result()),
        null != i && e.clipExtent(i), e
    }
      ...
      function n(i, o, r, l, s, d, c, u, f, m, g, p, h, b) {
        ...
        if (y > 4 * t && h--) {
          var w = l + m,
            ...
            M = A - o,
            R = v * I - x * M;
          (R * R / y > t || Bn((x * I + v * M) / y - .5) > .3 || l * m + s * g + d * p < no) && (n(i, o, r, l, s, d,
            O, A, T, w /= k, S /= k, E, h, b), b.point(O, A), n(O, A, T, w, S, E, c, u, f, m, g, p, h, b))
        }
      }
      return function(t) {
        function i(n, i) {
        ...
        function r(i, o) {
          var r = v([i, o]),
            a = e(i, o);
          n(b, x, h, y, w, S, b = a[0], x = a[1], h = i, y = r[0], w = r[1], S = r[2], to, t), t.point(b, x)
        }
    ...
    function wt(e) {
      ...
      return t.stream = function(e) {
          ...
          return arguments.length ? (A = null == e ? (O = l = s = d = null, ze) : ve(O = +e[0][0], l = +e[0][1], s = +
            e[1][0], d = +e[1][1]), o()) : null == O ? null : [
            [O, l],
            [s, d]
          ]
        }, t.scale = function(e) {
          ...
          return arguments.length ? (y = e[0] % 360 * Hn, w = e[1] % 360 * Hn, S = e.length > 2 ? e[2] % 360 * Hn : 0,
            i()) : [y * Vn, w * Vn, S * Vn]
        }, t.angle = function(e) {
    ...
    function kt(e, t) {
      ...
      return n.invert = function(e, t) {
        var n = l - t,
          i = $n(e, Bn(n)) * Qn(n);
        return n * o < 0 && (i -= Fn * Qn(e) * Qn(n)), [i / o, a((r - (e * e + n * n) * o * o) / (2 * o))]
      }, n
    }
    ...
    function Tt() {
      return _t().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-.6, 38.7])
    }
    ...
    function Ot() {
      ...
      return e.invert = function(e) {
        var t = s.scale(),
          ...
          i = (e[0] - n[0]) / t,
          o = (e[1] - n[1]) / t;
        return (o >= .12 && o < .234 && i >= -.425 && i < -.214 ? d : o >= .166 && o < .234 && i >= -.214 && i < -
          .115 ? c : s).invert(e)
      }, e.stream = function(e) {
        ...
        return arguments.length ? (s.scale(t), d.scale(.35 * t), c.scale(t), e.translate(s.translate())) : s.scale()
    ...
    function Nt(e) {
      ...
      return r.scale = function(e) {
        ...
        return arguments.length ? (null == e ? c = n = i = o = null : (c = +e[0][0], n = +e[0][1], i = +e[1][0],
          o = +e[1][1]), t()) : null == c ? null : [
          [c, n],
          [i, o]
        ]
      }, t()
    ...
    function Bt(e, t) {
      var n = a(uo * Zn(t)),
        i = n * n,
        o = i * i * i;
      return [e * Wn(n) / (uo * (ao + 3 * lo * i + o * (7 * so + 9 * co * i))), n * (ao + lo * i + o * (so + co * i))]
    }
    ...
    function jt() {
      ...
      return t.invert = function(e) {
        ...
        return arguments.length ? (v = null == t ? (p = o = r = a = null, ze) : ve(p = +t[0][0], o = +t[0][1], r = +
          t[1][0], a = +t[1][1]), e()) : null == p ? null : [
          [p, o],
          [r, a]
        ]
      }, t.scale = function(t) {
    ...
    function Kt(e, t) {
      var n = t * t,
        i = n * n;
      return [e * (.8707 - .131979 * n + i * (-.013791 + i * (.003971 * n - .001529 * i))), t * (1.007226 + n * (
        .015085 + i * (-.044475 + .028874 * n - .005916 * i)))]
    }
    ...
    var nn, on, rn, an, ln, sn, dn, cn, un, fn, mn, gn, pn, hn, bn, xn, vn, yn, wn, Sn, En, kn, _n, Tn, Cn, On, An,
      In, Mn, Rn, Pn, Dn = new i,
      Nn = 1e-6,
      Ln = 1e-12,
      Fn = Math.PI,
      Un = Fn / 2,
      ...
      li = {
        ...
        polygonEnd: function() {
          ri.polygonEnd(), li.point = _, li.lineStart = C, li.lineEnd = O, ii < 0 ? (sn = -(cn = 180), dn = -(un =
            90)) : ai > Nn ? un = 90 : ai < -Nn && (dn = -90), bn[0] = sn, bn[1] = cn
        },
        sphere: function() {
          sn = -(cn = 180), dn = -(un = 90)
        }
    ...
    q.invert = q;
    var di, ci, ui, fi, mi, gi, pi, hi, bi, xi, vi, yi = n(),
      wi = ue(function() {
        return !0
      }, ge, he, [-Fn, -Un]),
      Si = 1e9,
      ...
      ji = {
        ...
        result: function() {
          var e = Wi ? [Yi / Wi, $i / Wi] : Bi ? [Vi / Bi, Hi / Bi] : Gi ? [Ui / Gi, zi / Gi] : [NaN, NaN];
      ...
      point: function(e, t) {
        switch (this._point) {
          ...
          case 1:
            ...
            break;
          default:
            null == this._circle && (this._circle = ot(this._radius)), this._string.push("M", e, ",", t, this
              ._circle)
        }
      },
      result: function() {
    ...
    Bt.invert = function(e, t) {
        for (var n, i, o, r = t, l = r * r, s = l * l * l, d = 0; d < fo && (i = r * (ao + lo * l + s * (so + co *
            l)) - t, o = ao + 3 * lo * l + s * (7 * so + 9 * co * l), r -= n = i / o, l = r * r, s = l * l * l, !(Bn(
              n) < Ln)); ++d);
        ...
        do {
          var r = i * i,
            a = r * r;
          i -= n = (i * (1.007226 + r * (.015085 + a * (-.044475 + .028874 * r - .005916 * a))) - t) / (1.007226 + r *
            (.045255 + a * (-.311325 + .259866 * r - .005916 * 11 * a)))
        } while (Bn(n) > Nn && --o > 0);
        return [e / (.8707 + (r = i * i) * (-.131979 + r * (-.013791 + r * r * r * (.003971 - .001529 * r)))), i]
      ...
      .geoAzimuthalEqualAreaRaw = oo, e.geoAzimuthalEquidistant = Rt, e.geoAzimuthalEquidistantRaw = ro, e.geoBounds =
      N, e.geoCentroid = W, e.geoCircle = ie, e.geoClipAntimeridian = wi, e.geoClipCircle = be, e.geoClipExtent = ye,
      e.geoClipRectangle = ve, e.geoConicConformal = Ut, e.geoConicConformalRaw = Ft, e.geoConicEqualArea = _t, e
      .geoConicEqualAreaRaw = kt, e.geoConicEquidistant = Ht, e.geoConicEquidistantRaw = Vt, e.geoContains = Pe, e
      .geoDistance = Te, e.geoEqualEarth = Yt, e.geoEqualEarthRaw = Bt, e.geoEquirectangular = Gt, e
      .geoEquirectangularRaw = zt, e.geoGnomonic = Wt, e.geoGnomonicRaw = $t, e.geoGraticule = Le, e.geoGraticule10 =
      Fe, e.geoIdentity = jt, e.geoInterpolate = Ue, e.geoLength = _e, e.geoMercator = Dt, e.geoMercatorRaw = Pt, e
      .geoNaturalEarth1 = qt, e.geoNaturalEarth1Raw = Kt, e.geoOrthographic = Zt, e.geoOrthographicRaw = Xt, e
      .geoPath = rt, e.geoProjection = yt, e.geoProjectionMutator = wt, e.geoRotation = ee, e.geoStereographic = Jt, e
      .geoStereographicRaw = Qt, e.geoStream = f, e.geoTransform = at, e.geoTransverseMercator = tn, e
