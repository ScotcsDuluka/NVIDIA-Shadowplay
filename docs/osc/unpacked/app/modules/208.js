// ─────────────────────────────────────────────────────────────
// APP MODULE 208
// role       : provider shadowPlayEndpoints
// defines    : angular.module("main.localSdk.shadowPlaySdk")
// requires   : (none)
  ...
  n.provider("shadowPlayEndpoints", [function() {
    ...
    return {
      ...
      $get: ["NvEndpointFactory", "localSdk", function(n, i) {
        var o, r, a, l, s, d, c, u, f, m, g, p, h, b, x, v, y, w, S, E, k, _, T, C, O, A, I, M, R, P, D, N, L,
          F, U, z, G, V, H, B, Y, $, W, j, K, q, X, Z, Q, J, ee, te, ne, ie, oe, re, ae, le, se, de, ce, ue,
          fe, me, ge, pe, he, be, xe, ve, ye, we, Se, Ee, ke, _e, Te, Ce, Oe, Ae, Ie, Me, Re, Pe, De, Ne, Le,
          Fe, Ue, ze, Ge, Ve, He, Be, Ye, $e, We, je, Ke, qe, Xe, Ze, Qe, Je, et, tt, nt, it, ot, rt, at, lt =
          i.newLocalEndpointFactory("ShadowPlay", e),
