...
function(e, t, n) {
  ! function(e, i) {
    ...
    function n(e, t, n, i, o) {
      var r = e * e,
        a = r * e;
      return ((1 - 3 * e + 3 * r - a) * t + (4 - 6 * r + 3 * a) * n + (1 + 3 * e + 3 * r - 3 * a) * i + a * o) / 6
    }
    ...
    function f(e, t) {
      t || (t = []);
      var n, i = e ? Math.min(t.length, e.length) : 0,
        o = t.slice();
      return function(r) {
    ...
    function w(e, t) {
      var n, i, o, r = j.lastIndex = K.lastIndex = 0,
        a = -1,
        l = [],
        s = [];
      for (e += "", t += "";
        (n = j.exec(e)) && (i = K.exec(t));)(o = i.index) > r && (o = t.slice(r, o), l[a] ? l[a] += o : l[++a] = o), (
        n = n[0]) === (i = i[0]) ? l[a] ? l[a] += i : l[++a] = i : (l[++a] = null, s.push({
        i: a,
        x: b(n, i)
      })), r = K.lastIndex;
      return r < t.length && (o = t.slice(r), l[a] ? l[a] += o : l[++a] = o), l.length < 2 ? s[0] ? y(s[0].x) : v(t) :
        (t = s.length, function(e) {
    ...
    function S(e, n) {
      var i, o = typeof n;
      return null == n || "boolean" === o ? r(n) : ("number" === o ? b : "string" === o ? (i = t.color(n)) ? (n = i,
          Y) : w : n instanceof t.color ? Y : n instanceof Date ? h : m(n) ? f : Array.isArray(n) ? p :
        "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? x : b)(e, n)
    }
    ...
    function T(e, t, n, i, o, r) {
      var a, l, s;
      return (a = Math.sqrt(e * e + t * t)) && (e /= a, t /= a), (s = e * n + t * i) && (n -= e * s, i -= t * s), (l =
        Math.sqrt(n * n + i * i)) && (n /= l, i /= l, s /= l), e * i < t * n && (e = -e, t = -t, s = -s, a = -a), {
        translateX: o,
        translateY: r,
    ...
    function C(e) {
      return "none" === e ? X : (G || (G = document.createElement("DIV"), V = document.documentElement, H = document
          .defaultView), G.style.transform = e, e = H.getComputedStyle(V.appendChild(G), null).getPropertyValue(
          "transform"), V.removeChild(G), e = e.slice(7, -1).split(","), T(+e[0], +e[1], +e[2], +e[3], +e[4], +e[
        5]))
    }

    function O(e) {
      return null == e ? X : (B || (B = document.createElementNS("http://www.w3.org/2000/svg", "g")), B.setAttribute(
          "transform", e), (e = B.transform.baseVal.consolidate()) ? (e = e.matrix, T(e.a, e.b, e.c, e.d, e.e, e
        .f)) : X)
    }
    ...
    function A(e, t, n, i) {
      ...
      return function(t, n) {
        var i = [],
          o = [];
        return t = e(t), n = e(n), r(t.translateX, t.translateY, n.translateX, n.translateY, i, o), a(t.rotate, n
            .rotate, i, o), l(t.skewX, n.skewX, i, o), s(t.scaleX, t.scaleY, n.scaleX, n.scaleY, i, o), t = n =
          null,
          function(e) {
    ...
    function U(e, t) {
      for (var n = 0, i = t.length - 1, o = t[0], r = new Array(i < 0 ? 0 : i); n < i;) r[n] = e(o, o = t[++n]);
      return function(e) {
    ...
    e.interpolate = S, e.interpolateArray = g, e.interpolateBasis = i, e.interpolateBasisClosed = o, e
      .interpolateCubehelix = le, e.interpolateCubehelixLong = se, e.interpolateDate = h, e.interpolateDiscrete = E, e
      .interpolateHcl = re, e.interpolateHclLong = ae, e.interpolateHsl = ie, e.interpolateHslLong = oe, e
      .interpolateHue = k, e.interpolateLab = N, e.interpolateNumber = b, e.interpolateNumberArray = f, e
      .interpolateObject = x, e.interpolateRgb = Y, e.interpolateRgbBasis = $, e.interpolateRgbBasisClosed = W, e
      .interpolateRound = _, e.interpolateString = w, e.interpolateTransformCss = Z, e.interpolateTransformSvg = Q, e
      .interpolateZoom = P, e.piecewise = U, e.quantize = z, Object.defineProperty(e, "__esModule", {
        value: !0
      })
  })
}
