  ...
  ! function(e, n) {
    ...
    function n(e) {
      return function() {
        var t = this.ownerDocument,
          n = this.namespaceURI;
        return n === Ke && t.documentElement.namespaceURI === Ke ? t.createElement(e) : t.createElementNS(n, e)
      }
    }
    ...
    function l(e) {
      ...
      for (var t = this._groups, n = t.length, i = new Array(n), o = 0; o < n; ++o)
        for (var r, l, s = t[o], d = s.length, c = i[o] = new Array(d), u = 0; u < d; ++u)(r = s[u]) && (l = e.call(r,
          r.__data__, u, s)) && ("__data__" in r && (l.__data__ = r.__data__), c[u] = l);
    ...
    function c(e) {
      ...
      for (var t = this._groups, n = t.length, i = [], o = [], r = 0; r < n; ++r)
        for (var a, l = t[r], s = l.length, c = 0; c < s; ++c)(a = l[c]) && (i.push(e.call(a, a.__data__, c, l)), o
          .push(a));
      return new Le(i, o)
    }
    ...
    function f(e) {
      ...
      for (var t = this._groups, n = t.length, i = new Array(n), o = 0; o < n; ++o)
        for (var r, a = t[o], l = a.length, s = i[o] = [], d = 0; d < l; ++d)(r = a[d]) && e.call(r, r.__data__, d,
          a) && s.push(r);
      return new Le(i, this._parents)
    }
    ...
    function p(e, t) {
      this.ownerDocument = e.ownerDocument, this.namespaceURI = e.namespaceURI, this._next = null, this._parent = e,
        this.__data__ = t
    }
    ...
    function b(e, t, n, i, o, r) {
      for (var a, l = 0, s = t.length, d = r.length; l < d; ++l)(a = t[l]) ? (a.__data__ = r[l], i[l] = a) : n[l] =
        new p(e, r[l]);
    ...
    function x(e, t, n, i, o, r, a) {
      var l, s, d, c = {},
        ...
        f = r.length,
        m = new Array(u);
      for (l = 0; l < u; ++l)(s = t[l]) && (m[l] = d = Xe + a.call(s, s.__data__, l, t), d in c ? o[l] = s : c[d] =
      s);
      for (l = 0; l < f; ++l) d = Xe + a.call(e, r[l], l, r), (s = c[d]) ? (i[l] = s, s.__data__ = r[l], c[d] =
        null) : n[l] = new p(e, r[l]);
    ...
    function w(e, t, n) {
      var i = this.enter(),
        o = this,
        r = this.exit();
      return i = "function" == typeof e ? e(i) : i.append(e + ""), null != t && (o = t(o)), null == n ? r.remove() :
        n(r), i && o ? i.merge(o).order() : o
    }

    function S(e) {
      for (var t = this._groups, n = e._groups, i = t.length, o = n.length, r = Math.min(i, o), a = new Array(i), l =
          0; l < r; ++l)
        for (var s, d = t[l], c = n[l], u = d.length, f = a[l] = new Array(u), m = 0; m < u; ++m)(s = d[m] || c[m]) &&
          (f[m] = s);
      for (; l < i; ++l) a[l] = t[l];
    ...
    function E() {
      for (var e = this._groups, t = -1, n = e.length; ++t < n;)
        for (var i, o = e[t], r = o.length - 1, a = o[r]; --r >= 0;)(i = o[r]) && (a && 4 ^ i.compareDocumentPosition(
          a) && a.parentNode.insertBefore(i, a), a = i);
      return this
    }
    ...
    function k(e) {
      ...
      for (var n = this._groups, i = n.length, o = new Array(i), r = 0; r < i; ++r) {
        for (var a, l = n[r], s = l.length, d = o[r] = new Array(s), c = 0; c < s; ++c)(a = l[c]) && (d[c] = a);
        d.sort(t)
      }
    ...
    function U(e, n) {
      ...
      return this.each((null == n ? i.local ? P : R : "function" == typeof n ? i.local ? F : L : i.local ? N : D)(i,
        n))
    }
    ...
    function B(e, t, n) {
      return arguments.length > 1 ? this.each((null == t ? G : "function" == typeof t ? H : V)(e, t, null == n ? "" :
        n)) : Y(this.node(), e)
    }
    ...
    function K(e, t) {
      return arguments.length > 1 ? this.each((null == t ? $ : "function" == typeof t ? j : W)(e, t)) : this.node()[e]
    }
    ...
    function le(e) {
      return arguments.length ? this.each(null == e ? oe : ("function" == typeof e ? ae : re)(e)) : this.node()
        .textContent
    }
    ...
    function ue(e) {
      return arguments.length ? this.each(null == e ? se : ("function" == typeof e ? ce : de)(e)) : this.node()
        .innerHTML
    }
    ...
    function Oe(e) {
      return function() {
        var t = this.__on;
        if (t) {
          for (var n, i = 0, o = -1, r = t.length; i < r; ++i) n = t[i], e.type && n.type !== e.type || n.name !== e
            .name ? t[++o] = n : this.removeEventListener(n.type, n.listener, n.capture);
      ...
      return function(o, r, a) {
        ...
        if (s)
          for (var c = 0, u = s.length; c < u; ++c)
            if ((l = s[c]).type === e.type && l.name === e.name) return this.removeEventListener(l.type, l.listener,
              l.capture), this.addEventListener(l.type, l.listener = d, l.capture = n), void(l.value = t);
    ...
    function Re(e, t, n) {
      var i = z(e),
        o = i.CustomEvent;
      "function" == typeof o ? o = new o(t, n) : (o = i.document.createEvent("Event"), n ? (o.initEvent(t, n.bubbles,
        n.cancelable), o.detail = n.detail) : o.initEvent(t, !1, !1)), e.dispatchEvent(o)
    }
    ...
    function $e(e) {
      return "string" == typeof e ? new Le([document.querySelectorAll(e)], [document.documentElement]) : new Le([
        null == e ? [] : e
      ], Je)
    }
    ...
    Ve.prototype = Ge.prototype = {
      ...
      }, e.clientPoint = Be, e.create = ze, e.creator = o, e.customEvent = Me, e.local = Ge, e.matcher = u, e.mouse =
      Ye, e.namespace = t, e.namespaces = qe, e.select = Ue, e.selectAll = $e, e.selection = Fe, e.selector = a, e
      .selectorAll = d, e.style = Y, e.touch = We, e.touches = je, e.window = z, Object.defineProperty(e,
        "__esModule", {
          value: !0
        })
  })
