// ─────────────────────────────────────────────────────────────
// APP MODULE 151
// role       : directive nvVirtualGridList | directive nvVirtualGridListRepeat | directive nvVirtualGridListItem
// requires   : (none)
...
function(e, t, n) {
  ...
  var o = i.ngMainCommonModule.directive("nvVirtualGridList", function() {
    ...
    r = i.ngMainCommonModule.directive("nvVirtualGridListRepeat", ["$document", "_", "$compile", function(e, t, n) {
      function i(e) {
        var t, n, i, o, r;
        if (t = e.match(
            /^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), !t)
        throw new Error('Expected expression in form of "_item_ in _collection_[ track by _id_]" but got {0}', e);
      ...
      function r(t, n, i, o) {
        for (var r = e[0].styleSheets, a = n.attr("nv-repeat-item-class"), d = 0, c = r.length; d < c; d++) {
          var u = r[d];
          if (u.cssRules)
      ...
      function a(e) {
        var t, n, o = i(e.attr("nv-virtual-grid-list-repeat")),
        ...
        return t = o.key + " in row", o.aliasAs && (t += " alias as " + o.aliasAs), o.trackBy && (t +=
            " track by " + o.trackBy), r && (s = "md-on-demand"), d && (c = 'md-top-index="' + d + '"'), a = a
          .replace(/nv-virtual-grid-list-repeat=["'].*?['"]/g, ""), n =
          '<md-content layout="row" flex><md-virtual-repeat-container flex id="vertical-container" ' + c +
          '><div md-virtual-repeat="row in nvVirtualGridListItems" layout="row" flex ' + s + ' class="' + l +
          '"><nv-virtual-grid-list-item ng-repeat="' + t + '">' + a +
  ...
  t.nvVirtualGridList = o, t.nvVirtualGridListRepeat = r, t.nvVirtualGridListItem = a
}
