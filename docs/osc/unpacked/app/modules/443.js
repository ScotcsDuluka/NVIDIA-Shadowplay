...
function(e, t, n) {
  ! function(e, i) {
    ...
    function b(e, t, n) {
      ...
      return e.translate(o > i ? (i + o) / 2 : Math.min(0, i) || Math.max(0, o), a > r ? (r + a) / 2 : Math.min(0,
        r) || Math.max(0, a))
    }

    function x() {
      function e(e) {
        e.property("__zoom", g).on("wheel.zoom", k).on("mousedown.zoom", _).on("dblclick.zoom", T).filter(L).on(
          "touchstart.zoom", C).on("touchmove.zoom", O).on("touchend.zoom touchcancel.zoom", A).style(
      ...
      function k() {
        ...
        if (R.apply(this, arguments)) {
          ...
          u(), t.wheel = setTimeout(e, B), t.zoom("mouse", D(x(d(n, i), t.mouse[0], t.mouse[1]), t.extent, U))
        }
      }
      ...
      function _() {
        ...
        if (!M && R.apply(this, arguments)) {
          var i = S(this, arguments, !0),
            ...
            s = o.event.clientX,
            d = o.event.clientY;
          n.dragDisable(o.event.view), c(), i.mouse = [l, this.__zoom.invert(l)], r.interrupt(this), i.start()
        }
      }
      ...
      function T() {
        if (R.apply(this, arguments)) {
          ...
          u(), z > 0 ? o.select(this).transition().duration(z).call(w, a, n) : o.select(this).call(e.transform, a)
        }
      }

      function C() {
        if (R.apply(this, arguments)) {
          var e, t, n, i, a = o.event.touches,
            l = a.length,
            s = S(this, arguments, o.event.changedTouches.length === l);
          for (c(), t = 0; t < l; ++t) n = a[t], i = o.touch(this, a, n.identifier), i = [i, this.__zoom.invert(i), n
            .identifier
          ], s.touch0 ? s.touch1 || s.touch0[2] === i[2] || (s.touch1 = i, s.taps = 0) : (s.touch0 = i, e = !0, s
            .taps = 1 + !!I);
      ...
      function O() {
        if (this.__zooming) {
          var e, t, n, i, r = S(this, arguments),
            a = o.event.changedTouches,
            l = a.length;
          for (u(), I && (I = clearTimeout(I)), r.taps = 0, e = 0; e < l; ++e) t = a[e], n = o.touch(this, a, t
              .identifier), r.touch0 && r.touch0[2] === t.identifier ? r.touch0[0] = n : r.touch1 && r.touch1[2] === t
            .identifier && (r.touch1[0] = n);
          if (t = r.that.__zoom, r.touch1) {
            ...
            t = d(t, Math.sqrt(g / p)), n = [(s[0] + f[0]) / 2, (s[1] + f[1]) / 2], i = [(c[0] + m[0]) / 2, (c[1] + m[
              1]) / 2]
          } else {
            if (!r.touch0) return;
      ...
      function A() {
        if (this.__zooming) {
          var e, t, n = S(this, arguments),
            i = o.event.changedTouches,
            r = i.length;
          for (c(), M && clearTimeout(M), M = setTimeout(function() {
              M = null
            }, H), e = 0; e < r; ++e) t = i[e], n.touch0 && n.touch0[2] === t.identifier ? delete n.touch0 : n
      ...
      return e.transform = function(e, t, n) {
        ...
        i.property("__zoom", g), e !== i ? w(e, t, n) : i.interrupt().each(function() {
          S(this, arguments).start().zoom(null, "function" == typeof t ? t.apply(this, arguments) : t).end()
        })
        ...
        e.transform(t, function() {
          return D(this.__zoom.translate("function" == typeof n ? n.apply(this, arguments) : n, "function" ==
            typeof i ? i.apply(this, arguments) : i), P.apply(this, arguments), U)
        })
        ...
        e.transform(t, function() {
          ...
          return D(v.translate(r[0], r[1]).scale(t.k).translate("function" == typeof n ? -n.apply(this,
            arguments) : -n, "function" == typeof i ? -i.apply(this, arguments) : -i), e, U)
        }, o)
      }, E.prototype = {
        start: function() {
