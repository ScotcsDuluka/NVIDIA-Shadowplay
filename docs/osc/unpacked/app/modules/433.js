  ...
  ! function(e, i) {
    ...
    function s(e) {
      return function(t, n, i) {
        return 2 === arguments.length && "function" == typeof n && (i = n, n = void 0), l(t, n).then(function(t) {
          return e(t, i)
        })
      }
    }
    ...
    var g = s(t.csvParse),
      ...
      b = m("text/html"),
      x = m("image/svg+xml");
    e.blob = i, e.buffer = r, e.csv = g, e.dsv = d, e.html = b, e.image = c, e.json = f, e.svg = x, e.text = l, e
      .tsv = p, e.xml = h, Object.defineProperty(e, "__esModule", {
        value: !0
      })
  })
}
