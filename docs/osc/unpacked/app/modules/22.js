// ─────────────────────────────────────────────────────────────
// APP MODULE 22
// role       : service octoolService
// requires   : (none)
// cefQuery   : QUERY_OSC_SET_EXPERIMENTAL
...
function(e, t, n) {
  ...
  var o = n(109),
    ...
    c = n(2);
  n(12), n(4), n(47);
  var u = c.ngMainCommonModule.service("octoolService", ["$state", "$log", "$q", "$window", "$filter", "$http",
    "eventAggregator", "cefService", "oscDisplayService", "shadowPlayService", "hotkeyService", "settingsService",
    "telemetryService", "hardwareService", "oscNotificationService", "gfwslService", "PERFTOOL_EVENTS",
    "SHADOWPLAY_EVENTS", "HOTKEY_EVENTS", "COMMON_EVENTS", "OSC_CONFIG", "OVERLAY_VIEW", "SCAN_TYPE", "MODULE",
    "TELEMETRY_OSC_AVAILABLE_STATUS", "TELEMETRY_OSC_EVENT_NAMES", "TELEMETRY_OSC_TOGGLE_STATE", "SYSTEM_TYPE",
    "OVERCLOCKING_FEATURE", "DISCLAIMER_OPTIONS", "$timeout", "$interval", "OC_SCANNER_STATUS",
    "NOTIFIER_SELECTIONS", "PERFTOOL_VIEWNAMES",
    function(e, t, n, i, o, a, s, c, u, f, m, g, p, h, b, x, v, y, w, S, E, k, T, C, O, A, I, M, R, P, D, N, L, F,
      U) {
      function z() {
        D(function() {
      ...
      function G() {
        var e = Me;
        return Ae.info("experimental", g.experimentalSetting), Ie = E.perfmonOCTool, B().then(function(e) {
          ...
          }), j(), Me || !e || Be || g.experimentalSetting || Z(), Ie ? (W(), Oe.callbackMap = new d.default,
            Oe.getGPUInfoAndFillData().then(function() {
              Me = Me && Oe.isOCSupported(), ae(), Ae.info("persisted data:", (0, l.default)(Oe
                  ...
                  .setDefaultLoggingPathOnInit(), Oe.checkRLAMonitor().then(function() {
                    Oe.isRLAMonitor ? (Oe.overlayViews[4].enabled = !0, Oe.defaultOverlayViewName =
                      "Latency") : (Oe.overlayViews[4].enabled = !1, Oe.defaultOverlayViewName =
                      "Basic")
                  }), Oe.getSupportedDD(), Oe.getFlashIndicatorStatus() && Oe.setFlashIndicatorSize(!0)), Oe
                .createPerfMetricsSets(), Ae.info("Initialized")
            }).then(function() {
          ...
          if (e) {
            ...
            if (n >= tt) {
              ...
              if (i >= nt) {
                ...
                var o = Array.isArray(e.GPU) && _.isString(e.GPU[0].GPUArchitecture) ? parseInt(e.GPU[0]
                  .GPUArchitecture, 10) : 0;
                Ae.info("gpuArch", o);
                var r = ot < o,
                  a = it <= o && ot >= o && !t;
        ...
        if (Ae.info("Logging toggle hotkey pressed, is perf. currently enabled by file logging - ", Oe
          ...
          Oe.enablePerfTracking(!0, void 0, !0).then(function(e) {
            ne("LoggingToggle", i).then(function() {
              Ae.info("File logging enabled"), s.trigger(v.PERF_OVERLAY_VISIBILITY_CHANGED, Tt), Oe
                .sendPerformanceToolLoggingSessionTelemetry(!0, !1)
            })
          })
        }
      }
      ...
      function W() {
        Ae.info("registernotifications"), s.on(w.OCTOOLUI_TOGGLE, yt), s.on(w.PERFOVERLAY_TOGGLE, wt), s.on(w
            .PERFOVERLAY_CYCLE, St), s.on(w.RESET_AVERAGES, Et), s.on(w.TOGGLE_LOGGING, kt), s.on(y.GAME_STARTED,
          K), s.on(y.GAME_EXITED, X), c.registerForNotification(Xe, "RegisterPerfStatsNotifications").then(angular
            .noop,
            function(e) {
              Ae.info("register pert metrics notification error: ", e)
            }, Q), c.registerForNotification(Xe, "OcScanStatusUpdatesNotifications").then(angular.noop, function(
          e) {
            Ae.info("register scan status notification error: ", e)
          }, J), c.registerForNotification(Xe, "powerStatusNotification").then(angular.noop, function(e) {
            Ae.info("register power status notification error: ", e)
          }, _e)
      }

      function j() {
        Ae.info("unRegisterNotification"), s.off(w.OCTOOLUI_TOGGLE, yt), s.off(w.PERFOVERLAY_TOGGLE, wt), s.off(w
          .PERFOVERLAY_CYCLE, St), s.off(w.RESET_AVERAGES, $), s.off(w.TOGGLE_LOGGING, kt), s.off(y.GAME_STARTED,
          K), s.off(y.GAME_EXITED, X)
      }

      function K(e) {
        Le = !0, Ae.info("onAppStarted: ", e, " isValidProcessAttached:", Re), Oe.setProcessId(e.startedAppPID), Oe
          .isRFIIntegrated(e.startedAppCmsID, e.startedAppPID), void 0 == Oe.persistedData.rectAlignmentStatus && (
            Oe.persistedData.rectAlignmentStatus = !0), Oe.persistedData.rectAlignmentStatus && Oe
          .isRLASupportedDD && Oe.isRLAMonitor && (Tt ? Oe.alignMonitoringRect() : Oe.enablePerfTracking(!0, void 0,
            !1).then(function(e) {
      ...
      function q() {
        ...
        if (!Ue) {
          ...
          var e = 0,
            t = null,
            i = N(function() {
              e++, e >= 5 ? (Ae.error("Container plugin decalred as failed to load after waiting for 2.5 sec"), Ue
                .resolve(!1), N.cancel(i), i = void 0, Fe = !1) : (Ae.debug(
                "checking whether container plugin loaded.."), t = c.nativeQuery(Ze, "GetFeatureSupportState",
                void 0), t.finally(function() {
                Ae.debug("overclocking container plugin loaded"), t = null, Fe = !0, N.cancel(i), i =
                  void 0, Ue.resolve(!0)
              }))
            }, 500)
        }
      ...
      function X(e) {
        e.exitedAppPID === Oe.currentAppPID && (Ae.info("Current Game app exited: ", Oe.currentAppPID), Re = !1, Oe
          .setProcessId(0), Oe.sendLatencyMetricsTelemetry()), Le = !1
      }
      ...
      function Q(e) {
        ...
        if (Ie || Ae.error("updatePerfStats notification should be disabled in case of feature disable"), !(t && t
            .gpusPerfStats && t.gpusPerfStats.length > 0)) return void Ae.error(
        ...
        if (Oe.isFvSDKSessionStartInProgress && (Oe.isFvSDKSessionStartInProgress = !1, Ae.info(
            ...
            "perf metrics data:", t), Re = void 0 !== t.avgFps, t.AvgSWPCLatency ? Oe.isReflexStatsSupported = !0 :
          Oe.isReflexStatsSupported = !1, Oe.isRLAMonitor || Oe.isReflexStatsSupported === Oe
          .cachedReflexStatsSupported || s.trigger(v.PERF_OVERLAY_VISIBILITY_CHANGED, Tt), Oe
          .cachedReflexStatsSupported = Oe.isReflexStatsSupported, t.gSyncLamp) {
          var n = {
              dbAverage: !1,
              unverifiedFW: !1
            },
          ...
          (0, r.default)(t.gSyncLamp).forEach(function(e) {
            if ("lamEnabled" === e) t.gSyncLamp[e] !== De && (Ae.info("Lam metrics support recieved ", t
              .gSyncLamp[e]), De = t.gSyncLamp[e], Ae.info("perf metrics data:", t), s.trigger(v
              ...
              t[e] = "(" + o.topleftx + ", " + o.toplefty + ")"
                ...
                .dbAverage || 1 === t.gSyncLamp[e].latencySource, n.unverifiedFW = n.unverifiedFW || 1 === t
                .gSyncLamp[e].unverifiedFW, Ae.info("updatePerfStats islatestRFISupported :", Oe
                  .islatestRFISupported), t.gSyncLamp[e].latency >= 0 ? (Oe.isRLAMouseSupported = !0, Oe
                  .isReflexStatsSupported ? Oe.overlayViews[0].metricSet = ["avgFps", "e2eSystemLatency",
                    "AvgSWPCLatency"
                  ] : Oe.overlayViews[0].metricSet = ["avgFps", "e2eSystemLatency", "renderingLatency"], s
                  .trigger(v.PERF_OVERLAY_VISIBILITY_CHANGED, Tt)) : (Oe.isRLAMouseSupported = !1, Oe
                  .isReflexStatsSupported ? Oe.overlayViews[0].metricSet = ["avgFps", "pcDisplayLatency",
                    "AvgSWPCLatency"
                  ] : Oe.overlayViews[0].metricSet = ["avgFps", "pcDisplayLatency", "renderingLatency"], s
                  .trigger(v.PERF_OVERLAY_VISIBILITY_CHANGED, Tt))) : i = 1 === t.gSyncLamp[e].polledActuation :
              t[e] = t.gSyncLamp[e] / 1e3
          });
          var a = ["mouseLatency", "avgMouseLatency"];
          a.forEach(function(e) {
            t.gSyncLamp[e] && void 0 !== t.gSyncLamp[e].latency ? t.gSyncLamp[e].latency < 0 ? t[e] = t
              .gSyncLamp[e].latency : t[e] = t.gSyncLamp[e].latency / 1e3 : t[e] = void 0;
            var r = !1,
              a = "";
            "avgMouseLatency" === e ? i && (a = o("translate")("l10n.perfmonoc.polledAutuationDetection"), r = !
              0) : (n.dbAverage && (a += o("translate")("l10n.perfmonoc.databseaverage"), r = !0), n
              .unverifiedFW && (r ? a += ", " : r = !0, a += o("translate")("l10n.perfmonoc.unverified") +
                " " + o("translate")("l10n.perfmonoc.firmWare"))), Oe.perfMetrics.forEach(function(t) {
      ...
      function J(e) {
        ...
        if (Ae.info("scan status notification:", t), 1 === t.type) {
          var n = ce(t.gpuId);
          if (void 0 !== Oe.callbackMap.get(n)) return Oe.callbackMap.get(n)(t), void Oe.checkLimiters(t.gpuId)
        }
        var i = Oe.gpuData[t.gpuId];
        Oe.scanOperationInProgress = !1, i && (0 === t.type ? (Oe.gpuData[t.gpuId].backgroundOcScannerEnabled = !0,
          s.trigger(v.PERF_AUTO_TUNING_INFO_UPDATED, t), Ae.info("update ongoing scan progress:", t
            .percentComplete), i.scanStatus.percentComplete = t.percentComplete, 100 === t.percentComplete ? i
          .scanStatus.isScanInProgress = !1 : i.scanStatus.isScanInProgress = !0) : 1 === t.type && (Ae.info(
          "ongoing scan completed"), me(t, !0))), Oe.checkLimiters(t.gpuId)
      }
      ...
      function ee(e, t) {
        ...
        return n.forEach(function(e) {
          ...
          e.min = n.min, e.max = n.max, e.default = n.default, e.value = n.current, e.backedUpvalue = n.current,
            e.current = n.current, e.isSupported = n.isSupported
        }), n
      }

      function te(e, t) {
        var n = {};
        if (t.length > 0 ? n.isSupported = t[0].isVisible && t[0].sliderSetting.isSupported : n.isSupported = !1, n
          .enabled = n.isSupported, n.isSupported) {
          ...
          t.forEach(function(e) {
            ...
            }), i = Math.round(i / t.length), n.fanCount = t.length, n.autoPowerSwitch = {}, n.autoPowerSwitch
            .items = ["l10n.perfmonoc.automatic", "l10n.perfmonoc.manual"], n.autoPowerSwitch.disable = !1, n
            .autoPowerSwitch.selectedIndex = n.autoPower ? 0 : 1;
      ...
      function ne(e, t) {
        ...
        return i === Ze ? q().then(function(o) {
          return Ue && (Ue = null), o ? ie(e, t, i) : (Ae.error("Container plugin ", i, " Failed to load"), n
            .reject("Error: container plugin failed to load"))
        }) : ie(e, t, i)
      }
      ...
      function ie(e, t, n) {
        return c.nativeQuery(n, e, t).then(function(t) {
          ...
          var i = "";
          return n.result !== !1 && 0 === n._return_code || (i = i = e + " - " + n._return_code, gt.errorType =
            i, gt.reportedBy = C.plugin, Oe.sendPerformanceToolErrorTelemetry()), n
        }).catch(function(t) {
          Ae.error(e, "failed:", (0, l.default)(t));
          var n = e + " - " + (0, l.default)(t);
          return gt.errorType = n, gt.reportedBy = C.plugin, Oe.sendPerformanceToolErrorTelemetry(), null
        })
      }
        ...
        Oe.persistedData.ocData.gpuData.forEach(function(t, i) {
          e = e.then(function() {
            ...
            t.ocSliderControls.forEach(function(t) {
              ...
              t.current >= n.min && t.current <= n.max && n.current !== t.current && (n.current = t
                .current, e = !0)
            });
            var o = void 0;
            return e ? o = Oe.setManualOCLimits(i) : (Ae.info("No need to update limiter settings"), o = n
              .when(!0)), o.then(function() {
              if (!Oe.gpuData[i].fanSettings.isSupported) return Ae.info("Fan settings not supported"),
                n.when(!0);
              var e = !1;
              return t.fanSettings.autoPower !== Oe.gpuData[i].fanSettings.autoPower && (Oe.gpuData[i]
                  .fanSettings.autoPower = t.fanSettings.autoPower, e = !0), t.fanSettings.sliderSetting
                .current !== Oe.gpuData[i].fanSettings.sliderSetting.current && (Oe.gpuData[i]
                  .fanSettings.sliderSetting.current = t.fanSettings.sliderSetting.current, e = !0), e ?
                Oe.setFanSettings(i) : (Ae.info("No need to update fan settings"), n.when(!0))
            })
          })
        })
      }
      ...
      function ae() {
        ...
        return e ? (Oe.persistedData = JSON.parse(e), oe(), void(Me && re())) : (Ae.info("No stored data found"), Oe
          .persistedData = {
            version: et,
            ocData: {
              gpuData: []
      ...
      function de(e) {
        ...
        return t(e, L.SCAN_CANCELLED) && (n.errorCode = L.SCAN_CANCELLED, n.errorString = "ScanCancelled"), t(e, L
          .INTERNAL_ERROR) && (n.errorCode = L.INTERNAL_ERROR, n.errorString = "ScanInternalError"), t(e, L
          .CANCELLED_USER_REQUESTED) ? (n.errorCode = L.CANCELLED_USER_REQUESTED, n.errorString =
          "cancelledUserRequested") : t(e, L.CANCELLED_GPU_BUSY) ? (n.errorCode = L.CANCELLED_GPU_BUSY, n
          .errorString = "cancelledGpuBusy") : t(e, L.CANCELLED_USER_INPUT_DETECTED) ? (n.errorCode = L
          .CANCELLED_USER_INPUT_DETECTED, n.errorString = "cancelledInputDetected") : t(e, L
          .CANCELLED_POWER_SWITCH_TO_DC) ? (n.errorCode = L.CANCELLED_POWER_SWITCH_TO_DC, n.errorString =
          "cancelledSwitchToDC") : t(e, L.CANCELLED_SERVICE_SUSPENDED) ? (n.errorCode = L
          ...
          .errorString = "cancelledBackgroundScanDisabled") : t(e, L.CANCELLED_SERVICE_STOPPED) ? (n.errorCode = L
          .CANCELLED_SERVICE_STOPPED, n.errorString = "cancelledServiceStopped") : t(e, L
          .CANCELLED_CONFIGURATION_NOT_SUPPORTED) && (n.errorCode = L.CANCELLED_CONFIGURATION_NOT_SUPPORTED, n
          .errorString = "cancelledConfigNotSuppoted"), n
      }
      ...
      function fe(e, t) {
        ...
        if (t.isScanInProgress && !o) {
          var c = void 0;
          r ? c = "ScanCompletedSuccessFully" : a && (c = "ScanCancelled"), c && (gt.errorType = c, gt.reportedBy =
            C.others, Oe.sendPerformanceToolErrorTelemetry())
        }
        if (o ? t.isScanInProgress || (Ae.info("A current scan is found to be ongoing"), t.isScanInProgress = !0, t
            .percentComplete = 0, Oe.scanOperationInProgress = !1) : (t.isScanInProgress = !1, Oe
            .scanStopInProgress = !1), a && (Oe.scanOperationInProgress = !1, Oe.scanStopInProgress && (Oe
            .scanStopInProgress = !1)), 0 !== l.errorCode ? (t.errorCode = l.errorCode, t.resultText = "--", t
            .isLastScanSuccessful = !1, Oe.scanStopInProgress = !1, Ae.info("Last scan failed because of error", l
              .errorCode), gt.errorType = l.errorString, gt.reportedBy = C.others, Oe
            .sendPerformanceToolErrorTelemetry()) : t.errorCode = 0, r && (Ae.info(
              "Updating successfull last scan results"), Oe.scanOperationInProgress = !1, Oe.scanStopInProgress = !
            1, t.isLastScanSuccessful = !0, t.completionStatus = e.completionStatus, t.completionTime = e
            .completionTime, t.memoryOcOffsetMhz = e.memoryOcOffsetMhz, t.averageGpuClockOffsetMhz = e
            .averageGpuClockOffsetMhz, t.resultText = e.averageGpuClockOffsetMhz + "Mhz", e
            .averageGpuClockOffsetMhz >= 0 && (t.resultText = "+" + t.resultText)), d) {
      ...
      function me(e, t) {
        ...
        if (n && (n.backgroundOcScannerEnabled = e.stable, s.trigger(v.PERF_AUTO_TUNING_INFO_UPDATED, e), Ae.info(
            "Filling up scan status info"), fe(e, n.scanStatus), t)) {
      ...
      function ge() {
        var e = [{
          ...
          name: o("translate")("l10n.perfmonoc.average") + " " + o("translate")("l10n.perfmonoc.mouseLatency"),
          value: o("translate")("l10n.perfmonoc.notApplicable"),
          visible: !1,
          dynamicDisable: !0,
          disableValue: void 0,
          ...
          name: o("translate")("l10n.perfmonoc.average") + " " + o("translate")("l10n.perfmonoc.systemLatency"),
          value: o("translate")("l10n.perfmonoc.notApplicable"),
          visible: !1,
          dynamicDisable: !0,
          disableValue: void 0,
        ...
        t.forEach(function(e) {
          ...
          if (!e.dynamicDisable || (e.visible = t !== e.disableValue, e.visible)) {
            if ("avgFps" === e.metricId) {
              if ("FPS" === Oe.selectedOverlayViewName && void 0 === t) return e.value = "", void(e.visible = !
                1);
              e.visible = !0
            }
            if (void 0 === t) return e.value = o("translate")("l10n.perfmonoc.notApplicable"), e.unit = "", e
              .isFallbackValue = !0, void(e.isSuffixApplied = !1);
            ...
            if (void 0 !== e.fallbackValue) {
              if (t < 0 || 0 == t && "AvgSWPCLatency" === e.metricId) return e.value = e.fallbackValue, e.unit =
                "", e.isFallbackValue = !0, void(e.isSuffixApplied = !1);
              e.unit = e.actualUnit, e.isFallbackValue = !1
            }
            "lamMonitoringRect" === e.metricId ? (e.value = t, e.extraClass = e.isFallbackValue ? "" :
              ...
              .isFallbackValue ? "" : "perf-overlay-valid-value", e.isSuffixApplied && (e.extraClass +=
                " perf-overlay-suffixed-value")), be(e)
          }
        })
      }

      function be(e) {
        angular.isNumber(e.value) && ("avgFps" === e.metricId && (mt.meanFPS = e.value), "avgPCDisplayLatency" === e
          .metricId && (mt.meanPCDisplayLatency = e.value), "avgE2ESystemLatency" === e.metricId && (mt
            .meanSystemLatency = e.value), "avgMouseLatency" === e.metricId && (mt.meanMouseLatency = e.value),
          "renderingLatency" === e.metricId && (mt.meanRenderingLatency = e.value), "renderingPresentLatency" ===
          e.metricId && (mt.meanRenderPresentLatency = e.value))
      }
      ...
      function Ee() {
        ...
        n = (n + 1) % t, Oe.selectedOverlayViewName = e[n].id, s.trigger(v.PERF_OVERLAY_VISIBILITY_CHANGED, Tt), Ae
          .info("Performance overlay view changed to", Oe.selectedOverlayViewName), Oe.overlayViewUpdated = !0, ut
          .hotkeyUsed = O.yes, Oe.sendOverlaySessionTelemetry(!1, !0), D(function() {
      ...
      function ke(e) {
        if (!_t) {
          var t = e || Tt,
            n = t;
          we(!t), Oe.enablePerfTracking(Tt), void 0 == Oe.persistedData.rectAlignmentStatus && (Oe.persistedData
              .rectAlignmentStatus = !0), s.trigger(v.PERF_OVERLAY_VISIBILITY_CHANGED, Tt), Ae.info(
              "togglePerfOverlayVisibility isVisible : ", t), !Oe.getFlashIndicatorStatus() && Oe
            .isRLASupportedDD && Oe.isRLAMonitor && (t ? Oe.setFlashIndicatorVisibility(t) : Oe
              .selectedOverlayViewName === U.LATENCY || Oe.selectedOverlayViewName === U.REFLEX_ANALYZER ? Oe
              .setFlashIndicatorVisibility(t) : Oe.setFlashIndicatorVisibility(!t)), Tt && Oe.isRLAMonitor && Le &&
            (Oe.islegacyRFISupported ? (Ae.info("Toggle legacy RFI from in-game settings"), b.show(F
              .PERFMON_RFI_SUPPORT)) : Oe.islegacyRFISupported || Oe.islatestRFISupported || (Ae.info(
              "RFI not supported"), b.show(F.PERFMON_RECTALIGNMENT_SUPPORT))), n ? Oe.sendOverlaySessionTelemetry(!
              1, !0) : Oe.sendOverlaySessionTelemetry(!0, !1)
        }
      }
      ...
      Oe.defaultOverlayEnabledState = !0, Oe.defaultOverlayQuadrant = "RightTop", Oe.defaultOverlayViewName =
        "Latency", Oe.selectedOverlayViewName = Oe.defaultOverlayViewName, Oe.isPerfOverlayEnabled = !1, Oe
        .currentAppPID = 0, Oe.isAnyOtherOSDVisible = !1, Oe.isDC = !1, Oe.isRLAMonitor = !1, Oe
        .isRLAMouseSupported = !1, Oe.isRLASupportedDD = !1, Oe.flashIndicatorStatus = !1, Oe
        .rectAlignmentStatus = !0, Oe.islatestRFISupported = !1, Oe.islegacyRFISupported = !1, Oe.gpuData = [], Oe
        .perfMetrics = [], Oe.persistedData = {}, Oe.sidebarSessionParams = {
      ...
      Oe.skipExperimentalFlag = function() {
        ...
        e || (Ae.info("Logging path not found, switching to default path"), ne("GetDefaultLoggingPath").then(
          function(e) {
      ...
      Oe.setOCAdminConsent = function(e) {
        ...
        Ae.info("createPerfMetricsSets"), Oe.gpuData.forEach(function(e, t) {
          ...
          Oe.perfMetrics[t] ? (0, r.default)(Oe.perfMetrics[t]).forEach(function(e) {
            Oe.perfMetrics[t][e].name = n[e].name, Oe.perfMetrics[t][e].fallbackValue = n[e].fallbackValue
          }) : (Ae.info("createPerfMetricsSet, index:", t), Oe.perfMetrics[t] = n)
        })
      }, Oe.isOCSupported = function() {
        var e = !1;
        return Oe.gpuData && 1 == Oe.gpuData.length && (e = Oe.gpuData[0].ocConfig.manualOcScannerSupported && Oe
          .gpuData[0].ocConfig.backgroundOcScannerSupported), e
        ...
        return i.gpu = e, Oe.getCurrentOCConfig(t).then(function(e) {
          ...
          return i.uiState = Oe.gpuData[t] && Oe.gpuData[t].uiState || {}, i.uiState.tuningTypeSwitch = i
            .uiState.tuningTypeSwitch || {}, i.uiState.isSliderStateDirty = !1, i.scanStatus = Oe.gpuData[
            t] && Oe.gpuData[t].scanStatus || {}, i
        })
      }, Oe.fillGPUData = function(e) {
        var t = e.index;
        return Oe.getGPUData(e).then(function(e) {
          return Oe.gpuData[t] = e, Ae.info("gpuData : ", e), e.ocConfig.manualOcScannerSupported && e
            .ocConfig.backgroundOcScannerSupported ? Oe.getScanStatus(t).then(function() {
              return e
            }) : void n.when(e)
        })
        ...
        Ae.info("Updating persisted settings"), Oe.gpuData.forEach(function(e, t) {
          Oe.persistedData.ocData.gpuData[t] || (Oe.persistedData.ocData.gpuData[t] = {}), Oe.persistedData
            .ocData.gpuData[t].ocSliderControls = e.ocSliderControls.filter(function(e) {
        ...
        if (Ae.info("isPerfEnabled - " + He + " and isPerfEnabledByFileLogging - " + Oe
          ...
          if (He && Oe.isPerfEnabledbyFileLogging) return i ? Oe.isPerfEnabledbyFileLogging = !1 : He = !1, !0;
        ...
        if (e && (i ? Oe.isPerfEnabledbyFileLogging = !0 : He = !0), Ae.info("enablePerfTracking enable:", e,
            "duration:", t), t = t || Qe, Ne && (Ae.info("Cancel ongoing stop FvSDK service timer"), D.cancel(Ne),
            Ne = null), !e) return Ae.info("Start FvSDK stop service timer"), Ne = D(function() {
          var e = {
            isEnable: !1,
            intervalMS: t
          };
        ...
        return ne("StartOcManualScan", n, i).then(function(t) {
          return t.result || (Ae.error("Failed to start manual scan: ", e), Oe.scanOperationInProgress = !1,
            Oe.gpuData[e].scanStatus.resultText = "--", Oe.gpuData[e].scanStatus.errorCode = L
            .INTERNAL_ERROR, Oe.gpuData[e].scanStatus.isLastScanSuccessful = !1, s.trigger(v
              .PERF_OCSCAN_COMPLETION_UPDATE)), Oe.checkLimiters(e), t.result
        })
      }, Oe.stopManualScan = function(e) {
        if (Ae.info("stopManualScan, gpuIndex:", e), !Oe.gpuData[e].scanStatus.isScanInProgress) return Ae.info(
          "Manual scan not running, do nothing"), Oe.scanOperationInProgress = !1, n.when(!0);
        ...
        return ne("StopOcManualScan", t, i).then(function(t) {
          return t.result || (Ae.error("Stop scan API failed: ", e), Oe.scanOperationInProgress = !1, Oe
            .scanStopInProgress = !1), Oe.checkLimiters(e), t
        })
        ...
        return ne("GetLastOcScanResults", n).then(function(e) {
          e.result || (Ae.info("getScanStatus failed, deleting callback"), Oe.callbackMap.delete(t))
        })
        ...
        for (var n = [], i = Oe.gpuData[e].fanSettings.fanCount, o = 0; o < i; o++) {
          var r = {};
          r.index = o, r.autoPower = Oe.gpuData[e].fanSettings.autoPower, r.sliderSetting = Oe.gpuData[e]
            .fanSettings.sliderSetting, r.isVisible = Oe.gpuData[e].fanSettings.isSupported, n.push(r)
        }
        t.fanSettings = n;
        ...
        metricSet: Oe.isRLAMouseSupported ? ["avgFps", "e2eSystemLatency", "AvgSWPCLatency",
          "renderingLatency"] : ["avgFps", "pcDisplayLatency", "AvgSWPCLatency", "renderingLatency"]
      }, {
        id: "FPS",
        ...
        enabled: !0,
        metricSet: ["avgFps", "fps99", "renderingLatency", "cpuUtilization", "utilization", "frequency",
      ...
      Oe.isPerfOverlayVisible = function() {
        ...
        Ae.info("closeOcToolMenu"), _t = !1, we(Ct), Ct = void 0, Tt || Oe.enablePerfTracking(!1), s.trigger(v
            .PERF_OVERLAY_VISIBILITY_CHANGED, Tt), Me && (Oe.updatePersistedOCSettings(), le()), Oe
          .sendSidebarSessionTelemetry(), Tt && Oe.sendOverlaySessionTelemetry(!0, !1)
        ...
        Oe.enableReflexEnhancements || (i = [m.hotKeyMapping.PerfOverlayToggle]), f.dynamicHotkeyToggle(i, n),
          t && (we(n), Oe.enablePerfTracking(Tt), s.trigger(v.PERF_OVERLAY_VISIBILITY_CHANGED, Tt), Oe
            .sendOverlaySessionTelemetry(Tt, !Tt))
      }, Oe.sendSidebarSessionTelemetry = function() {
        h.getSystemInfo().then(function(e) {
          e && (Oe.sidebarSessionParams.systemType = e.MoboType), Ae.info("sendSidebarSessionTelemetry: ", Oe
            .sidebarSessionParams), p.push(A.OSC_PERFORMANCE_TOOL_SIDEBAR_SESSION, Oe.sidebarSessionParams)
        })
      }, Oe.sendOverlaySessionTelemetry = function(e, t) {
        e && (Oe.selectedOverlayViewName === U.FPS ? ut.overlayView = k.fps : Oe.selectedOverlayViewName === U
          .REFLEX_ANALYZER ? ut.overlayView = k.reflexAnalyzer : ut.overlayView = Oe.selectedOverlayViewName, ut
          .hotkeyUsed = O.no, Ae.info("sendOverlaySessionTelemetry start timer"), p.startTimer(A
            .OSC_PERFORMANCE_TOOL_OVERLAY_SESSION)), t && (ut.isSystemRLACapable = Oe.isRLAMonitor ? O.yes : O
          .no, ut.isMouseRLACapable = Oe.isRLAMouseSupported ? O.yes : O.no, Oe.isRLAMonitor ? ut.isRLAEnabled =
          Oe.rectAlignmentStatus ? O.yes : O.no : ut.isRLAEnabled = O.no, ut.isRFISupported = Oe
          .islegacyRFISupported || Oe.islatestRFISupported ? O.yes : O.no, ut.IsReflexStatsSupported = Oe
          .isReflexStatsSupported ? O.yes : O.no, Ae.info("sendOverlaySessionTelemetry stop timer: ", ut), p
          .endTimer(A.OSC_PERFORMANCE_TOOL_OVERLAY_SESSION, {
            info: ut
          }))
      }, Oe.sendLastScanResultsTelemetry = function() {
        Ae.info("sendLastScanResultsTelemetry: ", ft), p.push(A.OSC_PERFORMANCE_TOOL_LAST_SCAN_RESULTS, ft)
        ...
        h.getSystemInfo().then(function(e) {
          e && (gt.osVersion = e.OSVersion, gt.installedDDVersion = e.DriverVersion, gt.systemType = e
            .MoboType, gt.gpuName = e.GPU[0].LongGPUName), Ae.info("sendPerformanceToolErrorTelemetry: ",
            gt), p.push(A.OSC_PERFORMANCE_TOOL_ERROR, gt)
        })
        ...
        Oe.sidebarSessionParams.featureSupported = R.performanceMonitoring, Oe.sidebarSessionParams
          .appliedStatus = O.no, Oe.sidebarSessionParams.automaticTuningEnabled = O.no, Oe.sidebarSessionParams
          .disclaimerPromptOptionSelected = P.notPresented, Oe.sidebarSessionParams.isFullscreen = O.no, Oe
          .sidebarSessionParams.restoredDefaults = O.no, Oe.sidebarSessionParams.gpuChevronUsed = O.no, Oe
          .sidebarSessionParams.tuningTypeChevronUsed = O.no, Oe.sidebarSessionParams.perfMetricScrollUsed = O.no,
          Oe.sidebarSessionParams.HUDSettingUsed = O.no, Oe.sidebarSessionParams.gpuCount = 0, Oe
          .sidebarSessionParams.GPU1 = "", Oe.sidebarSessionParams.GPU2 = "", Oe.sidebarSessionParams.systemType =
          M.desktop
        ...
        Ae.info("sendPerformanceToolSampleSizeTelemetry: ", pt), p.push(A.OSC_PERFORMANCE_TOOL_SAMPLE_SIZE, pt)
      }, Oe.sendPerformanceToolResetAverageTelemetry = function() {
        Ae.info("sendPerformanceToolResetAverageTelemetry"), p.push(A.OSC_PERFORMANCE_TOOL_RESET_AVERAGE, bt)
        ...
        e && p.startTimer(A.OSC_PERFORMANCE_TOOL_LOGGING_SESSION), t && (Ae.info(
          "sendPerformanceToolLoggingSessionTelemetry"), p.endTimer(A.OSC_PERFORMANCE_TOOL_LOGGING_SESSION, {
          info: ht
        }))
      }, Oe.sendPerformanceToolSettingsTelemetry = function(e) {
        xt.settingName = e, e === vt.ReflexAnalyzer ? Oe.isRLAMonitor ? xt.settingValue = Oe.rectAlignmentStatus ?
          I.on : I.off : xt.settingValue = I.off : xt.settingValue = Oe.flashIndicatorStatus ? I.on : I.off, Ae
          .info("sendPerformanceToolSettingsTelemetry: ", xt), p.push(A.OSC_PERFORMANCE_TOOL_SETTINGS, xt)
        ...
        Oe.persistedData.flashIndicatorStatus = e, Oe.flashIndicatorStatus = e, le(), Ae.info(
            "Storing current Flash Indicator status to local storage - " + Oe.persistedData.flashIndicatorStatus),
          Oe.sendPerformanceToolSettingsTelemetry(vt.FlashIndicator)
        ...
        h.getSystemInfo().then(function(e) {
          return e && (Ge = parseFloat(e.DriverVersion, 10), Oe.isRLASupportedDD = Ve.DDVersion <= Ge), Ae
            .info("getSupportedDD : ", Oe.isRLASupportedDD), Oe.isRLASupportedDD
        })
      }, Oe.isRFIIntegrated = function(e, t) {
        Ke = e, Ae.info("currentGameCmsId : ", Ke), Te().then(function(e) {
          Ae.info(" HTTP chroma response ", (0, l.default)(e.data)), e.data && e.data.data && (e.data.data
            .forEach(function(e) {
              e.isReflexFISupported === !0 && (e.isReflexFIFullyAutomatic === !0 ? $e.push(e.cms_appId) :
                e.isReflexFISupported === !0 ? Ye.push(e.cms_appId) : Ae.info(
                  "Game do not have RFI integrated"), e.isReflexIntegrated === !0 && We.push(e
                  .cms_appId))
            }), Oe.islatestRFISupported = $e.includes(Ke), Ae.info("currentGame islatestRFISupported : ", Oe
              .islatestRFISupported), Oe.islegacyRFISupported = Ye.includes(Ke), Ae.info(
              "currentGame islegacyRFISupported : ", Oe.islegacyRFISupported), Oe.isReflexIntegrated = We
            .includes(Ke), Ae.info("currentGame isReflexIntegrated : ", Oe.isReflexIntegrated), (Oe
              .islatestRFISupported || Oe.islegacyRFISupported) && (je = t))
        }, function(e) {
