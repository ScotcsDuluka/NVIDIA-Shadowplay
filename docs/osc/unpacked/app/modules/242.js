// ─────────────────────────────────────────────────────────────
// APP MODULE 242
// role       : controller PreferencesHighlightsController
// requires   : (none)
...
function(e, t, n) {
  ...
  Object.defineProperty(t, "__esModule", {
    value: !0
  }), t.PreferencesHighlightsController = void 0;
  var r = n(8),
    a = o(r),
    l = n(3),
    s = i(l),
    d = n(1);
  n(60);
  var c = d.ngMainModule.controller("PreferencesHighlightsController", ["$log", "$scope", "$state", "$stateParams",
    "$filter", "$timeout", "$q", "eventAggregator", "sdkService", "oscDisplayService", "telemetryService",
    "RECORDING_PATH_TYPES", "KEYBOARD_EVENTS", "HIGHLIGHTS_EVENTS", "OSC_KEYBOARD", "TELEMETRY_OSC_EVENT_NAMES",
    ...
    function(e, t, n, i, o, r, l, d, c, u, f, m, g, p, h, b, x) {
      ...
      function y() {
        return c.getHighlightsEnabled().then(function(e) {
          ...
          A.error("ERROR retrieving highlights enabled: ", e), O.highlightsEnabled = !1, O.originalSettings
            .highlightsEnabled = !1
        })
      }
      ...
      function w(e) {
        c.getPermissions(e).then(function(e) {
          return O.gamePermissions = e.permissions && (e.permissions.highlightsRecordVideo == x.GRANTED || e
              .permissions.highlightsRecordScreenshot == x.GRANTED) && e.permissions.highlightsRecordVideo != x
            .DENIED && e.permissions.highlightsRecordScreenshot != x.DENIED, O.originalSettings
            .gamePermissions = O.gamePermissions, O.gamePermissions
        }, function(e) {
          return A.error("Exception getting game highlight permission", e), O.gamePermissions = !1, l.when(O
            .gamePermissions)
        })
      }
      ...
      function S() {
        ...
        return void 0 !== e.shortName && "" !== e.shortName ? c.getGameHighlightsSettings(c.getSDKInstance()
          .shortName).then(function(e) {
          return O.sdkGameRunning = !0, O.gameShortName = c.getSDKInstance().shortName, O.gameDisplayName = c
            .getSDKInstance().drsProfileName, O.gameHighlights = e.highlights, O.originalSettings
            .gameHighlights = JSON.parse((0, a.default)(O.gameHighlights)), w(O.gameShortName)
      ...
      function k() {
        return c.getCustomize().then(function(e) {
          0 !== e ? (O.highlightsPath = e.tempSaveFolder, O.maxSpace = O.initSpace = e.sizeMB / 1024, "" === O
            .highlightsPath && (O.highlightsPath = M)) : (O.maxSpace = I, O.highlightsPath = M, A.info(
            "Using default max size: ", O.maxSpace))
        })
      }

      function _() {
        A.info("Move progress bar started!"), O.percentComplete = 0, O.moveInProgress = !0, d.off(p.MOVE_STARTED, _)
      }
      ...
      var A = e.getInstance("osc/preferencesHighlightsController"),
        I = 5,
        M = "C:";
      O.highlightsPath = "", O.highlightsNewPath = "", O.maxSpace = I, O.initSpace = 0, O.moveInProgress = !1, O
        .timeoutDelay = 500, O.highlightsEnabled = !1, O.settingsDisabled = !1, O.gamePermissions = !1, O
        .gameHighlights = {}, O.sdkGameRunning = !1, O.originalSettings = {
          highlightsEnabled: !1,
          gamePermissions: !1,
          gameHighlights: {}
        }, O.entries = {
      ...
      O.setGamePermissions = function() {
        var e = {};
        return e.highlightsRecordVideo = e.highlightsRecordScreenshot = O.gamePermissions ? x.GRANTED : x.DENIED,
          c.setPermissions(O.gameShortName, e).then(function() {
        ...
        c.setGameHighlights(O.gameShortName, O.gamePermissions, O.gameHighlights).then(function() {
          A.info("Game highlights changed " + c.sdkInstance.drsProfileName + " to " + O.gameHighlights)
        })
      }, O.initPreferencesHighlights = function() {
        return R().then(function() {
          return s.isUndefined(i.newPath) || "" === i.newPath ? void l.all([E(), k()]) : (O
            .highlightsNewPath = i.newPath, O.initSpace = O.maxSpace = i.currentSize, O.highlightsEnabled =
            O.originalSettings.highlightsEnabled = i.enabled, O.initializeMoveProgressBar(), c
            .setCustomizePath(O.highlightsNewPath).then(function(e) {
        ...
        return A.info("Changing highlights path: ", O.highlightsPath), O.checkSettings().then(function() {
        ...
        O.originalSettings.highlightsEnabled != O.highlightsEnabled && (A.info("Update HL Enabled telemetry"), f
            .push(b.OSC_HIGHLIGHTS_GAME_TOGGLE, {
              gameName: "All",
            ...
            }), O.originalSettings.highlightsEnabled = O.highlightsEnabled), O.originalSettings.gamePermissions !=
          O.gamePermissions && (A.info("Update Game Permissions telemetry"), f.push(b
  ...
  t.PreferencesHighlightsController = c
}
