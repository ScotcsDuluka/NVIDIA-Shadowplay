// ─────────────────────────────────────────────────────────────
// APP MODULE 222
// role       : controller OsdCommentsController
// requires   : (none)
...
function(e, t, n) {
  ...
  Object.defineProperty(t, "__esModule", {
    value: !0
  }), t.OsdCommentsController = void 0;
  var o = n(106),
    r = i(o),
    a = n(1);
  n(35), n(4), n(34);
  var l = a.ngMainModule.controller("OsdCommentsController", ["$log", "$scope", "$filter", "eventAggregator",
    "osdService", "shadowPlayService", "keyboardService", "COMMON_EVENTS", "CONNECT_EVENTS", "HOTKEY_EVENTS",
    function(e, t, n, i, o, a, l, s, d, c) {
      ...
      function m(e) {
        e && e.summary && e.summary.total_count && (p.commentsCount = e.summary.total_count, p.comments = e.data,
        f())
      }
      ...
      var h = "l10n.showHideComments",
        b = !0;
      i.on(s.OSD_SETTINGS_CHANGED, f), i.on(d.FACEBOOK_COMMENTS, m), i.on(c.COMMENTS_TOGGLE, g), t.$on("$destroy",
        function() {
