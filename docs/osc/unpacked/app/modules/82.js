...
function(e, t, n) {
  ! function(e, i) {
    ...
    function r(e) {
      ...
      "onselectstart" in t ? i.on("selectstart.drag", o, !0) : (t.__noselect = t.style.MozUserSelect, t.style
        .MozUserSelect = "none")
    }
    ...
    function a(e, t) {
      ...
      }, 0)), "onselectstart" in i ? r.on("selectstart.drag", null) : (i.style.MozUserSelect = i.__noselect,
        delete i.__noselect)
    }
    ...
    function s(e, t, n, i, o, r, a, l, s, d) {
      this.target = e, this.type = t, this.subject = n, this.identifier = i, this.active = o, this.x = r, this.y = a,
        this.dx = l, this.dy = s, this._ = d
    }
    ...
    function m() {
      function e(e) {
        e.on("mousedown.drag", m).filter(C).on("touchstart.drag", h).on("touchmove.drag", b).on(
          "touchend.drag touchcancel.drag", x).style("touch-action", "none").style("-webkit-tap-highlight-color",
          "rgba(0,0,0,0)")
      }
      ...
      function m() {
        if (!E && k.apply(this, arguments)) {
          ...
          e && (n.select(n.event.view).on("mousemove.drag", g, !0).on("mouseup.drag", p, !0), r(n.event.view), i(),
            S = !1, y = n.event.clientX, w = n.event.clientY, e("start"))
        }
      }
      ...
      function p() {
        n.select(n.event.view).on("mousemove.drag mouseup.drag", null), a(n.event.view, S), o(), O.mouse("end")
      }

      function h() {
        if (k.apply(this, arguments)) {
          var e, t, o = n.event.changedTouches,
      ...
      function b() {
        var e, t, i = n.event.changedTouches,
          r = i.length;
      ...
      function v(t, i, o, r, a) {
        ...
        if (n.customEvent(new s(e, "beforestart", l, t, I, u[0], u[1], 0, 0, f), function() {
            return null != (n.event.subject = l = T.apply(r, a)) && (d = l.x - u[0] || 0, c = l.y - u[1] || 0, !0)
          })) return function m(g) {
          var p, h = u;
          switch (g) {
            case "start":
          ...
          n.customEvent(new s(e, g, l, t, p, u[0] + d, u[1] + c, u[0] - h[0], u[1] - h[1], f), f.apply, f, [g, r,
            a
          ])
        }
      }
