// ─────────────────────────────────────────────────────────────
// APP MODULE 149
// role       : service piplConfigService
// requires   : (none)
    ...
    o = i.ngMainCommonModule.service("piplConfigService", ["$log", "$q", "eventAggregator", "COMMON_EVENTS",
      ...
      function(e, t, n, i, o, r, a, l) {
        ...
        c.getPiplConfig = function() {
          ...
          g || (l.register(r.LOCALIZED_CONFIG_UPDATED, a.LOCALIZED_CONFIG_UPDATED), n.on(a.LOCALIZED_CONFIG_UPDATED,
            d), g = !0, u.info("Initialization completed"))
        }
      }
    ]);
  t.piplConfigService = o
}
