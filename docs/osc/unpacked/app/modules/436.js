...
function(e, t, n) {
  ! function(e, n) {
    ...
    function S(e, t) {
      var n, i, o, r, a, l = new C(e),
        s = +e.value && (l.value = e.value),
        d = [l];
      for (null == t && (t = k); n = d.pop();)
        if (s && (n.value = +n.data.value), (o = t(n.data)) && (a = o.length))
          for (n.children = new Array(a), r = a - 1; r >= 0; --r) d.push(i = n.children[r] = new C(o[r])), i.parent =
            n, i.depth = n.depth + 1;
    ...
    function A(e) {
      for (var t, n, i = 0, o = (e = O(ve.call(e))).length, r = []; i < o;) t = e[i], n && R(n, t) ? ++i : (n = D(r =
        I(r, t)), i = 0);
      return n
    }
    ...
    function I(e, t) {
      ...
      for (n = 0; n < e.length - 1; ++n)
        for (i = n + 1; i < e.length; ++i)
          if (M(L(e[n], e[i]), t) && M(L(e[n], t), e[i]) && M(L(e[i], t), e[n]) && P(F(e[n], e[i], t), e)) return [e[
            n], e[i], t];
      throw new Error
    }
    ...
    function U(e, t, n) {
      var i, o, r, a, l = e.x - t.x,
        s = e.y - t.y,
        d = l * l + s * s;
      d ? (o = t.r + n.r, o *= o, a = e.r + n.r, a *= a, o > a ? (i = (d + a - o) / (2 * d), r = Math.sqrt(Math.max(0,
        a / d - i * i)), n.x = e.x - i * l - r * s, n.y = e.y - i * s + r * l) : (i = (d + o - a) / (2 * d), r =
        Math.sqrt(Math.max(0, o / d - i * i)), n.x = t.x + i * l - r * s, n.y = t.y + i * s + r * l)) : (n.x = t.x +
        n.r, n.y = t.y)
    }
    ...
    function H(e) {
      ...
      U(n, t, i = e[2]), t = new V(t), n = new V(n), i = new V(i), t.next = i.previous = n, n.next = t.previous = i, i
        .next = n.previous = t;
      e: for (l = 3; l < o; ++l) {
    ...
    function q() {
      function e(e) {
        return e.x = n / 2, e.y = i / 2, t ? e.eachBefore(X(t)).eachAfter(Z(o, .5)).eachBefore(Q(1)) : e.eachBefore(X(
          K)).eachAfter(Z(W, 1)).eachAfter(Z(o, e.r / Math.min(n, i))).eachBefore(Q(Math.min(n, i) / (2 * e.r))), e
      }
      var t = null,
        n = 1,
        i = 1,
    ...
    function ee(e, t, n, i, o) {
      for (var r, a = e.children, l = -1, s = a.length, d = e.value && (i - t) / e.value; ++l < s;) r = a[l], r.y0 =
        n, r.y1 = o, r.x0 = t, r.x1 = t += r.value * d
    }
      ...
      function t(e, t) {
        return function(n) {
          ...
          var i = n.x0,
            ...
            a = n.x1 - o,
            l = n.y1 - o;
          a < i && (i = a = (i + a) / 2), l < r && (r = l = (r + l) / 2), n.x0 = i, n.y0 = r, n.x1 = a, n.y1 = l
        }
      }
      var n = 1,
        i = 1,
    ...
    function oe() {
      function e(e) {
        var i, o, r, a, l, s, d, c = e.length,
          u = new Array(c),
          f = {};
        for (o = 0; o < c; ++o) i = e[o], l = u[o] = new C(i), null != (s = t(i, o, e)) && (s += "") && (d = ye + (l
          .id = s), f[d] = d in f ? Se : l);
        for (o = 0; o < c; ++o)
    ...
    function de(e) {
      for (var t, n = 0, i = 0, o = e.children, r = o.length; --r >= 0;) t = o[r], t.z += n, t.m += n, n += t.s + (
        i += t.c)
    }
    ...
    function ue(e, t) {
      this._ = e, this.parent = null, this.children = null, this.A = null, this.a = this, this.z = 0, this.m = 0, this
        .c = 0, this.s = 0, this.t = null, this.i = t
    }

    function fe(e) {
      for (var t, n, i, o, r, a = new ue(e, 0), l = [a]; t = l.pop();)
        if (i = t._.children)
          for (t.children = new Array(r = i.length), o = r - 1; o >= 0; --o) l.push(n = t.children[o] = new ue(i[o],
            o)), n.parent = t;
    ...
    function me() {
      ...
      function i(e, t, n) {
        if (t) {
          for (var i, o = e, a = e, l = t, s = o.parent.children[0], d = o.m, c = a.m, u = l.m, f = s.m; l = le(l),
            o = ae(o), l && o;) s = ae(s), a = le(a), a.a = e, i = l.z + u - o.z - d + r(l._, o._), i > 0 && (se(ce(l,
            e, n), e, i), d += i, c += i), u += l.m, d += o.m, f += s.m, c += a.m;
    ...
    function ge(e, t, n, i, o) {
      for (var r, a = e.children, l = -1, s = a.length, d = e.value && (o - n) / e.value; ++l < s;) r = a[l], r.x0 =
        t, r.x1 = i, r.y0 = n, r.y1 = n += r.value * d
    }

    function pe(e, t, n, i, o, r) {
      for (var a, l, s, d, c, u, f, m, g, p, h, b = [], x = t.children, v = 0, y = 0, w = x.length, S = t.value; v <
        w;) {
        s = o - n, d = r - i;
        do c = x[y++].value; while (!c && y < w);
        for (u = f = c, p = Math.max(d / s, s / d) / (S * e), h = c * c * p, g = Math.max(f / h, h / u); y < w; ++y) {
          if (c += l = x[y].value, l < u && (u = l), l > f && (f = l), h = c * c * p, m = Math.max(f / h, h / u), m >
            g) {
            c -= l;
            break
          }
        ...
        }), a.dice ? ee(a, n, i, o, S ? i += d * c / S : r) : ge(a, n, i, S ? n += s * c / S : o, r), S -= c, v = y
      }
      return b
    }
    ...
    function he() {
      ...
      function t(e) {
        var t = a[e.depth],
          ...
          r = e.x1 - t,
          f = e.y1 - t;
        r < i && (i = r = (i + r) / 2), f < o && (o = f = (o + f) / 2), e.x0 = i, e.y0 = o, e.x1 = r, e.y1 = f, e
          .children && (t = a[e.depth + 1] = l(e) / 2, i += u(e) - t, o += s(e) - t, r -= d(e) - t, f -= c(e) - t, r <
            i && (i = r = (i + r) / 2), f < o && (o = f = (o + f) / 2), n(e, i, o, r, f))
      }
      var n = ke,
        i = !1,
        o = 1,
        ...
        function n(e, n, i, o, r) {
          if ((a = e._squarify) && a.ratio === t)
            for (var a, l, s, d, c, u = -1, f = a.length, m = e.value; ++u < f;) {
              for (l = a[u], s = l.children, d = l.value = 0, c = s.length; d < c; ++d) l.value += s[d].value;
              l.dice ? ee(l, n, i, o, i += (r - i) * l.value / m) : ge(l, n, i, n += (o - n) * l.value / m, r), m -= l
                .value
    ...
    e.cluster = s, e.hierarchy = S, e.pack = q, e.packEnclose = A, e.packSiblings = B, e.partition = te, e.stratify =
      oe, e.tree = me, e.treemap = he, e.treemapBinary = be, e.treemapDice = ee, e.treemapResquarify = _e, e
      .treemapSlice = ge, e.treemapSliceDice = xe, e.treemapSquarify = ke, Object.defineProperty(e, "__esModule", {
        value: !0
      })
  })
}
