...
function(e, t, n) {
  ...
  var o = i.ngMainCommonModule.service("gfwslService", ["$log", "$q", "hardwareService", "gfwslEndpoints",
    ...
    function(e, t, n, i, o) {
      function r(e, t) {
        var n = "";
        return e.DeviceId && e.VendorId ? (n = e.DeviceId + "_" + e.VendorId, e.SubSystemId && e.SubVendorId ? n =
          n + "_" + e.SubSystemId + "_" + e.SubVendorId : n += "_FFFF_FFFF") : (c.error(
          "GPU info has invalid DeviceId and/or VendorId"), n = "FFFF_FFFF_FFFF_FFFF"), n = n + "_" + ++t
      }
      ...
      function l(e) {
        return "1" === e.SLISupported && "1" === e.HasActiveSLITopology ? e.ActiveTopologyGPUCount : e.SLISupported
      }
      ...
      function s(e) {
        ...
        u = {}, u.gcV = _.last(o.oscPackageVersion.split("-")), u.GFPV = e.DriverVersion, u.sM = (e
            .TotalPhysicalMemory / f).toFixed() + "GB", u.osC = e.OSVersion, u.osB = e.OSBuildNumber, u.cSR = e
          .CurrentResolution, u.dIDa = a(e.GPU), u.cID = e.CPUName, u.is6 = "AMD64" === e.ProcessorArchitecture ?
          "1" : "0", u.IsB = "0", u.gIsB = "0", u.isO = e.IsOptimus, u.IsQ = t.IsQuadro, u.iLp = d.isLaptop(e), u
          .isSLI = l(e), u.glg = "en-US", u.lg = "1033"
      }
      var d = this,
