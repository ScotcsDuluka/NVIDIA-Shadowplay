...
function(e, t, n) {
  ! function(e, n) {
    ...
    function l(e) {
      var t, n;
      return e = (e + "").trim().toLowerCase(), (t = H.exec(e)) ? (n = t[1].length, t = parseInt(t[1], 16), 6 === n ?
          s(t) : 3 === n ? new f(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | 240 & t, (15 & t) << 4 | 15 & t, 1) : 8 ===
          n ? d(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (255 & t) / 255) : 4 === n ? d(t >> 12 & 15 | t >> 8 &
            240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | 240 & t, ((15 & t) << 4 | 15 & t) / 255) : null) : (t = B
          .exec(e)) ? new f(t[1], t[2], t[3], 1) : (t = Y.exec(e)) ? new f(255 * t[1] / 100, 255 * t[2] / 100, 255 *
          t[3] / 100, 1) : (t = $.exec(e)) ? d(t[1], t[2], t[3], t[4]) : (t = W.exec(e)) ? d(255 * t[1] / 100, 255 *
          t[2] / 100, 255 * t[3] / 100, t[4]) : (t = j.exec(e)) ? h(t[1], t[2] / 100, t[3] / 100, 1) : (t = K.exec(
        e)) ? h(t[1], t[2] / 100, t[3] / 100, t[4]) : q.hasOwnProperty(e) ? s(q[e]) : "transparent" === e ? new f(NaN,
          NaN, NaN, 0) : null
    }
    ...
    function h(e, t, n, i) {
      return i <= 0 ? e = t = n = NaN : n <= 0 || n >= 1 ? e = t = NaN : t <= 0 && (e = NaN), new v(e, t, n, i)
    }
    ...
    function b(e) {
      ...
      var t = e.r / 255,
        ...
        d = a - r,
        c = (a + r) / 2;
      return d ? (s = t === a ? (n - o) / d + 6 * (n < o) : n === a ? (o - t) / d + 2 : (t - n) / d + 4, d /= c < .5 ?
        a + r : 2 - a - r, s *= 60) : d = c > 0 && c < 1 ? 0 : s, new v(s, d, c, e.opacity)
    }
    ...
    function w(e) {
      ...
      return i === o && o === r ? t = n = a : (t = _((.4360747 * i + .3850649 * o + .1430804 * r) / J), n = _((
        .0139322 * i + .0971045 * o + .7141733 * r) / te)), new k(116 * a - 16, 500 * (t - a), 200 * (a - n), e
        .opacity)
    }
    ...
    function A(e) {
      ...
      if (e instanceof k || (e = w(e)), 0 === e.a && 0 === e.b) return new R(NaN, 0 < e.l && e.l < 100 ? 0 : NaN, e.l,
        e.opacity);
    ...
    t(i, l, {
      ...
      darker: function(e) {
        return e = null == e ? F : Math.pow(F, e), new f(this.r * e, this.g * e, this.b * e, this.opacity)
      },
      rgb: function() {
        return this
      },
      ...
      rgb: function() {
        var e = this.h % 360 + 360 * (this.h < 0),
          ...
          i = n + (n < .5 ? n : 1 - n) * t,
          o = 2 * n - i;
        return new f(y(e >= 240 ? e - 240 : e + 120, o, i), y(e, o, i), y(e < 120 ? e + 240 : e - 120, o, i),
          this.opacity)
      },
      displayable: function() {
    ...
    t(k, E, n(i, {
      ...
      rgb: function() {
        ...
        return t = J * T(t), e = ee * T(e), n = te * T(n), new f(C(3.1338561 * t - 1.6168667 * e - .4906146 *
          n), C(-.9787684 * t + 1.9161415 * e + .033454 * n), C(.0719453 * t - .2289914 * e + 1.4052427 *
          n), this.opacity)
      }
    })), t(R, M, n(i, {
      brighter: function(e) {
    ...
    t(L, N, n(i, {
        ...
        rgb: function() {
          var e = isNaN(this.h) ? 0 : (this.h + 120) * X,
            ...
            i = Math.cos(e),
            o = Math.sin(e);
          return new f(255 * (t + n * (ae * i + le * o)), 255 * (t + n * (se * i + de * o)), 255 * (t + n * (
            ce * i)), this.opacity)
        }
      })), e.color = l, e.cubehelix = N, e.gray = S, e.hcl = M, e.hsl = x, e.lab = E, e.lch = I, e.rgb = u, Object
