// ─────────────────────────────────────────────────────────────
// APP MODULE 250
// role       : controller PreferencesNotificationsController
// requires   : (none)
...
function(e, t, n) {
  ...
  var r = n(8),
    ...
    d = n(1);
  n(93);
  d.ngMainModule.controller("PreferencesNotificationsController", ["$log", "$scope", "$state", "eventAggregator",
    "oscNotificationService", "telemetryService", "nvCameraService", "KEYBOARD_EVENTS", "TELEMETRY_OSC_EVENT_NAMES",
    "quietMode2Service", "piplConfigService", "COMMON_EVENTS",
    function(e, t, n, i, o, r, l, d, c, u, f, m) {
      function g() {
        var e = !1,
          t = !1;
        s.forEach(b.notifiers, function(n) {
          s.isUndefined(n.viewHeader) && n.available && (n.enabled ? t = !0 : s.isUndefined(n.enabled) || s
            .isUndefined(n.name) || (e = !0))
      ...
      function h(e) {
        x.info("Connect status:", e.isConnectEnabled), b.isConnectEnabled = e.isConnectEnabled, b.notifiers = o
          .getConfigs()
      }
      var b = this;
      b.title = "l10n.settings", b.icon = "icon-settings", b.status = "", b.globalToggle = !1, b.notifiers = {};
      ...
      b.checkExperimentalFeatures = function() {
        return l.isGfeAnselSupported().then(function(e) {
          x.info("GFE-IPC-Ansel Supported? " + e), e === !1 ? b.notifiers.anselReadyAppStarted.name = void 0 :
            b.notifiers.anselReadyAppStarted.name = "l10n.openAnsel", b.notifiers.anselHeader.viewHeader = e
        }, function(e) {
        ...
        f.isConnectEnabled().then(function(e) {
          ...
          i.on(m.PIPL_CONFIG_UPDATED, h), b.notifiers = o.getConfigs(), b.checkExperimentalFeatures().then(
            function() {
              g()
            }), p()
        })
        ...
        r.push(c.OSC_PREFERENCES_NOTIFICATIONS_CHANGED, e), o.setConfigs(b.notifiers), i.off(d.ESCAPE, b.done),
          i.off(m.PIPL_CONFIG_UPDATED, h)
      })
    }
  ])
}
