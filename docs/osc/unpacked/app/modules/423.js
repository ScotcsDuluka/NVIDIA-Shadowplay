...
function(e, t, n) {
  ...
  var i = n(21),
    ...
    X = function(e, t, n) {
      return e === B && X(H, t, n), x(e), t = S(t, !0), x(n), o(V, t) ? (n.enumerable ? (o(e, F) && e[F][t] && (e[F][
        t] = !1), n = k(n, {
        enumerable: E(0, !1)
    ...
    J = function(e) {
      ...
      return !(this === B && o(V, e) && !o(H, e)) && (!(t || !o(this, e) || !o(V, e) || o(this, F) && this[F][e]) || t)
    },
    ee = function(e, t) {
    ...
    te = function(e) {
      for (var t, n = R(w(e)), i = [], r = 0; n.length > r;) o(V, t = n[r++]) || t == F || t == s || i.push(t);
      return i
    },
    ne = function(e) {
      for (var t, n = e === B, i = R(n ? H : w(e)), r = [], a = 0; i.length > a;) !o(V, t = i[a++]) || n && !o(B, t) ||
        r.push(V[t]);
      return r
    };
  Y || (P = function() {
    ...
    return this._k
  }), T.f = ee, O.f = X, n(120).f = _.f = te, n(54).f = J, C.f = ne, r && !n(52) && l(B, "propertyIsEnumerable", J,
    !0), g.f = function(e) {
    return K(m(e))
  }), a(a.G + a.W + a.F * !Y, {
    Symbol: P
  ...
  }), P[L][U] || n(27)(P[L], U, P[L].valueOf), u(P, "Symbol"), u(Math, "Math", !0), u(i.JSON, "JSON", !0)
}
