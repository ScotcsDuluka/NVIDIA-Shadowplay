...
function(e, t, n) {
  ...
  var l = a.ngMainCommonModule.service("oscTargetService", ["$log", "$q", "telemetryService", "targetService",
    ...
    "AB_HUB_SOCKET_EVENTS", "AB_HUB_MESSAGE_TYPES", "AB_STORE", "OSC_BUILD_INFO", "OSC_CONFIG", "COMMON_EVENTS",
    function(e, t, n, i, o, a, l, s, d, c, u, f, m, g, p, h) {
      ...
      function x(e) {
        O.event("AB Context updated", e), e.messageType === f.SYNC && n.syncExperienceControlInfo(e.experiments)
      }
      ...
      function w(e) {
        ...
        t.all([n, i]).then(function(t) {
          ...
          if (n || i)
            ...
            addExperimentDeferred.resolve(!0)) : (a = I.activeExperiments || [], a.push(e), I.persist_());
          k("add", f.ADD, e)
        })
      }
      ...
      function _(e, n) {
        ...
        return t.all([i, o]).then(function(t) {
          var n = t[0],
            ...
            o = {},
            a = [];
          n || i ? (n ? (a = A.activeExperiments, o = E(a, e), A.activeExperiments = T(a, e), A.persist_()) : (
            a = I.activeExperiments, o = E(a, e), I.activeExperiments = T(a, e), I.persist_()), r.resolve(!!
            o), k("remove", f.DELETE, o)) : r.resolve(!1)
        }), r.promise
      }
      ...
      C.updateLoginStatus = function() {
        ...
        e && e.userId ? (O.info("Setting user to " + e.userId), D.userId = e.userId, a.syncUser(m.AB_STORE_NAME, e
            .userId), A = a.getCachedUserItem(e.userId, m.AB_STORE_NAME, m.USER_AB_STATE)) : A = null, C
          .setMboxThirdPartyId(e && e.userId)
      }, C.init = function() {
        i.setExperimentMbox(p.windowName), C.updateLoginStatus(), I = a.getCachedGlobalItem(m.AB_STORE_NAME, m
          .USER_AB_STATE), i.setQaConfig(p.experienceControlQa), b(), d.register(u.AB_CONTEXT_UPDATED, h
          .AB_CONTEXT_UPDATED), o.on(h.AB_CONTEXT_UPDATED, x), d.register(u.AB_HUB_STATUS_UPDATED, h
          .AB_HUB_STATUS_UPDATED), o.on(h.AB_HUB_STATUS_UPDATED, v)
        ...
        return i.getVariant(e).then(function(e) {
          ...
          e && (e.apiFailure ? (n && O.info("Tracking failure telemetry for activity id: ", r), y(r).then(
            function(t) {
              t ? (O.info("api failure for get variant, resolving saved experiment data", e), o.resolve(
                t.data)) : (O.info("api failure for get variant, no saved data found"), o.reject(e))
            })) : (_(r, !0), o.reject(e)))
        }), o.promise
