// ─────────────────────────────────────────────────────────────
// APP MODULE 205
// role       : provider nvCameraEndpoints
// defines    : angular.module("main.localSdk.nvCameraSdk")
// requires   : (none)
    ...
    return {
      ...
      $get: ["NvEndpointFactory", "localSdk", function(n, i) {
        var o, r, a, l, s, d, c, u, f, m, g, p, h, b, x, v, y, w, S, E, k, _, T, C, O, A, I, M, R, P, D, N, L,
          F, U, z, G, V, H, B = i.newLocalEndpointFactory("NvCamera", e),
