...
function(e, t, n) {
  ! function(e, n) {
    ...
    function s() {
      for (var e, t, n = f, i = 1 / 0; n;) n._call ? (i > n._time && (i = n._time), e = n, n = n._next) : (t = n
    ...
    function d(e) {
      if (!g) {
        p && (p = clearTimeout(p));
        var t = e - v;
        t > 24 ? (e < 1 / 0 && (p = setTimeout(a, e - w.now() - y)), h && (h = clearInterval(h))) : (h || (x = w
        .now(), h = setInterval(l, b)), g = 1, S(a))
      }
    }
    ...
    function u(e, n, o) {
      var r = new i,
        a = n;
      return null == n ? (r.restart(e, n, o), r) : (n = +n, o = null == o ? t() : +o, r.restart(function t(i) {
    ...
    var f, m, g = 0,
      ...
      S = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) :
      function(e) {
        setTimeout(e, 17)
      };
    i.prototype = o.prototype = {
      ...
      restart: function(e, n, i) {
        ...
        i = (null == i ? t() : +i) + (null == n ? 0 : +n), this._next || m === this || (m ? m._next = this : f =
          this, m = this), this._call = e, this._time = i, d()
      },
      stop: function() {
