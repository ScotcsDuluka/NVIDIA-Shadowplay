  ...
  var l = a.ngMainCommonModule.service("webrtcP2PService", ["$log", "$q", "websocketService",
    ...
    function(e, t, n, i) {
      var o = {
        ...
        d = function(e) {
          var t = this;
          t.id = e, t.host = null, t.incomingSocket = null, t.outgoingSocket = null, t.localVideoCB = [], t
            .remoteVideoCB = [], t.hangupCB = [], t.proxyUrl = null, t.proxySessionId = null, t.rtcPeerConnection =
            null, t.remoteVideoStream = null, t.verbose = !1, t.micMuted = !1, t.remoteAudioMuted = !1, t
            .cameraMuted = !1, t.muteMicrophone = function(e) {
              t.micMuted = e, s(t)("Set microphone mute", e), t.rtcPeerConnection && t.rtcPeerConnection.setMicMute(
                e)
              ...
              t.cameraMuted = e, s(t)("Set camera mute", e), t.rtcPeerConnection && t.rtcPeerConnection.setCamMute(
                e)
              ...
              navigator.mediaDevices.enumerateDevices().then(function(n) {
                ...
                if (i)
                  for (var o = i.deviceId, r = 0; r < t.remoteVideoCB.length; ++r) t.remoteVideoCB[r](t
                    .remoteVideoStream, !1, o)
              })
        ...
        c = function(t) {
          var n = this;
          n.localStream = null, n.remoteDesc = null, n.peerConnection = null, n.storedIceCandidates = [], n
            .muteAudio = !1, n.muteVideo = !1;
          var a = function() {
          ...
          var s = function(e) {
            ...
            c = function(e) {
              return function(i) {
                ...
                var o = {};
                e ? (o.webrtc_type = "offer", o.do_audio = t.audioEnabled, o.do_video = t.videoEnabled) : o
                  .webrtc_type = "answer", o.sessioninfo = i, t.onSendData(o)
              }
            },
            u = function(e) {
              n.peerConnection = i.newRTCPeerConnection(o), n.peerConnection.onicecandidate = d, n.peerConnection
                .onaddstream = t.onRemoteStream, n.peerConnection.addStream(n.localStream), e ? (a()(
                  "Creating Offer"), n.peerConnection.createOffer(c(!0), function(e) {
                  a()("offer error: " + e)
                })) : (a()("Creating Answer", n.remoteDesc), n.peerConnection.setRemoteDescription(n.remoteDesc), n
                  .peerConnection.createAnswer(c(!1), function(e) {
                    a()("answer error: " + e)
            ...
            f = function(e) {
              return function(i) {
                n.localStream = i, i.getVideoTracks().length > 0 && a()("Using video device:" + i
                  .getVideoTracks()[0].label), i.getAudioTracks().length > 0 && a()("Using audio device:" + i
                    .getAudioTracks()[0].label), t.onLocalStream && t.onLocalStream(i), n.setMicMute(n.muteAudio),
                  n.setCamMute(n.muteVideo), a()("Got local stream. Create peer connection"), u(e)
              }
            },
            m = function(o) {
          ...
          this.createOffer = function() {
            ...
            a()("Creating answer to host aud=" + t.audioEnabled + " vid=" + t.videoEnabled, e), n.remoteDesc = i
              .newRTCSessionDescription(e), m(!1)
          }, this.beginCall = function(e) {
            a()("Accepting answer from guest"), n.remoteDesc = i.newRTCSessionDescription(e), n.peerConnection
              .setRemoteDescription(n.remoteDesc), n.addRemoteIceCandidates([])
            ...
            a()("setting microphone mute=" + e), n.muteAudio = e, n.localStream && n.localStream.getAudioTracks()[
              0] && (n.localStream.getAudioTracks()[0].enabled = !e)
          }, this.setCamMute = function(e) {
            a()("setting camera mute=" + e), n.muteVideo = e, n.localStream && n.localStream.getVideoTracks()[
              0] && (n.localStream.getVideoTracks()[0].enabled = !e)
            ...
            t.onSendData(e), n.localStream.getTracks().forEach(function(e) {
                e.stop()
              }), n.peerConnection.close(), n.peerConnection = null, n.gotRemoteDesc = !1, n.localStream = null, t
              .onRemoteStream && t.onRemoteStream(null), t.onLocalStream && t.onLocalStream(null)
          }
        },
        u = function(e, t, i, o) {
          var r = new URL(e);
          return o ? (t += i ? "_guest" : "_host", e = "wss://" + r.hostname + ":47984/upgrade?sessionid=" + t) : (
            t += i ? "_host" : "_guest", e = "wss://" + r.hostname + "/server/" + t), n.create(e)
        },
        f = function(e) {
          return e in a || (a[e] = new d(e)), a[e]
        },
        m = function(e) {
          e.rtcPeerConnection && (e.rtcPeerConnection.hangup(), e.rtcPeerConnection = null, e.host = null), e
            .outgoingSocket && (e.outgoingSocket.close(), e.outgoingSocket = null), e.incomingSocket && (e
              .incomingSocket.close(), e.incomingSocket = null);
        ...
        g = {
          ...
          answer: function(e, t) {
            var n = t.sessioninfo;
            s(e)("got answer ", t), e.initMuteStates(), e.rtcPeerConnection.beginCall(n), "icecandidates" in t &&
      ...
      this.registerLocalVideoCallback = function(e, t) {
        ...
        var i = f(e);
        if (i.remoteVideoCB.length < 1) throw "Error: Need to at least have one remote video tag registered";
      ...
      function() {
        ...
        var i = f(e);
        if (i.remoteVideoCB.length < 1) throw "Error: Need to at least have one remote video tag registered";
        i.proxyUrl = n.proxyAddress, i.proxySessionId = n.proxySessionId, i.host = !0, i.rtcPeerConnection =
          new c({
            name: i.id + ".host",
      ...
      function() {
          s(i)("Listening for messages from guest on", i.incomingSocket.url()), i.outgoingSocket = u(i
            .proxyUrl, i.proxySessionId, !0, !0), i.outgoingSocket.on("$open", function() {
