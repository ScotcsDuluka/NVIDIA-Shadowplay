...
function(e, t, n) {
  ! function(e, i) {
    ...
    function i(e) {
      for (var t = 0, n = e.length, i = e[n - 1][1] * e[0][0] - e[n - 1][0] * e[0][1]; ++t < n;) i += e[t - 1][1] * e[
        t][0] - e[t - 1][0] * e[t][1];
      return i
    }
    ...
    function u() {
      ...
      function l(e, t, n) {
        function i(e) {
          var t, i, a = [e[0][0] + o, e[0][1] + r],
            l = [e[1][0] + o, e[1][1] + r],
            d = s(a),
            c = s(l);
          (t = g[d]) ? (i = m[c]) ? (delete g[t.end], delete m[i.start], t === i ? (t.ring.push(l), n(t.ring)) : m[t
            .start] = g[i.end] = {
            start: t.start,
            end: i.end,
            ring: t.ring.concat(i.ring)
          }) : (delete g[t.end], t.ring.push(l), g[t.end = c] = t) : (t = m[c]) ? (i = g[d]) ? (delete m[t.start],
            delete g[i.end], t === i ? (t.ring.push(l), n(t.ring)) : m[i.start] = g[t.end] = {
              start: i.start,
              end: t.end,
        ...
        var o, r, a, l, d, c, m = new Array,
          g = new Array;
        for (o = r = -1, l = e[0] >= t, y[l << 1].forEach(i); ++o < u - 1;) a = l, l = e[o + 1] >= t, y[a | l << 1]
          .forEach(i);
        for (y[l << 0].forEach(i); ++r < f - 1;) {
          for (o = -1, l = e[r * u + u] >= t, d = e[r * u] >= t, y[l << 1 | d << 2].forEach(i); ++o < u - 1;) a = l,
            l = e[r * u + u + o + 1] >= t, c = d, d = e[r * u + o + 1] >= t, y[a | l << 1 | d << 2 | c << 3].forEach(
              i);
          y[l | d << 3].forEach(i)
        }
        for (o = -1, d = e[r * u] >= t, y[d << 2].forEach(i); ++o < u - 1;) c = d, d = e[r * u + o + 1] >= t, y[d <<
          2 | c << 3].forEach(i);
        y[d << 3].forEach(i)
      }
      ...
      function d(e, t, n) {
        e.forEach(function(e) {
          var i, o = e[0],
            ...
            l = 0 | r,
            s = t[l * u + a];
          o > 0 && o < u && a === o && (i = t[l * u + a - 1], e[0] = o + (n - i) / (s - i) - .5), r > 0 && r <
            f && l === r && (i = t[(l - 1) * u + a], e[1] = r + (n - i) / (s - i) - .5)
        })
      }
      var u = 1,
        f = 1,
      ...
      return e.contour = a, e.size = function(t) {
        ...
        return arguments.length ? (m = "function" == typeof t ? t : o(Array.isArray(t) ? v.call(t) : t), e) : m
      }, e.smooth = function(t) {
    ...
    function f(e, t, n) {
      for (var i = e.width, o = e.height, r = (n << 1) + 1, a = 0; a < o; ++a)
        for (var l = 0, s = 0; l < i + n; ++l) l < i && (s += e.data[l + a * i]), l >= n && (l >= r && (s -= e.data[
          l - r + a * i]), t.data[l - n + a * i] = s / Math.min(l + 1, i - 1 + r - l, r))
    }

    function m(e, t, n) {
      for (var i = e.width, o = e.height, r = (n << 1) + 1, a = 0; a < i; ++a)
        for (var l = 0, s = 0; l < o + n; ++l) l < o && (s += e.data[a + l * i]), l >= n && (l >= r && (s -= e.data[
          a + (l - r) * i]), t.data[a + (l - n) * i] = s / Math.min(l + 1, o - 1 + r - l, r))
    }
    ...
    function b() {
      ...
      return e.x = function(t) {
        ...
        return arguments.length ? (_ = "function" == typeof t ? t : o(Array.isArray(t) ? v.call(t) : t), e) : _
