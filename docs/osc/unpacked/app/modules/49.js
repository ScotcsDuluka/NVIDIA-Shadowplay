// ─────────────────────────────────────────────────────────────
// APP MODULE 49
// role       : service ugcService
// requires   : (none)
// cefQuery   : QUERY_HTTPSERVER_START
...
function(e, t, n) {
  ...
  var l = a.ngMainCommonModule.service("ugcService", ["$q", "$log", "$window", "$timeout", "hardwareService",
    ...
    "oscGalleryService", "socketService", "eventAggregator", "runTimeConfigService", "hardwareConfigWrapper",
    "recordingPathConfigWrapper", "twitchIngestServerConfigWrapper", "shotWithGeForceService", "oscTargetService",
    "cefService", "OSC_CONFIG", "COMMON_EVENTS", "ACCOUNT_SOCKET_EVENTS", "ACCOUNT_EVENTS", "CONNECT_EVENTS",
    "OSC_EVENTS", "NOTIFIER_SELECTIONS", "piplConfigService",
    function(e, t, n, i, o, a, l, s, d, c, u, f, m, g, p, h, b, x, v, y, w, S, E, k, _, T, C, O) {
      ...
      D.info("ugcService created"), R.setupHwConfig = function() {
        ...
        return f.register(E.USER_TOKEN_CHANGED, k.USER_TOKEN_CHANGED), m.on(k.USER_TOKEN_CHANGED, R
          .onUserTokenChanged), m.on(T.OSC_STATE, M), m.on(S.PIPL_CONFIG_UPDATED, I), g.init(w), h.init(t
          .getRecordingPaths), b.init(t.getPreferredTwitchIngestServer), O.isConnectEnabled().then(function(t) {
        ...
        D.info("logInFromBrowser, service:", e, t, r), y.isInDesktopMode().then(function(a) {
          if (a) {
            ...
            var c, u = [2259, 6460, 7119, 8870, 9096],
              f = "https://google.com",
              g = ["error"],
              p = {
            ...
            y.query(p, !0).then(angular.noop, angular.noop, function(a) {
              ...
              if ("serverCreated" === a.callbackReason) {
                ...
                c = a.portNumber, f = f.replace("{{portNumber}}", c.toString()), u = n.open(f, "_blank")
                ...
                p = p.replace("{{portNumber}}", c.toString()), d.setAuthToken(e, m, p), u && (u.close(),
                  u = null), i(function() {
                  r ? s.show(C.LOGIN_COMPLETED_WINDOWED_GAME_BROADCAST, e) : l.openOSC(t, o)
                }, 0)
              }
            })
