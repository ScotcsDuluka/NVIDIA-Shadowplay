...
Partial Class NVIDIA_Shadowplay_Helper
    ...
    Private Sub InitializeComponent()
        ...
        Mode_EngineOverlay = New NvToggleButton()
        Mode_EngineLabel = New Label()
        ...
        Panel_MAIN.Controls.Add(Mode_EngineOverlay)
        Panel_MAIN.Controls.Add(Mode_EngineLabel)
        ...
        NvIconButton3.ButtonVariant = Launcher.NvIconButton.IconVariant.Ghost
        ...
        RadioButton2.ButtonSizeSetting = Launcher.NvButton.NvBtnSize.Small
        RadioButton2.ButtonVariant = Launcher.NvButton.NvButtonVariant.Blue
        ...
        openoverlay.ButtonSizeSetting = Launcher.NvButton.NvBtnSize.Large
        openoverlay.ButtonVariant = Launcher.NvButton.NvButtonVariant.Green
        openoverlay.CornerRadius = 10
        openoverlay.Font = New Font("Bahnschrift", 11F, FontStyle.Bold)
        openoverlay.ForeColor = Color.White
        openoverlay.Location = New Point(834, 0)
        ...
        Use_Overlay.SizeMode = Launcher.NvToggleButton.ToggleSizeMode.Small
        ...
        ' Mode_EngineOverlay
        '
        Mode_EngineOverlay.BackColor = Color.FromArgb(CByte(30), CByte(32), CByte(35))
        Mode_EngineOverlay.IsOn = False
        Mode_EngineOverlay.Location = New Point(676, 296)
        Mode_EngineOverlay.Name = "Mode_EngineOverlay"
        Mode_EngineOverlay.OffColor = Color.FromArgb(CByte(74), CByte(74), CByte(74))
        Mode_EngineOverlay.OnColor = Color.FromArgb(CByte(118), CByte(185), CByte(0))
        Mode_EngineOverlay.ShowGlow = False
        Mode_EngineOverlay.Size = New Size(36, 20)
        Mode_EngineOverlay.SizeMode = NvToggleButton.ToggleSizeMode.Small
        Mode_EngineOverlay.TabIndex = 78
        Mode_EngineOverlay.Text = "NvToggleButton2"

        '
        ' Mode_EngineLabel
        '
        Mode_EngineLabel.AutoSize = True
        Mode_EngineLabel.ForeColor = Color.DimGray
        Mode_EngineLabel.Location = New Point(726, 298)
        Mode_EngineLabel.Name = "Mode_EngineLabel"
        Mode_EngineLabel.Size = New Size(190, 16)
        Mode_EngineLabel.TabIndex = 79
        Mode_EngineLabel.Text = "E N G I N E   O V E R L A Y"
        ' 
        ' UseOverlay_LBL
        ' 
        ...
        NvStatusDot_NVNOTIFIER.Status = Launcher.NvStatusDot.DotStatus.Stopped
        ...
        NvStatusDot_OVERLAYAPI.Status = Launcher.NvStatusDot.DotStatus.Stopped
        ...
        NvStatusDot_NVAPI.Status = Launcher.NvStatusDot.DotStatus.Stopped
        ...
        NvIconButton1.ButtonVariant = Launcher.NvIconButton.IconVariant.Ghost
    ...
    Friend WithEvents Mode_EngineOverlay As NvToggleButton
    Friend WithEvents Mode_EngineLabel As Label
