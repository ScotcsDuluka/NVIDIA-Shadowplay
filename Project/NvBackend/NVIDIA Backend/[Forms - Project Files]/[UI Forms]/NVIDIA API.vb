...
Public Class API_RUN
    ...
    Public Sub HandleAppsSmart()
        ...
        For Each app In apps
            ' Resolve each owner through the canonical deployment tree.
            ' Legacy Application\ and Overlay\ fallbacks remain in AppLayout.
            Dim exePath As String = AppLayout.ExePath(app)
