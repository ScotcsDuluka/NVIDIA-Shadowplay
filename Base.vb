...
Public Class Base
    ...
    Private Sub Logo_Click(sender As Object, e As EventArgs) Handles Logo.Click
        Notifier.Show()
        Notifier.icon_n.Text = ("")
        Notifier.text_n.Text = ("Press Alt + Z to use Shadowplay Experience in-game Notifier")
    End Sub
    ...
    Private Sub CheckForUpdates()
        Dim currentVersion As String = "2.47.341" ' เวอร์ชันที่ติดตั้งอยู่
    ...
    Private Sub upif(sender As Object, e As EventArgs)
        ...
        'Using stream = client.OpenRead("https://www.mediafire.com/file/rj9dkcisp18p3xf/2.47.341.text/file")
        'DisplayNotifierMessage("", "Version Shadowplay™ is latest.")
        'End Using
        'End Using
        'atch
        ...
        'End Try
        'Else
        'DisplayNotifierMessage("", "No internet connection found.")
        'End If
    End Sub
