...
- **Date:** 2026-09-04 12:54:37
- **Machine:**  · OS: Microsoft Windows NT 10.0.26340.0
- **FFmpeg:** $FFmpeg · **Screen:** 1680x1050 · **Seconds/scenario:** 3
...
|---|---|---|---|---|
| S1 | FPS | avg_frame_rate≈60 (config wins, not display) | 9050000/151903 → 59.58 fps | PASS |
| S2 | Resolution(native) | 1680x1050 | 1680x1050 | PASS |
| S3 | Resolution(custom) | 1280x720 | 1280x720 | PASS |
| S4 | Bitrate(CBR) | 10.2 Mbps ±40% (low-motion dips = WARN) | 10.34 Mbps | PASS |
