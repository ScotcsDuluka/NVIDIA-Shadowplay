...
Partial Public Class CaptureEngine
    ...
    Private Function DetectSystemFormat() As AudioFormatInfo
        Try
    ...
    Private Function DetectMicFormat(deviceId As String, deviceName As String) As AudioFormatInfo
        Try
            Using devEnum As New MMDeviceEnumerator()
    ...
    Private Shared Function WaveFormatToInfo(wf As WaveFormat) As AudioFormatInfo
