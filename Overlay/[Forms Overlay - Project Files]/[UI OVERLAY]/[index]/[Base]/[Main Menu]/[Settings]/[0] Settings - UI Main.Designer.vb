...
Partial Class Base_Settings
    ...
    Private Sub InitializeComponent()
        ...
        Panel.Controls.Add(ToggleToastSlot3)
        Panel.Controls.Add(Desc_ToastSlots3)
        ...
        ' ToggleToastSlot3
        ' 
        ToggleToastSlot3.BackColor = Color.FromArgb(CByte(38), CByte(43), CByte(47))
