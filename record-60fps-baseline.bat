@echo off
echo NVIDIA ShadowPlay 60 FPS Baseline Recording with 10ms Timeline Delay
echo ===========================================================
...
set LOG_FILE=%OUTPUT_DIR%\timing-forensic-60fps-baseline-%DATE:/=-%-%TIME::=-%.log
set OUTPUT_FILE=%OUTPUT_DIR%\baseline-60fps.mp4

REM Create output directory if it doesn't exist
if not exist "%OUTPUT_DIR%" mkdir "%OUTPUT_DIR%"

echo Starting 60 FPS baseline recording with 10ms timeline delay ON...
