...
Partial Class NVIDIA_Shadowplay_Helper
    ...
    Private Sub InitializeComponent()
        ...
        PictureBox8.Location = New Point(353, 11)
        PictureBox8.Name = "PictureBox8"
        PictureBox8.Size = New Size(376, 10)
        ...
        PictureBox7.Location = New Point(353, 560)
        PictureBox7.Name = "PictureBox7"
        PictureBox7.Size = New Size(376, 20)
        ...
        ' Use_Overlay
        ' 
        Use_Overlay.BackColor = Color.FromArgb(CByte(18), CByte(18), CByte(18))
        Use_Overlay.Font = New Font("Segoe UI Black", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Use_Overlay.ForeColor = Color.White
        Use_Overlay.Location = New Point(990, 25)
        Use_Overlay.Name = "Use_Overlay"
        Use_Overlay.Size = New Size(75, 22)
        Use_Overlay.TabIndex = 10
        Use_Overlay.Text = "ON/OFF"
        Use_Overlay.UseVisualStyleBackColor = False
        ' 
        ' Label1
        ' 
        ...
        Label1.Location = New Point(833, 97)
        Label1.Name = "Label1"
        ...
        overlay_text.Location = New Point(851, 24)
        overlay_text.Name = "overlay_text"
        overlay_text.Size = New Size(204, 23)
        overlay_text.TabIndex = 8
        overlay_text.Text = "NVIDIA OVERLAY"
        ' 
        ' Label2
        ' 
        Label2.BackColor = Color.FromArgb(CByte(30), CByte(30), CByte(30))
        Label2.Font = New Font("TypeTwo", 24F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        PictureBox1.Size = New Size(241, 128)
        ...
        PictureBox4.Location = New Point(353, 19)
        PictureBox4.Name = "PictureBox4"
        PictureBox4.Size = New Size(376, 544)
        ...
        PictureBox6.Location = New Point(833, 130)
        PictureBox6.Name = "PictureBox6"
        PictureBox6.Size = New Size(241, 20)
